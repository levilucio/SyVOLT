...
class HMotherFather_IsolatedLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        ...
        super(HMotherFather_IsolatedLHS, self).__init__(name='HMotherFather_IsolatedLHS', num_nodes=3, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = 1997444016527105233
...
return True
"""
        self.vs[0]["GUID__"] = 7542296199904250560
...
return True
"""
        self.vs[1]["GUID__"] = 5348606994341403064
...
return True
"""
        self.vs[2]["GUID__"] = 3019499363827439056
