...
class HFourMembers_ConnectedLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        ...
        super(HFourMembers_ConnectedLHS, self).__init__(name='HFourMembers_ConnectedLHS', num_nodes=9, edges=[])
        
        # Add the edges
        self.add_edges([(0, 1), (0, 2), (0, 3), (0, 4), (1, 6), (2, 5), (3, 7), (4, 8)])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('2d22c11c-db38-48b0-8fc9-dd2487185a78')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('69b20c30-8212-4bb9-a0f2-2bcfa89fd5a3')
...
.""")
        ...
        self.vs[1]["GUID__"] = UUID('d44a6c02-3fdf-4d27-89c3-45730db685ee')
...
.""")
        ...
        self.vs[2]["GUID__"] = UUID('55649502-1346-428e-a82c-bf21c690896c')
...
.""")
        ...
        self.vs[3]["GUID__"] = UUID('3ba46358-4cb4-4908-9a3d-9901fe0ed518')
...
.""")
        ...
        self.vs[4]["GUID__"] = UUID('6c3da4c7-6782-4502-86cf-989934f90593')
...
return True
"""
        self.vs[5]["GUID__"] = UUID('e0763fe8-37e8-4283-929a-836224db1711')
...
return True
"""
        self.vs[6]["GUID__"] = UUID('5a1615c6-1915-4550-89ab-467f09dee347')
...
return True
"""
        self.vs[7]["GUID__"] = UUID('5e488aa8-408d-44ed-bccc-1e6821afc197')
...
return True
"""
        self.vs[8]["GUID__"] = UUID('05850815-602b-4bde-8a48-39806aa752a6')
