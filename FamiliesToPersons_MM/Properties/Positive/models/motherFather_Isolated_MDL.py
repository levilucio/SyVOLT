"""
__motherFather_Isolated_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Fri Apr 17 13:30:59 2015
...
def motherFather_Isolated_MDL(self, rootNode, MT_pre__FamiliesToPersonsMMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('motherFather_Isolated')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_LHS(400.0,180.0,self.obj42)
       new_obj.DrawObject(self.UMLmodel)
...
newfunction = motherFather_Isolated_MDL
