"""
__motherFather_Connected_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Fri Apr 17 13:33:39 2015
...
def motherFather_Connected_MDL(self, rootNode, MT_pre__FamiliesToPersonsMMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('motherFather_Connected')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Family(560.0,360.0,self.obj37)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Member(420.0,280.0,self.obj38)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj42=MT_pre__directLink_S(self)
    ...
    # MT_label__
    self.obj42.MT_label__.setValue('6')
    ...
    self.obj42.MT_pre__associationType.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn attr_value == "father"\n')
    self.obj42.MT_pre__associationType.setHeight(15)

    self.obj42.graphClass_= graph_MT_pre__directLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_S(670.0,352.0,self.obj42)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_S(550.0,362.0,self.obj43)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_LHS(380.0,220.0,self.obj46)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj37,self.obj42,[620.0, 402.0, 670.0, 352.0],"true", 2),
(self.obj37,self.obj43,[620.0, 402.0, 550.0, 362.0],"true", 2) )
    ...
    # Connections for obj42 (graphObject_: Obj5) of type MT_pre__directLink_S
    self.drawConnections(
(self.obj42,self.obj39,[670.0, 352.0, 720.0, 302.0],"true", 2) )
    # Connections for obj43 (graphObject_: Obj6) of type MT_pre__directLink_S
    self.drawConnections(
(self.obj43,self.obj38,[550.0, 362.0, 480.0, 322.0],"true", 2) )
    # Connections for obj46 (graphObject_: Obj9) of type LHS
    self.drawConnections(
 )

newfunction = motherFather_Connected_MDL
