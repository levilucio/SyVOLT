"""
__daughterMother_Isolated_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Fri Apr 17 13:44:34 2015
...
def daughterMother_Isolated_MDL(self, rootNode, MT_pre__FamiliesToPersonsMMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('daughterMother_Isolated')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_LHS(360.0,180.0,self.obj60)
       new_obj.DrawObject(self.UMLmodel)
...
newfunction = daughterMother_Isolated_MDL
