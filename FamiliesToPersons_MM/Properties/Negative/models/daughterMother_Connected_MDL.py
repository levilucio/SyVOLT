"""
__daughterMother_Connected_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Fri Apr 17 13:43:04 2015
...
def daughterMother_Connected_MDL(self, rootNode, MT_pre__FamiliesToPersonsMMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('daughterMother_Connected')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_LHS(380.0,220.0,self.obj60)
       new_obj.DrawObject(self.UMLmodel)
...
newfunction = daughterMother_Connected_MDL
