"""
__apply_contains.py_____________________________________________________
...
class apply_contains(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_apply_contains
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = apply_contains( self.parent )
