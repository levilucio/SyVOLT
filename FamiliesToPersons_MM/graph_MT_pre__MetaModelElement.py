"""
__graph_MT_pre__MetaModelElement.py___________________________________________________________
...
class graph_MT_pre__MetaModelElement(graphEntity):
...
new_class = graph_MT_pre__MetaModelElement
