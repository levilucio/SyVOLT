"""
__Station_S.py_____________________________________________________
...
class Station_S(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MetaModelElement_S']
      self.graphClass_ = graph_Station_S
   ...
   def clone(self):
      cloneObject = Station_S( self.parent )
