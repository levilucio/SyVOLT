"""
__MT_post__Attribute.py_____________________________________________________
...
class MT_post__Attribute(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__Expression']
      self.graphClass_ = graph_MT_post__Attribute
      ...
      self.generatedAttributes = {'MT_post__name': ('ATOM3Text', ),
                                  'MT_label__': ('ATOM3String', ),
                                  'MT_pivotOut__': ('ATOM3String', )      }
      self.realOrder = ['MT_post__name','MT_label__','MT_pivotOut__']
      self.directEditing = [0,1,1]
   def clone(self):
      cloneObject = MT_post__Attribute( self.parent )
