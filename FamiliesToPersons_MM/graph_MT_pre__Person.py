"""
__graph_MT_pre__Person.py___________________________________________________________
...
class graph_MT_pre__Person(graphEntity):
...
new_class = graph_MT_pre__Person
