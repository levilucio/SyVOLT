"""
__graph_MT_post__Station.py___________________________________________________________
...
class graph_MT_post__Station(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([6.0, 3.0, 6.0, 12.0])[:2], tags = self.tag, font=font, fill = 'grey45', anchor = 'center', text = 'MT_post__Station', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__Station
