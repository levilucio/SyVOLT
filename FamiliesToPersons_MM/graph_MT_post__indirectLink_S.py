"""
__graph_MT_post__indirectLink_S.py___________________________________________________________

Automatically generated LINK for entity MT_post__indirectLink_S
...
class graph_MT_post__indirectLink_S(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "indirectLink_S")
      ...
      self.le.FirstLink.decoration.setValue( ('indirectLink_S_1stLink', self.le.FirstLink))
      self.le.FirstSegment= widthXfillXdecoration()
      self.le.FirstSegment.width=ATOM3Integer(2)
      self.le.FirstSegment.fill=ATOM3String('blue', 20)
      ...
      self.le.SecondSegment.decoration.setValue( ('indirectLink_S_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('indirectLink_S_2ndLink', self.le.SecondLink))
