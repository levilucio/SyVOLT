"""
__MT_post__GenericNode_.py_____________________________________________________
...
from graph_MT_post__GenericNode_ import *
class MT_post__GenericNode_(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_post__GenericNode_
   ...
   def clone(self):
      cloneObject = MT_post__GenericNode_( self.parent )
