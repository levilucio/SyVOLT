"""
__FamiliesToPersonsMM_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Fri Apr 17 14:22:13 2015
...
def FamiliesToPersonsMM_MDL(self, rootNode, CD_ClassDiagramsV3RootNode=None):

    # --- Generating attributes code for ASG CD_ClassDiagramsV3 ---
    if( CD_ClassDiagramsV3RootNode ): 
        # name
        CD_ClassDiagramsV3RootNode.name.setValue('FamiliesToPersonsMM')
    ...
    # Graphical_Appearance
    self.obj29.Graphical_Appearance.setValue( ('HouseholdRoot', self.obj29))

    # name
    self.obj29.name.setValue('HouseholdRoot')
    ...
    # Graphical_Appearance
    self.obj30.Graphical_Appearance.setValue( ('Family', self.obj30))

    # name
    self.obj30.name.setValue('Family')
    ...
    # Graphical_Appearance
    self.obj31.Graphical_Appearance.setValue( ('Member', self.obj31))

    # name
    self.obj31.name.setValue('Member')
    ...
    # Graphical_Appearance
    self.obj35.Graphical_Appearance.setValue( ('CommunityRoot', self.obj35))

    # name
    self.obj35.name.setValue('CommunityRoot')
    ...
    # Graphical_Appearance
    self.obj36.Graphical_Appearance.setValue( ('Person', self.obj36))

    # name
    self.obj36.name.setValue('Person')
    ...
    # Graphical_Appearance
    self.obj37.Graphical_Appearance.setValue( ('Man', self.obj37))

    # name
    self.obj37.name.setValue('Man')
    ...
    # Graphical_Appearance
    self.obj38.Graphical_Appearance.setValue( ('Attribute', self.obj38))

    # name
    self.obj38.name.setValue('Attribute')
    ...
    # Graphical_Appearance
    self.obj39.Graphical_Appearance.setValue( ('Equation', self.obj39))

    # name
    self.obj39.name.setValue('Equation')
    ...
    # Graphical_Appearance
    self.obj40.Graphical_Appearance.setValue( ('Expression', self.obj40))

    # name
    self.obj40.name.setValue('Expression')
    ...
    # Abstract
    self.obj40.Abstract.setValue((None, 1))
    ...
    # Graphical_Appearance
    self.obj41.Graphical_Appearance.setValue( ('Constant', self.obj41))

    # name
    self.obj41.name.setValue('Constant')
    ...
    # Graphical_Appearance
    self.obj42.Graphical_Appearance.setValue( ('Concat', self.obj42))

    # name
    self.obj42.name.setValue('Concat')
    ...
    # Graphical_Appearance
    self.obj79.Graphical_Appearance.setValue( ('Woman', self.obj79))

    # name
    self.obj79.name.setValue('Woman')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(540.0,920.0,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    # Graphical_Appearance
    self.obj43.Graphical_Appearance.setValue( ('match_contains', self.obj43))
    ...
    # name
    self.obj43.name.setValue('match_contains')
    ...
    # Graphical_Appearance
    self.obj44.Graphical_Appearance.setValue( ('apply_contains', self.obj44))
    ...
    # name
    self.obj44.name.setValue('apply_contains')
    ...
    # Graphical_Appearance
    self.obj45.Graphical_Appearance.setValue( ('backward_link', self.obj45))
    ...
    # name
    self.obj45.name.setValue('backward_link')
    ...
    # Graphical_Appearance
    self.obj46.Graphical_Appearance.setValue( ('indirectLink_S', self.obj46))
    ...
    # name
    self.obj46.name.setValue('indirectLink_S')
    ...
    # Graphical_Appearance
    self.obj47.Graphical_Appearance.setValue( ('directLink_T', self.obj47))
    ...
    # name
    self.obj47.name.setValue('directLink_T')
    ...
    # Graphical_Appearance
    self.obj48.Graphical_Appearance.setValue( ('directLink_S', self.obj48))
    ...
    # name
    self.obj48.name.setValue('directLink_S')
    ...
    # Graphical_Appearance
    self.obj50.Graphical_Appearance.setValue( ('trace_link', self.obj50))
    ...
    # name
    self.obj50.name.setValue('trace_link')
    ...
    # Graphical_Appearance
    self.obj51.Graphical_Appearance.setValue( ('hasAttr_S', self.obj51))
    ...
    # name
    self.obj51.name.setValue('hasAttr_S')
    ...
    # Graphical_Appearance
    self.obj52.Graphical_Appearance.setValue( ('hasAttr_T', self.obj52))
    ...
    # name
    self.obj52.name.setValue('hasAttr_T')
    ...
    # Graphical_Appearance
    self.obj53.Graphical_Appearance.setValue( ('leftExpr', self.obj53))
    ...
    # name
    self.obj53.name.setValue('leftExpr')
    ...
    # Graphical_Appearance
    self.obj54.Graphical_Appearance.setValue( ('rightExpr', self.obj54))
    ...
    # name
    self.obj54.name.setValue('rightExpr')
    ...
    # Graphical_Appearance
    self.obj55.Graphical_Appearance.setValue( ('arg_1', self.obj55))
    ...
    # name
    self.obj55.name.setValue('arg_1')
    ...
    # Graphical_Appearance
    self.obj56.Graphical_Appearance.setValue( ('arg_2', self.obj56))
    ...
    # name
    self.obj56.name.setValue('arg_2')
    ...
    self.obj82=CD_Inheritance3(self)
    self.obj82.isGraphObjectVisual = True

    if(hasattr(self.obj82, '_setHierarchicalLink')):
      self.obj82._setHierarchicalLink(False)

    self.obj82.graphClass_= graph_CD_Inheritance3
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(646.0,821.5,self.obj82)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
...
(self.obj28,self.obj46,[711.0, 192.98360655737704, 1026.0, 203.0, 1274.5, 81.5, 1274.5, 81.5],"true", 4),
...
(self.obj28,self.obj51,[711.0, 243.1081967213115, 1346.0, 240.975409836],"true", 2) )
    # Connections for obj29 (graphObject_: Obj1) named HouseholdRoot
    self.drawConnections(
(self.obj29,self.obj59,[436.0, 341.0, 468.4, 303.6],"true", 2) )
    # Connections for obj30 (graphObject_: Obj2) named Family
    self.drawConnections(
(self.obj30,self.obj57,[656.0, 341.0, 641.4, 303.6],"true", 2) )
    # Connections for obj31 (graphObject_: Obj3) named Member
    self.drawConnections(
...
(self.obj42,self.obj65,[1859.0, 721.0, 1831.0, 571.0],"true", 2) )
    # Connections for obj79 (graphObject_: Obj61) named Woman
    self.drawConnections(
(self.obj79,self.obj82,[656.0, 921.0, 646.0, 821.5],"true", 2) )
    # Connections for obj43 (graphObject_: Obj15) named match_contains
    self.drawConnections(
(self.obj43,self.obj28,[361.8, 199.8, 521.0, 192.98360655737704],"true", 2) )
    # Connections for obj44 (graphObject_: Obj17) named apply_contains
    self.drawConnections(
(self.obj44,self.obj34,[362.491532278, 586.86445, 521.0, 592.9016393442623],"true", 2) )
    # Connections for obj45 (graphObject_: Obj19) named backward_link
    self.drawConnections(
(self.obj45,self.obj28,[1245.0, 339.5, 1245.0, 254.5, 711.0, 243.1081967213115],"true", 3) )
    # Connections for obj46 (graphObject_: Obj21) named indirectLink_S
    self.drawConnections(
(self.obj46,self.obj28,[1274.5, 81.5, 1274.5, 81.5, 711.0, 192.98360655737704],"true", 3) )
    # Connections for obj47 (graphObject_: Obj23) named directLink_T
    self.drawConnections(
(self.obj47,self.obj34,[1193.0, 684.5, 1193.0, 684.5, 711.0, 696.1803278688525],"true", 3) )
    # Connections for obj48 (graphObject_: Obj25) named directLink_S
    self.drawConnections(
(self.obj48,self.obj28,[950.5, 86.5, 950.5, 86.5, 711.0, 192.98360655737704],"true", 3) )
    # Connections for obj49 (graphObject_: Obj27) named paired_with
    self.drawConnections(
(self.obj49,self.obj33,[136.0, 401.0, 136.0, 541.0],"true", 2) )
    # Connections for obj50 (graphObject_: Obj29) named trace_link
    self.drawConnections(
(self.obj50,self.obj28,[1242.0, 481.0, 937.0, 308.0, 711.0, 291.44262295081967],"true", 3) )
    # Connections for obj51 (graphObject_: Obj31) named hasAttr_S
    self.drawConnections(
(self.obj51,self.obj38,[1346.0, 240.97540983606558, 1516.0, 501.0],"true", 2) )
    # Connections for obj52 (graphObject_: Obj33) named hasAttr_T
    self.drawConnections(
(self.obj52,self.obj38,[1292.49804688, 838.905737705, 1481.0, 621.0],"true", 2) )
    # Connections for obj53 (graphObject_: Obj35) named leftExpr
    self.drawConnections(
(self.obj53,self.obj40,[1618.0, 211.0, 1683.0, 281.0],"true", 2) )
    # Connections for obj54 (graphObject_: Obj37) named rightExpr
    self.drawConnections(
(self.obj54,self.obj40,[1866.15625, 208.0, 1803.0, 281.0],"true", 2) )
    # Connections for obj55 (graphObject_: Obj39) named arg_1
    self.drawConnections(
(self.obj55,self.obj40,[1780.0, 551.0, 1763.0, 421.0],"true", 2) )
    # Connections for obj56 (graphObject_: Obj41) named arg_2
    self.drawConnections(
...
(self.obj65,self.obj40,[1831.0, 571.0, 1803.0, 421.0],"true", 2) )
    # Connections for obj82 (graphObject_: Obj62) of type CD_Inheritance3
    self.drawConnections(
(self.obj82,self.obj34,[646.0, 821.5, 636.0, 722.0],"true", 2) )

newfunction = FamiliesToPersonsMM_MDL
