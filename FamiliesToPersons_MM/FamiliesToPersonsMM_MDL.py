...
Author: levi
Modified: Fri Apr 17 11:06:49 2015
...
def FamiliesToPersonsMM_MDL(self, rootNode, CD_ClassDiagramsV3RootNode=None):
    ...
    if self.genGraphics:
       ...
       new_obj.layConstraints['scale'] = [1.0, 1.6524590163934427]
    else: new_obj = None
    ...
    if self.genGraphics:
       ...
       new_obj.layConstraints['scale'] = [1.0, 1.1618852459016393]
    else: new_obj = None
    ...
    # Graphical_Appearance
    self.obj38.Graphical_Appearance.setValue( ('Woman', self.obj38))

    # name
    self.obj38.name.setValue('Woman')
    ...
    # Graphical_Appearance
    self.obj39.Graphical_Appearance.setValue( ('match_contains', self.obj39))
    ...
    # name
    self.obj39.name.setValue('match_contains')
    ...
    # Graphical_Appearance
    self.obj40.Graphical_Appearance.setValue( ('apply_contains', self.obj40))
    ...
    # name
    self.obj40.name.setValue('apply_contains')
    ...
    # Graphical_Appearance
    self.obj41.Graphical_Appearance.setValue( ('backward_link', self.obj41))
    ...
    # name
    self.obj41.name.setValue('backward_link')
    ...
    # Graphical_Appearance
    self.obj42.Graphical_Appearance.setValue( ('indirectLink_S', self.obj42))
    ...
    # name
    self.obj42.name.setValue('indirectLink_S')
    ...
    # Graphical_Appearance
    self.obj43.Graphical_Appearance.setValue( ('directLink_T', self.obj43))
    ...
    # name
    self.obj43.name.setValue('directLink_T')
    ...
    # Graphical_Appearance
    self.obj44.Graphical_Appearance.setValue( ('directLink_S', self.obj44))
    ...
    # name
    self.obj44.name.setValue('directLink_S')
    ...
    # Graphical_Appearance
    self.obj45.Graphical_Appearance.setValue( ('paired_with', self.obj45))
    ...
    # name
    self.obj45.name.setValue('paired_with')
    ...
    # Graphical_Appearance
    self.obj46.Graphical_Appearance.setValue( ('trace_link', self.obj46))
    ...
    # name
    self.obj46.name.setValue('trace_link')
