"""
__directLink_T.py_____________________________________________________
...
class directLink_T(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_directLink_T
   ...
   def clone(self):
      cloneObject = directLink_T( self.parent )
