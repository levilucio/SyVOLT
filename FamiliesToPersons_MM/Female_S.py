"""
__Female_S.py_____________________________________________________
...
class Female_S(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MetaModelElement_S']
      self.graphClass_ = graph_Female_S
   ...
   def clone(self):
      cloneObject = Female_S( self.parent )
