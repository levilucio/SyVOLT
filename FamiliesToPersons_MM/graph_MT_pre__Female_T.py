"""
__graph_MT_pre__Female_T.py___________________________________________________________
...
class graph_MT_pre__Female_T(graphEntity):
...
new_class = graph_MT_pre__Female_T
