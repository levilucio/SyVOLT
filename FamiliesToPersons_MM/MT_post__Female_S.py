"""
__MT_post__Female_S.py_____________________________________________________
...
class MT_post__Female_S(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__MetaModelElement_S']
      self.graphClass_ = graph_MT_post__Female_S
   ...
   def clone(self):
      cloneObject = MT_post__Female_S( self.parent )
