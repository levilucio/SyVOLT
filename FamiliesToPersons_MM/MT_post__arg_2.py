"""
__MT_post__arg_2.py_____________________________________________________
...
from graph_MT_post__arg_2 import *
class MT_post__arg_2(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_post__arg_2
   ...
   def clone(self):
      cloneObject = MT_post__arg_2( self.parent )
