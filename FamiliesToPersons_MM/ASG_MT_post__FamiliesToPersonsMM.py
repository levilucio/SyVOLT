"""
__ASG_MT_post__FamiliesToPersonsMM.py_____________________________________________________
...
class ASG_MT_post__FamiliesToPersonsMM(ASG, ATOM3Type):
   ...
   def open(self, parent, topWindowParent):
       from ATOM3 import *
       a = ATOM3(topWindowParent, 'MT_post__FamiliesToPersonsMM', 0, 1, self)
