"""
__MT_post__GenericEdge_FamiliesToPersonsMM.py_____________________________________________________
...
from graph_MT_post__GenericEdge_FamiliesToPersonsMM import *
class MT_post__GenericEdge_FamiliesToPersonsMM(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_post__GenericEdge_FamiliesToPersonsMM
   ...
   def clone(self):
      cloneObject = MT_post__GenericEdge_FamiliesToPersonsMM( self.parent )
