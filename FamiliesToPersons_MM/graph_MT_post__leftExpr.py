...
class graph_MT_post__leftExpr(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le=linkEditor(self,self.semObject, "leftExpr")
      ...
      self.le.FirstLink.decoration.setValue( ('leftExpr_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('leftExpr_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('leftExpr_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('leftExpr_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('leftExpr_2ndLink', self.le.SecondLink))
