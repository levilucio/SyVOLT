"""
__graph_MT_post__HouseholdRoot.py___________________________________________________________
...
class graph_MT_post__HouseholdRoot(graphEntity):
...
new_class = graph_MT_post__HouseholdRoot
