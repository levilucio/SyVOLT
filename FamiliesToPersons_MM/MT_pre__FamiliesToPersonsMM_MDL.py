...
Author: levi
Modified: Fri Apr 17 14:22:57 2015
...
def MT_pre__FamiliesToPersonsMM_MDL(self, rootNode, CD_ClassDiagramsV3RootNode=None):
    ...
    # Graphical_Appearance
    self.obj43.Graphical_Appearance.setValue( ('MT_pre__Woman', self.obj43))

    # name
    self.obj43.name.setValue('MT_pre__Woman')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(540.0,920.0,self.obj43)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [2.05625, 1.0]
    ...
    # Graphical_Appearance
    self.obj68.Graphical_Appearance.setValue( ('MT_pre__GenericNode_FamiliesToPersonsMM', self.obj68))

    # name
    self.obj68.name.setValue('MT_pre__GenericNode_FamiliesToPersonsMM')
    ...
    # Abstract
    self.obj68.Abstract.setValue((None, 0))
    ...
    # display
    self.obj68.display.setValue('Multiplicities:\n  - To GenericEdge_FamiliesToPersonsMM: 0 to N\n  - From GenericEdge_FamiliesToPersonsMM: 0 to N\n')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(0.0,0.0,self.obj68)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [2.05625, 1.0]
    ...
    # Graphical_Appearance
    self.obj44.Graphical_Appearance.setValue( ('MT_pre__match_contains', self.obj44))
    self.obj44.Graphical_Appearance.linkInfo=linkEditor(self,self.obj44.Graphical_Appearance.semObject, "match_contains")
    ...
    self.obj44.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('match_contains_1stLink', self.obj44.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj44.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('match_contains_1stSegment', self.obj44.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj44.Graphical_Appearance.linkInfo.Center.setValue( ('match_contains_Center', self.obj44.Graphical_Appearance.linkInfo))
    ...
    self.obj44.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('match_contains_2ndSegment', self.obj44.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj44.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('match_contains_2ndLink', self.obj44.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj44.name.setValue('MT_pre__match_contains')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(361.8,199.8,self.obj44)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # Graphical_Appearance
    self.obj45.Graphical_Appearance.setValue( ('MT_pre__apply_contains', self.obj45))
    self.obj45.Graphical_Appearance.linkInfo=linkEditor(self,self.obj45.Graphical_Appearance.semObject, "apply_contains")
    ...
    self.obj45.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('apply_contains_1stLink', self.obj45.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj45.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('apply_contains_1stSegment', self.obj45.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj45.Graphical_Appearance.linkInfo.Center.setValue( ('apply_contains_Center', self.obj45.Graphical_Appearance.linkInfo))
    ...
    self.obj45.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('apply_contains_2ndSegment', self.obj45.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj45.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('apply_contains_2ndLink', self.obj45.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj45.name.setValue('MT_pre__apply_contains')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(362.491532278,586.86445,self.obj45)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 0.8
    ...
    # Graphical_Appearance
    self.obj46.Graphical_Appearance.setValue( ('MT_pre__backward_link', self.obj46))
    self.obj46.Graphical_Appearance.linkInfo=linkEditor(self,self.obj46.Graphical_Appearance.semObject, "backward_link")
    ...
    self.obj46.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('backward_link_1stLink', self.obj46.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj46.Graphical_Appearance.linkInfo.FirstSegment.fill=ATOM3String('grey', 20)
    ...
    self.obj46.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('backward_link_1stSegment', self.obj46.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj46.Graphical_Appearance.linkInfo.Center.setValue( ('backward_link_Center', self.obj46.Graphical_Appearance.linkInfo))
    ...
    self.obj46.Graphical_Appearance.linkInfo.SecondSegment.fill=ATOM3String('grey', 20)
    ...
    self.obj46.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('backward_link_2ndSegment', self.obj46.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj46.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('backward_link_2ndLink', self.obj46.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj46.name.setValue('MT_pre__backward_link')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1245.0,339.5,self.obj46)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj47.Graphical_Appearance.setValue( ('MT_pre__indirectLink_S', self.obj47))
    self.obj47.Graphical_Appearance.linkInfo=linkEditor(self,self.obj47.Graphical_Appearance.semObject, "indirectLink_S")
    ...
    self.obj47.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('indirectLink_S_1stLink', self.obj47.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj47.Graphical_Appearance.linkInfo.FirstSegment.fill=ATOM3String('blue', 20)
    ...
    self.obj47.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('indirectLink_S_1stSegment', self.obj47.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj47.Graphical_Appearance.linkInfo.Center.setValue( ('indirectLink_S_Center', self.obj47.Graphical_Appearance.linkInfo))
    ...
    self.obj47.Graphical_Appearance.linkInfo.SecondSegment.fill=ATOM3String('blue', 20)
    ...
    self.obj47.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('indirectLink_S_2ndSegment', self.obj47.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj47.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('indirectLink_S_2ndLink', self.obj47.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj47.name.setValue('MT_pre__indirectLink_S')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1274.5,81.5,self.obj47)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj48.Graphical_Appearance.setValue( ('MT_pre__directLink_T', self.obj48))
    self.obj48.Graphical_Appearance.linkInfo=linkEditor(self,self.obj48.Graphical_Appearance.semObject, "directLink_T")
    ...
    self.obj48.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('directLink_T_1stLink', self.obj48.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj48.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('directLink_T_1stSegment', self.obj48.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj48.Graphical_Appearance.linkInfo.Center.setValue( ('directLink_T_Center', self.obj48.Graphical_Appearance.linkInfo))
    ...
    self.obj48.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('directLink_T_2ndSegment', self.obj48.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj48.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('directLink_T_2ndLink', self.obj48.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj48.name.setValue('MT_pre__directLink_T')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1193.0,684.5,self.obj48)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj49.Graphical_Appearance.setValue( ('MT_pre__directLink_S', self.obj49))
    self.obj49.Graphical_Appearance.linkInfo=linkEditor(self,self.obj49.Graphical_Appearance.semObject, "directLink_S")
    ...
    self.obj49.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('directLink_S_1stLink', self.obj49.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj49.Graphical_Appearance.linkInfo.FirstSegment.fill=ATOM3String('yellow', 20)
    ...
    self.obj49.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('directLink_S_1stSegment', self.obj49.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj49.Graphical_Appearance.linkInfo.Center.setValue( ('directLink_S_Center', self.obj49.Graphical_Appearance.linkInfo))
    ...
    self.obj49.Graphical_Appearance.linkInfo.SecondSegment.fill=ATOM3String('yellow', 20)
    ...
    self.obj49.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('directLink_S_2ndSegment', self.obj49.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj49.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('directLink_S_2ndLink', self.obj49.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj49.name.setValue('MT_pre__directLink_S')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(950.5,86.5,self.obj49)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj50.Graphical_Appearance.setValue( ('MT_pre__paired_with', self.obj50))
    self.obj50.Graphical_Appearance.linkInfo=linkEditor(self,self.obj50.Graphical_Appearance.semObject, "paired_with")
    ...
    self.obj50.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('paired_with_1stLink', self.obj50.Graphical_Appearance.linkInfo.FirstLink))
    self.obj50.Graphical_Appearance.linkInfo.FirstSegment= widthXfillXdecoration()
    self.obj50.Graphical_Appearance.linkInfo.FirstSegment.width=ATOM3Integer(1)
    ...
    self.obj50.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('paired_with_1stSegment', self.obj50.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj50.Graphical_Appearance.linkInfo.Center.setValue( ('paired_with_Center', self.obj50.Graphical_Appearance.linkInfo))
    self.obj50.Graphical_Appearance.linkInfo.SecondSegment= widthXfillXdecoration()
    self.obj50.Graphical_Appearance.linkInfo.SecondSegment.width=ATOM3Integer(1)
    ...
    self.obj50.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('paired_with_2ndSegment', self.obj50.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj50.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('paired_with_2ndLink', self.obj50.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj50.name.setValue('MT_pre__paired_with')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(136.0,401.0,self.obj50)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj51.Graphical_Appearance.setValue( ('MT_pre__trace_link', self.obj51))
    self.obj51.Graphical_Appearance.linkInfo=linkEditor(self,self.obj51.Graphical_Appearance.semObject, "trace_link")
    ...
    self.obj51.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('trace_link_1stLink', self.obj51.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj51.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('trace_link_1stSegment', self.obj51.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj51.Graphical_Appearance.linkInfo.Center.setValue( ('trace_link_Center', self.obj51.Graphical_Appearance.linkInfo))
    ...
    self.obj51.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('trace_link_2ndSegment', self.obj51.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj51.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('trace_link_2ndLink', self.obj51.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj51.name.setValue('MT_pre__trace_link')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1242.0,481.0,self.obj51)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj52.Graphical_Appearance.setValue( ('MT_pre__hasAttr_S', self.obj52))
    self.obj52.Graphical_Appearance.linkInfo=linkEditor(self,self.obj52.Graphical_Appearance.semObject, "hasAttr_S")
    ...
    self.obj52.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('hasAttr_S_1stLink', self.obj52.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj52.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('hasAttr_S_1stSegment', self.obj52.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj52.Graphical_Appearance.linkInfo.Center.setValue( ('hasAttr_S_Center', self.obj52.Graphical_Appearance.linkInfo))
    ...
    self.obj52.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('hasAttr_S_2ndSegment', self.obj52.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj52.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('hasAttr_S_2ndLink', self.obj52.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj52.name.setValue('MT_pre__hasAttr_S')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1346.0,240.975409836,self.obj52)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj53.Graphical_Appearance.setValue( ('MT_pre__hasAttr_T', self.obj53))
    self.obj53.Graphical_Appearance.linkInfo=linkEditor(self,self.obj53.Graphical_Appearance.semObject, "hasAttr_T")
    ...
    self.obj53.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('hasAttr_T_1stLink', self.obj53.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj53.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('hasAttr_T_1stSegment', self.obj53.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj53.Graphical_Appearance.linkInfo.Center.setValue( ('hasAttr_T_Center', self.obj53.Graphical_Appearance.linkInfo))
    ...
    self.obj53.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('hasAttr_T_2ndSegment', self.obj53.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj53.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('hasAttr_T_2ndLink', self.obj53.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj53.name.setValue('MT_pre__hasAttr_T')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1292.49804688,838.905737705,self.obj53)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj54.Graphical_Appearance.setValue( ('MT_pre__leftExpr', self.obj54))
    self.obj54.Graphical_Appearance.linkInfo=linkEditor(self,self.obj54.Graphical_Appearance.semObject, "leftExpr")
    ...
    self.obj54.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('leftExpr_1stLink', self.obj54.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj54.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('leftExpr_1stSegment', self.obj54.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj54.Graphical_Appearance.linkInfo.Center.setValue( ('leftExpr_Center', self.obj54.Graphical_Appearance.linkInfo))
    ...
    self.obj54.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('leftExpr_2ndSegment', self.obj54.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj54.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('leftExpr_2ndLink', self.obj54.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj54.name.setValue('MT_pre__leftExpr')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1618.0,211.0,self.obj54)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj55.Graphical_Appearance.setValue( ('MT_pre__rightExpr', self.obj55))
    self.obj55.Graphical_Appearance.linkInfo=linkEditor(self,self.obj55.Graphical_Appearance.semObject, "rightExpr")
    ...
    self.obj55.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('rightExpr_1stLink', self.obj55.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj55.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('rightExpr_1stSegment', self.obj55.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj55.Graphical_Appearance.linkInfo.Center.setValue( ('rightExpr_Center', self.obj55.Graphical_Appearance.linkInfo))
    ...
    self.obj55.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('rightExpr_2ndSegment', self.obj55.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj55.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('rightExpr_2ndLink', self.obj55.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj55.name.setValue('MT_pre__rightExpr')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1866.15625,208.0,self.obj55)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj56.Graphical_Appearance.setValue( ('MT_pre__arg_1', self.obj56))
    self.obj56.Graphical_Appearance.linkInfo=linkEditor(self,self.obj56.Graphical_Appearance.semObject, "arg_1")
    ...
    self.obj56.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('arg_1_1stLink', self.obj56.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj56.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('arg_1_1stSegment', self.obj56.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj56.Graphical_Appearance.linkInfo.Center.setValue( ('arg_1_Center', self.obj56.Graphical_Appearance.linkInfo))
    ...
    self.obj56.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('arg_1_2ndSegment', self.obj56.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj56.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('arg_1_2ndLink', self.obj56.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj56.name.setValue('MT_pre__arg_1')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1780.0,551.0,self.obj56)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    self.obj57=CD_Association3(self)
    ...
    # Graphical_Appearance
    self.obj57.Graphical_Appearance.setValue( ('MT_pre__arg_2', self.obj57))
    self.obj57.Graphical_Appearance.linkInfo=linkEditor(self,self.obj57.Graphical_Appearance.semObject, "arg_2")
    self.obj57.Graphical_Appearance.linkInfo.FirstLink= stickylink()
    self.obj57.Graphical_Appearance.linkInfo.FirstLink.arrow=ATOM3Boolean()
    self.obj57.Graphical_Appearance.linkInfo.FirstLink.arrow.setValue((' ', 0))
    self.obj57.Graphical_Appearance.linkInfo.FirstLink.arrow.config = 0
    self.obj57.Graphical_Appearance.linkInfo.FirstLink.arrowShape1=ATOM3Integer(8)
    self.obj57.Graphical_Appearance.linkInfo.FirstLink.arrowShape2=ATOM3Integer(10)
    self.obj57.Graphical_Appearance.linkInfo.FirstLink.arrowShape3=ATOM3Integer(3)
    self.obj57.Graphical_Appearance.linkInfo.FirstLink.decoration=ATOM3Appearance()
    self.obj57.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('arg_2_1stLink', self.obj57.Graphical_Appearance.linkInfo.FirstLink))
    self.obj57.Graphical_Appearance.linkInfo.FirstSegment= widthXfillXdecoration()
    self.obj57.Graphical_Appearance.linkInfo.FirstSegment.width=ATOM3Integer(2)
    self.obj57.Graphical_Appearance.linkInfo.FirstSegment.fill=ATOM3String('black', 20)
    self.obj57.Graphical_Appearance.linkInfo.FirstSegment.stipple=ATOM3String('', 20)
    self.obj57.Graphical_Appearance.linkInfo.FirstSegment.arrow=ATOM3Boolean()
    self.obj57.Graphical_Appearance.linkInfo.FirstSegment.arrow.setValue((' ', 0))
    self.obj57.Graphical_Appearance.linkInfo.FirstSegment.arrow.config = 0
    self.obj57.Graphical_Appearance.linkInfo.FirstSegment.arrowShape1=ATOM3Integer(8)
    self.obj57.Graphical_Appearance.linkInfo.FirstSegment.arrowShape2=ATOM3Integer(10)
    self.obj57.Graphical_Appearance.linkInfo.FirstSegment.arrowShape3=ATOM3Integer(3)
    self.obj57.Graphical_Appearance.linkInfo.FirstSegment.decoration=ATOM3Appearance()
    self.obj57.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('arg_2_1stSegment', self.obj57.Graphical_Appearance.linkInfo.FirstSegment))
    self.obj57.Graphical_Appearance.linkInfo.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
    self.obj57.Graphical_Appearance.linkInfo.Center=ATOM3Appearance()
    self.obj57.Graphical_Appearance.linkInfo.Center.setValue( ('arg_2_Center', self.obj57.Graphical_Appearance.linkInfo))
    self.obj57.Graphical_Appearance.linkInfo.SecondSegment= widthXfillXdecoration()
    self.obj57.Graphical_Appearance.linkInfo.SecondSegment.width=ATOM3Integer(2)
    self.obj57.Graphical_Appearance.linkInfo.SecondSegment.fill=ATOM3String('black', 20)
    self.obj57.Graphical_Appearance.linkInfo.SecondSegment.stipple=ATOM3String('', 20)
    self.obj57.Graphical_Appearance.linkInfo.SecondSegment.arrow=ATOM3Boolean()
    self.obj57.Graphical_Appearance.linkInfo.SecondSegment.arrow.setValue((' ', 0))
    self.obj57.Graphical_Appearance.linkInfo.SecondSegment.arrow.config = 0
    self.obj57.Graphical_Appearance.linkInfo.SecondSegment.arrowShape1=ATOM3Integer(8)
    self.obj57.Graphical_Appearance.linkInfo.SecondSegment.arrowShape2=ATOM3Integer(10)
    self.obj57.Graphical_Appearance.linkInfo.SecondSegment.arrowShape3=ATOM3Integer(3)
    self.obj57.Graphical_Appearance.linkInfo.SecondSegment.decoration=ATOM3Appearance()
    self.obj57.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('arg_2_2ndSegment', self.obj57.Graphical_Appearance.linkInfo.SecondSegment))
    self.obj57.Graphical_Appearance.linkInfo.SecondSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
    self.obj57.Graphical_Appearance.linkInfo.SecondLink= stickylink()
    self.obj57.Graphical_Appearance.linkInfo.SecondLink.arrow=ATOM3Boolean()
    self.obj57.Graphical_Appearance.linkInfo.SecondLink.arrow.setValue((' ', 1))
    self.obj57.Graphical_Appearance.linkInfo.SecondLink.arrow.config = 0
    self.obj57.Graphical_Appearance.linkInfo.SecondLink.arrowShape1=ATOM3Integer(8)
    self.obj57.Graphical_Appearance.linkInfo.SecondLink.arrowShape2=ATOM3Integer(10)
    self.obj57.Graphical_Appearance.linkInfo.SecondLink.arrowShape3=ATOM3Integer(3)
    self.obj57.Graphical_Appearance.linkInfo.SecondLink.decoration=ATOM3Appearance()
    self.obj57.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('arg_2_2ndLink', self.obj57.Graphical_Appearance.linkInfo.SecondLink))
    self.obj57.Graphical_Appearance.linkInfo.FirstLink.decoration.semObject=self.obj57.Graphical_Appearance.semObject
    self.obj57.Graphical_Appearance.linkInfo.FirstSegment.decoration.semObject=self.obj57.Graphical_Appearance.semObject
    self.obj57.Graphical_Appearance.linkInfo.Center.semObject=self.obj57.Graphical_Appearance.semObject
    self.obj57.Graphical_Appearance.linkInfo.SecondSegment.decoration.semObject=self.obj57.Graphical_Appearance.semObject
    self.obj57.Graphical_Appearance.linkInfo.SecondLink.decoration.semObject=self.obj57.Graphical_Appearance.semObject

    # name
    self.obj57.name.setValue('MT_pre__arg_2')

    # displaySelect
    self.obj57.displaySelect.setValue( (['attributes', 'constraints', 'actions', 'cardinality'], [0, 0, 0, 0]) )
    self.obj57.displaySelect.config = 0
    ...
    # display
    self.obj57.display.setValue('Multiplicities:\n  - To Expression: 0 to N\n  - From Concat: 0 to N\n')
    ...
    self.obj57.graphClass_= graph_CD_Association3
    if self.genGraphics:
       new_obj = graph_CD_Association3(1965.53125,535.0,self.obj57)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj69.Graphical_Appearance.setValue( ('MT_pre__GenericEdge_FamiliesToPersonsMM', self.obj69))
    self.obj69.Graphical_Appearance.linkInfo=linkEditor(self,self.obj69.Graphical_Appearance.semObject, "GenericEdge_FamiliesToPersonsMM")
    ...
    self.obj69.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('GenericEdge_FamiliesToPersonsMM_1stLink', self.obj69.Graphical_Appearance.linkInfo.FirstLink))
    self.obj69.Graphical_Appearance.linkInfo.FirstSegment= widthXfillXdecoration()
    self.obj69.Graphical_Appearance.linkInfo.FirstSegment.width=ATOM3Integer(1)
    self.obj69.Graphical_Appearance.linkInfo.FirstSegment.fill=ATOM3String('purple', 20)
    ...
    self.obj69.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('GenericEdge_FamiliesToPersonsMM_1stSegment', self.obj69.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj69.Graphical_Appearance.linkInfo.Center.setValue( ('GenericEdge_FamiliesToPersonsMM_Center', self.obj69.Graphical_Appearance.linkInfo))
    self.obj69.Graphical_Appearance.linkInfo.SecondSegment= widthXfillXdecoration()
    self.obj69.Graphical_Appearance.linkInfo.SecondSegment.width=ATOM3Integer(1)
    self.obj69.Graphical_Appearance.linkInfo.SecondSegment.fill=ATOM3String('purple', 20)
    ...
    self.obj69.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('GenericEdge_FamiliesToPersonsMM_2ndSegment', self.obj69.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj69.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('GenericEdge_FamiliesToPersonsMM_2ndLink', self.obj69.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj69.name.setValue('MT_pre__GenericEdge_FamiliesToPersonsMM')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(0.0,0.0,self.obj69)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(641.4,303.6,self.obj58)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(754.6,277.8,self.obj59)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(468.4,303.6,self.obj60)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(609.891532278,704.0332,self.obj61)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(757.391532278,694.0332,self.obj62)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(502.391532278,694.0332,self.obj63)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(1656.0,461.0,self.obj64)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(1926.0,405.0,self.obj65)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(1831.0,571.0,self.obj66)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(646.0,821.5,self.obj67)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
...
(self.obj28,self.obj47,[711.0, 192.98360655737704, 1026.0, 203.0, 1274.5, 81.5, 1274.5, 81.5],"true", 4),
(self.obj28,self.obj49,[711.0, 192.98360655737704, 950.5, 86.5, 950.5, 86.5],"true", 3),
(self.obj28,self.obj52,[711.0, 243.1081967213115, 1346.0, 240.975409836],"true", 2) )
    # Connections for obj29 (graphObject_: Obj1) named MT_pre__HouseholdRoot
    self.drawConnections(
(self.obj29,self.obj60,[436.0, 341.0, 468.4, 303.6],"true", 2) )
    # Connections for obj30 (graphObject_: Obj2) named MT_pre__Family
    self.drawConnections(
(self.obj30,self.obj58,[656.0, 341.0, 641.4, 303.6],"true", 2) )
    # Connections for obj31 (graphObject_: Obj3) named MT_pre__Member
    self.drawConnections(
(self.obj31,self.obj59,[776.0, 341.0, 754.6, 277.8],"true", 2) )
    # Connections for obj32 (graphObject_: Obj4) named MT_pre__MatchModel
    self.drawConnections(
(self.obj32,self.obj44,[211.0, 189.0, 361.8, 199.8],"true", 2),
(self.obj32,self.obj50,[136.0, 261.0, 136.0, 401.0],"true", 2) )
    # Connections for obj33 (graphObject_: Obj5) named MT_pre__ApplyModel
    self.drawConnections(
(self.obj33,self.obj45,[211.0, 581.0, 362.491532278, 586.86445],"true", 2) )
    # Connections for obj34 (graphObject_: Obj6) named MT_pre__MetaModelElement_T
    self.drawConnections(
(self.obj34,self.obj46,[711.0, 592.9016393442623, 1245.0, 424.5, 1245.0, 339.5],"true", 3),
(self.obj34,self.obj48,[711.0, 696.1803278688525, 1193.0, 684.5, 1193.0, 684.5],"true", 3),
(self.obj34,self.obj51,[711.0, 592.9016393442623, 990.0, 584.0, 1242.0, 481.0],"true", 3),
(self.obj34,self.obj53,[711.0, 696.1803278688525, 1292.49804688, 838.905737705],"true", 2) )
    # Connections for obj35 (graphObject_: Obj7) named MT_pre__CommunityRoot
    self.drawConnections(
(self.obj35,self.obj63,[476.0, 721.0, 502.3915322780172, 694.0332000000001],"true", 2) )
    # Connections for obj36 (graphObject_: Obj8) named MT_pre__Person
    self.drawConnections(
(self.obj36,self.obj61,[616.0, 721.0, 609.8915322780176, 704.0332],"true", 2) )
    # Connections for obj37 (graphObject_: Obj9) named MT_pre__Man
    self.drawConnections(
(self.obj37,self.obj62,[796.0, 721.0, 757.3915322780169, 694.0332000000001],"true", 2) )
    # Connections for obj38 (graphObject_: Obj10) named MT_pre__Attribute
    self.drawConnections(
(self.obj38,self.obj64,[1636.0, 501.0, 1656.0, 461.0],"true", 2) )
    # Connections for obj39 (graphObject_: Obj11) named MT_pre__Equation
    self.drawConnections(
(self.obj39,self.obj54,[1676.0, 141.0, 1618.0, 211.0],"true", 2),
(self.obj39,self.obj55,[1831.0, 121.0, 1866.15625, 208.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj41,self.obj65,[2041.0, 401.0, 1926.0, 405.0],"true", 2) )
    # Connections for obj42 (graphObject_: Obj14) named MT_pre__Concat
    self.drawConnections(
(self.obj42,self.obj56,[1859.0, 721.0, 1780.0, 551.0],"true", 2),
(self.obj42,self.obj57,[1979.0, 721.0, 1965.53125, 535.0],"true", 2),
(self.obj42,self.obj66,[1859.0, 721.0, 1831.0, 571.0],"true", 2) )
    # Connections for obj43 (graphObject_: Obj15) named MT_pre__Woman
    self.drawConnections(
(self.obj43,self.obj67,[656.0, 921.0, 646.0, 821.5],"true", 2) )
    # Connections for obj68 (graphObject_: Obj64) named MT_pre__GenericNode_FamiliesToPersonsMM
    self.drawConnections(
(self.obj68,self.obj69,[1.0, 41.0, -3.0, 5.0], 0, 2) )
    # Connections for obj44 (graphObject_: Obj16) named MT_pre__match_contains
    self.drawConnections(
(self.obj44,self.obj28,[361.8, 199.8, 521.0, 192.98360655737704],"true", 2) )
    # Connections for obj45 (graphObject_: Obj18) named MT_pre__apply_contains
    self.drawConnections(
(self.obj45,self.obj34,[362.491532278, 586.86445, 521.0, 592.9016393442623],"true", 2) )
    # Connections for obj46 (graphObject_: Obj20) named MT_pre__backward_link
    self.drawConnections(
(self.obj46,self.obj28,[1245.0, 339.5, 1245.0, 254.5, 711.0, 243.1081967213115],"true", 3) )
    # Connections for obj47 (graphObject_: Obj22) named MT_pre__indirectLink_S
    self.drawConnections(
(self.obj47,self.obj28,[1274.5, 81.5, 1274.5, 81.5, 711.0, 192.98360655737704],"true", 3) )
    # Connections for obj48 (graphObject_: Obj24) named MT_pre__directLink_T
    self.drawConnections(
(self.obj48,self.obj34,[1193.0, 684.5, 1193.0, 684.5, 711.0, 696.1803278688525],"true", 3) )
    # Connections for obj49 (graphObject_: Obj26) named MT_pre__directLink_S
    self.drawConnections(
(self.obj49,self.obj28,[950.5, 86.5, 950.5, 86.5, 711.0, 192.98360655737704],"true", 3) )
    # Connections for obj50 (graphObject_: Obj28) named MT_pre__paired_with
    self.drawConnections(
(self.obj50,self.obj33,[136.0, 401.0, 136.0, 541.0],"true", 2) )
    # Connections for obj51 (graphObject_: Obj30) named MT_pre__trace_link
    self.drawConnections(
(self.obj51,self.obj28,[1242.0, 481.0, 937.0, 308.0, 711.0, 291.44262295081967],"true", 3) )
    # Connections for obj52 (graphObject_: Obj32) named MT_pre__hasAttr_S
    self.drawConnections(
(self.obj52,self.obj38,[1346.0, 240.97540983606558, 1516.0, 501.0],"true", 2) )
    # Connections for obj53 (graphObject_: Obj34) named MT_pre__hasAttr_T
    self.drawConnections(
(self.obj53,self.obj38,[1292.49804688, 838.905737705, 1481.0, 621.0],"true", 2) )
    # Connections for obj54 (graphObject_: Obj36) named MT_pre__leftExpr
    self.drawConnections(
(self.obj54,self.obj40,[1618.0, 211.0, 1683.0, 281.0],"true", 2) )
    # Connections for obj55 (graphObject_: Obj38) named MT_pre__rightExpr
    self.drawConnections(
(self.obj55,self.obj40,[1866.15625, 208.0, 1803.0, 281.0],"true", 2) )
    # Connections for obj56 (graphObject_: Obj40) named MT_pre__arg_1
    self.drawConnections(
(self.obj56,self.obj40,[1780.0, 551.0, 1763.0, 421.0],"true", 2) )
    # Connections for obj57 (graphObject_: Obj42) named MT_pre__arg_2
    self.drawConnections(
(self.obj57,self.obj40,[1965.53125, 535.0, 1838.0, 401.0],"true", 2) )
    # Connections for obj69 (graphObject_: Obj65) named MT_pre__GenericEdge_FamiliesToPersonsMM
    self.drawConnections(
(self.obj69,self.obj68,[-2.0, 5.0, 192.625, 1.0], 0, 2),
(self.obj69,self.obj28,[-0.36099999999999977, 5.0, 521.0, 192.98360655737704], 0, 2),
(self.obj69,self.obj29,[-0.36099999999999977, 5.0, 316.0, 341.0], 0, 2),
(self.obj69,self.obj30,[-0.36099999999999977, 5.0, 536.0, 341.0], 0, 2),
(self.obj69,self.obj31,[-0.36099999999999977, 5.0, 741.0, 381.0], 0, 2),
(self.obj69,self.obj32,[-0.36099999999999977, 5.0, 176.0, 121.0], 0, 2),
(self.obj69,self.obj33,[-0.36099999999999977, 5.0, 176.0, 541.0], 0, 2),
(self.obj69,self.obj34,[-0.36099999999999977, 5.0, 556.0, 541.2622950819672], 0, 2),
(self.obj69,self.obj35,[-0.36099999999999977, 5.0, 356.0, 721.0], 0, 2),
(self.obj69,self.obj36,[-0.36099999999999977, 5.0, 576.0, 721.0], 0, 2),
(self.obj69,self.obj37,[-0.36099999999999977, 5.0, 796.0, 721.0], 0, 2),
(self.obj69,self.obj38,[-0.36099999999999977, 5.0, 1481.0, 541.0], 0, 2),
(self.obj69,self.obj39,[-0.36099999999999977, 5.0, 1641.0, 69.0], 0, 2),
(self.obj69,self.obj40,[-0.36099999999999977, 5.0, 1641.0, 321.0], 0, 2),
(self.obj69,self.obj41,[-0.36099999999999977, 5.0, 2041.0, 321.0], 0, 2),
(self.obj69,self.obj42,[-0.36099999999999977, 5.0, 1821.0, 761.0], 0, 2),
(self.obj69,self.obj43,[-0.36099999999999977, 5.0, 576.0, 921.0], 0, 2),
(self.obj69,self.obj68,[-2.0, 5.0, 192.625, 1.0], 0, 2) )
    # Connections for obj58 (graphObject_: Obj44) of type CD_Inheritance3
    self.drawConnections(
(self.obj58,self.obj28,[641.4, 303.6, 636.0, 372.0],"true", 2) )
    # Connections for obj59 (graphObject_: Obj46) of type CD_Inheritance3
    self.drawConnections(
(self.obj59,self.obj28,[754.6, 277.8, 711.0, 291.44262295081967],"true", 2) )
    # Connections for obj60 (graphObject_: Obj48) of type CD_Inheritance3
    self.drawConnections(
(self.obj60,self.obj28,[468.4, 303.6, 521.0, 291.44262295081967],"true", 2) )
    # Connections for obj61 (graphObject_: Obj50) of type CD_Inheritance3
    self.drawConnections(
(self.obj61,self.obj34,[609.891532278, 704.0332, 596.0, 722.0],"true", 2) )
    # Connections for obj62 (graphObject_: Obj52) of type CD_Inheritance3
    self.drawConnections(
(self.obj62,self.obj34,[757.391532278, 694.0332, 711.0, 696.1803278688525],"true", 2) )
    # Connections for obj63 (graphObject_: Obj54) of type CD_Inheritance3
    self.drawConnections(
(self.obj63,self.obj34,[502.391532278, 694.0332, 521.0, 696.1803278688525],"true", 2) )
    # Connections for obj64 (graphObject_: Obj56) of type CD_Inheritance3
    self.drawConnections(
(self.obj64,self.obj40,[1656.0, 461.0, 1683.0, 421.0],"true", 2) )
    # Connections for obj65 (graphObject_: Obj58) of type CD_Inheritance3
    self.drawConnections(
(self.obj65,self.obj40,[1926.0, 405.0, 1838.0, 401.0],"true", 2) )
    # Connections for obj66 (graphObject_: Obj60) of type CD_Inheritance3
    self.drawConnections(
(self.obj66,self.obj40,[1831.0, 571.0, 1803.0, 421.0],"true", 2) )
    # Connections for obj67 (graphObject_: Obj62) of type CD_Inheritance3
    self.drawConnections(
(self.obj67,self.obj34,[646.0, 821.5, 636.0, 722.0],"true", 2) )
