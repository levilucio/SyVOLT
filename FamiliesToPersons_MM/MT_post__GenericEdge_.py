"""
__MT_post__GenericEdge_.py_____________________________________________________

Automatically generated AToM3 syntactic object (DO NOT MODIFY DIRECTLY)
Author: levi
Modified: Fri Jan 25 15:30:05 2013
...
from graph_MT_post__GenericEdge_ import *
class MT_post__GenericEdge_(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_post__GenericEdge_
   ...
   def clone(self):
      cloneObject = MT_post__GenericEdge_( self.parent )
