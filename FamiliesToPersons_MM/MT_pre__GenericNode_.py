"""
__MT_pre__GenericNode_.py_____________________________________________________

Automatically generated AToM3 syntactic object (DO NOT MODIFY DIRECTLY)
Author: levi
Modified: Fri Jan 25 15:28:54 2013
...
from graph_MT_pre__GenericNode_ import *
class MT_pre__GenericNode_(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_pre__GenericNode_
   ...
   def clone(self):
      cloneObject = MT_pre__GenericNode_( self.parent )
