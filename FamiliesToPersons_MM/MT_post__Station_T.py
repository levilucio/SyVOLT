"""
__MT_post__Station_T.py_____________________________________________________
...
class MT_post__Station_T(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__MetaModelElement_T']
      self.graphClass_ = graph_MT_post__Station_T
   ...
   def clone(self):
      cloneObject = MT_post__Station_T( self.parent )
