"""
__graph_MT_pre__Male_T.py___________________________________________________________
...
class graph_MT_pre__Male_T(graphEntity):
...
new_class = graph_MT_pre__Male_T
