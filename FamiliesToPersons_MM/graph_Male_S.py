"""
__graph_Male_S.py___________________________________________________________
...
class graph_Male_S(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([21.0, 22.0, 21.0, -239.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
