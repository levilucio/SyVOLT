"""
__graph_MT_pre__Male_S.py___________________________________________________________
...
class graph_MT_pre__Male_S(graphEntity):
...
new_class = graph_MT_pre__Male_S
