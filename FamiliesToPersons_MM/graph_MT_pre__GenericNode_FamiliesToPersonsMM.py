...
"""
__graph_MT_pre__GenericNode_FamiliesToPersonsMM.py___________________________________________________________
...
class graph_MT_pre__GenericNode_FamiliesToPersonsMM(graphEntity):
...
new_class = graph_MT_pre__GenericNode_FamiliesToPersonsMM
