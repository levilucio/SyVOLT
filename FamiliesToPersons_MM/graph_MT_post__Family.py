"""
__graph_MT_post__Family.py___________________________________________________________
...
class graph_MT_post__Family(graphEntity):
...
new_class = graph_MT_post__Family
