"""
__Male_S.py_____________________________________________________
...
class Male_S(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MetaModelElement_S']
      self.graphClass_ = graph_Male_S
   ...
   def clone(self):
      cloneObject = Male_S( self.parent )
