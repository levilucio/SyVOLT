...
class HNeg_CityCompany_ConnectedLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                Creates the himesis graph representing the AToM3 model HNeg_CityCompany_ConnectedLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True
        
                super(HNeg_CityCompany_ConnectedLHS, self).__init__(name='HNeg_CityCompany_ConnectedLHS', num_nodes=0, edges=[])
...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'Neg_CityCompany')
