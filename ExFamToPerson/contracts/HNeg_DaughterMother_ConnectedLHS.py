...
class HNeg_DaughterMother_ConnectedLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                Creates the himesis graph representing the AToM3 model HPos_DaughterMother_ConnectedLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True
        
                super(HNeg_DaughterMother_ConnectedLHS, self).__init__(name='HNeg_DaughterMother_ConnectedLHS', num_nodes=0, edges=[])
...
"""
        ...
        # Add the edges
                self.add_edges([
                (1,3), # match_class Family() -> association daughters
                (3,0), # association daughters  -> match_class Member()
                (1,4), # match_class Family() -> association mothers
                (4,2) # association mothers  -> match_class Member()
        ])
