...
class HPos_DaughterMother_ConnectedLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                ...
                super(HPos_DaughterMother_ConnectedLHS, self).__init__(name='HPos_DaughterMother_ConnectedLHS', num_nodes=0, edges=[])
