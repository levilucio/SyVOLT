...
class HPos_AssocCity_ConnectedLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                Creates the himesis graph representing the AToM3 model HPos_AssocCity_ConnectedLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True
        
                super(HPos_AssocCity_ConnectedLHS, self).__init__(name='HPos_AssocCity_ConnectedLHS', num_nodes=0, edges=[])
...
"""
        ...
        # Add the edges
                self.add_edges([
                (1,3), # match_class Country() -> association cities
                (3,0), # association cities  -> match_class City()
                (0,4), # match_class City() -> association companies
                (4,2) # association companies  -> match_class Company()
        ])
