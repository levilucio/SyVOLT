...
class HNeg_DaughterMother_IsolatedLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
        Creates the himesis graph representing the AToM3 model HPos_DaughterMother_IsolatedLHS.
                """
        # Flag this instance as compiled now
                self.is_compiled = True
        
                super(HNeg_DaughterMother_IsolatedLHS, self).__init__(name='HNeg_DaughterMother_IsolatedLHS', num_nodes=0, edges=[])
...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'Neg_DaughterMother')
