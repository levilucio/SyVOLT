...
class HNeg_CityCompany_CompleteLHS(HimesisPreConditionPatternLHS):
        def __init__(self, *args, **kwargs):
                """
                Creates the himesis graph representing the AToM3 model HNeg_CityCompany_CompleteLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True

                super(HNeg_CityCompany_CompleteLHS, self).__init__(name='HNeg_CityCompany_CompleteLHS', num_nodes=0, edges=[])
