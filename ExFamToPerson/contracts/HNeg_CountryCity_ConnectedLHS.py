...
class HNeg_CountryCity_ConnectedLHS(HimesisPreConditionPatternLHS):
        def __init__(self, *args, **kwargs):
                ...
                super(HNeg_CountryCity_ConnectedLHS, self).__init__(name='HNeg_CountryCity_ConnectedLHS', num_nodes=0, edges=[])
...
"""
        ...
        # Add the edges
                self.add_edges([
                (0,2), # match_class Country() -> association cities
                (2,1) # association cities  -> match_class City()
        ])
