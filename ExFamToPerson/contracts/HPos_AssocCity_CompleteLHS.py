...
"""
                ...
                self.vs[4]["mm__"] = """MT_pre__TownHall"""
...
"""
                ...
                # Add the edges
                self.add_edges([
                (5,10), # apply_class Community() -> backward_association
                (10,1), #  backward_association -> apply_class Country()
                (4,11), # apply_class TownHall() -> backward_association
                (11,0), #  backward_association -> apply_class City()
                (3,12), # apply_class Committee() -> backward_association
                (12,0), #  backward_association -> apply_class City()
                (4,8), # apply_class TownHall() -> association committee
                (8,3), # association committee  -> apply_class Committee()
                (5,9), # apply_class Community() -> association townHalls
                (9,4), # association townHalls  -> apply_class TownHall()
                (1,6), # match_class Country() -> association cities
                (6,0), # association cities  -> match_class City()
                (0,7), # match_class City() -> association companies
                (7,2) # association companies  -> match_class Company()
                ])
