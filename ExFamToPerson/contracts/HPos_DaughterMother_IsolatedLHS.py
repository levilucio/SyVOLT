...
class HPos_DaughterMother_IsolatedLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
        ...
        # Flag this instance as compiled now
                ...
                super(HPos_DaughterMother_IsolatedLHS, self).__init__(name='HPos_DaughterMother_IsolatedLHS', num_nodes=0, edges=[])
