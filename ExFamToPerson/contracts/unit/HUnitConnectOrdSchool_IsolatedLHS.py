...
class HUnitConnectOrdSchool_IsolatedLHS(HimesisPreConditionPatternLHS):
	def __init__(self):
		"""
		Creates the himesis graph representing the AToM3 model HUnitConnectOrdSchool_IsolatedLHS
		"""
		# Flag this instance as compiled now
		self.is_compiled = True

		super(HUnitConnectOrdSchool_IsolatedLHS, self).__init__(name='HUnitConnectOrdSchool_IsolatedLHS', num_nodes=0, edges=[])
		...
		self["name"] = """"""
		self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'HUnitConnectOrdSchool_IsolatedLHS')
		self["equations"] = []
