...
class HUnitSon2Man_ConnectedLHS(HimesisPreConditionPatternLHS):
	def __init__(self):
		"""
		Creates the himesis graph representing the AToM3 model HUnitSon2Man_ConnectedLHS
		"""
		# Flag this instance as compiled now
		self.is_compiled = True

		super(HUnitSon2Man_ConnectedLHS, self).__init__(name='HUnitSon2Man_ConnectedLHS', num_nodes=0, edges=[])
		...
		self["name"] = """"""
		self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'HUnitSon2Man_ConnectedLHS')
		self["equations"] = []
		...
		self.add_node()
		self.vs[2]["MT_pre__attr1"] = """return attr_value == "sons" """
		...
		# Add the edges
		self.add_edges([
			(0,2), # match class null(Fam) -> association sons
