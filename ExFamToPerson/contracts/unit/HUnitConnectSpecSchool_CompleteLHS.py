...
class HUnitConnectSpecSchool_CompleteLHS(HimesisPreConditionPatternLHS):
	def __init__(self):
		"""
		Creates the himesis graph representing the AToM3 model HUnitConnectSpecSchool_CompleteLHS
		"""
		# Flag this instance as compiled now
		self.is_compiled = True

		super(HUnitConnectSpecSchool_CompleteLHS, self).__init__(name='HUnitConnectSpecSchool_CompleteLHS', num_nodes=0, edges=[])
		...
		self["name"] = """"""
		self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'HUnitConnectSpecSchool_CompleteLHS')
		self["equations"] = []
		...
		# apply class SpecialFacility(18.0.a.1SpecialFacility) node
		self.add_node()
		self.vs[5]["MT_pre__attr1"] = """return True"""
		self.vs[5]["MT_label__"] = """6"""
		self.vs[5]["mm__"] = """MT_pre__SpecialFacility"""
		self.vs[5]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'18.0.a.1SpecialFacility')
		...
		# match association School--special-->Servicenode
		self.add_node()
		self.vs[8]["MT_pre__attr1"] = """return attr_value == "special" """
		...
		self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'18.0.a.0Districtassoc1118.0.a.1SpecialFacility')
		...
		self.vs[12]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'18.0.a.1SpecialFacilityassoc1218.0.a.2Person')
		...
		self['equations'].append(((5,'name'),('concat',(('constant','Special Facility Service for school '),(1,'name')))))
		...
		self.add_edges([
			...
			(1,8), # match class School(18.0.m.1School) -> association special
			...
			(11,5), # association OrdinaryFacility -> apply class OrdinaryFacility(18.0.a.1SpecialFacility)
			(5,12), # apply class OrdinaryFacility(18.0.a.1SpecialFacility) -> association members
