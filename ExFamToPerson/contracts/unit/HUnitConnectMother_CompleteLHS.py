...
class HUnitConnectMother_CompleteLHS(HimesisPreConditionPatternLHS):
	def __init__(self):
		"""
		Creates the himesis graph representing the AToM3 model HUnitConnectMother_CompleteLHS
		"""
		# Flag this instance as compiled now
		self.is_compiled = True

		super(HUnitConnectMother_CompleteLHS, self).__init__(name='HUnitConnectMother_CompleteLHS', num_nodes=0, edges=[])
		...
		self["name"] = """"""
		self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'HUnitConnectMother_CompleteLHS')
		self["equations"] = []
		...
		self.add_node()
		self.vs[6]["MT_pre__attr1"] = """return attr_value == "mothers" """
		...
		self.vs[9]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'9.0.a.1Womanassoc99.0.m.2Parent')
		...
		self.add_edges([
			...
			(1,6), # match class Family(9.0.m.1Family) -> association mothers
