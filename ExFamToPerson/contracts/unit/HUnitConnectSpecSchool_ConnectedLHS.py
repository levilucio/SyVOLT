...
class HUnitConnectSpecSchool_ConnectedLHS(HimesisPreConditionPatternLHS):
	def __init__(self):
		"""
		Creates the himesis graph representing the AToM3 model HUnitConnectSpecSchool_ConnectedLHS
		"""
		# Flag this instance as compiled now
		self.is_compiled = True

		super(HUnitConnectSpecSchool_ConnectedLHS, self).__init__(name='HUnitConnectSpecSchool_ConnectedLHS', num_nodes=0, edges=[])
		...
		self["name"] = """"""
		self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'HUnitConnectSpecSchool_ConnectedLHS')
		self["equations"] = []
		...
		self.add_node()
		self.vs[5]["MT_pre__attr1"] = """return attr_value == "special" """
		...
		self.add_edges([
			...
			(1,5), # match class School(18.0.m.1School) -> association special
