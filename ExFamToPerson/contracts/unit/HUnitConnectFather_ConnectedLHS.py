...
class HUnitConnectFather_ConnectedLHS(HimesisPreConditionPatternLHS):
	def __init__(self):
		"""
		Creates the himesis graph representing the AToM3 model HUnitConnectFather_ConnectedLHS
		"""
		# Flag this instance as compiled now
		self.is_compiled = True

		super(HUnitConnectFather_ConnectedLHS, self).__init__(name='HUnitConnectFather_ConnectedLHS', num_nodes=0, edges=[])
		...
		self["name"] = """"""
		self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'HUnitConnectFather_ConnectedLHS')
		self["equations"] = []
		...
		self.add_node()
		self.vs[4]["MT_pre__attr1"] = """return attr_value == "fathers" """
		...
		self.add_edges([
			...
			(1,4), # match class Family(9.0.m.1Family) -> association fathers
