...
class HUnitConnectSon_CompleteLHS(HimesisPreConditionPatternLHS):
	def __init__(self):
		"""
		Creates the himesis graph representing the AToM3 model HUnitConnectSon_CompleteLHS
		"""
		# Flag this instance as compiled now
		self.is_compiled = True

		super(HUnitConnectSon_CompleteLHS, self).__init__(name='HUnitConnectSon_CompleteLHS', num_nodes=0, edges=[])
		...
		self["name"] = """"""
		self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'HUnitConnectSon_CompleteLHS')
		self["equations"] = []
		...
		self.add_node()
		self.vs[6]["MT_pre__attr1"] = """return attr_value == "sons" """
		self.vs[6]["MT_label__"] = """7"""
		self.vs[6]["mm__"] = """MT_pre__directLink_S"""
		self.vs[6]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'9.0.m.1Familyassoc69.0.m.2Child')
		...
		self.vs[9]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'9.0.a.1Manassoc99.0.m.2Child')
		...
		self.add_edges([
			...
			(1,6), # match class Family(9.0.m.1Family) -> association sons
			(6,2), # association Parent -> match class Parent(9.0.m.2Child)
			...
			(4,9), # apply class Man(9.0.m.2Child) -> backward_association 
			(9,2), # backward_associationParent -> match_class Parent(9.0.m.2Child)
		])
