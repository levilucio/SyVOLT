...
class HUnitConnectDaughter_CompleteLHS(HimesisPreConditionPatternLHS):
	def __init__(self):
		"""
		Creates the himesis graph representing the AToM3 model HUnitConnectDaughter_CompleteLHS
		"""
		# Flag this instance as compiled now
		self.is_compiled = True

		super(HUnitConnectDaughter_CompleteLHS, self).__init__(name='HUnitConnectDaughter_CompleteLHS', num_nodes=0, edges=[])
		...
		self["name"] = """"""
		self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'HUnitConnectDaughter_CompleteLHS')
		self["equations"] = []
		...
		self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'Child')
		...
		# apply class Woman(9.0.a.1Woman) node
		self.add_node()
		self.vs[4]["MT_pre__attr1"] = """return True"""
		self.vs[4]["MT_label__"] = """5"""
		self.vs[4]["mm__"] = """MT_pre__Woman"""
		self.vs[4]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'9.0.a.1Woman')
		...
		# match association Family--daughters-->Parentnode
		self.add_node()
		self.vs[6]["MT_pre__attr1"] = """return attr_value == "daughters" """
		self.vs[6]["MT_label__"] = """7"""
		self.vs[6]["mm__"] = """MT_pre__directLink_S"""
		self.vs[6]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'9.0.m.1Familyassoc6Child')
		...
		self.vs[7]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'9.0.a.0Communityassoc79.0.a.1Woman')
		...
		self.vs[9]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'9.0.a.1Womanassoc9Child')
		...
		self.add_edges([
			...
			(1,6), # match class Family(9.0.m.1Family) -> association daughters
			(6,2), # association Parent -> match class Parent(Child)
			(3,7), # apply class Community(9.0.a.0Community) -> association persons
			(7,4), # association Man -> apply class Man(9.0.a.1Woman)
			...
			(4,9), # apply class Man(Child) -> backward_association 
			(9,2), # backward_associationParent -> match_class Parent(Child)
		])
