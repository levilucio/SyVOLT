...
class HdfacilitiesSolveRefNeighborhoodSchoolServiceChildDistrictSpecialFacilityPerson(Himesis):
    def __init__(self):
        ...
        self.add_edges([
                ...
                (20,13), # association facilities  -> apply_class SpecialFacility()
                (13,21), # apply_class SpecialFacility() -> association members
        ...
        self["equations"] = [((11,'ApplyAttribute'),('constant','solveRef')), ((13,'name'),('concat',(('constant','Special Facility Service for school '),(5,'name')))), ((13,'ApplyAttribute'),('constant','solveRef')), ((15,'ApplyAttribute'),('constant','solveRef')), ]
