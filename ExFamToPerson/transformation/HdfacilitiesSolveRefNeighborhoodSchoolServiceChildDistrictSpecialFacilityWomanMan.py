...
class HdfacilitiesSolveRefNeighborhoodSchoolServiceChildDistrictSpecialFacilityWomanMan(Himesis):
    def __init__(self):

    
    
        """
        Creates the himesis graph representing the DSLTrans rule dfacilitiesSolveRefNeighborhoodSchoolServiceChildDistrictSpecialFacilityWomanMan.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HdfacilitiesSolveRefNeighborhoodSchoolServiceChildDistrictSpecialFacilityWomanMan, self).__init__(name='HdfacilitiesSolveRefNeighborhoodSchoolServiceChildDistrictSpecialFacilityWomanMan', num_nodes=0, edges=[])
        
        
        # Set the graph attributes
        self["mm__"] = ['HimesisMM']
        
        self["name"] = """dfacilitiesSolveRefNeighborhoodSchoolServiceChildDistrictSpecialFacilityWomanMan"""
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'dfacilitiesSolveRefNeighborhoodSchoolServiceChildDistrictSpecialFacilityWomanMan')
        ...
        # apply association SpecialFacility--members-->Woman node
        self.add_node()
        self.vs[23]["attr1"] = """members"""
        self.vs[23]["mm__"] = """directLink_T"""
        # apply association SpecialFacility--members-->Man node
        self.add_node()
        ...
        self.add_edges([
                ...
                (5,20), # match_class School() -> association special
                (20,7), # association special  -> match_class Service()
                ...
                (22,13), # association facilities  -> apply_class SpecialFacility()
                (13,23), # apply_class SpecialFacility() -> association members
                (23,15), # association members  -> apply_class Woman()
                (13,24), # apply_class SpecialFacility() -> association members
        ...
        self["equations"] = [((11,'ApplyAttribute'),('constant','solveRef')), ((13,'name'),('concat',(('constant','Special Facility Service for school '),(5,'name')))), ((15,'ApplyAttribute'),('constant','solveRef')), ((17,'ApplyAttribute'),('constant','solveRef')), ]
