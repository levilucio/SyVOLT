...
class HcopersonsSolveRefCountryFamilyParentCommunityWoman(Himesis):
    def __init__(self):

    
    
        """
        Creates the himesis graph representing the DSLTrans rule copersonsSolveRefCountryFamilyParentCommunityWoman.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HcopersonsSolveRefCountryFamilyParentCommunityWoman, self).__init__(name='HcopersonsSolveRefCountryFamilyParentCommunityWoman', num_nodes=0, edges=[])
        
        
        # Set the graph attributes
        self["mm__"] = ['HimesisMM']
        self["name"] = """copersonsSolveRefCountryFamilyParentCommunityWoman"""
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'copersonsSolveRefCountryFamilyParentCommunityWoman')
        ...
        self.vs[2]["attr1"] = """copersonsSolveRefCountryFamilyParentCommunityWoman"""
        ...
        self.add_edges([
                ...
                (4,9), # match_class Family() -> association mothers
                (9,5), # association mothers  -> match_class Parent()
