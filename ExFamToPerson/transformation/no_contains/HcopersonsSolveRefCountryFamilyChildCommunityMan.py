...
class HcopersonsSolveRefCountryFamilyChildCommunityMan(Himesis):
    def __init__(self):
        ...
        self.vs[2]["attr1"] = """copersonsSolveRefCountryFamilyChildCommunityMan"""
        ...
        self.add_edges([
                ...
                (4,9), # match_class Family() -> association sons
                (9,5), # association sons  -> match_class Child()
