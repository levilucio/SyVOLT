...
class HetypeparameterOUTeAnnotationsSolveRefETypeParameterEAnnotationETypeParameterEAnnotation(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule etypeparameterOUTeAnnotationsSolveRefETypeParameterEAnnotationETypeParameterEAnnotation.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HetypeparameterOUTeAnnotationsSolveRefETypeParameterEAnnotationETypeParameterEAnnotation, self).__init__(name='HetypeparameterOUTeAnnotationsSolveRefETypeParameterEAnnotationETypeParameterEAnnotation', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'etypeparameterOUTeAnnotationsSolveRefETypeParameterEAnnotationETypeParameterEAnnotation')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'etypeparameterOUTeAnnotationsSolveRefETypeParameterEAnnotationETypeParameterEAnnotationmatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'etypeparameterOUTeAnnotationsSolveRefETypeParameterEAnnotationETypeParameterEAnnotationapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'etypeparameterOUTeAnnotationsSolveRefETypeParameterEAnnotationETypeParameterEAnnotationpairedwith2')
        
    	# match class ETypeParameter() node
    	self.add_node()
    	self.vs[3]["name"] = """"""
        self.vs[3]["classtype"] = """ETypeParameter"""
        self.vs[3]["mm__"] = """ETypeParameter"""
        self.vs[3]["cardinality"] = """+"""
        #self.vs[3]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'')
    	# match_contains node for class ETypeParameter()
        self.add_node()
    	...
    	# apply class ETypeParameter() node
    	self.add_node()
    	self.vs[7]["name"] = """"""
    	...
    	# apply_contains node for class ETypeParameter()
        self.add_node()
    	...
    	# match association ETypeParameter--eAnnotations-->EAnnotation node
    	self.add_node()
    	self.vs[11]["associationType"] = """eAnnotations"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association ETypeParameter--eAnnotations-->EAnnotation node
    	self.add_node()
    	self.vs[12]["associationType"] = """eAnnotations"""
        self.vs[12]["mm__"] = """directLink_T"""
        #self.vs[12]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc12')
        
    	# backward association ETypeParameter---->ETypeParameter node
    	self.add_node()
        ...
        self.add_edges([
    		...
    		(4,3), # match_contains -> match_class ETypeParameter()
    		(0,6), # matchmodel -> match_contains
    		(6,5), # match_contains -> match_class EAnnotation()
    		(1,8), # applymodel -> apply_contains
    		(8,7), # apply_contains -> apply_class ETypeParameter()
    		(1,10), # applymodel -> apply_contains
    		(10,9), # apply_contains -> apply_class EAnnotation()
    		(3,11), # match_class ETypeParameter() -> association eAnnotations
    		(11,5), # association eAnnotations  -> match_class EAnnotation()
    		(7,12), # apply_class ETypeParameter() -> association eAnnotations
    		(12,9), # association eAnnotations  -> apply_class EAnnotation()
    		(7,13), # apply_class ETypeParameter() -> backward_association
    		(13,3), #  backward_association -> apply_class ETypeParameter()
    		(9,14), # apply_class EAnnotation() -> backward_association
    		(14,5), #  backward_association -> apply_class EAnnotation()
    		(7,15), # apply_class ETypeParameter() -> has_apply_attribute ApplyAttribute ()
    		...
    		(9,21), # apply_class EAnnotation() -> has_apply_attribute ApplyAttribute ()
