...
class HeoperationOUTeGenericExceptionsSolveRefEOperationEGenericTypeEOperationEGenericType(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule eoperationOUTeGenericExceptionsSolveRefEOperationEGenericTypeEOperationEGenericType.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HeoperationOUTeGenericExceptionsSolveRefEOperationEGenericTypeEOperationEGenericType, self).__init__(name='HeoperationOUTeGenericExceptionsSolveRefEOperationEGenericTypeEOperationEGenericType', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperationOUTeGenericExceptionsSolveRefEOperationEGenericTypeEOperationEGenericType')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperationOUTeGenericExceptionsSolveRefEOperationEGenericTypeEOperationEGenericTypematchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperationOUTeGenericExceptionsSolveRefEOperationEGenericTypeEOperationEGenericTypeapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperationOUTeGenericExceptionsSolveRefEOperationEGenericTypeEOperationEGenericTypepairedwith2')
    	...
    	# match association EOperation--eGenericExceptions-->EGenericType node
    	self.add_node()
    	self.vs[11]["associationType"] = """eGenericExceptions"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EOperation--eGenericExceptions-->EGenericType node
    	self.add_node()
    	self.vs[12]["associationType"] = """eGenericExceptions"""
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EOperation() -> association eGenericExceptions
    		(11,5), # association eGenericExceptions  -> match_class EGenericType()
    		(7,12), # apply_class EOperation() -> association eGenericExceptions
    		(12,9), # association eGenericExceptions  -> apply_class EGenericType()
