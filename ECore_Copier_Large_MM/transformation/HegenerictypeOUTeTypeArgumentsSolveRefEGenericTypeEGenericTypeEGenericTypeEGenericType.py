...
class HegenerictypeOUTeTypeArgumentsSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericType(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule egenerictypeOUTeTypeArgumentsSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericType.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HegenerictypeOUTeTypeArgumentsSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericType, self).__init__(name='HegenerictypeOUTeTypeArgumentsSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericType', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeTypeArgumentsSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericType')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeTypeArgumentsSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericTypematchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeTypeArgumentsSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericTypeapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeTypeArgumentsSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericTypepairedwith2')
    	...
    	# match association EGenericType--eTypeArguments-->EGenericType node
    	self.add_node()
    	self.vs[11]["associationType"] = """eTypeArguments"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EGenericType--eTypeArguments-->EGenericType node
    	self.add_node()
    	self.vs[12]["associationType"] = """eTypeArguments"""
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EGenericType() -> association eTypeArguments
    		(11,5), # association eTypeArguments  -> match_class EGenericType()
    		(7,12), # apply_class EGenericType() -> association eTypeArguments
    		(12,9), # association eTypeArguments  -> apply_class EGenericType()
