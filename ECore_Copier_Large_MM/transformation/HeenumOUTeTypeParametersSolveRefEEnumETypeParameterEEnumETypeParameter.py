...
class HeenumOUTeTypeParametersSolveRefEEnumETypeParameterEEnumETypeParameter(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule eenumOUTeTypeParametersSolveRefEEnumETypeParameterEEnumETypeParameter.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HeenumOUTeTypeParametersSolveRefEEnumETypeParameterEEnumETypeParameter, self).__init__(name='HeenumOUTeTypeParametersSolveRefEEnumETypeParameterEEnumETypeParameter', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eenumOUTeTypeParametersSolveRefEEnumETypeParameterEEnumETypeParameter')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eenumOUTeTypeParametersSolveRefEEnumETypeParameterEEnumETypeParametermatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eenumOUTeTypeParametersSolveRefEEnumETypeParameterEEnumETypeParameterapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eenumOUTeTypeParametersSolveRefEEnumETypeParameterEEnumETypeParameterpairedwith2')
    	...
    	# match association EEnum--eTypeParameters-->ETypeParameter node
    	self.add_node()
    	self.vs[11]["associationType"] = """eTypeParameters"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EEnum--eTypeParameters-->ETypeParameter node
    	self.add_node()
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EEnum() -> association eTypeParameters
    		(11,5), # association eTypeParameters  -> match_class ETypeParameter()
    		(7,12), # apply_class EEnum() -> association eTypeParameters
