...
class HegenerictypeOUTeTypeParameterSolveRefEGenericTypeETypeParameterEGenericTypeETypeParameter(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule egenerictypeOUTeTypeParameterSolveRefEGenericTypeETypeParameterEGenericTypeETypeParameter.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HegenerictypeOUTeTypeParameterSolveRefEGenericTypeETypeParameterEGenericTypeETypeParameter, self).__init__(name='HegenerictypeOUTeTypeParameterSolveRefEGenericTypeETypeParameterEGenericTypeETypeParameter', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeTypeParameterSolveRefEGenericTypeETypeParameterEGenericTypeETypeParameter')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeTypeParameterSolveRefEGenericTypeETypeParameterEGenericTypeETypeParametermatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeTypeParameterSolveRefEGenericTypeETypeParameterEGenericTypeETypeParameterapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeTypeParameterSolveRefEGenericTypeETypeParameterEGenericTypeETypeParameterpairedwith2')
    	...
    	# match association EGenericType--eTypeParameter-->ETypeParameter node
    	self.add_node()
    	self.vs[11]["associationType"] = """eTypeParameter"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EGenericType--eTypeParameter-->ETypeParameter node
    	self.add_node()
    	self.vs[12]["associationType"] = """eTypeParameter"""
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EGenericType() -> association eTypeParameter
    		(11,5), # association eTypeParameter  -> match_class ETypeParameter()
    		(7,12), # apply_class EGenericType() -> association eTypeParameter
    		(12,9), # association eTypeParameter  -> apply_class ETypeParameter()
