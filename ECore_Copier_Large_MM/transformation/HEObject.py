...
class HEObject(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule EObject.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HEObject, self).__init__(name='HEObject', num_nodes=0, edges=[])
...
a.""")
        ...
        self["name"] = """EObject"""
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'EObject')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'EObjectmatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'EObjectapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'EObjectpairedwith2')
        
    	# match class EObject() node
    	self.add_node()
    	self.vs[3]["name"] = """"""
        self.vs[3]["classtype"] = """EObject"""
        self.vs[3]["mm__"] = """EObject"""
        ...
        self.add_edges([
    		...
    		(4,3), # match_contains -> match_class EObject()
    		(1,6), # applymodel -> apply_contains
    		(6,5), # apply_contains -> apply_class EObject()
    		(5,7), # apply_class EObject() -> has_apply_attribute ApplyAttribute ()
