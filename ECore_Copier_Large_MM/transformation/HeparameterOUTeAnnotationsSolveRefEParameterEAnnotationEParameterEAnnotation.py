...
class HeparameterOUTeAnnotationsSolveRefEParameterEAnnotationEParameterEAnnotation(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule eparameterOUTeAnnotationsSolveRefEParameterEAnnotationEParameterEAnnotation.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HeparameterOUTeAnnotationsSolveRefEParameterEAnnotationEParameterEAnnotation, self).__init__(name='HeparameterOUTeAnnotationsSolveRefEParameterEAnnotationEParameterEAnnotation', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eparameterOUTeAnnotationsSolveRefEParameterEAnnotationEParameterEAnnotation')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eparameterOUTeAnnotationsSolveRefEParameterEAnnotationEParameterEAnnotationmatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eparameterOUTeAnnotationsSolveRefEParameterEAnnotationEParameterEAnnotationapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eparameterOUTeAnnotationsSolveRefEParameterEAnnotationEParameterEAnnotationpairedwith2')
    	...
    	# match association EParameter--eAnnotations-->EAnnotation node
    	self.add_node()
    	self.vs[11]["associationType"] = """eAnnotations"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EParameter--eAnnotations-->EAnnotation node
    	self.add_node()
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EParameter() -> association eAnnotations
    		(11,5), # association eAnnotations  -> match_class EAnnotation()
    		(7,12), # apply_class EParameter() -> association eAnnotations
    		...
    		(7,15), # apply_class EParameter() -> has_apply_attribute ApplyAttribute ()
