...
class HeannotationOUTreferencesSolveRefEAnnotationEObjectEAnnotationEObject(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule eannotationOUTreferencesSolveRefEAnnotationEObjectEAnnotationEObject.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HeannotationOUTreferencesSolveRefEAnnotationEObjectEAnnotationEObject, self).__init__(name='HeannotationOUTreferencesSolveRefEAnnotationEObjectEAnnotationEObject', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eannotationOUTreferencesSolveRefEAnnotationEObjectEAnnotationEObject')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eannotationOUTreferencesSolveRefEAnnotationEObjectEAnnotationEObjectmatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eannotationOUTreferencesSolveRefEAnnotationEObjectEAnnotationEObjectapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eannotationOUTreferencesSolveRefEAnnotationEObjectEAnnotationEObjectpairedwith2')
    	...
    	# match class EObject() node
    	self.add_node()
    	self.vs[5]["name"] = """"""
        self.vs[5]["classtype"] = """EObject"""
        self.vs[5]["mm__"] = """EObject"""
        self.vs[5]["cardinality"] = """+"""
        #self.vs[5]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'')
    	# match_contains node for class EObject()
        self.add_node()
    	...
    	# apply class EObject() node
    	self.add_node()
    	self.vs[9]["name"] = """"""
        self.vs[9]["classtype"] = """EObject"""
        self.vs[9]["mm__"] = """EObject"""
        self.vs[9]["cardinality"] = """1"""
        #self.vs[9]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'')
    	# apply_contains node for class EObject()
        self.add_node()
        self.vs[10]["mm__"] = """apply_contains"""
        #self.vs[10]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'applycontains10')
        
        
    	# match association EAnnotation--references-->EObject node
    	self.add_node()
    	self.vs[11]["associationType"] = """references"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EAnnotation--references-->EObject node
    	self.add_node()
    	self.vs[12]["associationType"] = """references"""
    	...
    	# backward association EObject---->EObject node
    	self.add_node()
        ...
        self.add_edges([
    		...
    		(6,5), # match_contains -> match_class EObject()
    		(1,8), # applymodel -> apply_contains
    		(8,7), # apply_contains -> apply_class EAnnotation()
    		(1,10), # applymodel -> apply_contains
    		(10,9), # apply_contains -> apply_class EObject()
    		(3,11), # match_class EAnnotation() -> association references
    		(11,5), # association references  -> match_class EObject()
    		(7,12), # apply_class EAnnotation() -> association references
    		(12,9), # association references  -> apply_class EObject()
    		(7,13), # apply_class EAnnotation() -> backward_association
    		(13,3), #  backward_association -> apply_class EAnnotation()
    		(9,14), # apply_class EObject() -> backward_association
    		(14,5), #  backward_association -> apply_class EObject()
    		...
    		(9,21), # apply_class EObject() -> has_apply_attribute ApplyAttribute ()
