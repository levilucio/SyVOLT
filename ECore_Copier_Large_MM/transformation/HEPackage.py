...
a.""")
        ...
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'EPackagematchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'EPackageapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'EPackagepairedwith2')
        ...
        self.add_edges([
    		...
    		(3,7), # match_class EPackage() -> has_match_attribute name ()
    		(7,8), #  has_match_attribute name () -> match_attribute name ()
    		(3,9), # match_class EPackage() -> has_match_attribute nsURI ()
    		(9,10), #  has_match_attribute nsURI () -> match_attribute nsURI ()
    		(3,11), # match_class EPackage() -> has_match_attribute nsPrefix ()
    		(11,12), #  has_match_attribute nsPrefix () -> match_attribute nsPrefix ()
    		(5,13), # apply_class EPackage() -> has_apply_attribute name ()
    		...
    		(5,18), # apply_class EPackage() -> has_apply_attribute nsURI ()
    		(18,19), #  has_apply_attribute nsURI () -> apply_attribute nsURI ()
    		(20,21), #  equation of apply attribute nsURI () -> left_expr
    		(21,19), #  left_expr -> apply_attribute nsURI ()
    		(20,22), #  equation of apply attribute nsURI () -> right_expr
    		(22,10), # right_expr --> term
    		(5,23), # apply_class EPackage() -> has_apply_attribute nsPrefix ()
    		(23,24), #  has_apply_attribute nsPrefix () -> apply_attribute nsPrefix ()
    		(25,26), #  equation of apply attribute nsPrefix () -> left_expr
    		(26,24), #  left_expr -> apply_attribute nsPrefix ()
    		(25,27), #  equation of apply attribute nsPrefix () -> right_expr
    		(27,12), # right_expr --> term
    		(5,28), # apply_class EPackage() -> has_apply_attribute ApplyAttribute ()
