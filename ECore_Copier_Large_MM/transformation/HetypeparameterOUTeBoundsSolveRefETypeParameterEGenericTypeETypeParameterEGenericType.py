...
class HetypeparameterOUTeBoundsSolveRefETypeParameterEGenericTypeETypeParameterEGenericType(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule etypeparameterOUTeBoundsSolveRefETypeParameterEGenericTypeETypeParameterEGenericType.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HetypeparameterOUTeBoundsSolveRefETypeParameterEGenericTypeETypeParameterEGenericType, self).__init__(name='HetypeparameterOUTeBoundsSolveRefETypeParameterEGenericTypeETypeParameterEGenericType', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'etypeparameterOUTeBoundsSolveRefETypeParameterEGenericTypeETypeParameterEGenericType')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'etypeparameterOUTeBoundsSolveRefETypeParameterEGenericTypeETypeParameterEGenericTypematchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'etypeparameterOUTeBoundsSolveRefETypeParameterEGenericTypeETypeParameterEGenericTypeapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'etypeparameterOUTeBoundsSolveRefETypeParameterEGenericTypeETypeParameterEGenericTypepairedwith2')
    	...
    	# match association ETypeParameter--eBounds-->EGenericType node
    	self.add_node()
    	self.vs[11]["associationType"] = """eBounds"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association ETypeParameter--eBounds-->EGenericType node
    	self.add_node()
    	self.vs[12]["associationType"] = """eBounds"""
        ...
        self.add_edges([
    		...
    		(3,11), # match_class ETypeParameter() -> association eBounds
    		(11,5), # association eBounds  -> match_class EGenericType()
    		(7,12), # apply_class ETypeParameter() -> association eBounds
    		(12,9), # association eBounds  -> apply_class EGenericType()
