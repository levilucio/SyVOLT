...
class HegenerictypeOUTeClassifierSolveRefEGenericTypeEClassifierEGenericTypeEClassifier(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule egenerictypeOUTeClassifierSolveRefEGenericTypeEClassifierEGenericTypeEClassifier.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HegenerictypeOUTeClassifierSolveRefEGenericTypeEClassifierEGenericTypeEClassifier, self).__init__(name='HegenerictypeOUTeClassifierSolveRefEGenericTypeEClassifierEGenericTypeEClassifier', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeClassifierSolveRefEGenericTypeEClassifierEGenericTypeEClassifier')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeClassifierSolveRefEGenericTypeEClassifierEGenericTypeEClassifiermatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeClassifierSolveRefEGenericTypeEClassifierEGenericTypeEClassifierapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeClassifierSolveRefEGenericTypeEClassifierEGenericTypeEClassifierpairedwith2')
    	...
    	# match association EGenericType--eClassifier-->EClassifier node
    	self.add_node()
    	self.vs[11]["associationType"] = """eClassifier"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EGenericType--eClassifier-->EClassifier node
    	self.add_node()
    	self.vs[12]["associationType"] = """eClassifier"""
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EGenericType() -> association eClassifier
    		(11,5), # association eClassifier  -> match_class EClassifier()
    		(7,12), # apply_class EGenericType() -> association eClassifier
    		(12,9), # association eClassifier  -> apply_class EClassifier()
