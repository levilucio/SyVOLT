...
a.""")
    	...
    	# has match attribute literal() node
    	self.add_node()
    	self.vs[13]["mm__"] = """hasAttribute_S"""
        #self.vs[13]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'has')
    	# match attribute literal() node
    	self.add_node()
    	self.vs[14]["name"] = """literal"""
        ...
        self.add_edges([
    		...
    		(3,13), # match_class EEnumLiteral() -> has_match_attribute literal ()
    		(13,14), #  has_match_attribute literal () -> match_attribute literal ()
    		(5,15), # apply_class EEnumLiteral() -> has_apply_attribute name ()
    		...
    		(5,20), # apply_class EEnumLiteral() -> has_apply_attribute value ()
    		(20,21), #  has_apply_attribute value () -> apply_attribute value ()
    		(22,23), #  equation of apply attribute value () -> left_expr
    		(23,21), #  left_expr -> apply_attribute value ()
    		(22,24), #  equation of apply attribute value () -> right_expr
    		(24,10), # right_expr --> term
    		(5,25), # apply_class EEnumLiteral() -> has_apply_attribute instance ()
    		(25,26), #  has_apply_attribute instance () -> apply_attribute instance ()
    		(27,28), #  equation of apply attribute instance () -> left_expr
    		(28,26), #  left_expr -> apply_attribute instance ()
    		(27,29), #  equation of apply attribute instance () -> right_expr
    		(29,12), # right_expr --> term
    		(5,30), # apply_class EEnumLiteral() -> has_apply_attribute literal ()
    		(30,31), #  has_apply_attribute literal () -> apply_attribute literal ()
    		(32,33), #  equation of apply attribute literal () -> left_expr
    		(33,31), #  left_expr -> apply_attribute literal ()
    		(32,34), #  equation of apply attribute literal () -> right_expr
    		(34,14), # right_expr --> term
    		(5,35), # apply_class EEnumLiteral() -> has_apply_attribute ApplyAttribute ()
