...
class HereferenceOUTeGenericTypeSolveRefEReferenceEGenericTypeEReferenceEGenericType(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule ereferenceOUTeGenericTypeSolveRefEReferenceEGenericTypeEReferenceEGenericType.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HereferenceOUTeGenericTypeSolveRefEReferenceEGenericTypeEReferenceEGenericType, self).__init__(name='HereferenceOUTeGenericTypeSolveRefEReferenceEGenericTypeEReferenceEGenericType', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereferenceOUTeGenericTypeSolveRefEReferenceEGenericTypeEReferenceEGenericType')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereferenceOUTeGenericTypeSolveRefEReferenceEGenericTypeEReferenceEGenericTypematchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereferenceOUTeGenericTypeSolveRefEReferenceEGenericTypeEReferenceEGenericTypeapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereferenceOUTeGenericTypeSolveRefEReferenceEGenericTypeEReferenceEGenericTypepairedwith2')
    	...
    	# match association EReference--eGenericType-->EGenericType node
    	self.add_node()
    	self.vs[11]["associationType"] = """eGenericType"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EReference--eGenericType-->EGenericType node
    	self.add_node()
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EReference() -> association eGenericType
    		(11,5), # association eGenericType  -> match_class EGenericType()
    		(7,12), # apply_class EReference() -> association eGenericType
