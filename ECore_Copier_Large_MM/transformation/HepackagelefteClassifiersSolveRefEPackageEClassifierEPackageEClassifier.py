...
class HepackagelefteClassifiersSolveRefEPackageEClassifierEPackageEClassifier(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule epackagelefteClassifiersSolveRefEPackageEClassifierEPackageEClassifier.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HepackagelefteClassifiersSolveRefEPackageEClassifierEPackageEClassifier, self).__init__(name='HepackagelefteClassifiersSolveRefEPackageEClassifierEPackageEClassifier', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'epackagelefteClassifiersSolveRefEPackageEClassifierEPackageEClassifier')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'epackagelefteClassifiersSolveRefEPackageEClassifierEPackageEClassifiermatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'epackagelefteClassifiersSolveRefEPackageEClassifierEPackageEClassifierapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'epackagelefteClassifiersSolveRefEPackageEClassifierEPackageEClassifierpairedwith2')
    	...
    	# match association EPackage--eClassifiers-->EClassifier node
    	self.add_node()
    	self.vs[11]["associationType"] = """eClassifiers"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EPackage--eClassifiers-->EClassifier node
    	self.add_node()
    	self.vs[12]["associationType"] = """eClassifiers"""
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EPackage() -> association eClassifiers
    		(11,5), # association eClassifiers  -> match_class EClassifier()
    		(7,12), # apply_class EPackage() -> association eClassifiers
    		(12,9), # association eClassifiers  -> apply_class EClassifier()
