...
class HeattributelefteAnnotationsSolveRefEAttributeEAnnotationEAttributeEAnnotation(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule eattributelefteAnnotationsSolveRefEAttributeEAnnotationEAttributeEAnnotation.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HeattributelefteAnnotationsSolveRefEAttributeEAnnotationEAttributeEAnnotation, self).__init__(name='HeattributelefteAnnotationsSolveRefEAttributeEAnnotationEAttributeEAnnotation', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eattributelefteAnnotationsSolveRefEAttributeEAnnotationEAttributeEAnnotation')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eattributelefteAnnotationsSolveRefEAttributeEAnnotationEAttributeEAnnotationmatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eattributelefteAnnotationsSolveRefEAttributeEAnnotationEAttributeEAnnotationapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eattributelefteAnnotationsSolveRefEAttributeEAnnotationEAttributeEAnnotationpairedwith2')
    	...
    	# match association EAttribute--eAnnotations-->EAnnotation node
    	self.add_node()
    	self.vs[11]["associationType"] = """eAnnotations"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EAttribute--eAnnotations-->EAnnotation node
    	self.add_node()
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EAttribute() -> association eAnnotations
    		(11,5), # association eAnnotations  -> match_class EAnnotation()
    		(7,12), # apply_class EAttribute() -> association eAnnotations
