...
class HeannotationlefteAnnotationsSolveRefEAnnotationEAnnotationEAnnotationEAnnotation(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule eannotationlefteAnnotationsSolveRefEAnnotationEAnnotationEAnnotationEAnnotation.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HeannotationlefteAnnotationsSolveRefEAnnotationEAnnotationEAnnotationEAnnotation, self).__init__(name='HeannotationlefteAnnotationsSolveRefEAnnotationEAnnotationEAnnotationEAnnotation', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eannotationlefteAnnotationsSolveRefEAnnotationEAnnotationEAnnotationEAnnotation')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eannotationlefteAnnotationsSolveRefEAnnotationEAnnotationEAnnotationEAnnotationmatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eannotationlefteAnnotationsSolveRefEAnnotationEAnnotationEAnnotationEAnnotationapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eannotationlefteAnnotationsSolveRefEAnnotationEAnnotationEAnnotationEAnnotationpairedwith2')
    	...
    	# match association EAnnotation--eAnnotations-->EAnnotation node
    	self.add_node()
    	self.vs[11]["associationType"] = """eAnnotations"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EAnnotation--eAnnotations-->EAnnotation node
    	self.add_node()
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EAnnotation() -> association eAnnotations
    		(11,5), # association eAnnotations  -> match_class EAnnotation()
    		(7,12), # apply_class EAnnotation() -> association eAnnotations
