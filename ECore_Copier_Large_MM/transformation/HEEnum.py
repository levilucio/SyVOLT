...
a.""")
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EEnum() -> has_match_attribute instanceTypeName ()
    		(11,12), #  has_match_attribute instanceTypeName () -> match_attribute instanceTypeName ()
    		(3,13), # match_class EEnum() -> has_match_attribute serializable ()
    		(13,14), #  has_match_attribute serializable () -> match_attribute serializable ()
    		(5,15), # apply_class EEnum() -> has_apply_attribute name ()
    		...
    		(5,20), # apply_class EEnum() -> has_apply_attribute instanceClassName ()
    		...
    		(5,25), # apply_class EEnum() -> has_apply_attribute instanceTypeName ()
    		...
    		(5,30), # apply_class EEnum() -> has_apply_attribute serializable ()
    		...
    		(5,35), # apply_class EEnum() -> has_apply_attribute ApplyAttribute ()
