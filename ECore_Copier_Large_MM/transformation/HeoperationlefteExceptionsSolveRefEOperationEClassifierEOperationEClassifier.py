...
class HeoperationlefteExceptionsSolveRefEOperationEClassifierEOperationEClassifier(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule eoperationlefteExceptionsSolveRefEOperationEClassifierEOperationEClassifier.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HeoperationlefteExceptionsSolveRefEOperationEClassifierEOperationEClassifier, self).__init__(name='HeoperationlefteExceptionsSolveRefEOperationEClassifierEOperationEClassifier', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperationlefteExceptionsSolveRefEOperationEClassifierEOperationEClassifier')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperationlefteExceptionsSolveRefEOperationEClassifierEOperationEClassifiermatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperationlefteExceptionsSolveRefEOperationEClassifierEOperationEClassifierapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperationlefteExceptionsSolveRefEOperationEClassifierEOperationEClassifierpairedwith2')
    	...
    	# match association EOperation--eExceptions-->EClassifier node
    	self.add_node()
    	self.vs[11]["associationType"] = """eExceptions"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EOperation--eExceptions-->EClassifier node
    	self.add_node()
    	self.vs[12]["associationType"] = """eExceptions"""
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EOperation() -> association eExceptions
    		(11,5), # association eExceptions  -> match_class EClassifier()
    		(7,12), # apply_class EOperation() -> association eExceptions
    		(12,9), # association eExceptions  -> apply_class EClassifier()
