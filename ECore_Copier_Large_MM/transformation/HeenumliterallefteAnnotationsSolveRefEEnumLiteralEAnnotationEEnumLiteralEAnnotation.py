...
class HeenumliterallefteAnnotationsSolveRefEEnumLiteralEAnnotationEEnumLiteralEAnnotation(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule eenumliterallefteAnnotationsSolveRefEEnumLiteralEAnnotationEEnumLiteralEAnnotation.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HeenumliterallefteAnnotationsSolveRefEEnumLiteralEAnnotationEEnumLiteralEAnnotation, self).__init__(name='HeenumliterallefteAnnotationsSolveRefEEnumLiteralEAnnotationEEnumLiteralEAnnotation', num_nodes=0, edges=[])
...
a.""")
        ...
        self["name"] = """eenumliterallefteAnnotationsSolveRefEEnumLiteralEAnnotationEEnumLiteralEAnnotation"""
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eenumliterallefteAnnotationsSolveRefEEnumLiteralEAnnotationEEnumLiteralEAnnotation')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eenumliterallefteAnnotationsSolveRefEEnumLiteralEAnnotationEEnumLiteralEAnnotationmatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eenumliterallefteAnnotationsSolveRefEEnumLiteralEAnnotationEEnumLiteralEAnnotationapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eenumliterallefteAnnotationsSolveRefEEnumLiteralEAnnotationEEnumLiteralEAnnotationpairedwith2')
    	...
    	# match association EEnumLiteral--eAnnotations-->EAnnotation node
    	self.add_node()
    	self.vs[11]["associationType"] = """eAnnotations"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EEnumLiteral--eAnnotations-->EAnnotation node
    	self.add_node()
        ...
        self.add_edges([
    		...
    		(8,7), # apply_contains -> apply_class EEnumLiteral()
    		(1,10), # applymodel -> apply_contains
    		(10,9), # apply_contains -> apply_class EAnnotation()
    		(3,11), # match_class EEnumLiteral() -> association eAnnotations
    		(11,5), # association eAnnotations  -> match_class EAnnotation()
    		(7,12), # apply_class EEnumLiteral() -> association eAnnotations
    		(12,9), # association eAnnotations  -> apply_class EAnnotation()
    		(7,13), # apply_class EEnumLiteral() -> backward_association
    		(13,3), #  backward_association -> apply_class EEnumLiteral()
    		(9,14), # apply_class EAnnotation() -> backward_association
    		(14,5), #  backward_association -> apply_class EAnnotation()
    		(7,15), # apply_class EEnumLiteral() -> has_apply_attribute ApplyAttribute ()
