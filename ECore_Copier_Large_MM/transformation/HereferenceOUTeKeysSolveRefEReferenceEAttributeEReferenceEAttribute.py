...
class HereferenceOUTeKeysSolveRefEReferenceEAttributeEReferenceEAttribute(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule ereferenceOUTeKeysSolveRefEReferenceEAttributeEReferenceEAttribute.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HereferenceOUTeKeysSolveRefEReferenceEAttributeEReferenceEAttribute, self).__init__(name='HereferenceOUTeKeysSolveRefEReferenceEAttributeEReferenceEAttribute', num_nodes=0, edges=[])
...
a.""")
        ...
        self["name"] = """ereferenceOUTeKeysSolveRefEReferenceEAttributeEReferenceEAttribute"""
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereferenceOUTeKeysSolveRefEReferenceEAttributeEReferenceEAttribute')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereferenceOUTeKeysSolveRefEReferenceEAttributeEReferenceEAttributematchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereferenceOUTeKeysSolveRefEReferenceEAttributeEReferenceEAttributeapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereferenceOUTeKeysSolveRefEReferenceEAttributeEReferenceEAttributepairedwith2')
    	...
    	# match association EReference--eKeys-->EAttribute node
    	self.add_node()
    	self.vs[11]["associationType"] = """eKeys"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EReference--eKeys-->EAttribute node
    	self.add_node()
    	self.vs[12]["associationType"] = """eKeys"""
        ...
        self.add_edges([
    		...
    		(6,5), # match_contains -> match_class EAttribute()
    		(1,8), # applymodel -> apply_contains
    		(8,7), # apply_contains -> apply_class EReference()
    		(1,10), # applymodel -> apply_contains
    		(10,9), # apply_contains -> apply_class EAttribute()
    		(3,11), # match_class EReference() -> association eKeys
    		(11,5), # association eKeys  -> match_class EAttribute()
    		(7,12), # apply_class EReference() -> association eKeys
    		(12,9), # association eKeys  -> apply_class EAttribute()
    		(7,13), # apply_class EReference() -> backward_association
    		(13,3), #  backward_association -> apply_class EReference()
    		(9,14), # apply_class EAttribute() -> backward_association
    		(14,5), #  backward_association -> apply_class EAttribute()
    		...
    		(9,21), # apply_class EAttribute() -> has_apply_attribute ApplyAttribute ()
