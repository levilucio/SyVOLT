...
class HeclassOUTeGenericSuperTypesSolveRefEClassEGenericTypeEClassEGenericType(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule eclassOUTeGenericSuperTypesSolveRefEClassEGenericTypeEClassEGenericType.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HeclassOUTeGenericSuperTypesSolveRefEClassEGenericTypeEClassEGenericType, self).__init__(name='HeclassOUTeGenericSuperTypesSolveRefEClassEGenericTypeEClassEGenericType', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eclassOUTeGenericSuperTypesSolveRefEClassEGenericTypeEClassEGenericType')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eclassOUTeGenericSuperTypesSolveRefEClassEGenericTypeEClassEGenericTypematchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eclassOUTeGenericSuperTypesSolveRefEClassEGenericTypeEClassEGenericTypeapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eclassOUTeGenericSuperTypesSolveRefEClassEGenericTypeEClassEGenericTypepairedwith2')
    	...
    	# match association EClass--eGenericSuperTypes-->EGenericType node
    	self.add_node()
    	self.vs[11]["associationType"] = """eGenericSuperTypes"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EClass--eGenericSuperTypes-->EGenericType node
    	self.add_node()
    	self.vs[12]["associationType"] = """eGenericSuperTypes"""
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EClass() -> association eGenericSuperTypes
    		(11,5), # association eGenericSuperTypes  -> match_class EGenericType()
    		(7,12), # apply_class EClass() -> association eGenericSuperTypes
    		(12,9), # association eGenericSuperTypes  -> apply_class EGenericType()
