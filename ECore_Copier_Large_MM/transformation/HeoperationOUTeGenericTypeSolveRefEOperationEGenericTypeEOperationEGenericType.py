...
class HeoperationOUTeGenericTypeSolveRefEOperationEGenericTypeEOperationEGenericType(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule eoperationOUTeGenericTypeSolveRefEOperationEGenericTypeEOperationEGenericType.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HeoperationOUTeGenericTypeSolveRefEOperationEGenericTypeEOperationEGenericType, self).__init__(name='HeoperationOUTeGenericTypeSolveRefEOperationEGenericTypeEOperationEGenericType', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperationOUTeGenericTypeSolveRefEOperationEGenericTypeEOperationEGenericType')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperationOUTeGenericTypeSolveRefEOperationEGenericTypeEOperationEGenericTypematchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperationOUTeGenericTypeSolveRefEOperationEGenericTypeEOperationEGenericTypeapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperationOUTeGenericTypeSolveRefEOperationEGenericTypeEOperationEGenericTypepairedwith2')
    	...
    	# match association EOperation--eGenericType-->EGenericType node
    	self.add_node()
    	self.vs[11]["associationType"] = """eGenericType"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EOperation--eGenericType-->EGenericType node
    	self.add_node()
    	self.vs[12]["associationType"] = """eGenericType"""
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EOperation() -> association eGenericType
    		(11,5), # association eGenericType  -> match_class EGenericType()
    		(7,12), # apply_class EOperation() -> association eGenericType
    		(12,9), # association eGenericType  -> apply_class EGenericType()
