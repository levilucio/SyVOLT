...
class HedatatypeOUTeTypeParametersSolveRefEDataTypeETypeParameterEDataTypeETypeParameter(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule edatatypeOUTeTypeParametersSolveRefEDataTypeETypeParameterEDataTypeETypeParameter.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HedatatypeOUTeTypeParametersSolveRefEDataTypeETypeParameterEDataTypeETypeParameter, self).__init__(name='HedatatypeOUTeTypeParametersSolveRefEDataTypeETypeParameterEDataTypeETypeParameter', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'edatatypeOUTeTypeParametersSolveRefEDataTypeETypeParameterEDataTypeETypeParameter')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'edatatypeOUTeTypeParametersSolveRefEDataTypeETypeParameterEDataTypeETypeParametermatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'edatatypeOUTeTypeParametersSolveRefEDataTypeETypeParameterEDataTypeETypeParameterapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'edatatypeOUTeTypeParametersSolveRefEDataTypeETypeParameterEDataTypeETypeParameterpairedwith2')
    	...
    	# match association EDataType--eTypeParameters-->ETypeParameter node
    	self.add_node()
    	self.vs[11]["associationType"] = """eTypeParameters"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EDataType--eTypeParameters-->ETypeParameter node
    	self.add_node()
    	self.vs[12]["associationType"] = """eTypeParameters"""
        self.vs[12]["mm__"] = """directLink_T"""
        #self.vs[12]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc12')
        
    	# backward association EDataType---->EDataType node
    	self.add_node()
        ...
        self.add_edges([
    		...
    		(6,5), # match_contains -> match_class ETypeParameter()
    		(1,8), # applymodel -> apply_contains
    		(8,7), # apply_contains -> apply_class EDataType()
    		(1,10), # applymodel -> apply_contains
    		(10,9), # apply_contains -> apply_class ETypeParameter()
    		(3,11), # match_class EDataType() -> association eTypeParameters
    		(11,5), # association eTypeParameters  -> match_class ETypeParameter()
    		(7,12), # apply_class EDataType() -> association eTypeParameters
    		(12,9), # association eTypeParameters  -> apply_class ETypeParameter()
    		(7,13), # apply_class EDataType() -> backward_association
    		(13,3), #  backward_association -> apply_class EDataType()
    		(9,14), # apply_class ETypeParameter() -> backward_association
    		(14,5), #  backward_association -> apply_class ETypeParameter()
    		(7,15), # apply_class EDataType() -> has_apply_attribute ApplyAttribute ()
    		...
    		(9,21), # apply_class ETypeParameter() -> has_apply_attribute ApplyAttribute ()
