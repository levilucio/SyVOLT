...
class HegenerictypeOUTeLowerBoundSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericType(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule egenerictypeOUTeLowerBoundSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericType.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HegenerictypeOUTeLowerBoundSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericType, self).__init__(name='HegenerictypeOUTeLowerBoundSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericType', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeLowerBoundSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericType')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeLowerBoundSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericTypematchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeLowerBoundSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericTypeapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'egenerictypeOUTeLowerBoundSolveRefEGenericTypeEGenericTypeEGenericTypeEGenericTypepairedwith2')
    	...
    	# match association EGenericType--eLowerBound-->EGenericType node
    	self.add_node()
    	self.vs[11]["associationType"] = """eLowerBound"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EGenericType--eLowerBound-->EGenericType node
    	self.add_node()
    	self.vs[12]["associationType"] = """eLowerBound"""
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EGenericType() -> association eLowerBound
    		(11,5), # association eLowerBound  -> match_class EGenericType()
    		(7,12), # apply_class EGenericType() -> association eLowerBound
    		(12,9), # association eLowerBound  -> apply_class EGenericType()
