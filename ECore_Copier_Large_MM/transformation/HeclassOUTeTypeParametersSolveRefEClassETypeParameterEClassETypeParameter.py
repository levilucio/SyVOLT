...
class HeclassOUTeTypeParametersSolveRefEClassETypeParameterEClassETypeParameter(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule eclassOUTeTypeParametersSolveRefEClassETypeParameterEClassETypeParameter.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HeclassOUTeTypeParametersSolveRefEClassETypeParameterEClassETypeParameter, self).__init__(name='HeclassOUTeTypeParametersSolveRefEClassETypeParameterEClassETypeParameter', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eclassOUTeTypeParametersSolveRefEClassETypeParameterEClassETypeParameter')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eclassOUTeTypeParametersSolveRefEClassETypeParameterEClassETypeParametermatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eclassOUTeTypeParametersSolveRefEClassETypeParameterEClassETypeParameterapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eclassOUTeTypeParametersSolveRefEClassETypeParameterEClassETypeParameterpairedwith2')
    	...
    	# match association EClass--eTypeParameters-->ETypeParameter node
    	self.add_node()
    	self.vs[11]["associationType"] = """eTypeParameters"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EClass--eTypeParameters-->ETypeParameter node
    	self.add_node()
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EClass() -> association eTypeParameters
    		(11,5), # association eTypeParameters  -> match_class ETypeParameter()
    		(7,12), # apply_class EClass() -> association eTypeParameters
