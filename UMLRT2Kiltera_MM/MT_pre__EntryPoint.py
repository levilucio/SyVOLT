"""
__MT_pre__EntryPoint.py_____________________________________________________
...
from graph_MT_pre__EntryPoint import *
class MT_pre__EntryPoint(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_pre__Vertex', 'MT_pre__MetaModelElement_S']
      self.graphClass_ = graph_MT_pre__EntryPoint
   ...
   def clone(self):
      cloneObject = MT_pre__EntryPoint( self.parent )
