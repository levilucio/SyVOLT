"""
__graph_MT_post__State.py___________________________________________________________
...
class graph_MT_post__State(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([76.0, 41.0, 76.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__State', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__State
