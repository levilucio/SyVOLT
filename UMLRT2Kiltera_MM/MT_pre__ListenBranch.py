"""
__MT_pre__ListenBranch.py_____________________________________________________
...
class MT_pre__ListenBranch(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_pre__MetaModelElement_T']
      self.graphClass_ = graph_MT_pre__ListenBranch
   ...
   def clone(self):
      cloneObject = MT_pre__ListenBranch( self.parent )
