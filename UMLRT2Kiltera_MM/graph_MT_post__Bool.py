"""
__graph_MT_post__Bool.py___________________________________________________________
...
class graph_MT_post__Bool(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([57.0, 35.0, 57.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__Bool', width = '0', justify= 'left', stipple='' )
