"""
__graph_Vertex.py___________________________________________________________
...
class graph_Vertex(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([79.0, 36.0, 79.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'Vertex', width = '0', justify= 'left', stipple='' )
        ...
        h = drawing.create_text(self.translate([88.0, 60.0, 88.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
