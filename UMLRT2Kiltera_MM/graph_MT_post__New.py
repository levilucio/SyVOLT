"""
__graph_MT_post__New.py___________________________________________________________
...
class graph_MT_post__New(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([111.0, 63.0, 111.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__New', width = '0', justify= 'left', stipple='' )
