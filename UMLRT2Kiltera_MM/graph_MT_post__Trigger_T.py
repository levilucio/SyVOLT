"""
__graph_MT_post__Trigger_T.py___________________________________________________________
...
class graph_MT_post__Trigger_T(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([101.0, 64.0, 101.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__Trigger_T', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__Trigger_T
