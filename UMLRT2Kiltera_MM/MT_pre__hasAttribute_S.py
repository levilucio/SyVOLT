"""
__MT_pre__hasAttribute_S.py_____________________________________________________
...
class MT_pre__hasAttribute_S(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_pre__hasAttribute_S
   ...
   def clone(self):
      cloneObject = MT_pre__hasAttribute_S( self.parent )
