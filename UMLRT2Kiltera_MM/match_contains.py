"""
__match_contains.py_____________________________________________________
...
class match_contains(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_match_contains
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = match_contains( self.parent )
