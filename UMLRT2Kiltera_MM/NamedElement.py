"""
__NamedElement.py_____________________________________________________
...
from graph_NamedElement import *
class NamedElement(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['Element', 'MetaModelElement_S']
      self.graphClass_ = graph_NamedElement
   ...
   def clone(self):
      cloneObject = NamedElement( self.parent )
