"""
__MT_post__PackageContainer.py_____________________________________________________
...
from graph_MT_post__PackageContainer import *
class MT_post__PackageContainer(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__NamedElement', 'MT_post__MetaModelElement_S']
      self.graphClass_ = graph_MT_post__PackageContainer
   ...
   def clone(self):
      cloneObject = MT_post__PackageContainer( self.parent )
