"""
__graph_MetaModelElement_T.py___________________________________________________________
...
class graph_MetaModelElement_T(graphEntity):
...
new_class = graph_MetaModelElement_T
