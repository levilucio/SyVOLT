"""
__MT_pre__OUT2.py_____________________________________________________
...
class MT_pre__OUT2(ASGNode, ATOM3Type):
   ...
   def clone(self):
      cloneObject = MT_pre__OUT2( self.parent )
