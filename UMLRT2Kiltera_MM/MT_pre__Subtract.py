"""
__MT_pre__Subtract.py_____________________________________________________
...
from graph_MT_pre__Subtract import *
class MT_pre__Subtract(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_pre__Operation', 'MT_pre__Expression']
      self.graphClass_ = graph_MT_pre__Subtract
      ...
      self.realOrder = ['MT_pre__Type','MT_pre__Type','MT_pre__name','MT_pre__name','MT_label__','MT_pivotOut__','MT_pivotIn__','MT_subtypeMatching__']
      self.directEditing = [0,0,0,0,1,1,1,1]
   def clone(self):
      cloneObject = MT_pre__Subtract( self.parent )
