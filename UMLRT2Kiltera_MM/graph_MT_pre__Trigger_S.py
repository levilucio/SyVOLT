"""
__graph_MT_pre__Trigger_S.py___________________________________________________________
...
class graph_MT_pre__Trigger_S(graphEntity):
...
new_class = graph_MT_pre__Trigger_S
