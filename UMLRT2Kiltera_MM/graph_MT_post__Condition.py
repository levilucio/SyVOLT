"""
__graph_MT_post__Condition.py___________________________________________________________
...
class graph_MT_post__Condition(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([119.0, 58.0, 119.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__Condition', width = '0', justify= 'left', stipple='' )
    ...
    def postMT_post__Condition( self, actionID, * params):
        return None

    def preMT_post__Condition( self, actionID, * params):
        return None
...
new_class = graph_MT_post__Condition
