...
class graph_Signal(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([103.0, 31.0, 103.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'Signal', width = '0', justify= 'left', stipple='' )
