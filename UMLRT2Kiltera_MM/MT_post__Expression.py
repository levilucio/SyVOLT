"""
__MT_post__Expression.py_____________________________________________________
...
from graph_MT_post__Expression import *
class MT_post__Expression(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_post__Expression
   ...
   def clone(self):
      cloneObject = MT_post__Expression( self.parent )
