"""
__SIBLING0.py_____________________________________________________
...
class SIBLING0(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['TransitionType', 'MetaModelElement_S']
      self.graphClass_ = graph_SIBLING0
   ...
   def clone(self):
      cloneObject = SIBLING0( self.parent )
