"""
__graph_MT_post__OUT1.py___________________________________________________________
...
class graph_MT_post__OUT1(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([105.0, 42.0, 105.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__OUT1', width = '0', justify= 'left', stipple='' )
