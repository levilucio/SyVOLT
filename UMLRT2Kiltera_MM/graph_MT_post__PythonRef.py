"""
__graph_MT_post__PythonRef.py___________________________________________________________
...
class graph_MT_post__PythonRef(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([105.0, 60.0, 105.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__PythonRef', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__PythonRef
