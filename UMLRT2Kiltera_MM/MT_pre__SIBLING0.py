"""
__MT_pre__SIBLING0.py_____________________________________________________
...
class MT_pre__SIBLING0(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_pre__TransitionType', 'MT_pre__MetaModelElement_S']
      self.graphClass_ = graph_MT_pre__SIBLING0
   ...
   def clone(self):
      cloneObject = MT_pre__SIBLING0( self.parent )
