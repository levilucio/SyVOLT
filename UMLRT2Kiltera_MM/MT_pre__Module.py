"""
__MT_pre__Module.py_____________________________________________________
...
from graph_MT_pre__Module import *
class MT_pre__Module(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_pre__ProcDef', 'MT_pre__MetaModelElement_T']
      self.graphClass_ = graph_MT_pre__Module
   ...
   def clone(self):
      cloneObject = MT_pre__Module( self.parent )
