"""
__MT_post__Module.py_____________________________________________________
...
from graph_MT_post__Module import *
class MT_post__Module(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__ProcDef', 'MT_post__MetaModelElement_T']
      self.graphClass_ = graph_MT_post__Module
   ...
   def clone(self):
      cloneObject = MT_post__Module( self.parent )
