"""
__graph_Transition.py___________________________________________________________
...
class graph_Transition(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([115.0, 32.0, 115.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'Transition', width = '0', justify= 'left', stipple='' )
