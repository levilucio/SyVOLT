"""
__FuncDef.py_____________________________________________________
...
from graph_FuncDef import *
class FuncDef(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['Def', 'MetaModelElement_T']
      self.graphClass_ = graph_FuncDef
   ...
   def clone(self):
      cloneObject = FuncDef( self.parent )
