"""
__MT_post__Trigger_T.py_____________________________________________________
...
from graph_MT_post__Trigger_T import *
class MT_post__Trigger_T(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__Proc', 'MT_post__MetaModelElement_T']
      self.graphClass_ = graph_MT_post__Trigger_T
   ...
   def clone(self):
      cloneObject = MT_post__Trigger_T( self.parent )
