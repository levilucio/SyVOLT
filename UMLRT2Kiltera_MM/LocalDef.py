"""
__LocalDef.py_____________________________________________________
...
class LocalDef(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['Proc', 'MetaModelElement_T']
      self.graphClass_ = graph_LocalDef
   ...
   def clone(self):
      cloneObject = LocalDef( self.parent )
