"""
__graph_MT_pre__Subtract.py___________________________________________________________
...
class graph_MT_pre__Subtract(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([67.0, 36.0, 67.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__Subtract', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__Subtract
