"""
__graph_MT_post__CapsuleRole.py___________________________________________________________
...
class graph_MT_post__CapsuleRole(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([86.0, 34.0, 86.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__CapsuleRole', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__CapsuleRole
