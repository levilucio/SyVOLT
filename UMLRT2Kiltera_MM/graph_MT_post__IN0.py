"""
__graph_MT_post__IN0.py___________________________________________________________
...
class graph_MT_post__IN0(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([98.0, 44.0, 98.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__IN0', width = '0', justify= 'left', stipple='' )
