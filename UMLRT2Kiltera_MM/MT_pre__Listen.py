"""
__MT_pre__Listen.py_____________________________________________________
...
class MT_pre__Listen(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_pre__Proc', 'MT_pre__MetaModelElement_T']
      self.graphClass_ = graph_MT_pre__Listen
   ...
   def clone(self):
      cloneObject = MT_pre__Listen( self.parent )
