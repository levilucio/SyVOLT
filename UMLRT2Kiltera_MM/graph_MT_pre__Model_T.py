"""
__graph_MT_pre__Model_T.py___________________________________________________________
...
class graph_MT_pre__Model_T(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([116.0, 58.0, 116.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__Model_T', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__Model_T
