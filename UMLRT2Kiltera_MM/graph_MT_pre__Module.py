"""
__graph_MT_pre__Module.py___________________________________________________________
...
class graph_MT_pre__Module(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([104.0, 61.0, 104.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__Module', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__Module
