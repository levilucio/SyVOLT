"""
__MT_post__Add.py_____________________________________________________
...
from graph_MT_post__Add import *
class MT_post__Add(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__Operation', 'MT_post__Expression']
      self.graphClass_ = graph_MT_post__Add
   ...
   def clone(self):
      cloneObject = MT_post__Add( self.parent )
