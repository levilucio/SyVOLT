"""
__MT_post__SIBLING0.py_____________________________________________________
...
from graph_MT_post__SIBLING0 import *
class MT_post__SIBLING0(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__TransitionType', 'MT_post__MetaModelElement_S']
      self.graphClass_ = graph_MT_post__SIBLING0
   ...
   def clone(self):
      cloneObject = MT_post__SIBLING0( self.parent )
