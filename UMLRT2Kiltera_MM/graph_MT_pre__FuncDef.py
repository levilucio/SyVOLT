"""
__graph_MT_pre__FuncDef.py___________________________________________________________
...
class graph_MT_pre__FuncDef(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([89.0, 61.0, 89.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__FuncDef', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__FuncDef
