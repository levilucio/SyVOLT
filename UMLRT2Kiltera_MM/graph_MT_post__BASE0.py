"""
__graph_MT_post__BASE0.py___________________________________________________________
...
class graph_MT_post__BASE0(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([90.0, 40.0, 90.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__BASE0', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__BASE0
