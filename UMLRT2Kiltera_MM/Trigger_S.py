"""
__Trigger_S.py_____________________________________________________
...
class Trigger_S(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['Element', 'MetaModelElement_S']
      self.graphClass_ = graph_Trigger_S
   ...
   def clone(self):
      cloneObject = Trigger_S( self.parent )
