"""
__MT_pre__Seq.py_____________________________________________________
...
from graph_MT_pre__Seq import *
class MT_pre__Seq(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_pre__Par', 'MT_pre__MetaModelElement_T']
      self.graphClass_ = graph_MT_pre__Seq
   ...
   def clone(self):
      cloneObject = MT_pre__Seq( self.parent )
