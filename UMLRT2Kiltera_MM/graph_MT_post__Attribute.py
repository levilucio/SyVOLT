"""
__graph_MT_post__Attribute.py___________________________________________________________
...
class graph_MT_post__Attribute(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([63.0, 34.0, 63.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__Attribute', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__Attribute
