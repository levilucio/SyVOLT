"""
__MT_pre__Equation.py_____________________________________________________
...
class MT_pre__Equation(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_pre__Equation
   ...
   def clone(self):
      cloneObject = MT_pre__Equation( self.parent )
