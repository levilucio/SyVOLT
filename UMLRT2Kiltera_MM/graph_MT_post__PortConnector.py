"""
__graph_MT_post__PortConnector.py___________________________________________________________
...
class graph_MT_post__PortConnector(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([120.0, 39.0, 120.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__PortConnector', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__PortConnector
