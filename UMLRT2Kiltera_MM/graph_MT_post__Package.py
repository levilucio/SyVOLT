"""
__graph_MT_post__Package.py___________________________________________________________
...
class graph_MT_post__Package(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([121.0, 37.0, 121.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__Package', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__Package
