"""
__graph_MT_pre__ConditionSet.py___________________________________________________________
...
class graph_MT_pre__ConditionSet(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([119.0, 63.0, 119.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__ConditionSet', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__ConditionSet
