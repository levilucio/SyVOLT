"""
__graph_MT_pre__PortRef.py___________________________________________________________
...
class graph_MT_pre__PortRef(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([58.0, 37.0, 58.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__PortRef', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__PortRef
