"""
__MT_post__Vertex.py_____________________________________________________
...
from graph_MT_post__Vertex import *
class MT_post__Vertex(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__StateMachineElement', 'MT_post__MetaModelElement_S']
      self.graphClass_ = graph_MT_post__Vertex
   ...
   def clone(self):
      cloneObject = MT_post__Vertex( self.parent )
