"""
__MT_pre__Expression.py_____________________________________________________
...
from graph_MT_pre__Expression import *
class MT_pre__Expression(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_pre__Expression
   ...
   def clone(self):
      cloneObject = MT_pre__Expression( self.parent )
