"""
__MT_post__GenericNode_UMLRT2Kiltera_MM.py_____________________________________________________
...
from graph_MT_post__GenericNode_UMLRT2Kiltera_MM import *
class MT_post__GenericNode_UMLRT2Kiltera_MM(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_post__GenericNode_UMLRT2Kiltera_MM
   ...
   def clone(self):
      cloneObject = MT_post__GenericNode_UMLRT2Kiltera_MM( self.parent )
