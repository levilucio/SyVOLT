"""
__MT_pre__PLUGIN2.py_____________________________________________________
...
from graph_MT_pre__PLUGIN2 import *
class MT_pre__PLUGIN2(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_pre__RoleType', 'MT_pre__MetaModelElement_S']
      self.graphClass_ = graph_MT_pre__PLUGIN2
   ...
   def clone(self):
      cloneObject = MT_pre__PLUGIN2( self.parent )
