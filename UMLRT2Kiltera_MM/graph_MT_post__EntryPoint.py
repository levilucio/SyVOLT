"""
__graph_MT_post__EntryPoint.py___________________________________________________________
...
class graph_MT_post__EntryPoint(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([100.0, 33.0, 100.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__EntryPoint', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__EntryPoint
