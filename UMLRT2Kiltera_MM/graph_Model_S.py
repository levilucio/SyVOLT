"""
__graph_Model_S.py___________________________________________________________
...
class graph_Model_S(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([99.0, 36.0, 99.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'Model_S', width = '0', justify= 'left', stipple='' )
