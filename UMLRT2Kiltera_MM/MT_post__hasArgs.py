"""
__MT_post__hasArgs.py_____________________________________________________
...
from graph_MT_post__hasArgs import *
class MT_post__hasArgs(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_post__hasArgs
   ...
   def clone(self):
      cloneObject = MT_post__hasArgs( self.parent )
