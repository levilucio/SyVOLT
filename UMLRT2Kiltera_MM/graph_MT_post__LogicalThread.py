"""
__graph_MT_post__LogicalThread.py___________________________________________________________
...
class graph_MT_post__LogicalThread(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([85.0, 37.0, 85.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__LogicalThread', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__LogicalThread
