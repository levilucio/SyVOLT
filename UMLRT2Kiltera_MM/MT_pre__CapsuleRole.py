"""
__MT_pre__CapsuleRole.py_____________________________________________________
...
from graph_MT_pre__CapsuleRole import *
class MT_pre__CapsuleRole(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_pre__NamedElement', 'MT_pre__MetaModelElement_S']
      self.graphClass_ = graph_MT_pre__CapsuleRole
   ...
   def clone(self):
      cloneObject = MT_pre__CapsuleRole( self.parent )
