...
class graph_ApplyModel(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([67.0, 50.0, 67.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'ApplyModel', width = '0', justify= 'left', stipple='' )
