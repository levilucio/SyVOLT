"""
__Model_T.py_____________________________________________________
...
from graph_Model_T import *
class Model_T(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MetaModelElement_T']
      self.graphClass_ = graph_Model_T
   ...
   def clone(self):
      cloneObject = Model_T( self.parent )
