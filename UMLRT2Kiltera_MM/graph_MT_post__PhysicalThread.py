"""
__graph_MT_post__PhysicalThread.py___________________________________________________________
...
class graph_MT_post__PhysicalThread(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([123.0, 38.0, 123.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__PhysicalThread', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__PhysicalThread
