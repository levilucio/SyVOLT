"""
__graph_MT_post__PortConnectorRef.py___________________________________________________________
...
class graph_MT_post__PortConnectorRef(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([112.0, 35.0, 112.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__PortConnectorRef', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__PortConnectorRef
