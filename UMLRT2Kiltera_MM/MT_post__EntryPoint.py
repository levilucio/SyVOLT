"""
__MT_post__EntryPoint.py_____________________________________________________
...
from graph_MT_post__EntryPoint import *
class MT_post__EntryPoint(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__Vertex', 'MT_post__MetaModelElement_S']
      self.graphClass_ = graph_MT_post__EntryPoint
   ...
   def clone(self):
      cloneObject = MT_post__EntryPoint( self.parent )
