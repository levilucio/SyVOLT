...
def delete_uncollapsed_element_match_diff_rules_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('DeleteUncollapsedElementMatchDiffRules')
    # --- ASG attributes over ---


    self.obj55=MT_pre__MetaModelElement_S(self)
    ...
    # MT_pivotOut__
    self.obj55.MT_pivotOut__.setValue('element2')
    ...
    self.obj55.graphClass_= graph_MT_pre__MetaModelElement_S
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(140.0,100.0,self.obj55)
    ...
    if self.genGraphics:
       new_obj = graph_RHS(440.0,20.0,self.obj56)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj57.constraint.setValue('if len([i for i in graph.neighbors(PreNode(\'2\').index) if graph.vs[i][\'mm__\'] == \'match_contains\']) == 0:\n    return True\n\nreturn False\n')
    self.obj57.constraint.setHeight(15)

    self.obj57.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(20.0,20.0,self.obj57)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # Connections for obj55 (graphObject_: Obj0) of type MT_pre__MetaModelElement_S
...
newfunction = delete_uncollapsed_element_match_diff_rules_MDL
