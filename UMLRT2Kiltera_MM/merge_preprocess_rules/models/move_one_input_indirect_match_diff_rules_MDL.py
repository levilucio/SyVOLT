...
def move_one_input_indirect_match_diff_rules_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MoveOneInputIndirectMatchDiffRules')
    # --- ASG attributes over ---
...
newfunction = move_one_input_indirect_match_diff_rules_MDL
