...
class HMoveOneInputTraceLinkRHS(HimesisPostConditionPattern):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMoveOneInputTraceLinkRHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HMoveOneInputTraceLinkRHS, self).__init__(name='HMoveOneInputTraceLinkRHS', num_nodes=4, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('d13d13fb-638a-4d98-ad57-628f9da1fcda')
        
        # Set the node attributes
        self.vs[0]["MT_label__"] = """12"""
        self.vs[0]["mm__"] = """MT_post__trace_link"""
        self.vs[0]["GUID__"] = UUID('efa4c168-0b30-47e9-a62a-051ea43139e7')
...
return attr_value
"""
        self.vs[1]["GUID__"] = UUID('1dfc88a3-40bc-4f4f-83b9-119163b50e22')
...
return attr_value
"""
        self.vs[2]["GUID__"] = UUID('1f4068d1-a25e-4a2d-a3f8-ce53f7abe773')
...
return attr_value
"""
        self.vs[3]["GUID__"] = UUID('7e0c5123-cd50-4472-9d2d-613f6cbd782f')

        from HMoveOneInputTraceLinkLHS import HMoveOneInputTraceLinkLHS
        self.pre = HMoveOneInputTraceLinkLHS()
    ...
    def execute(self, packet, match):
        ...
        # Create new edges
        #===============================================================================
        # trace_link12 -> MetaModelElement_S7
        graph.add_edges((labels['12'], labels['7']))
        # MetaModelElement_T9 -> trace_link12
        graph.add_edges((labels['9'], labels['12']))
