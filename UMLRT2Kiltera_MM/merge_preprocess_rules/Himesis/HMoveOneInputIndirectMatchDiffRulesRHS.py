...
class HMoveOneInputIndirectMatchDiffRulesRHS(HimesisPostConditionPattern):
    def __init__(self):
        ...
        super(HMoveOneInputIndirectMatchDiffRulesRHS, self).__init__(name='HMoveOneInputIndirectMatchDiffRulesRHS', num_nodes=4, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('49d4bb9e-0e4a-4efb-ae60-c9ce4ef11696')
        
        # Set the node attributes
        self.vs[0]["MT_label__"] = """19"""
        self.vs[0]["mm__"] = """MT_post__indirectLink_S"""
        self.vs[0]["GUID__"] = UUID('e12cea2a-c1cf-4c9e-ad1b-8ceebccd7148')
...
return attr_value
"""
        self.vs[1]["GUID__"] = UUID('bbca1a05-1cf8-4422-b526-e5692d58d287')
...
return attr_value
"""
        self.vs[2]["GUID__"] = UUID('ae3d9cd7-237e-444e-9149-cf6d3f4d176a')
...
return attr_value
"""
        self.vs[3]["GUID__"] = UUID('cb22b3ac-52e6-4094-b830-ee6e7565566b')
