"""
__graph_MT_pre__SIBLING0.py___________________________________________________________
...
class graph_MT_pre__SIBLING0(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([91.0, 38.0, 91.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__SIBLING0', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__SIBLING0
