"""
__graph_MT_post__TransitionType.py___________________________________________________________
...
class graph_MT_post__TransitionType(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([95.0, 39.0, 95.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__TransitionType', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__TransitionType
