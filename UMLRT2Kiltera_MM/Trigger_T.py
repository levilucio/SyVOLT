"""
__Trigger_T.py_____________________________________________________
...
class Trigger_T(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['Proc', 'MetaModelElement_T']
      self.graphClass_ = graph_Trigger_T
   ...
   def clone(self):
      cloneObject = Trigger_T( self.parent )
