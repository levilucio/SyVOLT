"""
__graph_MT_post__Print.py___________________________________________________________
...
class graph_MT_post__Print(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([111.0, 53.0, 111.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__Print', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__Print
