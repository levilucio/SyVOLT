"""
__MT_post__PythonRef.py_____________________________________________________
...
from graph_MT_post__PythonRef import *
class MT_post__PythonRef(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__Name', 'MT_post__MetaModelElement_T']
      self.graphClass_ = graph_MT_post__PythonRef
   ...
   def clone(self):
      cloneObject = MT_post__PythonRef( self.parent )
