"""
__graph_MT_pre__Capsule.py___________________________________________________________
...
class graph_MT_pre__Capsule(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([79.0, 34.0, 79.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__Capsule', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__Capsule
