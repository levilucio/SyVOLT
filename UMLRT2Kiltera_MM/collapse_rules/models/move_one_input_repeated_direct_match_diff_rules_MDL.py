"""
__move_one_input_repeated_direct_match_diff_rules_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Wed Aug 21 13:13:43 2013
...
def move_one_input_repeated_direct_match_diff_rules_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MoveOneInputRepeatedDirectMatchDiffRules')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(40.0,300.0,self.obj71)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(120.0,153.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(241.0,301.0,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_S(350.5,301.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj81=MT_pre__directLink_S(self)
    ...
    # MT_pre__associationType
    self.obj81.MT_pre__associationType.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj81.MT_pre__associationType.setHeight(15)

    self.obj81.graphClass_= graph_MT_pre__directLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_S(310.5,374.5,self.obj81)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(600.0,300.0,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(676.0,152.0,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(797.0,300.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__directLink_S(847.0,374.0,self.obj78)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_RHS(480.0,100.0,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj80.constraint.setValue('#if len([i for i in graph.neighbors(PreNode(\'5\').index) if graph.vs[i][\'mm__\'] == \'match_contains\']) == 0:\n#    return True\n\n#return False\nreturn True\n')
    ...
    self.drawConnections(
(self.obj73,self.obj74,[411.0, 375.0, 350.5, 301.0],"true", 2),
(self.obj73,self.obj81,[411.0, 375.0, 310.5, 374.5],"true", 2) )
    # Connections for obj74 (graphObject_: Obj3) of type MT_pre__directLink_S
    self.drawConnections(
(self.obj74,self.obj72,[350.5, 301.0, 290.0, 227.0],"true", 2) )
    # Connections for obj81 (graphObject_: Obj10) of type MT_pre__directLink_S
    self.drawConnections(
(self.obj81,self.obj71,[310.5, 374.5, 210.0, 374.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj77,self.obj78,[967.0, 374.0, 847.0, 374.0],"true", 2) )
    # Connections for obj78 (graphObject_: Obj7) of type MT_post__directLink_S
    self.drawConnections(
(self.obj78,self.obj75,[847.0, 374.0, 770.0, 374.0],"true", 2) )
...
newfunction = move_one_input_repeated_direct_match_diff_rules_MDL
