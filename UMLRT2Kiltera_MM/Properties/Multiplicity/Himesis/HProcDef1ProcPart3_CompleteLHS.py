...
class HProcDef1ProcPart3_CompleteLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HProcDef1ProcPart3_CompleteLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HProcDef1ProcPart3_CompleteLHS, self).__init__(name='HProcDef1ProcPart3_CompleteLHS', num_nodes=5, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('eb83f42f-29e9-468c-8b8b-551b48bd610b')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('86ae15c1-7ab7-4a3e-8e45-073f62c84969')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('c8b86b75-ee19-4a33-9cc9-f9079cdedc9d')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('8d4a10ee-7885-4c23-acfa-a1a7843e8dc1')
...
.""")
        ...
        self.vs[3]["GUID__"] = UUID('f49ce444-be45-44cf-bbc8-913be36a8ecb')
...
.""")
        ...
        self.vs[4]["GUID__"] = UUID('a8cf89ea-4f98-4534-95e9-f1b6f5d8dca8')
