...
class HTrigger01ExprPart4_CompleteLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HTrigger01ExprPart4_CompleteLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HTrigger01ExprPart4_CompleteLHS, self).__init__(name='HTrigger01ExprPart4_CompleteLHS', num_nodes=3, edges=[])
