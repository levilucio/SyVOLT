...
class HLocalDef1ProcPart2_CompleteLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HLocalDef1ProcPart2_CompleteLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HLocalDef1ProcPart2_CompleteLHS, self).__init__(name='HLocalDef1ProcPart2_CompleteLHS', num_nodes=3, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('70048c93-cb95-49d1-bf1f-3a4819bea417')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('abf8e6d5-ff72-48d0-a632-bf4f94ca4681')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('9c736ce3-6311-4410-ac9d-71cdf0374d27')
...
.""")
        ...
        self.vs[2]["GUID__"] = UUID('f7cd70a1-f976-4fdf-80aa-589b4f65537a')
