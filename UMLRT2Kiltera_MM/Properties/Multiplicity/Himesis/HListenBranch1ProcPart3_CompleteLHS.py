...
class HListenBranch1ProcPart3_CompleteLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HListenBranch1ProcPart3_CompleteLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HListenBranch1ProcPart3_CompleteLHS, self).__init__(name='HListenBranch1ProcPart3_CompleteLHS', num_nodes=5, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('8f54299b-eeff-44b6-b87b-ea74531f087d')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('c5744297-4a22-4bab-8930-e3a7f60a4b56')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('d1706ddb-d0dc-4cbf-8d30-0c8024cace75')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('664291f8-82c1-4794-b1a4-9cd2965f46e3')
...
.""")
        ...
        self.vs[3]["GUID__"] = UUID('28250c77-de66-4278-b30a-3e5ede84a609')
...
.""")
        ...
        self.vs[4]["GUID__"] = UUID('eff77faf-ac78-49b0-b16e-4269d0b83f10')
