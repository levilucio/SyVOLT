"""
__LocalDef1orMoreDefPart1_Complete_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Mon Mar  2 14:55:41 2015
...
def LocalDef1orMoreDefPart1_Complete_MDL(self, rootNode, MT_pre__UMLRT2Kiltera_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('LocalDef1orMoreDefPart1_Complete')
    # --- ASG attributes over ---
    ...
    # MT_pivotOut__
    self.obj63228.MT_pivotOut__.setValue('element1')
    ...
    # MT_pivotIn__
    self.obj63228.MT_pivotIn__.setValue('')
    self.obj63228.MT_pivotIn__.setNone()
...
newfunction = LocalDef1orMoreDefPart1_Complete_MDL
