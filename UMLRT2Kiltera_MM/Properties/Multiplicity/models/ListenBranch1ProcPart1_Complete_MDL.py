"""
__ListenBranch1ProcPart1_Complete_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Wed Mar  4 23:42:35 2015
...
def ListenBranch1ProcPart1_Complete_MDL(self, rootNode, MoTifRuleRootNode=None, MT_pre__UMLRT2Kiltera_MMRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('ListenBranch1ProcPart1_Complete')
    # --- ASG attributes over ---
    ...
    # MT_pivotIn__
    self.obj73770.MT_pivotIn__.setValue('')
    self.obj73770.MT_pivotIn__.setNone()
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__ListenBranch(60.0,80.0,self.obj73770)
...
newfunction = ListenBranch1ProcPart1_Complete_MDL
