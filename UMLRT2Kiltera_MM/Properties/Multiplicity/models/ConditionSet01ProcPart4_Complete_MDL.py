"""
__ConditionSet01ProcPart4_Complete_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Wed Mar  4 17:04:18 2015
...
def ConditionSet01ProcPart4_Complete_MDL(self, rootNode, MoTifRuleRootNode=None, MT_pre__UMLRT2Kiltera_MMRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('ConditionSet01ProcPart4_Complete')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_T(297.0,221.0,self.obj10638)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Proc(120.0,200.0,self.obj10637)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj124,self.obj10638,[257.0, 141.0, 297.0, 221.0],"true", 2) )
    # Connections for obj10638 (graphObject_: Obj3) of type MT_pre__directLink_T
    self.drawConnections(
(self.obj10638,self.obj10637,[297.0, 221.0, 337.0, 301.0],"true", 2) )
...
newfunction = ConditionSet01ProcPart4_Complete_MDL
