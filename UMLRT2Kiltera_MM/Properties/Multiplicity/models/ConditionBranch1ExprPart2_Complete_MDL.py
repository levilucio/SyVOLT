"""
__ConditionBranch1ExprPart2_Complete_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Mon Mar  2 18:47:07 2015
...
def ConditionBranch1ExprPart2_Complete_MDL(self, rootNode, MT_pre__UMLRT2Kiltera_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('ConditionBranch1ExprPart2_Complete')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Expr(140.0,220.0,self.obj10639)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_T(307.0,231.0,self.obj10640)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.drawConnections(
(self.obj124,self.obj10640,[257.0, 141.0, 307.0, 231.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj10640,self.obj10639,[307.0, 231.0, 357.0, 321.0],"true", 2) )

newfunction = ConditionBranch1ExprPart2_Complete_MDL
