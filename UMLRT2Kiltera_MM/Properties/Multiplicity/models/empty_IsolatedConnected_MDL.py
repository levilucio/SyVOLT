"""
__empty_IsolatedConnected_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Mon Feb 23 13:31:01 2015
...
def empty_IsolatedConnected_MDL(self, rootNode, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('empty_IsolatedConnected')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_LHS(100.0,120.0,self.obj23)
...
newfunction = empty_IsolatedConnected_MDL
