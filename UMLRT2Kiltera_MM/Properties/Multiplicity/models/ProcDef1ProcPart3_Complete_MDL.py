"""
__ProcDef1ProcPart3_Complete_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Wed Mar  4 23:22:25 2015
...
def ProcDef1ProcPart3_Complete_MDL(self, rootNode, MoTifRuleRootNode=None, MT_pre__UMLRT2Kiltera_MMRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('ProcDef1ProcPart3_Complete')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_T(194.0,221.0,self.obj52722)
    ...
    self.obj63240=MT_pre__directLink_T(self)
    self.obj63240.isGraphObjectVisual = True

    if(hasattr(self.obj63240, '_setHierarchicalLink')):
      self.obj63240._setHierarchicalLink(False)

    # MT_label__
    self.obj63240.MT_label__.setValue('5')

    # MT_pivotOut__
    self.obj63240.MT_pivotOut__.setValue('')
    self.obj63240.MT_pivotOut__.setNone()

    # MT_subtypeMatching__
    self.obj63240.MT_subtypeMatching__.setValue(('True', 0))
    self.obj63240.MT_subtypeMatching__.config = 0

    # MT_pivotIn__
    self.obj63240.MT_pivotIn__.setValue('')
    self.obj63240.MT_pivotIn__.setNone()

    # MT_pre__associationType
    self.obj63240.MT_pre__associationType.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj63240.MT_pre__associationType.setHeight(15)

    self.obj63240.graphClass_= graph_MT_pre__directLink_T
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_T(357.0,191.0,self.obj63240)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    self.obj63240.graphObject_ = new_obj

    # Add node to the root: rootNode
    rootNode.addNode(self.obj63240)
    self.globalAndLocalPostcondition(self.obj63240, rootNode)
    self.obj63240.postAction( rootNode.CREATE )
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__ProcDef(40.0,40.0,self.obj42206)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Proc(40.0,200.0,self.obj52721)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj63239=MT_pre__Proc(self)
    self.obj63239.isGraphObjectVisual = True

    if(hasattr(self.obj63239, '_setHierarchicalLink')):
      self.obj63239._setHierarchicalLink(False)

    # MT_pivotOut__
    self.obj63239.MT_pivotOut__.setValue('')
    self.obj63239.MT_pivotOut__.setNone()

    # MT_subtypeMatching__
    self.obj63239.MT_subtypeMatching__.setValue(('True', 1))
    self.obj63239.MT_subtypeMatching__.config = 0

    # MT_pre__classtype
    self.obj63239.MT_pre__classtype.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj63239.MT_pre__classtype.setHeight(15)

    # MT_pivotIn__
    self.obj63239.MT_pivotIn__.setValue('')
    self.obj63239.MT_pivotIn__.setNone()

    # MT_label__
    self.obj63239.MT_label__.setValue('4')

    # MT_pre__cardinality
    self.obj63239.MT_pre__cardinality.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj63239.MT_pre__cardinality.setHeight(15)

    # MT_pre__name
    self.obj63239.MT_pre__name.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj63239.MT_pre__name.setHeight(15)

    self.obj63239.graphClass_= graph_MT_pre__Proc
    if self.genGraphics:
       new_obj = graph_MT_pre__Proc(240.0,140.0,self.obj63239)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Proc", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    else: new_obj = None
    self.obj63239.graphObject_ = new_obj

    # Add node to the root: rootNode
    rootNode.addNode(self.obj63239)
    self.globalAndLocalPostcondition(self.obj63239, rootNode)
    self.obj63239.postAction( rootNode.CREATE )
...
(self.obj52722,self.obj52721,[194.0, 221.0, 257.0, 301.0],"true", 2) )
    # Connections for obj63240 (graphObject_: Obj11) of type MT_pre__directLink_T
    self.drawConnections(
(self.obj63240,self.obj63239,[357.0, 191.0, 457.0, 241.0],"true", 2) )
    # Connections for obj42206 (graphObject_: Obj7) of type MT_pre__ProcDef
    self.drawConnections(
(self.obj42206,self.obj52722,[257.0, 141.0, 194.0, 221.0],"true", 2),
(self.obj42206,self.obj63240,[257.0, 141.0, 357.0, 191.0],"true", 2) )
    # Connections for obj52721 (graphObject_: Obj8) of type MT_pre__Proc
    self.drawConnections(
 )
    # Connections for obj63239 (graphObject_: Obj10) of type MT_pre__Proc
    self.drawConnections(
 )
...
newfunction = ProcDef1ProcPart3_Complete_MDL
