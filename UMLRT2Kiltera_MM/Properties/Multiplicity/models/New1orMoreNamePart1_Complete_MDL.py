"""
__New1orMoreNamePart1_Complete_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Mon Mar  2 13:32:34 2015
...
def New1orMoreNamePart1_Complete_MDL(self, rootNode, MT_pre__UMLRT2Kiltera_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('New1orMoreNamePart1_Complete')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__New(140.0,140.0,self.obj124)
       new_obj.DrawObject(self.UMLmodel)
...
newfunction = New1orMoreNamePart1_Complete_MDL
