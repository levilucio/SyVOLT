"""
__ListenBranch1ProcPart3_Complete_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Wed Mar  4 23:49:43 2015
...
def ListenBranch1ProcPart3_Complete_MDL(self, rootNode, MoTifRuleRootNode=None, MT_pre__UMLRT2Kiltera_MMRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('ListenBranch1ProcPart3_Complete')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_T(197.0,210.0,self.obj84288)
    ...
    self.obj94810=MT_pre__directLink_T(self)
    self.obj94810.isGraphObjectVisual = True

    if(hasattr(self.obj94810, '_setHierarchicalLink')):
      self.obj94810._setHierarchicalLink(False)

    # MT_label__
    self.obj94810.MT_label__.setValue('5')

    # MT_pivotOut__
    self.obj94810.MT_pivotOut__.setValue('')
    self.obj94810.MT_pivotOut__.setNone()

    # MT_subtypeMatching__
    self.obj94810.MT_subtypeMatching__.setValue(('True', 0))
    self.obj94810.MT_subtypeMatching__.config = 0

    # MT_pivotIn__
    self.obj94810.MT_pivotIn__.setValue('')
    self.obj94810.MT_pivotIn__.setNone()

    # MT_pre__associationType
    self.obj94810.MT_pre__associationType.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj94810.MT_pre__associationType.setHeight(15)

    self.obj94810.graphClass_= graph_MT_pre__directLink_T
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_T(357.0,201.0,self.obj94810)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    self.obj94810.graphObject_ = new_obj

    # Add node to the root: rootNode
    rootNode.addNode(self.obj94810)
    self.globalAndLocalPostcondition(self.obj94810, rootNode)
    self.obj94810.postAction( rootNode.CREATE )
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__ListenBranch(40.0,40.0,self.obj73770)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Proc(40.0,200.0,self.obj84285)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj94807=MT_pre__Proc(self)
    self.obj94807.isGraphObjectVisual = True

    if(hasattr(self.obj94807, '_setHierarchicalLink')):
      self.obj94807._setHierarchicalLink(False)

    # MT_pivotOut__
    self.obj94807.MT_pivotOut__.setValue('')
    self.obj94807.MT_pivotOut__.setNone()

    # MT_subtypeMatching__
    self.obj94807.MT_subtypeMatching__.setValue(('True', 1))
    self.obj94807.MT_subtypeMatching__.config = 0

    # MT_pre__classtype
    self.obj94807.MT_pre__classtype.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj94807.MT_pre__classtype.setHeight(15)

    # MT_pivotIn__
    self.obj94807.MT_pivotIn__.setValue('')
    self.obj94807.MT_pivotIn__.setNone()

    # MT_label__
    self.obj94807.MT_label__.setValue('4')

    # MT_pre__cardinality
    self.obj94807.MT_pre__cardinality.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj94807.MT_pre__cardinality.setHeight(15)

    # MT_pre__name
    self.obj94807.MT_pre__name.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj94807.MT_pre__name.setHeight(15)

    self.obj94807.graphClass_= graph_MT_pre__Proc
    if self.genGraphics:
       new_obj = graph_MT_pre__Proc(240.0,160.0,self.obj94807)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Proc", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    else: new_obj = None
    self.obj94807.graphObject_ = new_obj

    # Add node to the root: rootNode
    rootNode.addNode(self.obj94807)
    self.globalAndLocalPostcondition(self.obj94807, rootNode)
    self.obj94807.postAction( rootNode.CREATE )
...
(self.obj84288,self.obj84285,[197.0, 210.0, 257.0, 301.0],"true", 2) )
    # Connections for obj94810 (graphObject_: Obj17) of type MT_pre__directLink_T
    self.drawConnections(
(self.obj94810,self.obj94807,[357.0, 201.0, 457.0, 261.0],"true", 2) )
    # Connections for obj73770 (graphObject_: Obj13) of type MT_pre__ListenBranch
    self.drawConnections(
(self.obj73770,self.obj84288,[257.0, 141.0, 197.0, 210.0],"true", 2),
(self.obj73770,self.obj94810,[257.0, 141.0, 357.0, 201.0],"true", 2) )
    # Connections for obj84285 (graphObject_: Obj14) of type MT_pre__Proc
    self.drawConnections(
 )
    # Connections for obj94807 (graphObject_: Obj16) of type MT_pre__Proc
    self.drawConnections(
 )
...
newfunction = ListenBranch1ProcPart3_Complete_MDL
