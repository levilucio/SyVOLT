"""
__ListenBranch01PatternPart3_Complete_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Mon Mar  2 20:14:32 2015
...
def ListenBranch01PatternPart3_Complete_MDL(self, rootNode, MT_pre__UMLRT2Kiltera_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('ListenBranch01PatternPart3_Complete')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_T(241.0,257.0,self.obj42182)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj63211=MT_pre__directLink_T(self)
    self.obj63211.isGraphObjectVisual = True

    if(hasattr(self.obj63211, '_setHierarchicalLink')):
      self.obj63211._setHierarchicalLink(False)

    # MT_label__
    self.obj63211.MT_label__.setValue('5')

    # MT_pivotOut__
    self.obj63211.MT_pivotOut__.setValue('')
    self.obj63211.MT_pivotOut__.setNone()

    # MT_subtypeMatching__
    self.obj63211.MT_subtypeMatching__.setValue(('True', 0))
    self.obj63211.MT_subtypeMatching__.config = 0

    # MT_pivotIn__
    self.obj63211.MT_pivotIn__.setValue('')
    self.obj63211.MT_pivotIn__.setNone()

    # MT_pre__associationType
    self.obj63211.MT_pre__associationType.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj63211.MT_pre__associationType.setHeight(15)

    self.obj63211.graphClass_= graph_MT_pre__directLink_T
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_T(377.0,201.0,self.obj63211)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    self.obj63211.graphObject_ = new_obj

    # Add node to the root: rootNode
    rootNode.addNode(self.obj63211)
    self.globalAndLocalPostcondition(self.obj63211, rootNode)
    self.obj63211.postAction( rootNode.CREATE )
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Pattern(80.0,240.0,self.obj42181)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj63209=MT_pre__Pattern(self)
    self.obj63209.isGraphObjectVisual = True

    if(hasattr(self.obj63209, '_setHierarchicalLink')):
      self.obj63209._setHierarchicalLink(False)

    # MT_pivotOut__
    self.obj63209.MT_pivotOut__.setValue('')
    self.obj63209.MT_pivotOut__.setNone()

    # MT_subtypeMatching__
    self.obj63209.MT_subtypeMatching__.setValue(('True', 0))
    self.obj63209.MT_subtypeMatching__.config = 0

    # MT_pre__classtype
    self.obj63209.MT_pre__classtype.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj63209.MT_pre__classtype.setHeight(15)

    # MT_pivotIn__
    self.obj63209.MT_pivotIn__.setValue('')
    self.obj63209.MT_pivotIn__.setNone()

    # MT_label__
    self.obj63209.MT_label__.setValue('4')

    # MT_pre__cardinality
    self.obj63209.MT_pre__cardinality.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj63209.MT_pre__cardinality.setHeight(15)

    # MT_pre__name
    self.obj63209.MT_pre__name.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj63209.MT_pre__name.setHeight(15)

    self.obj63209.graphClass_= graph_MT_pre__Pattern
    if self.genGraphics:
       new_obj = graph_MT_pre__Pattern(260.0,140.0,self.obj63209)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Pattern", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    else: new_obj = None
    self.obj63209.graphObject_ = new_obj

    # Add node to the root: rootNode
    rootNode.addNode(self.obj63209)
    self.globalAndLocalPostcondition(self.obj63209, rootNode)
    self.obj63209.postAction( rootNode.CREATE )
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__ListenBranch(60.0,60.0,self.obj31668)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.drawConnections(
(self.obj42182,self.obj42181,[241.0, 257.0, 297.0, 341.0],"true", 2) )
    # Connections for obj63211 (graphObject_: Obj11) of type MT_pre__directLink_T
    self.drawConnections(
(self.obj63211,self.obj63209,[377.0, 201.0, 477.0, 241.0],"true", 2) )
    # Connections for obj42181 (graphObject_: Obj8) of type MT_pre__Pattern
    self.drawConnections(
 )
    # Connections for obj63209 (graphObject_: Obj10) of type MT_pre__Pattern
    self.drawConnections(
 )
    # Connections for obj31668 (graphObject_: Obj7) of type MT_pre__ListenBranch
    self.drawConnections(
(self.obj31668,self.obj42182,[277.0, 161.0, 241.0, 257.0],"true", 2),
(self.obj31668,self.obj63211,[277.0, 161.0, 377.0, 201.0],"true", 2) )

newfunction = ListenBranch01PatternPart3_Complete_MDL
