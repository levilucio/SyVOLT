"""
__ConditionBranch1ExprPart1_Complete_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Mon Mar  2 18:44:54 2015
...
def ConditionBranch1ExprPart1_Complete_MDL(self, rootNode, MT_pre__UMLRT2Kiltera_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('ConditionBranch1ExprPart1_Complete')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__ConditionBranch(120.0,60.0,self.obj124)
       new_obj.DrawObject(self.UMLmodel)
...
newfunction = ConditionBranch1ExprPart1_Complete_MDL
