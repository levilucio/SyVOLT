"""
__HInstProcDefParamspart1_Complete_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Fri Mar  6 16:43:47 2015
...
def HInstProcDefParamspart1_Complete_MDL(self, rootNode, MoTifRuleRootNode=None, MT_pre__UMLRT2Kiltera_MMRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('HInstProcDefParamspart1_Complete')
    # --- ASG attributes over ---
    ...
    # MT_pivotIn__
    self.obj42241.MT_pivotIn__.setValue('')
    self.obj42241.MT_pivotIn__.setNone()
...
newfunction = HInstProcDefParamspart1_Complete_MDL
