...
Author: gehan
Modified: Sun Mar  1 11:08:21 2015
...
def InstStateSameNamePart1_Complete_MDL(self, rootNode, MoTifRuleRootNode=None, MT_pre__UMLRT2Kiltera_MMRootNode=None):
    ...
    # MT_label__
    self.obj124.MT_label__.setValue('4')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Inst(60.0,260.0,self.obj124)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj128=MT_pre__hasAttribute_T(self)
    ...
    self.obj128.graphClass_= graph_MT_pre__hasAttribute_T
    if self.genGraphics:
       new_obj = graph_MT_pre__hasAttribute_T(358.5,353.0,self.obj128)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj121,self.obj125,[257.0, 115.0, 338.5, 110.0],"true", 2) )
    # Connections for obj124 (graphObject_: Obj4) of type MT_pre__Inst
    self.drawConnections(
(self.obj124,self.obj128,[277.0, 361.0, 358.5, 353.0],"true", 2) )
...
(self.obj125,self.obj129,[338.5, 110.0, 420.0, 105.0],"true", 2) )
    # Connections for obj128 (graphObject_: Obj8) of type MT_pre__hasAttribute_T
    self.drawConnections(
(self.obj128,self.obj130,[358.5, 353.0, 440.0, 345.0],"true", 2) )
