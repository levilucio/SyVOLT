"""
__HInstProcDefParamspart4_Complete_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Fri Mar  6 16:58:35 2015
...
def HInstProcDefParamspart4_Complete_MDL(self, rootNode, MoTifRuleRootNode=None, MT_pre__UMLRT2Kiltera_MMRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('HInstProcDefParamspart4_Complete')
    # --- ASG attributes over ---
    ...
    self.obj73839=MT_pre__Name(self)
    ...
    # MT_pivotOut__
    self.obj73839.MT_pivotOut__.setValue('')
    self.obj73839.MT_pivotOut__.setNone()
    ...
    # MT_label__
    self.obj73839.MT_label__.setValue('21')
    ...
    self.obj73839.graphClass_= graph_MT_pre__Name
    if self.genGraphics:
       new_obj = graph_MT_pre__Name(60.0,220.0,self.obj73839)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Name", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj73840=MT_pre__directLink_T(self)
    self.obj73840.isGraphObjectVisual = True

    if(hasattr(self.obj73840, '_setHierarchicalLink')):
      self.obj73840._setHierarchicalLink(False)

    # MT_label__
    self.obj73840.MT_label__.setValue('22')

    # MT_pivotOut__
    self.obj73840.MT_pivotOut__.setValue('')
    self.obj73840.MT_pivotOut__.setNone()

    # MT_subtypeMatching__
    self.obj73840.MT_subtypeMatching__.setValue(('True', 0))
    self.obj73840.MT_subtypeMatching__.config = 0

    # MT_pivotIn__
    self.obj73840.MT_pivotIn__.setValue('')
    self.obj73840.MT_pivotIn__.setNone()

    # MT_pre__associationType
    self.obj73840.MT_pre__associationType.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj73840.MT_pre__associationType.setHeight(15)

    self.obj73840.graphClass_= graph_MT_pre__directLink_T
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_T(339.5,291.0,self.obj73840)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    self.obj73840.graphObject_ = new_obj

    # Add node to the root: rootNode
    rootNode.addNode(self.obj73840)
    self.globalAndLocalPostcondition(self.obj73840, rootNode)
    self.obj73840.postAction( rootNode.CREATE )
...
(self.obj63289,self.obj73840,[397.0, 261.0, 339.5, 291.0],"true", 2) )
    ...
    # Connections for obj73839 (graphObject_: Obj75) of type MT_pre__Name
    self.drawConnections(
 )
...
(self.obj63324,self.obj63323,[339.5, 241.0, 282.0, 221.0],"true", 2) )
    # Connections for obj73840 (graphObject_: Obj76) of type MT_pre__directLink_T
    self.drawConnections(
(self.obj73840,self.obj73839,[339.5, 291.0, 282.0, 321.0],"true", 2) )
...
newfunction = HInstProcDefParamspart4_Complete_MDL
