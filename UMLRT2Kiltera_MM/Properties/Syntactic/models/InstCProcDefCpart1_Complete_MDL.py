"""
__InstCProcDefCpart1_Complete_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Fri Mar  6 10:56:11 2015
...
def InstCProcDefCpart1_Complete_MDL(self, rootNode, MoTifRuleRootNode=None, MT_pre__UMLRT2Kiltera_MMRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('InstCProcDefCpart1_Complete')
    # --- ASG attributes over ---
...
newfunction = InstCProcDefCpart1_Complete_MDL
