...
class HInstProcDefParamspart1_CompleteLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HInstProcDefParamspart1_CompleteLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HInstProcDefParamspart1_CompleteLHS, self).__init__(name='HInstProcDefParamspart1_CompleteLHS', num_nodes=13, edges=[])
        
        # Add the edges
        self.add_edges([(1, 0), (2, 0), (3, 1), (6, 2), (3, 7), (3, 8), (3, 9), (7, 10), (8, 12), (9, 11), (6, 4), (4, 5)])
...
.""")
        self["name"] = """"""
        self["GUID__"] = UUID('8242ab27-7bb9-4283-8b78-13b6a482e816')
...
"""
        ...
        self.vs[0]["GUID__"] = UUID('d19ab0f3-a0f4-4b36-9870-0e70d3a3882d')
...
.""")
        ...
        self.vs[1]["GUID__"] = UUID('5e6f9b24-13d6-4e2b-a30b-0bf8d16854ea')
...
.""")
        ...
        self.vs[2]["GUID__"] = UUID('d8154280-4b82-4a65-a041-7c59618e5b76')
...
"""
        ...
        self.vs[3]["GUID__"] = UUID('9a9bea18-10e4-4024-9171-ae8caa476e70')
...
.""")
        ...
        self.vs[4]["GUID__"] = UUID('44ff5210-6633-4558-b957-cd8939e4a495')
...
"""
        ...
        self.vs[5]["GUID__"] = UUID('c58b2944-c3a1-4318-aae0-311d55e84b6d')
...
"""
        ...
        self.vs[6]["GUID__"] = UUID('814ddc86-10a1-4974-b65e-4d574473257a')
...
.""")
        ...
        self.vs[7]["GUID__"] = UUID('54fccfab-1b75-4ee3-8064-4e03d07be6f4')
...
.""")
        ...
        self.vs[8]["GUID__"] = UUID('362aea28-e190-45e7-a66e-d938bd7aaf2a')
...
.""")
        ...
        self.vs[9]["GUID__"] = UUID('be179189-0ac4-49ec-88e5-9c07b7bd15d7')
...
"""
        ...
        self.vs[10]["GUID__"] = UUID('3c028743-f783-41ce-8ab1-59b0a23aa115')
...
"""
        ...
        self.vs[11]["GUID__"] = UUID('8b9e0b3a-829a-45fb-b9b7-d7ab66eeca91')
...
"""
        ...
        self.vs[12]["GUID__"] = UUID('2eecc589-6331-4236-9536-59f881b56fa3')
