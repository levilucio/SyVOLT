...
class HInstHProcDefHpart1_CompleteLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HInstHProcDefHpart1_CompleteLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HInstHProcDefHpart1_CompleteLHS, self).__init__(name='HInstHProcDefHpart1_CompleteLHS', num_nodes=7, edges=[])
