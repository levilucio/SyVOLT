"""
__Par2ProcsPart1_Complete_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Sun Feb 22 10:57:35 2015
...
def Par2ProcsPart1_Complete_MDL(self, rootNode, MT_pre__UMLRT2Kiltera_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('Par2ProcsPart1_Complete')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Par(120.0,60.0,self.obj124)
       new_obj.DrawObject(self.UMLmodel)
...
newfunction = Par2ProcsPart1_Complete_MDL
