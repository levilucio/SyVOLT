...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,2), # apply_class Listen() -> association branches
                (2,1), # association branches  -> apply_class ListenBranch()
                ])
        
                # Add the attribute equations
                self["equations"] = [((0,'pivot'),('constant','LISTEN')), ]
