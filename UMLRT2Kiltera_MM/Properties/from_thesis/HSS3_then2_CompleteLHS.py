...
"""
                ...
                # Add the edges
                self.add_edges([
                (5,6), # apply_class ProcDef() -> association channelNames
                (6,1), # association channelNames  -> apply_class Name()
                (5,7), # apply_class ProcDef() -> association channelNames
                (7,2), # association channelNames  -> apply_class Name()
                (5,8), # apply_class ProcDef() -> association channelNames
                (8,3), # association channelNames  -> apply_class Name()
                (5,9), # apply_class ProcDef() -> association channelNames
                (9,4), # association channelNames  -> apply_class Name()
                ])
        
                # Add the attribute equations
                self["equations"] = [((0,'pivot'),('constant','INST')), ((0,'name'),('constant','Handler')), ((5,'name'),('constant','Handler')), ]
