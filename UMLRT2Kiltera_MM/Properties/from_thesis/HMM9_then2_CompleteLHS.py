...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'MM9_then2')
...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,3), # apply_class Trigger() -> association output
                (3,1), # association output  -> apply_class Expr()
                (0,4), # apply_class Trigger() -> association output
                (4,2), # association output  -> apply_class Expr()
                ])
