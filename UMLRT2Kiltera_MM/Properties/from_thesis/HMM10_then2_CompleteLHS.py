...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'MM10_then2')
        
                # Nodes that represent match classes
        
        
        #Nodes that represent apply classes
        # match class ConditionSet() node
                self.add_node()
...
"""
        ...
        # apply association ConditionSet--alternative-->Proc node
                self.add_node()
...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,3), # apply_class ConditionSet() -> association alternative
                (3,1), # association alternative  -> apply_class Proc()
                (0,4), # apply_class ConditionSet() -> association alternative
                (4,2), # association alternative  -> apply_class Proc()
                ])
        
                # Add the attribute equations
                self["equations"] = [((0,'pivot'),('constant','ConditionSet')), ]
