...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'MM2_then2')
        
                # Nodes that represent match classes
        
        
        #Nodes that represent apply classes
        # match class LocalDef() node
                self.add_node()
...
"""
        ...
        # apply association LocalDef--p-->Proc node
                self.add_node()
...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,3), # apply_class LocalDef() -> association p
                (3,1), # association p  -> apply_class Proc()
                (0,4), # apply_class LocalDef() -> association p
                (4,2), # association p  -> apply_class Proc()
                ])
        
                # Add the attribute equations
                self["equations"] = [((0,'pivot'),('constant','LOCALDEF')), ]
