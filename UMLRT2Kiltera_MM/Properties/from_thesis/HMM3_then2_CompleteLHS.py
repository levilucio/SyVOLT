...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'MM3_then2')
...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,3), # apply_class ConditionBranch() -> association if
                (3,1), # association if  -> apply_class Expr()
                (0,4), # apply_class ConditionBranch() -> association if
                (4,2), # association if  -> apply_class Expr()
                ])
