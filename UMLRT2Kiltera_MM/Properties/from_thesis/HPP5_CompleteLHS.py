...
"""
                ...
                # Add the edges
                self.add_edges([
                (2,8), # apply_class ProcDef() -> backward_association
                (8,0), #  backward_association -> apply_class State()
                (4,9), # apply_class LocalDef() -> backward_association
                (9,0), #  backward_association -> apply_class State()
                (3,10), # apply_class ProcDef() -> backward_association
                (10,1), #  backward_association -> apply_class State()
                (2,6), # apply_class ProcDef() -> association p
                (6,4), # association p  -> apply_class LocalDef()
                (4,7), # apply_class LocalDef() -> association def
                (7,3), # association def  -> apply_class ProcDef()
                (0,5), # match_class State() -> association states
                (5,1) # association states  -> match_class State()
                ])
