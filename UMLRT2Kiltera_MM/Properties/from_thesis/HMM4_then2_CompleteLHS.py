...
"""
        ...
        # apply association ConditionBranch--then-->Proc node
                self.add_node()
...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,3), # apply_class ConditionBranch() -> association then
                (3,1), # association then  -> apply_class Proc()
                (0,4), # apply_class ConditionBranch() -> association then
                (4,2), # association then  -> apply_class Proc()
                ])
