...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'SS3_if2')
...
"""
                ...
                (5,1), # association channelNames  -> apply_class Name()
                (0,6), # apply_class Inst() -> association channelNames
                (6,2), # association channelNames  -> apply_class Name()
                (0,7), # apply_class Inst() -> association channelNames
                (7,3), # association channelNames  -> apply_class Name()
                (0,8), # apply_class Inst() -> association channelNames
                (8,4), # association channelNames  -> apply_class Name()
                ])
