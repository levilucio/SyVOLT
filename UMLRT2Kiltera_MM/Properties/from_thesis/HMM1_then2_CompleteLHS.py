...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'MM1_then2')
...
"""
        ...
        # apply association New--p-->Proc node
                self.add_node()
...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,3), # apply_class New() -> association p
                (3,1), # association p  -> apply_class Proc()
                (0,4), # apply_class New() -> association p
