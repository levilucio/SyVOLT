...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'MM9_then1')
...
"""
        ...
        # apply association Trigger--output-->Expr node
                self.add_node()
...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,2), # apply_class Trigger() -> association output
                (2,1), # association output  -> apply_class Expr()
                ])
        
                # Add the attribute equations
                self["equations"] = [((0,'pivot'),('constant','TRIGGER')), ]
