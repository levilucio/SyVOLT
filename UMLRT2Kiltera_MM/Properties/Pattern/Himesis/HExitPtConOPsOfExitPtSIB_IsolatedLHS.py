...
class HExitPtConOPsOfExitPtSIB_IsolatedLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HExitPtConOPsOfExitPtSIB_IsolatedLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HExitPtConOPsOfExitPtSIB_IsolatedLHS, self).__init__(name='HExitPtConOPsOfExitPtSIB_IsolatedLHS', num_nodes=10, edges=[])
        
        # Add the edges
        self.add_edges([(4, 0), (6, 0), (1, 4), (7, 6), (7, 8), (8, 9)])
...
p1
.""")
        self["name"] = """ExitPtConOPsOfExitPtSIB_Isolated"""
        self["GUID__"] = UUID('d4db04b8-a767-46ed-8a25-bcaaa6a9942c')
...
"""
        ...
        self.vs[0]["GUID__"] = UUID('7321f6ca-4af3-47b1-995e-55cd93db709f')
...
"""
        ...
        self.vs[1]["GUID__"] = UUID('e549655e-dbb2-4156-a37b-6d1fd79e7155')
...
"""
        ...
        self.vs[2]["GUID__"] = UUID('4c1a62c8-4c02-4abf-8b6f-712e4ac60d32')
...
"""
        ...
        self.vs[3]["GUID__"] = UUID('04c5af3d-b4bc-426c-b421-466df2f2c88a')
...
.""")
        ...
        self.vs[4]["GUID__"] = UUID('24973c95-a44f-49dc-88b6-6f2866c09e85')
...
"""
        ...
        self.vs[5]["GUID__"] = UUID('6bbff82b-f4b2-447a-bfbd-e1739a8ea549')
...
.""")
        ...
        self.vs[6]["GUID__"] = UUID('0babc7c7-18d6-4932-9bed-a8206a60ded4')
...
"""
        ...
        self.vs[7]["GUID__"] = UUID('b207e283-569c-4f3d-968a-e6a8170eda53')
...
.""")
        ...
        self.vs[8]["GUID__"] = UUID('0dad0fd3-ffff-44b2-a5e0-ce7aa171bd10')
...
"""
        ...
        self.vs[9]["GUID__"] = UUID('47bc34f5-64e9-44ca-8758-e97235141dea')
