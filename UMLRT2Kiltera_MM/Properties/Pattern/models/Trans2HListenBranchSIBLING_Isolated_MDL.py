"""
__Trans2HListenBranchSIBLING_Isolated_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Mon Mar  9 10:01:18 2015
...
def Trans2HListenBranchSIBLING_Isolated_MDL(self, rootNode, MT_pre__UMLRT2Kiltera_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('Trans2HListenBranchSIBLING_Isolated')
    # --- ASG attributes over ---
...
newfunction = Trans2HListenBranchSIBLING_Isolated_MDL
