"""
__nestedStates2nestedProcDefs_Connected_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Sun Mar  1 14:29:43 2015
...
def nestedStates2nestedProcDefs_Connected_MDL(self, rootNode, MoTifRuleRootNode=None, MT_pre__UMLRT2Kiltera_MMRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('nestedStates2nestedProcDefs_Connected')
    # --- ASG attributes over ---
...
(self.obj21183,self.obj31725,[297.0, 175.0, 387.0, 195.0],"true", 2) )
...
(self.obj21187,self.obj21190,[444.0, 313.0, 442.0, 349.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj31725,self.obj21184,[387.0, 195.0, 477.0, 215.0],"true", 2) )
...
newfunction = nestedStates2nestedProcDefs_Connected_MDL
