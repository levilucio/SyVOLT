...
Author: gehan
Modified: Mon Mar  9 11:33:51 2015
...
def Trans2HListenBranchOUT_Complete_MDL(self, rootNode, MT_pre__UMLRT2Kiltera_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    self.obj52795=MT_pre__OUT2(self)
    self.obj52795.isGraphObjectVisual = True

    if(hasattr(self.obj52795, '_setHierarchicalLink')):
      self.obj52795._setHierarchicalLink(False)

    # MT_label__
    self.obj52795.MT_label__.setValue('33')

    # MT_pivotOut__
    self.obj52795.MT_pivotOut__.setValue('element2')

    # MT_subtypeMatching__
    self.obj52795.MT_subtypeMatching__.setValue(('True', 0))
    self.obj52795.MT_subtypeMatching__.config = 0

    # MT_pre__classtype
    self.obj52795.MT_pre__classtype.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj52795.MT_pre__classtype.setHeight(15)

    # MT_pre__cardinality
    self.obj52795.MT_pre__cardinality.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj52795.MT_pre__cardinality.setHeight(15)

    # MT_pre__name
    self.obj52795.MT_pre__name.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj52795.MT_pre__name.setHeight(15)

    # MT_pivotIn__
    self.obj52795.MT_pivotIn__.setValue('element2')

    self.obj52795.graphClass_= graph_MT_pre__OUT2
    if self.genGraphics:
       new_obj = graph_MT_pre__OUT2(40.0,160.0,self.obj52795)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__OUT2", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    else: new_obj = None
    self.obj52795.graphObject_ = new_obj

    # Add node to the root: rootNode
    rootNode.addNode(self.obj52795)
    self.globalAndLocalPostcondition(self.obj52795, rootNode)
    self.obj52795.postAction( rootNode.CREATE )
    ...
    self.obj52796=MT_pre__directLink_S(self)
    self.obj52796.isGraphObjectVisual = True

    if(hasattr(self.obj52796, '_setHierarchicalLink')):
      self.obj52796._setHierarchicalLink(False)

    # MT_label__
    self.obj52796.MT_label__.setValue('34')

    # MT_pivotOut__
    self.obj52796.MT_pivotOut__.setValue('')
    self.obj52796.MT_pivotOut__.setNone()

    # MT_subtypeMatching__
    self.obj52796.MT_subtypeMatching__.setValue(('True', 0))
    self.obj52796.MT_subtypeMatching__.config = 0

    # MT_pivotIn__
    self.obj52796.MT_pivotIn__.setValue('')
    self.obj52796.MT_pivotIn__.setNone()

    # MT_pre__associationType
    self.obj52796.MT_pre__associationType.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj52796.MT_pre__associationType.setHeight(15)

    self.obj52796.graphClass_= graph_MT_pre__directLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_S(237.0,172.0,self.obj52796)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    self.obj52796.graphObject_ = new_obj

    # Add node to the root: rootNode
    rootNode.addNode(self.obj52796)
    self.globalAndLocalPostcondition(self.obj52796, rootNode)
    self.obj52796.postAction( rootNode.CREATE )
    ...
    # Connections for obj52795 (graphObject_: Obj47) of type MT_pre__OUT2
    self.drawConnections(
 )
...
(self.obj10674,self.obj129,[427.0, 215.0, 462.0, 196.0],"true", 2) )
    # Connections for obj52796 (graphObject_: Obj48) of type MT_pre__directLink_S
    self.drawConnections(
(self.obj52796,self.obj52795,[237.0, 172.0, 242.0, 235.0],"true", 2) )
...
(self.obj124,self.obj52796,[232.0, 109.0, 237.0, 172.0],"true", 2) )
