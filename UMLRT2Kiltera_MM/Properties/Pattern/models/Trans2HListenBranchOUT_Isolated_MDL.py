...
Author: gehan
Modified: Mon Mar  9 11:41:53 2015
...
def Trans2HListenBranchOUT_Isolated_MDL(self, rootNode, MT_pre__UMLRT2Kiltera_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    self.obj73842=MT_pre__OUT2(self)
    self.obj73842.isGraphObjectVisual = True

    if(hasattr(self.obj73842, '_setHierarchicalLink')):
      self.obj73842._setHierarchicalLink(False)

    # MT_label__
    self.obj73842.MT_label__.setValue('5')

    # MT_pivotOut__
    self.obj73842.MT_pivotOut__.setValue('element2')

    # MT_subtypeMatching__
    self.obj73842.MT_subtypeMatching__.setValue(('True', 0))
    self.obj73842.MT_subtypeMatching__.config = 0

    # MT_pre__classtype
    self.obj73842.MT_pre__classtype.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj73842.MT_pre__classtype.setHeight(15)

    # MT_pre__cardinality
    self.obj73842.MT_pre__cardinality.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj73842.MT_pre__cardinality.setHeight(15)

    # MT_pre__name
    self.obj73842.MT_pre__name.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj73842.MT_pre__name.setHeight(15)

    # MT_pivotIn__
    self.obj73842.MT_pivotIn__.setValue('')
    self.obj73842.MT_pivotIn__.setNone()

    self.obj73842.graphClass_= graph_MT_pre__OUT2
    if self.genGraphics:
       new_obj = graph_MT_pre__OUT2(40.0,220.0,self.obj73842)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__OUT2", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    else: new_obj = None
    self.obj73842.graphObject_ = new_obj

    # Add node to the root: rootNode
    rootNode.addNode(self.obj73842)
    self.globalAndLocalPostcondition(self.obj73842, rootNode)
    self.obj73842.postAction( rootNode.CREATE )
    ...
    # Connections for obj73842 (graphObject_: Obj64) of type MT_pre__OUT2
    self.drawConnections(
 )
