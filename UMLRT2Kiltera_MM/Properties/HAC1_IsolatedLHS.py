...
class HAC1_IsolatedLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
        Creates the himesis graph representing the AToM3 model HAC1_IsolatedLHS.
                """
        # Flag this instance as compiled now
                self.is_compiled = True
        
                super(HAC1_IsolatedLHS, self).__init__(name='HAC1_IsolatedLHS', num_nodes=0, edges=[])
