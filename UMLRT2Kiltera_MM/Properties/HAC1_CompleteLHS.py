...
class HAC1_CompleteLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                Creates the himesis graph representing the AToM3 model HAC1_CompleteLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True

                super(HAC1_CompleteLHS, self).__init__(name='HAC1_CompleteLHS', num_nodes=0, edges=[])
...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'AC1')
...
"""
                ...
                self.vs[1]["mm__"] = """MT_pre__SIBLING0"""
...
"""
                ...
                # backward association SIBLING0---->ListenBranch node
                self.add_node()
                ...
                # Add the edges
                self.add_edges([
                (4,18), # apply_class ListenBranch() -> backward_association
                (18,1), #  backward_association -> apply_class SIBLING0()
                ...
                (15,8), # association channelNames  -> apply_class Name()
                ...
                (0,10), # match_class Transition() -> association type
                (10,1), # association type  -> match_class SIBLING0()
                (0,11), # match_class Transition() -> association triggers
