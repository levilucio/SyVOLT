...
Author: gehan
Modified: Mon Feb 16 19:37:08 2015
...
def state2trans2exitptTrue_Connected_MDL(self, rootNode, MoTifRuleRootNode=None, MT_pre__UMLRT2Kiltera_MMRootNode=None):
    ...
    # MT_label__
    self.obj125.MT_label__.setValue('12')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__ExitPoint(300.0,180.0,self.obj125)
    ...
    # MT_label__
    self.obj124.MT_label__.setValue('13')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Transition(100.0,280.0,self.obj124)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__State(80.0,80.0,self.obj121)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj122=MT_pre__directLink_S(self)
    ...
    # MT_label__
    self.obj122.MT_label__.setValue('14')
    ...
    self.obj122.MT_pre__associationType.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj122.MT_pre__associationType.setHeight(15)

    self.obj122.graphClass_= graph_MT_pre__directLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_S(389.5,205.0,self.obj122)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj123=MT_pre__directLink_S(self)
    ...
    # MT_label__
    self.obj123.MT_label__.setValue('15')
    ...
    # MT_pre__associationType
    self.obj123.MT_pre__associationType.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj123.MT_pre__associationType.setHeight(15)

    self.obj123.graphClass_= graph_MT_pre__directLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_S(289.5,255.0,self.obj123)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    # Connections for obj125 (graphObject_: Obj5) of type MT_pre__ExitPoint
    self.drawConnections(
 )
    # Connections for obj124 (graphObject_: Obj4) of type MT_pre__Transition
    self.drawConnections(
 )
    # Connections for obj121 (graphObject_: Obj1) of type MT_pre__State
    self.drawConnections(
(self.obj121,self.obj122,[277.0, 155.0, 389.5, 205.0],"true", 2),
(self.obj121,self.obj123,[277.0, 155.0, 289.5, 255.0],"true", 2) )
    # Connections for obj122 (graphObject_: Obj2) of type MT_pre__directLink_S
    self.drawConnections(
(self.obj122,self.obj125,[389.5, 205.0, 502.0, 255.0],"true", 2) )
    # Connections for obj123 (graphObject_: Obj3) of type MT_pre__directLink_S
    self.drawConnections(
(self.obj123,self.obj124,[289.5, 255.0, 302.0, 355.0],"true", 2) )
