"""
__state2trans2exitptTrue_Isolated_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Mon Feb 16 16:09:04 2015
...
def state2trans2exitptTrue_Isolated_MDL(self, rootNode, MoTifRuleRootNode=None, MT_pre__UMLRT2Kiltera_MMRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('state2trans2exitptTrue_Isolated')
    # --- ASG attributes over ---
...
newfunction = state2trans2exitptTrue_Isolated_MDL
