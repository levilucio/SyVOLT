...
Author: gehan
Modified: Sun Feb 15 11:18:56 2015
...
def state2procdef_Complete_MDL(self, rootNode, MT_pre__UMLRT2Kiltera_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__State(80.0,100.0,self.obj124)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj126=MT_pre__trace_link(self)
    ...
    self.obj126.graphClass_= graph_MT_pre__trace_link
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(287.0,288.0,self.obj126)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj125=MT_pre__ProcDef(self)
    ...
    self.obj125.graphClass_= graph_MT_pre__ProcDef
    if self.genGraphics:
       new_obj = graph_MT_pre__ProcDef(80.0,300.0,self.obj125)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # Connections for obj126 (graphObject_: Obj3) of type MT_pre__trace_link
    self.drawConnections(
(self.obj126,self.obj124,[287.0, 288.0, 277.0, 175.0],"true", 2) )
    # Connections for obj125 (graphObject_: Obj2) of type MT_pre__ProcDef
    self.drawConnections(
(self.obj125,self.obj126,[297.0, 401.0, 287.0, 288.0],"true", 2) )
