"""
__state2procdef_Complete_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Mon Feb 16 12:05:09 2015
...
def state2procdef_Complete_MDL(self, rootNode, MT_pre__UMLRT2Kiltera_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('state2procdef_Complete')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_LHS(40.0,60.0,self.obj123)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__State(80.0,120.0,self.obj124)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj10634=MT_pre__trace_link(self)
    ...
    # MT_label__
    self.obj10634.MT_label__.setValue('3')
    ...
    self.obj10634.graphClass_= graph_MT_pre__trace_link
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(297.0,278.0,self.obj10634)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj10633=MT_pre__ProcDef(self)
    self.obj10633.isGraphObjectVisual = True

    if(hasattr(self.obj10633, '_setHierarchicalLink')):
      self.obj10633._setHierarchicalLink(False)

    # MT_label__
    self.obj10633.MT_label__.setValue('2')

    # MT_pivotOut__
    self.obj10633.MT_pivotOut__.setValue('')
    self.obj10633.MT_pivotOut__.setNone()

    # MT_subtypeMatching__
    self.obj10633.MT_subtypeMatching__.setValue(('True', 0))
    self.obj10633.MT_subtypeMatching__.config = 0

    # MT_pre__classtype
    self.obj10633.MT_pre__classtype.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj10633.MT_pre__classtype.setHeight(15)

    # MT_pre__cardinality
    self.obj10633.MT_pre__cardinality.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj10633.MT_pre__cardinality.setHeight(15)

    # MT_pre__name
    self.obj10633.MT_pre__name.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj10633.MT_pre__name.setHeight(15)

    # MT_pivotIn__
    self.obj10633.MT_pivotIn__.setValue('')
    self.obj10633.MT_pivotIn__.setNone()

    self.obj10633.graphClass_= graph_MT_pre__ProcDef
    if self.genGraphics:
       new_obj = graph_MT_pre__ProcDef(100.0,260.0,self.obj10633)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__ProcDef", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    else: new_obj = None
    self.obj10633.graphObject_ = new_obj

    # Add node to the root: rootNode
    rootNode.addNode(self.obj10633)
    self.globalAndLocalPostcondition(self.obj10633, rootNode)
    self.obj10633.postAction( rootNode.CREATE )
    ...
    # Connections for obj10634 (graphObject_: Obj3) of type MT_pre__trace_link
    self.drawConnections(
(self.obj10634,self.obj124,[297.0, 278.0, 277.0, 195.0],"true", 2) )
    # Connections for obj10633 (graphObject_: Obj2) of type MT_pre__ProcDef
    self.drawConnections(
(self.obj10633,self.obj10634,[317.0, 361.0, 297.0, 278.0],"true", 2) )

newfunction = state2procdef_Complete_MDL
