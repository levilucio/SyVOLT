...
class HState2trans2exitptTrue_ConnectedLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HState2trans2exitptTrue_ConnectedLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HState2trans2exitptTrue_ConnectedLHS, self).__init__(name='HState2trans2exitptTrue_ConnectedLHS', num_nodes=5, edges=[])
        
        # Add the edges
        self.add_edges([(4, 0), (1, 3), (3, 2), (1, 4)])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('90ce36c3-0629-4d65-a27c-6208ce7ab9b3')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('948c8daf-76a2-4298-8c07-532d22787c96')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('79c24536-b651-4535-8b3f-93a38e24b6a7')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('a8dc849e-5c23-440e-be8a-dccc0a8a1d0f')
...
.""")
        ...
        self.vs[3]["GUID__"] = UUID('6fc6f66a-69ee-4056-9a1b-fa7356a3f6e2')
...
.""")
        ...
        self.vs[4]["GUID__"] = UUID('e34899ea-8fa0-45b2-9bbd-c33b1da5bf8d')
