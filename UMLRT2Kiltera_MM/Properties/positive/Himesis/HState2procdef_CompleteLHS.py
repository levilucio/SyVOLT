...
class HState2procdef_CompleteLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HState2procdef_CompleteLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HState2procdef_CompleteLHS, self).__init__(name='HState2procdef_CompleteLHS', num_nodes=3, edges=[])
