...
class HExitpoint2procdefparTrueNOATTR_CompleteLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HExitpoint2procdefparTrueNOATTR_CompleteLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HExitpoint2procdefparTrueNOATTR_CompleteLHS, self).__init__(name='HExitpoint2procdefparTrueNOATTR_CompleteLHS', num_nodes=10, edges=[])
        
        # Add the edges
        self.add_edges([(7, 0), (9, 0), (0, 3), (6, 1), (8, 1), (3, 1), (4, 2), (2, 8), (2, 9), (5, 6), (5, 7), (5, 4)])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('3d31e012-7540-4592-a505-cceed55808de')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('843e45cd-8e01-4616-a6f9-ecdc0b88e74b')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('bebdc05f-63c3-4518-b9dc-6f4a14cf3074')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('e1c109d6-348b-40cc-89f7-f3aea9a488d8')
...
.""")
        ...
        self.vs[3]["GUID__"] = UUID('c71c7ba0-c71f-4079-b519-1b005d27e33b')
...
.""")
        ...
        self.vs[4]["GUID__"] = UUID('2126e095-cab4-41d5-b21c-1a312c3a06b7')
...
return True
"""
        self.vs[5]["GUID__"] = UUID('70a77465-dc45-46ae-b199-b9b705c6a764')
...
.""")
        ...
        self.vs[6]["GUID__"] = UUID('ec9edbce-8a90-401e-ba2b-663dc4aa8a1c')
...
.""")
        ...
        self.vs[7]["GUID__"] = UUID('47a8907c-af19-4512-b438-ba0b07cf2ba0')
...
.""")
        ...
        self.vs[8]["GUID__"] = UUID('f1c14bb2-aa14-4ef1-b21c-6e272b55aa34')
...
.""")
        ...
        self.vs[9]["GUID__"] = UUID('8463c2f8-b0d0-4b9e-b994-8e69bba2d0fb')
