...
class HAC1_ConnectedLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                Creates the himesis graph representing the AToM3 model HAC1_ConnectedLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True
        
                super(HAC1_ConnectedLHS, self).__init__(name='HAC1_ConnectedLHS', num_nodes=0, edges=[])
...
"""
        ...
        # Add the edges
                self.add_edges([
                (0,4), # match_class Transition() -> association type
                (4,1), # association type  -> match_class SIBLING0()
                (0,5), # match_class Transition() -> association triggers
