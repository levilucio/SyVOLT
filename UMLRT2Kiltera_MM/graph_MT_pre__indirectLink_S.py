...
class graph_MT_pre__indirectLink_S(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le=linkEditor(self,self.semObject, "MT_pre__indirectLink_S")
      ...
      self.le.FirstLink.decoration.setValue( ('MT_pre__indirectLink_S_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('MT_pre__indirectLink_S_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('MT_pre__indirectLink_S_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('MT_pre__indirectLink_S_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('MT_pre__indirectLink_S_2ndLink', self.le.SecondLink))
