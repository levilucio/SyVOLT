"""
__BASE0.py_____________________________________________________
...
from graph_BASE0 import *
class BASE0(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['PortType', 'MetaModelElement_S']
      self.graphClass_ = graph_BASE0
