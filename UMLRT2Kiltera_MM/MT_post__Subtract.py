"""
__MT_post__Subtract.py_____________________________________________________
...
from graph_MT_post__Subtract import *
class MT_post__Subtract(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__Operation', 'MT_post__Expression']
      self.graphClass_ = graph_MT_post__Subtract
      ...
      self.generatedAttributes = {'MT_post__Type': ('ATOM3Text', ),
                                  'MT_post__Type': ('ATOM3Text', ),
                                  'MT_post__name': ('ATOM3Text', ),
                                  'MT_post__name': ('ATOM3Text', ),
                                  'MT_label__': ('ATOM3String', ),
                                  'MT_pivotOut__': ('ATOM3String', )      }
      self.realOrder = ['MT_post__Type','MT_post__Type','MT_post__name','MT_post__name','MT_label__','MT_pivotOut__']
      self.directEditing = [0,0,0,0,1,1]
   def clone(self):
      cloneObject = MT_post__Subtract( self.parent )
