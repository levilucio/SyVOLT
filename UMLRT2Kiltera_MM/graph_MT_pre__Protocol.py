"""
__graph_MT_pre__Protocol.py___________________________________________________________
...
class graph_MT_pre__Protocol(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([62.0, 35.0, 62.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__Protocol', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__Protocol
