"""
__graph_MT_pre__Concat.py___________________________________________________________
...
class graph_MT_pre__Concat(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        font = tkFont.Font( family='Arial', size=12, weight='normal', slant='roman', underline=0)
        h = drawing.create_text(self.translate([80.0, 40.0, 80.0, 11.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__Concat', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__Concat
