"""
__MT_post__Concat.py_____________________________________________________
...
from graph_MT_post__Concat import *
class MT_post__Concat(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__Operation', 'MT_post__Expression']
      self.graphClass_ = graph_MT_post__Concat
   ...
   def clone(self):
      cloneObject = MT_post__Concat( self.parent )
