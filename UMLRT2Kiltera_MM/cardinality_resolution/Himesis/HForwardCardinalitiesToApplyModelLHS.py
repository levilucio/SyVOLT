...
p3
a.""")
        self["MT_constraint__"] = pickle.loads("""Vif PreNode('1')['cardinality'] == '+' and PreNode('2')['cardinality'] != '+':\u000a    return True\u000a\u000areturn False\u000a
p1
.""")
        self["name"] = """"""
        self["GUID__"] = UUID('251b2425-791e-4183-b0db-fe1b4cb10f00')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('ff146314-2cde-4737-a3ac-5bd1b838e7fc')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('47ae65a1-cdef-445a-8951-1319092e30f2')
