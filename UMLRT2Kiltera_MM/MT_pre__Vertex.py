"""
__MT_pre__Vertex.py_____________________________________________________
...
from graph_MT_pre__Vertex import *
class MT_pre__Vertex(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_pre__StateMachineElement', 'MT_pre__MetaModelElement_S']
      self.graphClass_ = graph_MT_pre__Vertex
   ...
   def clone(self):
      cloneObject = MT_pre__Vertex( self.parent )
