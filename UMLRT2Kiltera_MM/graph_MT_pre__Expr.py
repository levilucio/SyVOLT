"""
__graph_MT_pre__Expr.py___________________________________________________________
...
class graph_MT_pre__Expr(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([120.0, 60.0, 120.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__Expr', width = '0', justify= 'left', stipple='' )
