...
class HCompositeState2ProcDef(Himesis):
    def __init__(self):
        ...
        self.add_edges([
                ...
                (36,35), # apply_contains -> apply_class Par()
                ...
                (40,37), # association channelNames  -> apply_class Name()
                (7,41), # apply_class LocalDef() -> association p
                (41,27), # association p  -> apply_class New()
                (9,42), # apply_class Inst() -> association channelNames
                (42,11), # association channelNames  -> apply_class Name()
                (9,43), # apply_class Inst() -> association channelNames
                (43,13), # association channelNames  -> apply_class Name()
                (9,44), # apply_class Inst() -> association channelNames
                (44,15), # association channelNames  -> apply_class Name()
                (9,45), # apply_class Inst() -> association channelNames
                (45,17), # association channelNames  -> apply_class Name()
                (19,46), # apply_class Inst() -> association channelNames
                (46,21), # association channelNames  -> apply_class Name()
                (19,47), # apply_class Inst() -> association channelNames
                (47,23), # association channelNames  -> apply_class Name()
                (19,48), # apply_class Inst() -> association channelNames
                (48,25), # association channelNames  -> apply_class Name()
                (27,49), # apply_class New() -> association channelNames
                (49,29), # association channelNames  -> apply_class Name()
                (27,50), # apply_class New() -> association channelNames
                (50,31), # association channelNames  -> apply_class Name()
                (27,51), # apply_class New() -> association channelNames
                (51,33), # association channelNames  -> apply_class Name()
                (27,52), # apply_class New() -> association p
                (52,35), # association p  -> apply_class Par()
                (35,53), # apply_class Par() -> association p
                (53,9), # association p  -> apply_class Inst()
                (35,54), # apply_class Par() -> association p
                (54,19), # association p  -> apply_class Inst()
        ...
        self["equations"] = [((3,'isComposite'),('constant','true')), ((5,'ApplyAttribute'),('constant','solveRef')), ((7,'ApplyAttribute'),('constant','solveRef')), ((9,'name'),('constant','C')), ((11,'literal'),('constant','enp')), ((13,'literal'),('constant','exit_in')), ((15,'literal'),('constant','exack_in')), ((17,'literal'),('constant','sh_in')), ((19,'name'),('constant','H')), ((21,'literal'),('constant','exit_in')), ((23,'literal'),('constant','exack_in')), ((25,'literal'),('constant','sh_in')), ((29,'literal'),('constant','exit_in')), ((31,'literal'),('constant','exack_in')), ((33,'literal'),('constant','sh_in')), ((37,'literal'),('constant','sh')), ]
