...
class HConnectOPState2CProcDefTransition2InstotherInTransitions(Himesis):
    def __init__(self):
        ...
        self.add_edges([
                ...
                (17,25), # apply_class Inst() -> backward_association
                (25,3), #  backward_association -> apply_class Transition()
                (11,26), # apply_class ConditionSet() -> backward_association
                (26,7), #  backward_association -> apply_class State()
                (0,2), # matchmodel -> pairedwith
                (2,1) # pairedwith -> applyModel				
		])

        # Add the attribute equations
        self["equations"] = [((7,'isComposite'),('constant','true')), ((11,'ApplyAttribute'),('constant','solveRef')), ((15,'literal'),('concat',(('constant','enp=A'),('concat',((9,'name'),('constant','A')))))), ((17,'ApplyAttribute'),('constant','solveRef')), ]
