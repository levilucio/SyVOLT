...
class HBasicState2ProcDef(Himesis):
    def __init__(self):
        ...
        self["equations"] = [((3,'isComposite'),('constant','false')), ((3,'hasOutgoingTransitions'),('constant','true')), ((5,'ApplyAttribute'),('constant','solveRef')), ((7,'ApplyAttribute'),('constant','solveRef')), ((9,'channel'),('constant','exit')), ((11,'channel'),('constant','exack')), ]
