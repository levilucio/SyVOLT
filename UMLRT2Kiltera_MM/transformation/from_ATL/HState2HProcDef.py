...
class HState2HProcDef(Himesis):
    def __init__(self):
        ...
        self.add_node()
        self.vs[38]["attr1"] = """branches"""
        self.vs[38]["mm__"] = """directLink_T"""
        # apply association Listen--branches-->ListenBranch node
        self.add_node()
        self.vs[39]["attr1"] = """branches"""
        ...
        self.add_edges([
                ...
                (15,39), # apply_class Listen() -> association branches
                (39,29), # association branches  -> apply_class ListenBranch()
                (17,40), # apply_class ListenBranch() -> association p
                (40,27), # association p  -> apply_class Seq()
                (21,41), # apply_class Listen() -> association branches
                (41,23), # association branches  -> apply_class ListenBranch()
                (23,42), # apply_class ListenBranch() -> association p
                (42,25), # association p  -> apply_class Trigger()
                (27,43), # apply_class Seq() -> association p
                (43,19), # association p  -> apply_class Trigger()
                (27,44), # apply_class Seq() -> association p
                (44,21), # association p  -> apply_class Listen()
                (29,45), # apply_class ListenBranch() -> association p
                (45,31), # association p  -> apply_class Null()
        ...
        self["equations"] = [((3,'isComposite'),('constant','true')), ((5,'ApplyAttribute'),('constant','solveRef')), ((7,'name'),('constant','H')), ((9,'literal'),('constant','exit_in')), ((11,'literal'),('constant','exack_in')), ((13,'literal'),('constant','sh_in')), ((15,'ApplyAttribute'),('constant','solveRef')), ((17,'channel'),('constant','exit')), ((19,'channel'),('constant','exit_in')), ((23,'channel'),('constant','exack_in')), ((25,'channel'),('constant','exack')), ((29,'channel'),('constant','sh_in')), ]
