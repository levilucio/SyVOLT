...
class HTransition2Inst(Himesis):
    def __init__(self):
        ...
        self.add_edges([
                ...
                (12,11), # match_contains -> match_class EntryPoint()
                ...
                (25,11), # association dest  -> match_class EntryPoint()
                (11,26), # match_class EntryPoint() -> association owningStateMachine
                (26,9), # association owningStateMachine  -> match_class StateMachine()
        ...
        self["equations"] = [((3,'isComposite'),('constant','true')), ((13,'name'),('concat',(('constant','S'),(9,'name')))), ((13,'ApplyAttribute'),('constant','solveRef')), ((15,'literal'),('constant','exack_in')), ((17,'literal'),('constant','exit_in')), ((19,'literal'),('concat',(('constant','A'),('concat',((11,'name'),('constant','A')))))), ((21,'literal'),('constant','sh_in')), ]
