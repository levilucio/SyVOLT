...
Author: gehan
Modified: Wed Feb 11 16:45:27 2015
...
def ConnectOPxState2CProcDefxTransition2InstxOtherInTransitions_MDL(self, rootNode, UMLRT2Kiltera_MMRootNode=None):
    ...
    # name
    self.obj121.name.setValue('enp=xox')
...
(self.obj119,self.obj157,[814.0, 334.0, 894.0, 294.0],"true", 2) )
    ...
    # Connections for obj121 (graphObject_: Obj21) named enp=xox
    self.drawConnections(
 )
    # Connections for obj122 (graphObject_: Obj22) named xox
    self.drawConnections(
 )
