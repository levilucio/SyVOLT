"""
__graph_MT_post__Site.py___________________________________________________________
...
class graph_MT_post__Site(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([102.0, 58.0, 102.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__Site', width = '0', justify= 'left', stipple='' )
