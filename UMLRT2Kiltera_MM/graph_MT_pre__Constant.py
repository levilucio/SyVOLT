"""
__graph_MT_pre__Constant.py___________________________________________________________
...
class graph_MT_pre__Constant(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([80.0, 40.0, 80.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__Constant', width = '0', justify= 'left', stipple='' )
        self.gf130 = GraphicalForm(drawing, h, 'gf130', fontObject=font)
        self.graphForms.append(self.gf130)
...
new_class = graph_MT_pre__Constant
