...
class graph_MT_post__hasArgs(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le=linkEditor(self,self.semObject, "hasArgs")
      ...
      self.le.FirstLink.decoration.setValue( ('hasArgs_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('hasArgs_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('hasArgs_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('hasArgs_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('hasArgs_2ndLink', self.le.SecondLink))
