"""
__Element.py_____________________________________________________
...
class Element(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MetaModelElement_S']
      self.graphClass_ = graph_Element
   ...
   def clone(self):
      cloneObject = Element( self.parent )
