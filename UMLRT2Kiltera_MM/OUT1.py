"""
__OUT1.py_____________________________________________________
...
from graph_OUT1 import *
class OUT1(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['SignalType', 'MetaModelElement_S']
      self.graphClass_ = graph_OUT1
