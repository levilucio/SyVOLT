"""
__graph_MT_pre__SignalType.py___________________________________________________________
...
class graph_MT_pre__SignalType(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([72.0, 35.0, 72.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__SignalType', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__SignalType
