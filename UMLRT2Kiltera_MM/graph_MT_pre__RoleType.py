"""
__graph_MT_pre__RoleType.py___________________________________________________________
...
class graph_MT_pre__RoleType(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([74.0, 43.0, 74.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__RoleType', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__RoleType
