"""
__MT_post__hasAttribute_S.py_____________________________________________________
...
from graph_MT_post__hasAttribute_S import *
class MT_post__hasAttribute_S(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_post__hasAttribute_S
   ...
   def clone(self):
      cloneObject = MT_post__hasAttribute_S( self.parent )
