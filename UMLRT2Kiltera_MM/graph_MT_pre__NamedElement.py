"""
__graph_MT_pre__NamedElement.py___________________________________________________________
...
class graph_MT_pre__NamedElement(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([109.0, 36.0, 109.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__NamedElement', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__NamedElement
