"""
__graph_MT_pre__Operation.py___________________________________________________________
...
class graph_MT_pre__Operation(graphEntity):
...
new_class = graph_MT_pre__Operation
