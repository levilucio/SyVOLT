"""
__graph_RoleType.py___________________________________________________________
...
class graph_RoleType(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([74.0, 43.0, 74.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'RoleType', width = '0', justify= 'left', stipple='' )
        self.gf173 = GraphicalForm(drawing, h, 'gf173', fontObject=font)
        ...
        self.gf174 = GraphicalForm(drawing, h, 'gf174', fontObject=font)
        self.graphForms.append(self.gf174)
