"""
__MT_pre__Match.py_____________________________________________________
...
from graph_MT_pre__Match import *
class MT_pre__Match(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_pre__Proc', 'MT_pre__MetaModelElement_T']
      self.graphClass_ = graph_MT_pre__Match
   ...
   def clone(self):
      cloneObject = MT_pre__Match( self.parent )
