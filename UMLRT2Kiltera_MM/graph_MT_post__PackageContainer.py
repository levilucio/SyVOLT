"""
__graph_MT_post__PackageContainer.py___________________________________________________________
...
class graph_MT_post__PackageContainer(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([99.0, 36.0, 99.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__PackageContainer', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__PackageContainer
