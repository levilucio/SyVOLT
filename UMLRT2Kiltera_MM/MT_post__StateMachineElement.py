"""
__MT_post__StateMachineElement.py_____________________________________________________
...
from graph_MT_post__StateMachineElement import *
class MT_post__StateMachineElement(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__NamedElement', 'MT_post__MetaModelElement_S']
      self.graphClass_ = graph_MT_post__StateMachineElement
   ...
   def clone(self):
      cloneObject = MT_post__StateMachineElement( self.parent )
