"""
__FIXED0.py_____________________________________________________
...
from graph_FIXED0 import *
class FIXED0(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['RoleType', 'MetaModelElement_S']
      self.graphClass_ = graph_FIXED0
   ...
   def clone(self):
      cloneObject = FIXED0( self.parent )
