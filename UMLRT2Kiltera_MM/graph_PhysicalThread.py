"""
__graph_PhysicalThread.py___________________________________________________________
...
class graph_PhysicalThread(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([123.0, 38.0, 123.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'PhysicalThread', width = '0', justify= 'left', stipple='' )
        ...
        h = drawing.create_text(self.translate([100.0, 60.0, 100.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
...
new_class = graph_PhysicalThread
