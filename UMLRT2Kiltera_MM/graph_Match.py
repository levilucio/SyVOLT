"""
__graph_Match.py___________________________________________________________
...
class graph_Match(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([113.0, 54.0, 113.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'Match', width = '0', justify= 'left', stipple='' )
