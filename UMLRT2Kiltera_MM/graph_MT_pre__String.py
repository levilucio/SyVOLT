"""
__graph_MT_pre__String.py___________________________________________________________
...
class graph_MT_pre__String(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([62.0, 32.0, 62.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__String', width = '0', justify= 'left', stipple='' )
        ...
        h = drawing.create_text(self.translate([-3, -3]), font=helv12,
                                ...
                                fill = "black", 
                                text=self.semanticObject.MT_label__.toMT_pre__String())
...
new_class = graph_MT_pre__String
