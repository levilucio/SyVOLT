"""
__graph_MT_post__MatchCase.py___________________________________________________________
...
class graph_MT_post__MatchCase(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([118.0, 62.0, 118.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__MatchCase', width = '0', justify= 'left', stipple='' )
        self.gf41 = GraphicalForm(drawing, h, 'gf41', fontObject=font)
...
new_class = graph_MT_post__MatchCase
