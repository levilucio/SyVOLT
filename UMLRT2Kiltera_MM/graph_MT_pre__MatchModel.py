...
class graph_MT_pre__MatchModel(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        font = tkFont.Font( family='Arial', size=12, weight='normal', slant='roman', underline=0)
        h = drawing.create_text(self.translate([82.0, 52.0, 82.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__MatchModel', width = '0', justify= 'left', stipple='' )
