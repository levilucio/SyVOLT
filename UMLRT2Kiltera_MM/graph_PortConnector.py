"""
__graph_PortConnector.py___________________________________________________________
...
class graph_PortConnector(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([120.0, 39.0, 120.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'PortConnector', width = '0', justify= 'left', stipple='' )
        ...
        h = drawing.create_text(self.translate([72.0, 64.0, 72.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
