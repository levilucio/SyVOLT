"""
__PortConnector.py_____________________________________________________
...
from graph_PortConnector import *
class PortConnector(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['NamedElement', 'MetaModelElement_S']
      self.graphClass_ = graph_PortConnector
   ...
   def clone(self):
      cloneObject = PortConnector( self.parent )
