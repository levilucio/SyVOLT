...
class graph_MT_post__trace_link(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le=linkEditor(self,self.semObject, "trace_link")
      ...
      self.le.FirstLink.decoration.setValue( ('trace_link_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('trace_link_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('trace_link_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('trace_link_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('trace_link_2ndLink', self.le.SecondLink))
