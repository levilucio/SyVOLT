"""
__graph_MT_post__Null.py___________________________________________________________
...
class graph_MT_post__Null(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([107.0, 66.0, 107.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__Null', width = '0', justify= 'left', stipple='' )
