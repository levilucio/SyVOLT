"""
__PLUGIN2.py_____________________________________________________
...
from graph_PLUGIN2 import *
class PLUGIN2(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['RoleType', 'MetaModelElement_S']
      self.graphClass_ = graph_PLUGIN2
   ...
   def clone(self):
      cloneObject = PLUGIN2( self.parent )
