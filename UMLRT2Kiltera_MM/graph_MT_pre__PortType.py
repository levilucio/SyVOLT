"""
__graph_MT_pre__PortType.py___________________________________________________________
...
class graph_MT_pre__PortType(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([106.0, 42.0, 106.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__PortType', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__PortType
