"""
__MT_post__Match.py_____________________________________________________
...
from graph_MT_post__Match import *
class MT_post__Match(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__Proc', 'MT_post__MetaModelElement_T']
      self.graphClass_ = graph_MT_post__Match
   ...
   def clone(self):
      cloneObject = MT_post__Match( self.parent )
