"""
__MT_post__hasAttribute_T.py_____________________________________________________
...
from graph_MT_post__hasAttribute_T import *
class MT_post__hasAttribute_T(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_post__hasAttribute_T
   ...
   def clone(self):
      cloneObject = MT_post__hasAttribute_T( self.parent )
