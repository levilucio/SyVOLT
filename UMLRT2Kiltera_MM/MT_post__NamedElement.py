"""
__MT_post__NamedElement.py_____________________________________________________
...
from graph_MT_post__NamedElement import *
class MT_post__NamedElement(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__Element', 'MT_post__MetaModelElement_S']
      self.graphClass_ = graph_MT_post__NamedElement
   ...
   def clone(self):
      cloneObject = MT_post__NamedElement( self.parent )
