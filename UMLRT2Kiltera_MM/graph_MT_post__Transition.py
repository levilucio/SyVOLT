"""
__graph_MT_post__Transition.py___________________________________________________________
...
class graph_MT_post__Transition(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([115.0, 32.0, 115.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__Transition', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__Transition
