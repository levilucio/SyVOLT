"""
__MT_pre__NamedElement.py_____________________________________________________
...
from graph_MT_pre__NamedElement import *
class MT_pre__NamedElement(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_pre__Element', 'MT_pre__MetaModelElement_S']
      self.graphClass_ = graph_MT_pre__NamedElement
   ...
   def clone(self):
      cloneObject = MT_pre__NamedElement( self.parent )
