"""
__MT_post__Package.py_____________________________________________________
...
from graph_MT_post__Package import *
class MT_post__Package(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__PackageContainer', 'MT_post__MetaModelElement_S']
      self.graphClass_ = graph_MT_post__Package
   ...
   def clone(self):
      cloneObject = MT_post__Package( self.parent )
