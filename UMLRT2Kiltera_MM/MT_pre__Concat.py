"""
__MT_pre__Concat.py_____________________________________________________
...
class MT_pre__Concat(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_pre__Operation', 'MT_pre__Expression']
      self.graphClass_ = graph_MT_pre__Concat
   ...
   def clone(self):
      cloneObject = MT_pre__Concat( self.parent )
