"""
__MT_pre__Model_T.py_____________________________________________________
...
from graph_MT_pre__Model_T import *
class MT_pre__Model_T(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_pre__MetaModelElement_T']
      self.graphClass_ = graph_MT_pre__Model_T
   ...
   def clone(self):
      cloneObject = MT_pre__Model_T( self.parent )
