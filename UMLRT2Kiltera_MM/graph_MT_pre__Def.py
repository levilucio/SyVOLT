"""
__graph_MT_pre__Def.py___________________________________________________________
...
class graph_MT_pre__Def(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([100.0, 55.0, 100.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__Def', width = '0', justify= 'left', stipple='' )
