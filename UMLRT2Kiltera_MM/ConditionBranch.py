"""
__ConditionBranch.py_____________________________________________________
...
class ConditionBranch(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MetaModelElement_T']
      self.graphClass_ = graph_ConditionBranch
   ...
   def clone(self):
      cloneObject = ConditionBranch( self.parent )
