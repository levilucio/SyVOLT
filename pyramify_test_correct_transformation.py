...
#         [self.rules, self.backwardPatterns, self.backwardPatterns2Rules, self.backwardPatternsComplete, self.matchRulePatterns] = pyramify.ramify_directory("GM2AUTOSAR_MM/transformation/HimesisWOFaulty/")
        ...
        #self.matchRulePatterns['HMapDistributable'] = matchRulePatterns['HMapDistributable']
        
        #self.matchRulePatterns['HMapVirtualDevice'] = matchRulePatterns['HMapVirtualDevice']
        
        #self.matchRulePatterns['HConnectPPortPrototype'] = matchRulePatterns['HConnectPPortPrototype']
        
        #self.matchRulePatterns['HConnectRPortPrototype'] = matchRulePatterns['HConnectRPortPrototype']
        
        #self.matchRulePatterns['HConnECU2VirtualDevice'] = matchRulePatterns['HConnECU2VirtualDevice']
...
#                           [HConnectPPortPrototype(), HConnectRPortPrototype()]]
        ...
        s = PathConditionGenerator(self.rules, transformation, rulesIncludingBackLinks, self.backwardPatterns, self.backwardPatterns2Rules,\
                               self.backwardPatternsComplete, self.matchRulePatterns, 2, False, output_suffix = "_PyRamify")
