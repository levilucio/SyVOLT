...
class Hstrongreference_OUT_type_SolveRef_StrongReference_EntityType_StrongReference_EntityType(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule strongreference_OUT_type_SolveRef_StrongReference_EntityType_StrongReference_EntityType.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(Hstrongreference_OUT_type_SolveRef_StrongReference_EntityType_StrongReference_EntityType, self).__init__(name='Hstrongreference_OUT_type_SolveRef_StrongReference_EntityType_StrongReference_EntityType', num_nodes=0, edges=[])
...
a.""")
        ...
        self["name"] = """strongreference_OUT_type_SolveRef_StrongReference_EntityType_StrongReference_EntityType"""
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'strongreference_OUT_type_SolveRef_StrongReference_EntityType_StrongReference_EntityType')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'strongreference_OUT_type_SolveRef_StrongReference_EntityType_StrongReference_EntityTypematchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'strongreference_OUT_type_SolveRef_StrongReference_EntityType_StrongReference_EntityTypeapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'strongreference_OUT_type_SolveRef_StrongReference_EntityType_StrongReference_EntityTypepairedwith2')
