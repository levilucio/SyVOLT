...
class HERCopierProp_IsolatedLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
        Creates the himesis graph representing the AToM3 model HERCopierProp_IsolatedLHS.
                """
        # Flag this instance as compiled now
                self.is_compiled = True
        
                super(HERCopierProp_IsolatedLHS, self).__init__(name='HERCopierProp_IsolatedLHS', num_nodes=0, edges=[])
