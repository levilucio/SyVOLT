...
class HUnitConnectCAE_CompleteLHS(HimesisPreConditionPatternLHS):
	def __init__(self):
		"""
		Creates the himesis graph representing the AToM3 model HUnitConnectCAE_CompleteLHS
		"""
		# Flag this instance as compiled now
		self.is_compiled = True

		super(HUnitConnectCAE_CompleteLHS, self).__init__(name='HUnitConnectCAE_CompleteLHS', num_nodes=0, edges=[])
		...
		self["name"] = """"""
		self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'HUnitConnectCAE_CompleteLHS')
		self["equations"] = []
		...
		self.add_node()
		self.vs[3]["MT_pre__attr1"] = """return attr_value == "entrie" """
		self.vs[3]["MT_label__"] = """4"""
		self.vs[3]["mm__"] = """MT_pre__directLink_T"""
		self.vs[3]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ATOMassoc3Entry')
		...
		# Add the edges
		self.add_edges([
			(1,3), # apply class null(ATOM) -> association entrie
			(3,2), # association null -> apply class null(Entry)
