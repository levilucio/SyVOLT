...
a.""")
        ...
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'DaughterRulematchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'DaughterRuleapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'DaughterRulepairedwith2')
    	...
    	self.add_node()
    	self.vs[19]["name"] = """famMemberDaughter"""
