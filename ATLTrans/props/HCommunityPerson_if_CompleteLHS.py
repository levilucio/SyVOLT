...
class HCommunityPerson_if_CompleteLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                Creates the himesis graph representing the AToM3 model HCommunityPerson_if_CompleteLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True

                super(HCommunityPerson_if_CompleteLHS, self).__init__(name='HCommunityPerson_if_CompleteLHS', num_nodes=0, edges=[])
...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'CommunityPerson_if')
...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,2), # apply_class CommunityRoot() -> association has
                (2,1), # association has  -> apply_class Person()
                ])
