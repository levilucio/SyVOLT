...
class HCommunityPerson_then_CompleteLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                Creates the himesis graph representing the AToM3 model HCommunityPerson_then_CompleteLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True

                super(HCommunityPerson_then_CompleteLHS, self).__init__(name='HCommunityPerson_then_CompleteLHS', num_nodes=0, edges=[])
...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'CommunityPerson_then')
...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,3), # apply_class CommunityRoot() -> association has
                (3,1), # association has  -> apply_class Person()
                (0,4), # apply_class CommunityRoot() -> association has
                (4,2), # association has  -> apply_class Person()
                ])
        
                # Add the attribute equations
                self["equations"] = [((0,'pivot'),('constant','COMMUNITY')), ((1,'pivot'),('constant','PERSON')), ]
