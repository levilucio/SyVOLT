...
"""
        ...
        # Add the edges
                self.add_edges([
                (0,3), # match_class Family() -> association mother
                (3,2), # association mother  -> match_class Member()
                (0,4), # match_class Family() -> association daughter
                (4,1) # association daughter  -> match_class Member()
        ])
