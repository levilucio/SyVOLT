...
"""
                ...
                # Add the edges
                self.add_edges([
                (6,18), # apply_class Man() -> backward_association
                (18,3), #  backward_association -> apply_class Member()
                (8,19), # apply_class Man() -> backward_association
                (19,1), #  backward_association -> apply_class Member()
                (7,20), # apply_class Woman() -> backward_association
                (20,4), #  backward_association -> apply_class Member()
                (9,21), # apply_class Woman() -> backward_association
                (21,2), #  backward_association -> apply_class Member()
                (5,14), # apply_class CommunityRoot() -> association has
                (14,6), # association has  -> apply_class Man()
                (5,15), # apply_class CommunityRoot() -> association has
                (15,7), # association has  -> apply_class Woman()
                (5,16), # apply_class CommunityRoot() -> association has
                (16,8), # association has  -> apply_class Man()
                (5,17), # apply_class CommunityRoot() -> association has
                (17,9), # association has  -> apply_class Woman()
                (0,10), # match_class Family() -> association father
                (10,1), # association father  -> match_class Member()
                (0,11), # match_class Family() -> association mother
                (11,2), # association mother  -> match_class Member()
                (0,12), # match_class Family() -> association son
                (12,3), # association son  -> match_class Member()
                (0,13), # match_class Family() -> association daughter
                (13,4) # association daughter  -> match_class Member()
                ])
