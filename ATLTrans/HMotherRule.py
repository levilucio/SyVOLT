...
class HMotherRule(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule MotherRule.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HMotherRule, self).__init__(name='HMotherRule', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'MotherRule')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'MotherRulematchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'MotherRuleapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'MotherRulepairedwith2')
    	...
    	self.add_node()
    	self.vs[9]["associationType"] = """mother"""
    	...
    	self.add_node()
    	self.vs[19]["name"] = """famMemberMother"""
        ...
        self.add_edges([
    		...
    		(3,9), # match_class Family() -> association mother
    		(9,5), # association mother  -> match_class Member()
    		...
    		(7,14), # apply_class Woman() -> has_apply_attribute ApplyAttribute ()
    		...
    		(7,20), # apply_class Woman() -> has_apply_attribute name ()
