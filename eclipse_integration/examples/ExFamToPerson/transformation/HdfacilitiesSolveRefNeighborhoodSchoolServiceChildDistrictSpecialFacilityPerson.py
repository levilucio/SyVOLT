...
class HdfacilitiesSolveRefNeighborhoodSchoolServiceChildDistrictSpecialFacilityPerson(Himesis):
    def __init__(self):
        ...
        self["equations"] = [((11,'ApplyAttribute'),('constant','solveRef')), ((13,'name'),('concat',(('constant','Special Facility Service for school '),(5,'name')))), ((15,'ApplyAttribute'),('constant','solveRef')), ]
