...
from tests.TestModules.HSM2SM_wrong_attribute import HSM2SM_wrong_attribute
...
class Test(unittest.TestCase):
    ...
    def testName(self):       
        ...
        p.graph = HSM2SM_wrong_attribute() 
          
        graph_to_dot("test_before_SM2SM_wrong_attribute_name", HSM2SM_wrong_attribute())
...
#         graph_to_dot("test_SM2SM_graph", p.graph)
        ...
        assert not comb_match.is_success
