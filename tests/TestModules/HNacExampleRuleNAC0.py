...
class HNacExampleRuleNAC0(HimesisPreConditionPatternNAC):
    def __init__(self, LHS):
        """
        Creates the himesis graph representing the AToM3 model HNacExampleRuleNAC0.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HNacExampleRuleNAC0, self).__init__(name='HNacExampleRuleNAC0', num_nodes=3, edges=[], LHS=LHS)
...
.""")
        self["name"] = """"""
        self["GUID__"] = UUID('54597b61-8736-400a-b516-d1ce1091dad5')
...
.""")
        ...
        self.vs[0]["GUID__"] = UUID('3f91fecb-a14e-4bf4-b0a2-ac28334c3226')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('5b55a809-1ea2-4bd3-8026-5136653ac283')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('c71b4de1-ff15-426c-b618-9135715c0a22')

        
        # Load the bridge between this NAC and its LHS
        from HNacExampleRuleNAC0Bridge import HNacExampleRuleNAC0Bridge
        self.bridge = HNacExampleRuleNAC0Bridge()
