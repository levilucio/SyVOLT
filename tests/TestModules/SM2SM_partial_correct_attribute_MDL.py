"""
__SM2SM_partial_correct_attribute_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Fri Jan 23 22:31:32 2015
...
def SM2SM_partial_correct_attribute_MDL(self, rootNode, PoliceStationMMRootNode=None):
    ...
    if( PoliceStationMMRootNode ): 
        ...
        # name
        PoliceStationMMRootNode.name.setValue('SM2SM_correct_attribute')
    # --- ASG attributes over ---
...
newfunction = SM2SM_partial_correct_attribute_MDL
