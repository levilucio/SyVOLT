"""
__SM2SM_complete_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Thu Jan 22 21:07:19 2015
...
def SM2SM_complete_MDL(self, rootNode, PoliceStationMMRootNode=None):
    ...
    if( PoliceStationMMRootNode ): 
        ...
        # name
        PoliceStationMMRootNode.name.setValue('SM2SM_complete')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_match_contains(461.0,231.0,self.obj43)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj44=match_contains(self)
    self.obj44.isGraphObjectVisual = True

    if(hasattr(self.obj44, '_setHierarchicalLink')):
      self.obj44._setHierarchicalLink(False)

    self.obj44.graphClass_= graph_match_contains
    if self.genGraphics:
       new_obj = graph_match_contains(591.0,231.0,self.obj44)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("match_contains", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_apply_contains(463.5,501.0,self.obj45)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj46=apply_contains(self)
    self.obj46.isGraphObjectVisual = True

    if(hasattr(self.obj46, '_setHierarchicalLink')):
      self.obj46._setHierarchicalLink(False)

    self.obj46.graphClass_= graph_apply_contains
    if self.genGraphics:
       new_obj = graph_apply_contains(593.5,501.0,self.obj46)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("apply_contains", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj49=indirectLink_S(self)
    self.obj49.isGraphObjectVisual = True

    if(hasattr(self.obj49, '_setHierarchicalLink')):
      self.obj49._setHierarchicalLink(False)

    self.obj49.graphClass_= graph_indirectLink_S
    if self.genGraphics:
       new_obj = graph_indirectLink_S(711.0,281.0,self.obj49)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # associationType
    self.obj50.associationType.setValue('t_')

    self.obj50.graphClass_= graph_directLink_T
    if self.genGraphics:
       new_obj = graph_directLink_T(711.0,461.0,self.obj50)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj51=paired_with(self)
    self.obj51.isGraphObjectVisual = True

    if(hasattr(self.obj51, '_setHierarchicalLink')):
      self.obj51._setHierarchicalLink(False)

    self.obj51.graphClass_= graph_paired_with
    if self.genGraphics:
       new_obj = graph_paired_with(343.5,361.0,self.obj51)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj54=trace_link(self)
    self.obj54.isGraphObjectVisual = True

    if(hasattr(self.obj54, '_setHierarchicalLink')):
      self.obj54._setHierarchicalLink(False)

    self.obj54.graphClass_= graph_trace_link
    if self.genGraphics:
       new_obj = graph_trace_link(581.0,371.0,self.obj54)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj55=trace_link(self)
    self.obj55.isGraphObjectVisual = True

    if(hasattr(self.obj55, '_setHierarchicalLink')):
      self.obj55._setHierarchicalLink(False)

    self.obj55.graphClass_= graph_trace_link
    if self.genGraphics:
       new_obj = graph_trace_link(841.0,371.0,self.obj55)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj52=hasAttr_S(self)
    self.obj52.isGraphObjectVisual = True

    if(hasattr(self.obj52, '_setHierarchicalLink')):
      self.obj52._setHierarchicalLink(False)

    self.obj52.graphClass_= graph_hasAttr_S
    if self.genGraphics:
       new_obj = graph_hasAttr_S(597.0,195.5,self.obj52)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_hasAttr_S(967.0,195.5,self.obj53)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("hasAttr_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
...
(self.obj35,self.obj49,[581.0, 281.0, 711.0, 281.0],"true", 2),
(self.obj35,self.obj52,[581.0, 281.0, 597.0, 195.5],"true", 2) )
    # Connections for obj36 (graphObject_: Obj1) named s_
    self.drawConnections(
(self.obj36,self.obj53,[841.0, 281.0, 967.0, 195.5],"true", 2) )
    # Connections for obj37 (graphObject_: Obj2) of type MatchModel
    self.drawConnections(
(self.obj37,self.obj51,[341.0, 181.0, 343.5, 361.0],"true", 2),
(self.obj37,self.obj43,[341.0, 181.0, 461.0, 231.0],"true", 2),
(self.obj37,self.obj44,[341.0, 181.0, 591.0, 231.0],"true", 2) )
    # Connections for obj38 (graphObject_: Obj3) of type ApplyModel
    self.drawConnections(
(self.obj38,self.obj45,[346.0, 541.0, 463.5, 501.0],"true", 2),
(self.obj38,self.obj46,[346.0, 541.0, 593.5, 501.0],"true", 2) )
    # Connections for obj39 (graphObject_: Obj4) named s_
    self.drawConnections(
(self.obj39,self.obj50,[581.0, 461.0, 711.0, 461.0],"true", 2),
(self.obj39,self.obj54,[581.0, 461.0, 581.0, 371.0],"true", 2) )
    # Connections for obj40 (graphObject_: Obj5) named s_
    self.drawConnections(
(self.obj40,self.obj55,[841.0, 461.0, 841.0, 371.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj43,self.obj35,[461.0, 231.0, 581.0, 281.0],"true", 2) )
    # Connections for obj44 (graphObject_: Obj9) of type match_contains
    self.drawConnections(
(self.obj44,self.obj36,[591.0, 231.0, 841.0, 281.0],"true", 2) )
    # Connections for obj45 (graphObject_: Obj10) of type apply_contains
    self.drawConnections(
(self.obj45,self.obj39,[463.5, 501.0, 581.0, 461.0],"true", 2) )
    # Connections for obj46 (graphObject_: Obj11) of type apply_contains
    self.drawConnections(
(self.obj46,self.obj40,[593.5, 501.0, 841.0, 461.0],"true", 2) )
    # Connections for obj49 (graphObject_: Obj14) of type indirectLink_S
    self.drawConnections(
(self.obj49,self.obj36,[711.0, 281.0, 841.0, 281.0],"true", 2) )
    # Connections for obj50 (graphObject_: Obj15) of type directLink_T
    self.drawConnections(
(self.obj50,self.obj40,[711.0, 461.0, 841.0, 461.0],"true", 2) )
    # Connections for obj51 (graphObject_: Obj16) of type paired_with
    self.drawConnections(
(self.obj51,self.obj38,[343.5, 361.0, 346.0, 541.0],"true", 2) )
    # Connections for obj54 (graphObject_: Obj19) of type trace_link
    self.drawConnections(
(self.obj54,self.obj35,[581.0, 371.0, 581.0, 281.0],"true", 2) )
    # Connections for obj55 (graphObject_: Obj20) of type trace_link
    self.drawConnections(
(self.obj55,self.obj36,[841.0, 371.0, 841.0, 281.0],"true", 2) )
    # Connections for obj52 (graphObject_: Obj17) of type hasAttr_S
    self.drawConnections(
(self.obj52,self.obj41,[597.0, 195.5, 613.0, 110.0],"true", 2) )
    # Connections for obj53 (graphObject_: Obj18) of type hasAttr_S
    self.drawConnections(
(self.obj53,self.obj42,[967.0, 195.5, 1093.0, 110.0],"true", 2) )

newfunction = SM2SM_complete_MDL
