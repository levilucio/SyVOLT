...
"""
    ...
    def execute(self, packet, match):
        ...
        # Create new edges
        #===============================================================================
        # Station_S1 -> directLink_S20
        graph.add_edges([(labels['1'], labels['20'])])
        # directLink_S20 -> Male_S2
        graph.add_edges([(labels['20'], labels['2'])])
        # Station_T3 -> directLink_T21
        graph.add_edges([(labels['3'], labels['21'])])
        # directLink_T21 -> Male_T4
        graph.add_edges([(labels['21'], labels['4'])])
