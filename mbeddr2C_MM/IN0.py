"""
__IN0.py_____________________________________________________
...
from graph_IN0 import *
class IN0(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['SignalType', 'MetaModelElement_S']
      self.graphClass_ = graph_IN0
