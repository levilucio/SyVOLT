"""
__graph_ImplementationModule_T.py___________________________________________________________
...
class graph_ImplementationModule_T(graphEntity):
...
new_class = graph_ImplementationModule_T
