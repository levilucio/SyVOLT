"""
__graph_Protocol.py___________________________________________________________
...
class graph_Protocol(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([62.0, 35.0, 62.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'Protocol', width = '0', justify= 'left', stipple='' )
        ...
        h = drawing.create_text(self.translate([112.0, 60.0, 112.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
