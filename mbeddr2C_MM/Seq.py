"""
__Seq.py_____________________________________________________
...
class Seq(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['Par', 'MetaModelElement_T']
      self.graphClass_ = graph_Seq
