...
"""
        ...
        # match class GlobarRefExpr() node
                self.add_node()
...
"""
                ...
                self.vs[10]["mm__"] = """MT_pre__GlobarRefExpr"""
...
"""
        ...
        # apply association ReferenceExpr--expression-->GlobarRefExpr node
                self.add_node()
...
"""
        ...
        # apply association GlobarRefExpr--var-->GlobalVariableDeclaration node
                self.add_node()
...
"""
                ...
                (36,10), # association expression  -> apply_class GlobarRefExpr()
                ...
                (10,40), # apply_class GlobarRefExpr() -> association var
