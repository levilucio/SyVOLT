...
class HGlobalVarGetsCorrectFunctionAddress at the initialization_CompleteLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                Creates the himesis graph representing the AToM3 model HGlobalVarGetsCorrectFunctionAddress at the initialization_CompleteLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True

                super(HGlobalVarGetsCorrectFunctionAddress at the initialization_CompleteLHS, self).__init__(name='HGlobalVarGetsCorrectFunctionAddress at the initialization_CompleteLHS', num_nodes=0, edges=[])
...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'GlobalVarGetsCorrectFunctionAddress at the initialization')
...
"""
                ...
                self["equations"] = [((14,'name'),('concat',(('constant','text'),('constant','__wire')))), ((16,'name'),('concat',(('constant','text'),('constant','__init')))), ((21,'name'),('concat',(('constant','text'),('constant','__wire')))), ((22,'name'),('concat',(('constant','text'),(3,'name')))), ((23,'name'),('concat',(('constant','text'),('constant','__ops')))), ((24,'name'),('concat',(('constant','text'),('constant','__idata')))), ((25,'name'),(1,'name')), ]
