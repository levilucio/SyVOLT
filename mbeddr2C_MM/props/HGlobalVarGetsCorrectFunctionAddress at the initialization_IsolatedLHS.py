...
class HGlobalVarGetsCorrectFunctionAddress at the initialization_IsolatedLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
        Creates the himesis graph representing the AToM3 model HGlobalVarGetsCorrectFunctionAddress at the initialization_IsolatedLHS.
                """
        # Flag this instance as compiled now
                self.is_compiled = True
        
                super(HGlobalVarGetsCorrectFunctionAddress at the initialization_IsolatedLHS, self).__init__(name='HGlobalVarGetsCorrectFunctionAddress at the initialization_IsolatedLHS', num_nodes=0, edges=[])
