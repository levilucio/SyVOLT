...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'VerySimple')
...
"""
        ...
        # Nodes that represent the apply associations of the property.
                ...
                self.vs[7]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'blink7')
                ...
                # Add the edges
                self.add_edges([
                (3,6), # apply_class FunctionPrototype() -> backward_association
                (6,1), #  backward_association -> apply_class InstanceConfiguration()
                (2,7), # apply_class Function() -> backward_association
                (7,1), #  backward_association -> apply_class InstanceConfiguration()
                (4,8), # apply_class FunctionPrototype() -> backward_association
                (8,0), #  backward_association -> apply_class ComponentInstance()
                (1,5), # match_class InstanceConfiguration() -> association contents
                (5,0) # association contents  -> match_class ComponentInstance()
                ])
        
                # Add the attribute equations
                self["equations"] = [((2,'name'),('concat',(('wildcard'),('constant','__init')))), ((3,'name'),('concat',(('wildcard'),('constant','__init')))), ((4,'name'),('concat',(('wildcard'),('constant','__wire')))), ]
