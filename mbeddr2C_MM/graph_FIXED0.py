"""
__graph_FIXED0.py___________________________________________________________
...
class graph_FIXED0(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([103.0, 37.0, 103.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'FIXED0', width = '0', justify= 'left', stipple='' )
        self.gf109 = GraphicalForm(drawing, h, 'gf109', fontObject=font)
        self.graphForms.append(self.gf109)
        ...
        self.gf110 = GraphicalForm(drawing, h, 'gf110', fontObject=font)
