"""
__graph_PortConnectorRef.py___________________________________________________________
...
class graph_PortConnectorRef(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([112.0, 35.0, 112.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'PortConnectorRef', width = '0', justify= 'left', stipple='' )
        ...
        h = drawing.create_text(self.translate([70.0, 68.0, 70.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
...
new_class = graph_PortConnectorRef
