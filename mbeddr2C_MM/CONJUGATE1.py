"""
__CONJUGATE1.py_____________________________________________________
...
from graph_CONJUGATE1 import *
class CONJUGATE1(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['PortType', 'MetaModelElement_S']
      self.graphClass_ = graph_CONJUGATE1
   ...
   def clone(self):
      cloneObject = CONJUGATE1( self.parent )
