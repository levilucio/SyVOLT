"""
__graph_ListenBranch.py___________________________________________________________
...
class graph_ListenBranch(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([121.0, 62.0, 121.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'ListenBranch', width = '0', justify= 'left', stipple='' )
