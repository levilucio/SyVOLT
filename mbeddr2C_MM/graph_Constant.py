...
class graph_Constant(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([80.0, 40.0, 80.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'Constant', width = '0', justify= 'left', stipple='' )
        ...
        self.gf131 = GraphicalForm(drawing, h, 'gf131', fontObject=font)
