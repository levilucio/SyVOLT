"""
__hasArgs.py_____________________________________________________
...
class hasArgs(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_hasArgs
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = hasArgs( self.parent )
