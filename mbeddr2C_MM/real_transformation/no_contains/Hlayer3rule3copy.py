...
class Hlayer3rule3copy(Himesis):
    def __init__(self):
        ...
        super(Hlayer3rule3copy, self).__init__(name='Hlayer3rule3copy', num_nodes=0, edges=[])
        
        
        # Set the graph attributes
        self["mm__"] = ['HimesisMM']
        self["name"] = """Hlayer3rule3copy"""
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'Hlayer3rule3copy')
