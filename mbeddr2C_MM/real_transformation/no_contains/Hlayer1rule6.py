...
class Hlayer1rule6(Himesis):
    def __init__(self):
        ...
        # Add the edges
        self.add_edges([
                (0,3), # matchmodel -> match_class ClientServerInterface(layer1rule6class0)
                (0,4), # matchmodel -> match_class ImplementationModule(layer1rule6class5)
                (1,5), # applymodel -> -> apply_class StructDeclaration(layer1rule6class1)
                (1,6), # applymodel -> -> apply_class StructType(layer1rule6class2)
                (4,7), # match_class ImplementationModule(layer1rule6class5) -> association contents
                (7,3), # association contents  -> match_class ClientServerInterface(layer1rule6class0)
                (6,8), # apply_class StructType(layer1rule6class2) -> association struct
                (8,5), # association struct  -> apply_class StructDeclaration(layer1rule6class1)
                (6,9), # apply_class StructType(layer1rule6class2) -> backward_association
                (9,4), #  backward_association -> apply_class ImplementationModule(layer1rule6class5)
                (5,10), # apply_class StructDeclaration(layer1rule6class1) -> backward_association
        ...
        self["equations"] = [((5,'__ApplyAttribute'),('constant','ClientServerStructIData')), ((6,'__ApplyAttribute'),('constant','TypeDefInterfaceStructType')), ]
