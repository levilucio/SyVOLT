...
class Hlayer1rule9(Himesis):
    def __init__(self):
        ...
        self.vs[2]["rulename"] = """layer1rule9"""
        ...
        self.add_edges([
                ...
                (7,13), # apply_class StructDeclaration(layer1rule9class1) -> backward_association
                (13,3), #  backward_association -> apply_class AtomicComponent(layer1rule9class0)
                (9,14), # apply_class StructType(layer1rule9class2) -> backward_association
