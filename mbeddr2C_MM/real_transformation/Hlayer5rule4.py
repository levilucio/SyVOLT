...
a.""")
        ...
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4matchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4applymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4pairedwith2')
        ...
        #self.vs[3]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class0')
    	# match_contains node for class TestCase(layer5rule4class0)
        self.add_node()
        self.vs[4]["mm__"] = """match_contains"""
        #self.vs[4]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class0matchcontains4')
        ...
        #self.vs[5]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class1')
    	# match_contains node for class StatementList(layer5rule4class1)
        self.add_node()
        self.vs[6]["mm__"] = """match_contains"""
        #self.vs[6]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class1matchcontains6')
        ...
        #self.vs[7]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class2')
    	# match_contains node for class ExpressionStatement(layer5rule4class2)
        self.add_node()
        self.vs[8]["mm__"] = """match_contains"""
        #self.vs[8]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class2matchcontains8')
        ...
        #self.vs[9]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class3')
    	# match_contains node for class PortAdapterOpCallExpr(layer5rule4class3)
        self.add_node()
        self.vs[10]["mm__"] = """match_contains"""
        #self.vs[10]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class3matchcontains10')
        ...
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class4')
    	# match_contains node for class PortAdapterRefExpr(layer5rule4class4)
        self.add_node()
        self.vs[12]["mm__"] = """match_contains"""
        #self.vs[12]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class4matchcontains12')
        ...
        #self.vs[13]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class5')
    	# match_contains node for class PortAdapter(layer5rule4class5)
        self.add_node()
        self.vs[14]["mm__"] = """match_contains"""
        #self.vs[14]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class5matchcontains14')
        ...
        #self.vs[15]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class6')
    	# match_contains node for class Operation(layer5rule4class6)
        self.add_node()
        self.vs[16]["mm__"] = """match_contains"""
        #self.vs[16]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class6matchcontains16')
        ...
        #self.vs[17]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class7')
    	# match_contains node for class AdapterInstancePortRef(layer5rule4class7)
        self.add_node()
        self.vs[18]["mm__"] = """match_contains"""
        #self.vs[18]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class7matchcontains18')
        ...
        #self.vs[19]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class8')
    	# match_contains node for class ComponentInstance(layer5rule4class8)
        self.add_node()
        self.vs[20]["mm__"] = """match_contains"""
        #self.vs[20]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class8matchcontains20')
        ...
        #self.vs[21]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class9')
    	# match_contains node for class ProvidedPort(layer5rule4class9)
        self.add_node()
        self.vs[22]["mm__"] = """match_contains"""
        #self.vs[22]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class9matchcontains22')
        ...
        #self.vs[23]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class10')
    	# match_contains node for class ClientServerInterface(layer5rule4class10)
        self.add_node()
        self.vs[24]["mm__"] = """match_contains"""
        #self.vs[24]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class10matchcontains24')
        ...
        #self.vs[25]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class11')
    	# apply_contains node for class StatementList(layer5rule4class11)
        self.add_node()
        self.vs[26]["mm__"] = """apply_contains"""
        #self.vs[26]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class11applycontains26')
        ...
        #self.vs[27]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class12')
    	# apply_contains node for class ExpressionStatement(layer5rule4class12)
        self.add_node()
        self.vs[28]["mm__"] = """apply_contains"""
        #self.vs[28]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class12applycontains28')
        ...
        #self.vs[29]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class13')
    	# apply_contains node for class FunctionCall(layer5rule4class13)
        self.add_node()
        self.vs[30]["mm__"] = """apply_contains"""
        #self.vs[30]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class13applycontains30')
        ...
        #self.vs[31]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class14')
    	# apply_contains node for class FunctionPrototype(layer5rule4class14)
        self.add_node()
        self.vs[32]["mm__"] = """apply_contains"""
        #self.vs[32]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class14applycontains32')
        ...
        #self.vs[33]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class15')
    	# apply_contains node for class ReferenceExpr(layer5rule4class15)
        self.add_node()
        self.vs[34]["mm__"] = """apply_contains"""
        #self.vs[34]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class15applycontains34')
        ...
        #self.vs[35]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class16')
    	# apply_contains node for class GlobalVarRef(layer5rule4class16)
        self.add_node()
        self.vs[36]["mm__"] = """apply_contains"""
        #self.vs[36]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class16applycontains36')
        ...
        #self.vs[37]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class17')
    	# apply_contains node for class GlobalVariableDeclaration(layer5rule4class17)
        self.add_node()
        self.vs[38]["mm__"] = """apply_contains"""
        #self.vs[38]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class17applycontains38')
        ...
        #self.vs[39]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class0assoc39layer5rule4class1')
        ...
        #self.vs[40]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class1assoc40layer5rule4class2')
        ...
        #self.vs[41]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class2assoc41layer5rule4class3')
        ...
        #self.vs[42]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class3assoc42layer5rule4class4')
        ...
        #self.vs[43]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class4assoc43layer5rule4class5')
        ...
        #self.vs[44]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class3assoc44layer5rule4class6')
        ...
        #self.vs[45]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class5assoc45layer5rule4class7')
        ...
        #self.vs[46]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class7assoc46layer5rule4class8')
        ...
        #self.vs[47]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class7assoc47layer5rule4class9')
        ...
        #self.vs[48]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class9assoc48layer5rule4class10')
        ...
        #self.vs[49]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class10assoc49layer5rule4class6')
        ...
        #self.vs[50]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class11assoc50layer5rule4class12')
    	# apply association ExpressionStatement--expr-->FunctionCall node
    	self.add_node()
    	self.vs[51]["associationType"] = """expr"""
        self.vs[51]["mm__"] = """directLink_T"""
        #self.vs[51]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class12assoc51layer5rule4class13')
        ...
        #self.vs[52]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class13assoc52layer5rule4class14')
    	# apply association FunctionCall--actuals-->ReferenceExpr node
    	self.add_node()
    	self.vs[53]["associationType"] = """actuals"""
        self.vs[53]["mm__"] = """directLink_T"""
        #self.vs[53]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class13assoc53layer5rule4class15')
        ...
        #self.vs[54]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class15assoc54layer5rule4class16')
        ...
        #self.vs[55]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class16assoc55layer5rule4class17')
        
    	# backward association TestCase---->StatementList node
    	self.add_node()
    	self.vs[56]["type"] = """ruleDef"""
        self.vs[56]["mm__"] = """backward_link"""
        #self.vs[56]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class0blink56layer5rule4class11')
    	# backward association ProvidedPort---->FunctionPrototype node
    	self.add_node()
    	self.vs[57]["type"] = """ruleDef"""
        self.vs[57]["mm__"] = """backward_link"""
        #self.vs[57]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class9blink57layer5rule4class14')
        ...
        #self.vs[58]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer5rule4class8blink58layer5rule4class17')
