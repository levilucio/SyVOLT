...
a.""")
        ...
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer1rule7matchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer1rule7applymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer1rule7pairedwith2')
        
    	# match class ImplementationModule(layer1rule7class0) node
    	self.add_node()
    	self.vs[3]["name"] = """layer1rule7class0"""
        self.vs[3]["classtype"] = """ImplementationModule"""
        self.vs[3]["mm__"] = """ImplementationModule"""
        self.vs[3]["cardinality"] = """+"""
        #self.vs[3]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer1rule7class0')
    	# match_contains node for class ImplementationModule(layer1rule7class0)
        self.add_node()
        self.vs[4]["mm__"] = """match_contains"""
        #self.vs[4]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer1rule7class0matchcontains4')
    	# match class AtomicComponent(layer1rule7class1) node
    	self.add_node()
    	self.vs[5]["name"] = """layer1rule7class1"""
        self.vs[5]["classtype"] = """AtomicComponent"""
        self.vs[5]["mm__"] = """AtomicComponent"""
        self.vs[5]["cardinality"] = """+"""
        #self.vs[5]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer1rule7class1')
    	# match_contains node for class AtomicComponent(layer1rule7class1)
        self.add_node()
        self.vs[6]["mm__"] = """match_contains"""
        #self.vs[6]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer1rule7class1matchcontains6')
        
        
    	# apply class ImplementationModule(layer1rule7class2) node
    	self.add_node()
    	self.vs[7]["name"] = """layer1rule7class2"""
        self.vs[7]["classtype"] = """ImplementationModule"""
        self.vs[7]["mm__"] = """ImplementationModule"""
        self.vs[7]["cardinality"] = """1"""
        #self.vs[7]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer1rule7class2')
    	# apply_contains node for class ImplementationModule(layer1rule7class2)
        self.add_node()
        self.vs[8]["mm__"] = """apply_contains"""
        #self.vs[8]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer1rule7class2applycontains8')
    	# apply class StructDeclaration(layer1rule7class3) node
    	self.add_node()
    	self.vs[9]["name"] = """layer1rule7class3"""
        self.vs[9]["classtype"] = """StructDeclaration"""
        self.vs[9]["mm__"] = """StructDeclaration"""
        self.vs[9]["cardinality"] = """1"""
        #self.vs[9]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer1rule7class3')
    	# apply_contains node for class StructDeclaration(layer1rule7class3)
        self.add_node()
        self.vs[10]["mm__"] = """apply_contains"""
        #self.vs[10]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer1rule7class3applycontains10')
        ...
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer1rule7class0assoc11layer1rule7class1')
        
    	# apply association ImplementationModule--contents-->StructDeclaration node
    	self.add_node()
    	self.vs[12]["associationType"] = """contents"""
        self.vs[12]["mm__"] = """directLink_T"""
        #self.vs[12]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer1rule7class2assoc12layer1rule7class3')
        
    	# backward association ImplementationModule---->ImplementationModule node
    	self.add_node()
    	self.vs[13]["type"] = """ruleDef"""
        self.vs[13]["mm__"] = """backward_link"""
        #self.vs[13]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer1rule7class0blink13layer1rule7class2')
    	# backward association AtomicComponent---->StructDeclaration node
    	self.add_node()
    	self.vs[14]["type"] = """ruleDef"""
        self.vs[14]["mm__"] = """backward_link"""
        #self.vs[14]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'layer1rule7class1blink14layer1rule7class3')
