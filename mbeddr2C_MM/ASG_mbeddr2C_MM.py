"""
__ASG_mbeddr2C_MM.py_____________________________________________________
...
class ASG_mbeddr2C_MM(ASG, ATOM3Type):
   ...
   def open(self, parent, topWindowParent):
       from ATOM3 import *
       a = ATOM3(topWindowParent, 'mbeddr2C_MM', 0, 1, self)
