"""
__Condition.py_____________________________________________________
...
class Condition(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['Proc', 'ConditionBranch', 'MetaModelElement_T']
      self.graphClass_ = graph_Condition
   ...
   def clone(self):
      cloneObject = Condition( self.parent )
