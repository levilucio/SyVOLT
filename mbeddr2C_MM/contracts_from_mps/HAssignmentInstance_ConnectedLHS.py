...
class HAssignmentInstance_ConnectedLHS(HimesisPreConditionPatternLHS):
	def __init__(self):
		...
		self.vs[9]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.1.m.0AssemblyConnectorassoc90.1.m.1InstancePortRef')
		...
		self.vs[10]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.1.m.1InstancePortRefassoc100.1.m.2ComponentInstance')
		...
		self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.1.m.1InstancePortRefassoc110.1.m.3RequiredPort')
		...
		self.vs[12]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.1.m.2ComponentInstanceassoc120.1.m.4AtomicComponent')
		...
		self.vs[13]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.1.m.4AtomicComponentassoc130.1.m.3RequiredPort')
		...
		self.vs[14]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.1.m.0AssemblyConnectorassoc140.1.m.5InstancePortRef')
		...
		self.vs[15]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.1.m.5InstancePortRefassoc150.1.m.6ComponentInstance')
		...
		self.vs[16]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.1.m.5InstancePortRefassoc160.1.m.7ProvidedPort')
		...
		self.vs[17]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.1.m.6ComponentInstanceassoc170.1.m.8AtomicComponent')
		...
		self.vs[18]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.1.m.8AtomicComponentassoc180.1.m.7ProvidedPort')

		# Add the edges
		self.add_edges([
			(0,9), # match class AssemblyConnector(0.1.m.0AssemblyConnector) -> association source
			(9,1), # association InstancePortRef -> match class InstancePortRef(0.1.m.1InstancePortRef)
			(1,10), # match class InstancePortRef(0.1.m.1InstancePortRef) -> association instance
			(10,2), # association ComponentInstance -> match class ComponentInstance(0.1.m.2ComponentInstance)
			(1,11), # match class InstancePortRef(0.1.m.1InstancePortRef) -> association port
			(11,3), # association RequiredPort -> match class RequiredPort(0.1.m.3RequiredPort)
			(2,12), # match class ComponentInstance(0.1.m.2ComponentInstance) -> association component
			(12,4), # association AtomicComponent -> match class AtomicComponent(0.1.m.4AtomicComponent)
			(4,13), # match class AtomicComponent(0.1.m.4AtomicComponent) -> association contents
			(13,3), # association RequiredPort -> match class RequiredPort(0.1.m.3RequiredPort)
			(0,14), # match class AssemblyConnector(0.1.m.0AssemblyConnector) -> association target
			(14,5), # association InstancePortRef -> match class InstancePortRef(0.1.m.5InstancePortRef)
			(5,15), # match class InstancePortRef(0.1.m.5InstancePortRef) -> association instance
			(15,6), # association ComponentInstance -> match class ComponentInstance(0.1.m.6ComponentInstance)
			(5,16), # match class InstancePortRef(0.1.m.5InstancePortRef) -> association port
			(16,7), # association ProvidedPort -> match class ProvidedPort(0.1.m.7ProvidedPort)
			(6,17), # match class ComponentInstance(0.1.m.6ComponentInstance) -> association component
			(17,8), # association AtomicComponent -> match class AtomicComponent(0.1.m.8AtomicComponent)
			(8,18), # match class AtomicComponent(0.1.m.8AtomicComponent) -> association contents
			(18,7), # association ProvidedPort -> match class ProvidedPort(0.1.m.7ProvidedPort)
		])
