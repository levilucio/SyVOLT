...
class HAssignmentInstance2_CompleteLHS(HimesisPreConditionPatternLHS):
	def __init__(self):
		...
		# apply class GenericDotExpression(0.3.a.0GenericDotExpression) node
		self.add_node()
		self.vs[9]["MT_pre__attr1"] = """return True"""
		self.vs[9]["MT_label__"] = """10"""
		self.vs[9]["mm__"] = """MT_pre__GenericDotExpression"""
		self.vs[9]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.0GenericDotExpression')

		# apply class GlobalVarRef(0.3.a.1GlobalVarRef) node
		self.add_node()
		self.vs[10]["MT_pre__attr1"] = """return True"""
		self.vs[10]["MT_label__"] = """11"""
		self.vs[10]["mm__"] = """MT_pre__GlobalVarRef"""
		self.vs[10]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.1GlobalVarRef')

		# apply class GlobalVariableDeclaration(0.3.a.2GlobalVariableDeclaration) node
		self.add_node()
		self.vs[11]["MT_pre__attr1"] = """return True"""
		self.vs[11]["MT_label__"] = """12"""
		self.vs[11]["mm__"] = """MT_pre__GlobalVariableDeclaration"""
		self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.2GlobalVariableDeclaration')

		# apply class ReferenceExpr(0.3.a.3ReferenceExpr) node
		self.add_node()
		self.vs[12]["MT_pre__attr1"] = """return True"""
		self.vs[12]["MT_label__"] = """13"""
		self.vs[12]["mm__"] = """MT_pre__ReferenceExpr"""
		self.vs[12]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.3ReferenceExpr')

		# apply class GenericMemberRef(0.3.a.4GenericMemberRef) node
		self.add_node()
		self.vs[13]["MT_pre__attr1"] = """return True"""
		self.vs[13]["MT_label__"] = """14"""
		self.vs[13]["mm__"] = """MT_pre__GenericMemberRef"""
		self.vs[13]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.4GenericMemberRef')

		# apply class GlobalVariableDeclaration(0.3.a.5GlobalVariableDeclaration) node
		self.add_node()
		self.vs[14]["MT_pre__attr1"] = """return True"""
		self.vs[14]["MT_label__"] = """15"""
		self.vs[14]["mm__"] = """MT_pre__GlobalVariableDeclaration"""
		self.vs[14]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.5GlobalVariableDeclaration')

		# apply class GlobalVarRef(0.3.a.6GlobalVarRef) node
		self.add_node()
		self.vs[15]["MT_pre__attr1"] = """return True"""
		self.vs[15]["MT_label__"] = """16"""
		self.vs[15]["mm__"] = """MT_pre__GlobalVarRef"""
		self.vs[15]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.6GlobalVarRef')

		# apply class AssignmentExpr(0.3.a.7AssignmentExpr) node
		self.add_node()
		self.vs[16]["MT_pre__attr1"] = """return True"""
		self.vs[16]["MT_label__"] = """17"""
		self.vs[16]["mm__"] = """MT_pre__AssignmentExpr"""
		self.vs[16]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.7AssignmentExpr')

		# apply class StructDeclaration(0.3.a.8StructDeclaration) node
		self.add_node()
		self.vs[17]["MT_pre__attr1"] = """return True"""
		self.vs[17]["MT_label__"] = """18"""
		self.vs[17]["mm__"] = """MT_pre__StructDeclaration"""
		self.vs[17]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.8StructDeclaration')

		# apply class Member(0.3.a.9Member) node
		self.add_node()
		self.vs[18]["MT_pre__attr1"] = """return True"""
		self.vs[18]["MT_label__"] = """19"""
		self.vs[18]["mm__"] = """MT_pre__Member"""
		self.vs[18]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.9Member')

		# apply class TypeDefType(0.3.a.10TypeDefType) node
		self.add_node()
		self.vs[19]["MT_pre__attr1"] = """return True"""
		self.vs[19]["MT_label__"] = """20"""
		self.vs[19]["mm__"] = """MT_pre__TypeDefType"""
		self.vs[19]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.10TypeDefType')

		# apply class TypeDef(0.3.a.11TypeDef) node
		self.add_node()
		self.vs[20]["MT_pre__attr1"] = """return True"""
		self.vs[20]["MT_label__"] = """21"""
		self.vs[20]["mm__"] = """MT_pre__TypeDef"""
		self.vs[20]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.11TypeDef')

		# apply class StructType(0.3.a.12StructType) node
		self.add_node()
		self.vs[21]["MT_pre__attr1"] = """return True"""
		self.vs[21]["MT_label__"] = """22"""
		self.vs[21]["mm__"] = """MT_pre__StructType"""
		self.vs[21]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.12StructType')
		...
		self.vs[22]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.m.0AssemblyConnectorassoc220.3.m.1InstancePortRef')
		...
		self.vs[23]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.m.1InstancePortRefassoc230.3.m.2ComponentInstance')
		...
		self.vs[24]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.m.1InstancePortRefassoc240.3.m.3RequiredPort')
		...
		self.vs[25]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.m.2ComponentInstanceassoc250.3.m.4AtomicComponent')
		...
		self.vs[26]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.m.4AtomicComponentassoc260.3.m.3RequiredPort')
		...
		self.vs[27]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.m.0AssemblyConnectorassoc270.3.m.5InstancePortRef')
		...
		self.vs[28]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.m.5InstancePortRefassoc280.3.m.6ComponentInstance')
		...
		self.vs[29]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.m.5InstancePortRefassoc290.3.m.7ProvidedPort')
		...
		self.vs[30]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.m.6ComponentInstanceassoc300.3.m.8AtomicComponent')
		...
		self.vs[31]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.m.8AtomicComponentassoc310.3.m.7ProvidedPort')
		...
		self.vs[32]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.7AssignmentExprassoc320.3.a.0GenericDotExpression')
		...
		self.vs[33]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.7AssignmentExprassoc330.3.a.3ReferenceExpr')
		...
		self.vs[34]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.0GenericDotExpressionassoc340.3.a.6GlobalVarRef')
		...
		self.vs[35]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.0GenericDotExpressionassoc350.3.a.4GenericMemberRef')
		...
		self.vs[36]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.3ReferenceExprassoc360.3.a.1GlobalVarRef')
		...
		self.vs[37]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.6GlobalVarRefassoc370.3.a.2GlobalVariableDeclaration')
		...
		self.vs[38]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.4GenericMemberRefassoc380.3.a.9Member')
		...
		self.vs[39]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.8StructDeclarationassoc390.3.a.9Member')
		...
		self.vs[40]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.1GlobalVarRefassoc400.3.a.5GlobalVariableDeclaration')
		...
		self.vs[41]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.2GlobalVariableDeclarationassoc410.3.a.10TypeDefType')
		...
		self.vs[42]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.10TypeDefTypeassoc420.3.a.11TypeDef')
		...
		self.vs[43]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.11TypeDefassoc430.3.a.12StructType')
		...
		self.vs[44]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.12StructTypeassoc440.3.a.8StructDeclaration')
		...
		self.vs[45]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.2GlobalVariableDeclarationassoc450.3.m.2ComponentInstance')

		# trace association StructDeclaration--trace-->AtomicComponentnode
		self.add_node()
		self.vs[46]["MT_label__"] = """47"""
		self.vs[46]["mm__"] = """MT_pre__trace_link"""
		self.vs[46]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.8StructDeclarationassoc460.3.m.4AtomicComponent')

		# trace association GlobalVariableDeclaration--trace-->ComponentInstancenode
		self.add_node()
		self.vs[47]["MT_label__"] = """48"""
		self.vs[47]["mm__"] = """MT_pre__trace_link"""
		self.vs[47]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.5GlobalVariableDeclarationassoc470.3.m.6ComponentInstance')

		# trace association Member--trace-->RequiredPortnode
		self.add_node()
		self.vs[48]["MT_label__"] = """49"""
		self.vs[48]["mm__"] = """MT_pre__trace_link"""
		self.vs[48]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'0.3.a.9Memberassoc480.3.m.3RequiredPort')
		...
		# Add the edges
		self.add_edges([
			(0,22), # match class AssemblyConnector(0.3.m.0AssemblyConnector) -> association source
			(22,1), # association InstancePortRef -> match class InstancePortRef(0.3.m.1InstancePortRef)
			(1,23), # match class InstancePortRef(0.3.m.1InstancePortRef) -> association instance
			(23,2), # association ComponentInstance -> match class ComponentInstance(0.3.m.2ComponentInstance)
			(1,24), # match class InstancePortRef(0.3.m.1InstancePortRef) -> association port
			(24,3), # association RequiredPort -> match class RequiredPort(0.3.m.3RequiredPort)
			(2,25), # match class ComponentInstance(0.3.m.2ComponentInstance) -> association component
			(25,4), # association AtomicComponent -> match class AtomicComponent(0.3.m.4AtomicComponent)
			(4,26), # match class AtomicComponent(0.3.m.4AtomicComponent) -> association contents
			(26,3), # association RequiredPort -> match class RequiredPort(0.3.m.3RequiredPort)
			(0,27), # match class AssemblyConnector(0.3.m.0AssemblyConnector) -> association target
			(27,5), # association InstancePortRef -> match class InstancePortRef(0.3.m.5InstancePortRef)
			(5,28), # match class InstancePortRef(0.3.m.5InstancePortRef) -> association instance
			(28,6), # association ComponentInstance -> match class ComponentInstance(0.3.m.6ComponentInstance)
			(5,29), # match class InstancePortRef(0.3.m.5InstancePortRef) -> association port
			(29,7), # association ProvidedPort -> match class ProvidedPort(0.3.m.7ProvidedPort)
			(6,30), # match class ComponentInstance(0.3.m.6ComponentInstance) -> association component
			(30,8), # association AtomicComponent -> match class AtomicComponent(0.3.m.8AtomicComponent)
			(8,31), # match class AtomicComponent(0.3.m.8AtomicComponent) -> association contents
			(31,7), # association ProvidedPort -> match class ProvidedPort(0.3.m.7ProvidedPort)
			(16,32), # apply class AssignmentExpr(0.3.a.7AssignmentExpr) -> association left
			(32,9), # association GenericDotExpression -> apply class GenericDotExpression(0.3.a.0GenericDotExpression)
			(16,33), # apply class AssignmentExpr(0.3.a.7AssignmentExpr) -> association right
			(33,12), # association ReferenceExpr -> apply class ReferenceExpr(0.3.a.3ReferenceExpr)
			(9,34), # apply class GenericDotExpression(0.3.a.0GenericDotExpression) -> association expression
			(34,15), # association GlobalVarRef -> apply class GlobalVarRef(0.3.a.6GlobalVarRef)
			(9,35), # apply class GenericDotExpression(0.3.a.0GenericDotExpression) -> association target
			(35,13), # association GenericMemberRef -> apply class GenericMemberRef(0.3.a.4GenericMemberRef)
			(12,36), # apply class ReferenceExpr(0.3.a.3ReferenceExpr) -> association expression
			(36,10), # association GlobalVarRef -> apply class GlobalVarRef(0.3.a.1GlobalVarRef)
			(15,37), # apply class GlobalVarRef(0.3.a.6GlobalVarRef) -> association var
			(37,11), # association GlobalVariableDeclaration -> apply class GlobalVariableDeclaration(0.3.a.2GlobalVariableDeclaration)
			(13,38), # apply class GenericMemberRef(0.3.a.4GenericMemberRef) -> association member
			(38,18), # association Member -> apply class Member(0.3.a.9Member)
			(17,39), # apply class StructDeclaration(0.3.a.8StructDeclaration) -> association members
			(39,18), # association Member -> apply class Member(0.3.a.9Member)
			(10,40), # apply class GlobalVarRef(0.3.a.1GlobalVarRef) -> association var
			(40,14), # association GlobalVariableDeclaration -> apply class GlobalVariableDeclaration(0.3.a.5GlobalVariableDeclaration)
			(11,41), # apply class GlobalVariableDeclaration(0.3.a.2GlobalVariableDeclaration) -> association type
			(41,19), # association TypeDefType -> apply class TypeDefType(0.3.a.10TypeDefType)
			(19,42), # apply class TypeDefType(0.3.a.10TypeDefType) -> association typeDef
			(42,20), # association TypeDef -> apply class TypeDef(0.3.a.11TypeDef)
			(20,43), # apply class TypeDef(0.3.a.11TypeDef) -> association original
			(43,21), # association StructType -> apply class StructType(0.3.a.12StructType)
			(21,44), # apply class StructType(0.3.a.12StructType) -> association struct
			(44,17), # association StructDeclaration -> apply class StructDeclaration(0.3.a.8StructDeclaration)
			(11,45), # apply class GlobalVariableDeclaration(0.3.m.2ComponentInstance) -> backward_association 
			(45,2), # backward_associationComponentInstance -> match_class ComponentInstance(0.3.m.2ComponentInstance)
			(17,46), # apply class StructDeclaration(0.3.m.4AtomicComponent) -> backward_association 
			(46,4), # backward_associationAtomicComponent -> match_class AtomicComponent(0.3.m.4AtomicComponent)
			(14,47), # apply class GlobalVariableDeclaration(0.3.m.6ComponentInstance) -> backward_association 
			(47,6), # backward_associationComponentInstance -> match_class ComponentInstance(0.3.m.6ComponentInstance)
			(18,48), # apply class Member(0.3.m.3RequiredPort) -> backward_association 
			(48,3), # backward_associationRequiredPort -> match_class RequiredPort(0.3.m.3RequiredPort)
		])
