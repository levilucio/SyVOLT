"""
__PortConnectorRef.py_____________________________________________________
...
from graph_PortConnectorRef import *
class PortConnectorRef(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['Element', 'MetaModelElement_S']
      self.graphClass_ = graph_PortConnectorRef
   ...
   def clone(self):
      cloneObject = PortConnectorRef( self.parent )
