"""
__graph_PortRef.py___________________________________________________________
...
class graph_PortRef(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([58.0, 37.0, 58.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'PortRef', width = '0', justify= 'left', stipple='' )
