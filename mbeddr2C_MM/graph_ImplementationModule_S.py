"""
__graph_ImplementationModule_S.py___________________________________________________________
...
class graph_ImplementationModule_S(graphEntity):
...
new_class = graph_ImplementationModule_S
