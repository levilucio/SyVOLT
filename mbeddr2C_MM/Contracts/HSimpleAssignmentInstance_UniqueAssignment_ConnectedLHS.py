...
class HSimpleAssignmentInstance_UniqueAssignment_ConnectedLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                Creates the himesis graph representing the AToM3 model HSimpleAssignmentInstance_UniqueAssignment_ConnectedLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True
        
                super(HSimpleAssignmentInstance_UniqueAssignment_ConnectedLHS, self).__init__(name='HSimpleAssignmentInstance_UniqueAssignment_ConnectedLHS', num_nodes=0, edges=[])
...
"""
        ...
        # Add the edges
                self.add_edges([
                (0,2), # match_class AssemblyConnector() -> association source
                (2,1) # association source  -> match_class InstancePortRef()
        ])
