...
class HSimpleAssignmentInstance_UniqueAssignment_IsolatedLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
        Creates the himesis graph representing the AToM3 model HSimpleAssignmentInstance_UniqueAssignment_IsolatedLHS.
                """
        # Flag this instance as compiled now
                self.is_compiled = True
        
                super(HSimpleAssignmentInstance_UniqueAssignment_IsolatedLHS, self).__init__(name='HSimpleAssignmentInstance_UniqueAssignment_IsolatedLHS', num_nodes=0, edges=[])
