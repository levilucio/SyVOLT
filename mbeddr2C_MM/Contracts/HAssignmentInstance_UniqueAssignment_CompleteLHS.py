...
class HAssignmentInstance_UniqueAssignment_CompleteLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                Creates the himesis graph representing the AToM3 model HAssignmentInstance_UniqueAssignment_CompleteLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True

                super(HAssignmentInstance_UniqueAssignment_CompleteLHS, self).__init__(name='HAssignmentInstance_UniqueAssignment_CompleteLHS', num_nodes=0, edges=[])
...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'AssignmentInstance_UniqueAssignment')
...
"""
                ...
                # Add the edges
                self.add_edges([
                (14,45), # apply_class GlobalVariableDeclaration() -> backward_association
                (45,7), #  backward_association -> apply_class ProvidedPort()
