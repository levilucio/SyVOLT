...
class HRulelayer1rule10_holds_CompleteLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                Creates the himesis graph representing the AToM3 model HRulelayer1rule10_holds_CompleteLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True

                super(HRulelayer1rule10_holds_CompleteLHS, self).__init__(name='HRulelayer1rule10_holds_CompleteLHS', num_nodes=0, edges=[])
...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'Rulelayer1rule10_holds')
...
"""
                ...
                self.vs[0]["mm__"] = """MT_pre__RequiredPort"""
...
"""
                ...
                self.vs[1]["mm__"] = """MT_pre__AtomicComponent"""
...
"""
                ...
                self.vs[2]["mm__"] = """MT_pre__StructDeclaration"""
...
"""
                ...
                # Add the edges
                self.add_edges([
                (2,5), # apply_class StructDeclaration() -> association members
                (5,3), # association members  -> apply_class Member()
                (1,4), # match_class AtomicComponent() -> association contents
                (4,0) # association contents  -> match_class RequiredPort()
                ])
        
                # Add the attribute equations
                self["equations"] = [((2,'name'),('concat',(('wildcard'),('constant','__cdata')))), ((3,'name'),('concat',(('wildcard'),('constant','__ops')))), ]
