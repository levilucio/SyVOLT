"""
__Module.py_____________________________________________________
...
class Module(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['ProcDef', 'MetaModelElement_T']
      self.graphClass_ = graph_Module
   ...
   def clone(self):
      cloneObject = Module( self.parent )
