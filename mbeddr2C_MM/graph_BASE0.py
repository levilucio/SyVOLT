"""
__graph_BASE0.py___________________________________________________________
...
class graph_BASE0(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([90.0, 40.0, 90.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'BASE0', width = '0', justify= 'left', stipple='' )
        ...
        self.gf95 = GraphicalForm(drawing, h, 'gf95', fontObject=font)
