"""
__StateMachine.py_____________________________________________________
...
class StateMachine(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['NamedElement', 'MetaModelElement_S']
      self.graphClass_ = graph_StateMachine
   ...
   def clone(self):
      cloneObject = StateMachine( self.parent )
