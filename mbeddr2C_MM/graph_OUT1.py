"""
__graph_OUT1.py___________________________________________________________
...
class graph_OUT1(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([105.0, 42.0, 105.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'OUT1', width = '0', justify= 'left', stipple='' )
        self.gf106 = GraphicalForm(drawing, h, 'gf106', fontObject=font)
        ...
        self.gf107 = GraphicalForm(drawing, h, 'gf107', fontObject=font)
