"""
__Function.py_____________________________________________________
...
class Function(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['Element', 'MetaModelElement_S']
      self.graphClass_ = graph_Function
   ...
   def clone(self):
      cloneObject = Function( self.parent )
