...
class Hlayer0rule4(Himesis):
	def __init__(self):
		...
		# match class VoidType(layer0rule4class0VoidType) node
		self.add_node()
		self.vs[3]["mm__"] = """VoidType"""
		self.vs[3]["attr1"] = """+"""

		# apply class VoidType(layer0rule4class1VoidType) node
		self.add_node()
		...
		# Add the edges
		self.add_edges([
			(0,3), # matchmodel -> match_class VoidType(layer0rule4class0VoidType)
			(1,4), # applymodel -> apply_classVoidType(layer0rule4class1VoidType)
