"""
__PythonRef.py_____________________________________________________
...
from graph_PythonRef import *
class PythonRef(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['FunctionPrototype', 'MetaModelElement_T']
      self.graphClass_ = graph_PythonRef
   ...
   def clone(self):
      cloneObject = PythonRef( self.parent )
