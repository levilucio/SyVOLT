"""
__hasAttribute_S.py_____________________________________________________
...
class hasAttribute_S(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_hasAttribute_S
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = hasAttribute_S( self.parent )
