"""
__graph_Proc.py___________________________________________________________
...
class graph_Proc(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([112.0, 61.0, 112.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'Proc', width = '0', justify= 'left', stipple='' )
        ...
        h = drawing.create_text(self.translate([111.0, 90.0, 111.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
