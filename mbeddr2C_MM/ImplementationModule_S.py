"""
__ImplementationModule_S.py_____________________________________________________
...
class ImplementationModule_S(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['Element', 'MetaModelElement_S']
      self.graphClass_ = graph_ImplementationModule_S
   ...
   def clone(self):
      cloneObject = ImplementationModule_S( self.parent )
