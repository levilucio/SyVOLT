"""
__graph_InitialPoint.py___________________________________________________________
...
class graph_InitialPoint(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([96.0, 40.0, 96.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'InitialPoint', width = '0', justify= 'left', stipple='' )
        ...
        h = drawing.create_text(self.translate([98.0, 65.0, 98.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
