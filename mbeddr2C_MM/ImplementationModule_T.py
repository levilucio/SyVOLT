"""
__ImplementationModule_T.py_____________________________________________________
...
class ImplementationModule_T(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MetaModelElement_T']
      self.graphClass_ = graph_ImplementationModule_T
   ...
   def clone(self):
      cloneObject = ImplementationModule_T( self.parent )
