"""
__InitialPoint.py_____________________________________________________
...
from graph_InitialPoint import *
class InitialPoint(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['Vertex', 'MetaModelElement_S']
      self.graphClass_ = graph_InitialPoint
   ...
   def clone(self):
      cloneObject = InitialPoint( self.parent )
