"""
__SignalType.py_____________________________________________________
...
from graph_SignalType import *
class SignalType(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MetaModelElement_S']
      self.graphClass_ = graph_SignalType
   ...
   def clone(self):
      cloneObject = SignalType( self.parent )
