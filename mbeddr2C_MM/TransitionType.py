"""
__TransitionType.py_____________________________________________________
...
from graph_TransitionType import *
class TransitionType(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MetaModelElement_S']
      self.graphClass_ = graph_TransitionType
   ...
   def clone(self):
      cloneObject = TransitionType( self.parent )
