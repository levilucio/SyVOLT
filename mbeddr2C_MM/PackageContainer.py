"""
__PackageContainer.py_____________________________________________________
...
from graph_PackageContainer import *
class PackageContainer(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['NamedElement', 'MetaModelElement_S']
      self.graphClass_ = graph_PackageContainer
   ...
   def clone(self):
      cloneObject = PackageContainer( self.parent )
