"""
__Thread.py_____________________________________________________
...
class Thread(ASGNode, ATOM3Type):
   ...
   def clone(self):
      cloneObject = Thread( self.parent )
