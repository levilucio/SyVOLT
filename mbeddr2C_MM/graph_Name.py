"""
__graph_Name.py___________________________________________________________
...
class graph_Name(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([101.0, 54.0, 101.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'Name', width = '0', justify= 'left', stipple='' )
