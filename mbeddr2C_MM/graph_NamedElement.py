"""
__graph_NamedElement.py___________________________________________________________
...
class graph_NamedElement(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([109.0, 36.0, 109.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'NamedElement', width = '0', justify= 'left', stipple='' )
        ...
        h = drawing.create_text(self.translate([90.0, 63.0, 90.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
