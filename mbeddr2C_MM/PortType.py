"""
__PortType.py_____________________________________________________
...
class PortType(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MetaModelElement_S']
      self.graphClass_ = graph_PortType
   ...
   def clone(self):
      cloneObject = PortType( self.parent )
