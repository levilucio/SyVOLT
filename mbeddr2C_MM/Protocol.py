"""
__Protocol.py_____________________________________________________
...
class Protocol(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['NamedElement', 'MetaModelElement_S']
      self.graphClass_ = graph_Protocol
   ...
   def clone(self):
      cloneObject = Protocol( self.parent )
