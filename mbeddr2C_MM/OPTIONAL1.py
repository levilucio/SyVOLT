"""
__OPTIONAL1.py_____________________________________________________
...
from graph_OPTIONAL1 import *
class OPTIONAL1(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['RoleType', 'MetaModelElement_S']
      self.graphClass_ = graph_OPTIONAL1
   ...
   def clone(self):
      cloneObject = OPTIONAL1( self.parent )
