"""
__EntryPoint.py_____________________________________________________
...
class EntryPoint(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['Vertex', 'MetaModelElement_S']
      self.graphClass_ = graph_EntryPoint
   ...
   def clone(self):
      cloneObject = EntryPoint( self.parent )
