"""
__Proc.py_____________________________________________________
...
from graph_Proc import *
class Proc(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MetaModelElement_T']
      self.graphClass_ = graph_Proc
