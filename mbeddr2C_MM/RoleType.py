"""
__RoleType.py_____________________________________________________
...
from graph_RoleType import *
class RoleType(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MetaModelElement_S']
      self.graphClass_ = graph_RoleType
   ...
   def clone(self):
      cloneObject = RoleType( self.parent )
