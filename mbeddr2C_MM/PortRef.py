"""
__PortRef.py_____________________________________________________
...
from graph_PortRef import *
class PortRef(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['Element', 'MetaModelElement_S']
      self.graphClass_ = graph_PortRef
   ...
   def clone(self):
      cloneObject = PortRef( self.parent )
