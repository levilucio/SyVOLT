"""
__CapsuleRole.py_____________________________________________________
...
from graph_CapsuleRole import *
class CapsuleRole(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['NamedElement', 'MetaModelElement_S']
      self.graphClass_ = graph_CapsuleRole
   ...
   def clone(self):
      cloneObject = CapsuleRole( self.parent )
