"""
__graph_FunctionPrototype.py___________________________________________________________
...
class graph_FunctionPrototype(graphEntity):
...
new_class = graph_FunctionPrototype
