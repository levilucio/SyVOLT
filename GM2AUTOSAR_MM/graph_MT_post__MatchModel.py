...
class graph_MT_post__MatchModel(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([73.0, 50.0, 73.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__MatchModel', width = '0', justify= 'left', stipple='' )
