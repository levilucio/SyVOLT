...
class Hmapping_component_SolveRef_Partition_Module_SwcToEcuMapping_SwCompToEcuMapping_component(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule mapping_component_SolveRef_Partition_Module_SwcToEcuMapping_SwCompToEcuMapping_component.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(Hmapping_component_SolveRef_Partition_Module_SwcToEcuMapping_SwCompToEcuMapping_component, self).__init__(name='Hmapping_component_SolveRef_Partition_Module_SwcToEcuMapping_SwCompToEcuMapping_component', num_nodes=0, edges=[])
...
a.""")
        ...
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'mapping_component_SolveRef_Partition_Module_SwcToEcuMapping_SwCompToEcuMapping_component')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'mapping_component_SolveRef_Partition_Module_SwcToEcuMapping_SwCompToEcuMapping_componentmatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'mapping_component_SolveRef_Partition_Module_SwcToEcuMapping_SwCompToEcuMapping_componentapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'mapping_component_SolveRef_Partition_Module_SwcToEcuMapping_SwCompToEcuMapping_componentpairedwith2')
        ...
        self.add_edges([
    		...
    		(9,21), # apply_class SwCompToEcuMapping_component() -> has_apply_attribute ApplyAttribute ()
