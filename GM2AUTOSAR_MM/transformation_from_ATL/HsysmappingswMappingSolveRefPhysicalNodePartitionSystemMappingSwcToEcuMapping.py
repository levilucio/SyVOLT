...
class HsysmappingswMappingSolveRefPhysicalNodePartitionSystemMappingSwcToEcuMapping(Himesis):
    def __init__(self, *args, **kwargs):

    
    
        """
        Creates the himesis graph representing the DSLTrans rule sysmappingswMappingSolveRefPhysicalNodePartitionSystemMappingSwcToEcuMapping.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HsysmappingswMappingSolveRefPhysicalNodePartitionSystemMappingSwcToEcuMapping, self).__init__(name='HsysmappingswMappingSolveRefPhysicalNodePartitionSystemMappingSwcToEcuMapping', num_nodes=0, edges=[])
        
        
        # Set the graph attributes
        self["mm__"] = ['HimesisMM']
        
        self["name"] = """sysmappingswMappingSolveRefPhysicalNodePartitionSystemMappingSwcToEcuMapping"""
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'sysmappingswMappingSolveRefPhysicalNodePartitionSystemMappingSwcToEcuMapping')
