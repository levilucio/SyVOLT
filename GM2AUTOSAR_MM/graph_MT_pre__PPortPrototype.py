"""
__graph_MT_pre__PPortPrototype.py___________________________________________________________
...
class graph_MT_pre__PPortPrototype(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([95.0, 33.0, 95.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__PPortPrototype', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__PPortPrototype
