...
class HConnectPPortPrototype_overlapLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HConnectPPortPrototype_overlapLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HConnectPPortPrototype_overlapLHS, self).__init__(name='HConnectPPortPrototype_overlapLHS', num_nodes=9, edges=[])
        
        # Add the edges
        self.add_edges([(5, 0), (0, 6), (6, 1), (1, 7), (2, 5), (7, 3), (3, 8), (8, 4)])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('ee9b6c04-eecf-4c58-bfcf-e835643a44bf')
...
"""
        ...
        self.vs[0]["GUID__"] = UUID('14b68235-afee-4333-8718-0549695d05ef')
...
.""")
        self.vs[1]["mm__"] = """MT_pre__Distributable"""
...
"""
        ...
        self.vs[1]["GUID__"] = UUID('0e710687-adb2-4fb6-a377-14164f30b4c5')
...
"""
        ...
        self.vs[2]["GUID__"] = UUID('9a1ea226-22ff-4111-93c6-04ca6f80213f')
...
"""
        ...
        self.vs[3]["GUID__"] = UUID('ba6d5eeb-7a42-4946-be92-69c5d80477ea')
...
"""
        ...
        self.vs[4]["GUID__"] = UUID('aa3b543e-0676-4da2-87e8-cb7c3d18df73')
...
.""")
        ...
        self.vs[5]["GUID__"] = UUID('adfe01d5-abf5-4f02-8a53-a717b3a1bdab')
...
.""")
        ...
        self.vs[6]["GUID__"] = UUID('6c208f44-ce2f-4700-a781-a9ad08561e93')
...
.""")
        ...
        self.vs[7]["GUID__"] = UUID('dae64c72-1e94-43d8-91e0-2f9726cea40d')
...
.""")
        ...
        self.vs[8]["GUID__"] = UUID('5aa2986c-c41e-497e-a55d-8cb20408f70b')
