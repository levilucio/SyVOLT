"""
__MapDistributable_overlap_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Thu Jun  6 11:37:38 2013
...
def MapDistributable_overlap_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MapDistributable_overlap')
    # --- ASG attributes over ---
...
newfunction = MapDistributable_overlap_MDL
