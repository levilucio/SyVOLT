"""
__ConnECU2VirtualDevice_overlap_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Thu Jun  6 11:42:05 2013
...
def ConnECU2VirtualDevice_overlap_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('ConnECU2VirtualDevice_overlap')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_LHS(40.0,60.0,self.obj60)
       new_obj.DrawObject(self.UMLmodel)
...
newfunction = ConnECU2VirtualDevice_overlap_MDL
