"""
__MapECU2FiveElements_overlap_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Thu Jun  6 11:36:52 2013
...
def MapECU2FiveElements_overlap_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MapECU2FiveElements_overlap')
    # --- ASG attributes over ---
    ...
    self.obj57=MT_pre__Distributable(self)
    ...
    self.obj57.graphClass_= graph_MT_pre__Distributable
    if self.genGraphics:
       new_obj = graph_MT_pre__Distributable(320.0,200.0,self.obj57)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj59=MT_pre__directLink_S(self)
    ...
    # MT_pre__associationType
    self.obj59.MT_pre__associationType.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj59.MT_pre__associationType.setHeight(15)

    self.obj59.graphClass_= graph_MT_pre__directLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_S(380.0,334.0,self.obj59)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
...
(self.obj55,self.obj58,[270.0, 154.0, 270.0, 274.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj56,self.obj59,[270.0, 394.0, 380.0, 334.0],"true", 2) )
    # Connections for obj57 (graphObject_: Obj2) of type MT_pre__Distributable
    self.drawConnections(
 )
    # Connections for obj58 (graphObject_: Obj3) of type MT_pre__directLink_S
    self.drawConnections(
(self.obj58,self.obj56,[270.0, 274.0, 270.0, 394.0],"true", 2) )
    # Connections for obj59 (graphObject_: Obj4) of type MT_pre__directLink_S
    self.drawConnections(
(self.obj59,self.obj57,[380.0, 334.0, 490.0, 274.0],"true", 2) )
    # Connections for obj60 (graphObject_: Obj5) of type LHS
    self.drawConnections(
 )

newfunction = MapECU2FiveElements_overlap_MDL
