"""
__ConnectPPortPrototype_overlap_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Thu Jun  6 12:01:10 2013
...
def ConnectPPortPrototype_overlap_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('ConnectPPortPrototype_overlap')
    # --- ASG attributes over ---
...
newfunction = ConnectPPortPrototype_overlap_MDL
