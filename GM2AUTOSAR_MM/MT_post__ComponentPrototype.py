"""
__MT_post__ComponentPrototype.py_____________________________________________________
...
from graph_MT_post__ComponentPrototype import *
class MT_post__ComponentPrototype(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__MetaModelElement_T']
      self.graphClass_ = graph_MT_post__ComponentPrototype
   ...
   def clone(self):
      cloneObject = MT_post__ComponentPrototype( self.parent )
