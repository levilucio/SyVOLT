"""
__paired_with.py_____________________________________________________
...
class paired_with(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_paired_with
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = paired_with( self.parent )
