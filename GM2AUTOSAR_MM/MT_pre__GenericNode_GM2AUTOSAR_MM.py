"""
__MT_pre__GenericNode_GM2AUTOSAR_MM.py_____________________________________________________
...
from graph_MT_pre__GenericNode_GM2AUTOSAR_MM import *
class MT_pre__GenericNode_GM2AUTOSAR_MM(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_pre__GenericNode_GM2AUTOSAR_MM
   ...
   def clone(self):
      cloneObject = MT_pre__GenericNode_GM2AUTOSAR_MM( self.parent )
