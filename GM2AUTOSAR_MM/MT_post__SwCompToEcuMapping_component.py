"""
__MT_post__SwCompToEcuMapping_component.py_____________________________________________________
...
from graph_MT_post__SwCompToEcuMapping_component import *
class MT_post__SwCompToEcuMapping_component(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__MetaModelElement_T']
      self.graphClass_ = graph_MT_post__SwCompToEcuMapping_component
      ...
      self.realOrder = ['MT_post__attr1','MT_label__','MT_pivotOut__']
      self.directEditing = [0,1,1]
   def clone(self):
      cloneObject = MT_post__SwCompToEcuMapping_component( self.parent )
