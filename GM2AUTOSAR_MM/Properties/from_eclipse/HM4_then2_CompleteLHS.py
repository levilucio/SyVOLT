...
class HM4_then2_CompleteLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                Creates the himesis graph representing the AToM3 model HM4_then2_CompleteLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True

                super(HM4_then2_CompleteLHS, self).__init__(name='HM4_then2_CompleteLHS', num_nodes=0, edges=[])
...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'M4_then2')
...
"""
                ...
                self.vs[2]["mm__"] = """MT_pre__EcuInstance"""
...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,3), # apply_class SwcToEcuMapping() -> association ecuInstance
                (3,1), # association ecuInstance  -> apply_class EcuInstance()
                (0,4), # apply_class SwcToEcuMapping() -> association ecuInstance
                (4,2), # association ecuInstance  -> apply_class EcuInstance()
                ])
