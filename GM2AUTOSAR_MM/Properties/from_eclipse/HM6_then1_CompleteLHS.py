...
class HM6_then1_CompleteLHS(HimesisPreConditionPatternLHS):
        def __init__(self, *args, **kwargs):
                """
                Creates the himesis graph representing the AToM3 model HM6_then1_CompleteLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True

                super(HM6_then1_CompleteLHS, self).__init__(name='HM6_then1_CompleteLHS', num_nodes=0, edges=[])
...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'M6_then1')
...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,2), # apply_class System() -> association mapping
                (2,1), # association mapping  -> apply_class SystemMapping()
                ])
