...
class HP2_IsolatedLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
        Creates the himesis graph representing the AToM3 model HP2_IsolatedLHS.
                """
        # Flag this instance as compiled now
                self.is_compiled = True
        
                super(HP2_IsolatedLHS, self).__init__(name='HP2_IsolatedLHS', num_nodes=0, edges=[])
