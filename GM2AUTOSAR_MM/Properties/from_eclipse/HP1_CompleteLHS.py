...
"""
                ...
                (0,7), # match_class PhysicalNode() -> association virtualDevice
                (7,1), # association virtualDevice  -> match_class Partition()
                (1,8), # match_class Partition() -> association distributable
                (8,2), # association distributable  -> match_class Module()
                (2,9), # match_class Module() -> association execFrame
                (9,3), # association execFrame  -> match_class Scheduler()
                (3,10), # match_class Scheduler() -> association provided
                (10,4) # association provided  -> match_class Service()
                ])
        
                # Add the attribute equations
                self["equations"] = [((0,'cardinality'),('constant','+')), ((1,'cardinality'),('constant','+')), ((2,'cardinality'),('constant','+')), ((3,'cardinality'),('constant','+')), ((4,'cardinality'),('constant','1')), ((5,'cardinality'),('constant','+')), ((6,'cardinality'),('constant','+')), ]
