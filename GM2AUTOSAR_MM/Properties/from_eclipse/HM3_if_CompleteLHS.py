...
class HM3_if_CompleteLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                Creates the himesis graph representing the AToM3 model HM3_if_CompleteLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True

                super(HM3_if_CompleteLHS, self).__init__(name='HM3_if_CompleteLHS', num_nodes=0, edges=[])
