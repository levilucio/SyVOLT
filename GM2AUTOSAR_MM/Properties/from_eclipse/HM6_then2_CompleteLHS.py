...
class HM6_then2_CompleteLHS(HimesisPreConditionPatternLHS):
        def __init__(self, *args, **kwargs):
                """
                Creates the himesis graph representing the AToM3 model HM6_then2_CompleteLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True

                super(HM6_then2_CompleteLHS, self).__init__(name='HM6_then2_CompleteLHS', num_nodes=0, edges=[])
...
"""
        ...
        # match class SystemMapping() node
                self.add_node()
...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,3), # apply_class System() -> association mapping
                (3,1), # association mapping  -> apply_class SystemMapping()
                (0,4), # apply_class System() -> association mapping
                (4,2), # association mapping  -> apply_class SystemMapping()
                ])
