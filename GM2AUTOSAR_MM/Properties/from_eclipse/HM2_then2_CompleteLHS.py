...
class HM2_then2_CompleteLHS(HimesisPreConditionPatternLHS):
        def __init__(self, *args, **kwargs):
                """
                Creates the himesis graph representing the AToM3 model HM2_then2_CompleteLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True

                super(HM2_then2_CompleteLHS, self).__init__(name='HM2_then2_CompleteLHS', num_nodes=0, edges=[])
...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'M2_then2')
...
"""
                ...
                self.vs[0]["mm__"] = """MT_pre__SoftwareComposition"""
...
"""
                ...
                self.vs[1]["mm__"] = """MT_pre__CompositionType"""
...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,3), # apply_class SoftwareComposition() -> association softwareComposition
                (3,1), # association softwareComposition  -> apply_class CompositionType()
                (0,4), # apply_class SoftwareComposition() -> association softwareComposition
                (4,2), # association softwareComposition  -> apply_class CompositionType()
                ])
