...
class HM2_then1_CompleteLHS(HimesisPreConditionPatternLHS):
        def __init__(self, *args, **kwargs):
                ...
                super(HM2_then1_CompleteLHS, self).__init__(name='HM2_then1_CompleteLHS', num_nodes=0, edges=[])
...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,2), # apply_class SoftwareComposition() -> association softwareComposition
                (2,1), # association softwareComposition  -> apply_class CompositionType()
                ])
