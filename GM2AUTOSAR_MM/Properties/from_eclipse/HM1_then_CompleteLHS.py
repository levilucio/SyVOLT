...
class HM1_then_CompleteLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                Creates the himesis graph representing the AToM3 model HM1_then_CompleteLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True

                super(HM1_then_CompleteLHS, self).__init__(name='HM1_then_CompleteLHS', num_nodes=0, edges=[])
...
"""
                self["name"] = """"""
                self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'M1_then')
...
"""
                ...
                # Add the edges
                self.add_edges([
                (0,2), # apply_class CompositionType() -> association component
                (2,1), # association component  -> apply_class ComponentPrototype()
                ])
