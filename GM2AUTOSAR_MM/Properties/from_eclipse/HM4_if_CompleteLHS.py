...
class HM4_if_CompleteLHS(HimesisPreConditionPatternLHS):
        def __init__(self, *args, **kwargs):
                """
                Creates the himesis graph representing the AToM3 model HM4_if_CompleteLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True

                super(HM4_if_CompleteLHS, self).__init__(name='HM4_if_CompleteLHS', num_nodes=0, edges=[])
