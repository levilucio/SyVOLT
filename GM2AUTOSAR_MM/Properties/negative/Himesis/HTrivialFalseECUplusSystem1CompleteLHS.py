...
p3
a.""")
        self["MT_constraint__"] = pickle.loads("""Vif PreNode('1')['cardinality']=='+' and PreNode('2')['cardinality']=='1':\u000a    return True\u000areturn False\u000a
p1
.""")
        self["name"] = """"""
        self["GUID__"] = UUID('b13d2273-9548-4b2a-902c-39294cb58912')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('cc0f6cc5-4086-4961-9001-784af54ce2ef')
...
.""")
        ...
        self.vs[1]["GUID__"] = UUID('57bff8f5-7ff2-46e3-b78d-dfb88ee12ba7')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('43fc4675-d6e8-4549-b39b-5c972c4032ae')
