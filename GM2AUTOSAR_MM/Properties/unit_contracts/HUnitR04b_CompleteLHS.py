...
class HUnitR04b_CompleteLHS(HimesisPreConditionPatternLHS):
	def __init__(self):
		...
		self.vs[5]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'4.1.a.0CompositionType')

		# apply class RPortPrototype(4.1.a.1RPortPrototype) node
		self.add_node()
		self.vs[6]["MT_pre__attr1"] = """return True"""
		self.vs[6]["MT_label__"] = """7"""
		self.vs[6]["mm__"] = """MT_pre__RPortPrototype"""
		self.vs[6]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'4.1.a.1RPortPrototype')
		...
		self.vs[7]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'4.1.m.0PhysicalNodeassoc74.1.m.1Partition')
		...
		self.vs[8]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'4.1.m.1Partitionassoc84.1.m.2Module')
		...
		self.vs[9]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'4.1.m.2Moduleassoc94.1.m.3Scheduler')

		# match association Scheduler--required-->Servicenode
		self.add_node()
		self.vs[10]["MT_pre__attr1"] = """return attr_value == "required" """
		self.vs[10]["MT_label__"] = """11"""
		self.vs[10]["mm__"] = """MT_pre__directLink_S"""
		self.vs[10]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'4.1.m.3Schedulerassoc104.1.m.4Service')
		...
		self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'4.1.a.0CompositionTypeassoc114.1.a.1RPortPrototype')

		# trace association CompositionType--trace-->PhysicalNodenode
		self.add_node()
		self.vs[12]["MT_label__"] = """13"""
		self.vs[12]["mm__"] = """MT_pre__trace_link"""
		self.vs[12]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'4.1.a.0CompositionTypeassoc124.1.m.0PhysicalNode')

		self['equations'].append(((6,'shortName'),('concat',((3,'name'),('constant','REQ')))))

		# Add the edges
		self.add_edges([
			(0,7), # match class PhysicalNode(4.1.m.0PhysicalNode) -> association partition
			(7,1), # association Partition -> match class Partition(4.1.m.1Partition)
			(1,8), # match class Partition(4.1.m.1Partition) -> association module
			(8,2), # association Module -> match class Module(4.1.m.2Module)
			(2,9), # match class Module(4.1.m.2Module) -> association scheduler
			(9,3), # association Scheduler -> match class Scheduler(4.1.m.3Scheduler)
			(3,10), # match class Scheduler(4.1.m.3Scheduler) -> association required
			(10,4), # association Service -> match class Service(4.1.m.4Service)
			(5,11), # apply class CompositionType(4.1.a.0CompositionType) -> association port
			(11,6), # association PPortPrototype -> apply class PPortPrototype(4.1.a.1RPortPrototype)
			(5,12), # apply class CompositionType(4.1.m.0PhysicalNode) -> backward_association 
			(12,0), # backward_associationPhysicalNode -> match_class PhysicalNode(4.1.m.0PhysicalNode)
		])
