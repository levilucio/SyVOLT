"""
__M3ThenClausePart1IsolatedConnected_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Fri Oct 18 10:24:39 2013
...
def M3ThenClausePart1IsolatedConnected_MDL(self, rootNode, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('M3ThenClausePart1IsolatedConnected')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_LHS(140.0,60.0,self.obj1535)
...
newfunction = M3ThenClausePart1IsolatedConnected_MDL
