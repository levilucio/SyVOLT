"""
__S1ThenClauseIsolatedConnected_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Wed Oct 16 11:44:06 2013
...
def S1ThenClauseIsolatedConnected_MDL(self, rootNode, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('S1ThenClauseIsolatedConnected')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_LHS(160.0,400.0,self.obj1535)
...
newfunction = S1ThenClauseIsolatedConnected_MDL
