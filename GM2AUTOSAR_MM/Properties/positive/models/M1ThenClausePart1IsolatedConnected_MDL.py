"""
__M1ThenClausePart1IsolatedConnected_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Thu Oct 17 15:22:44 2013
...
def M1ThenClausePart1IsolatedConnected_MDL(self, rootNode, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('M1ThenClausePart1IsolatedConnected')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_LHS(140.0,80.0,self.obj1535)
...
newfunction = M1ThenClausePart1IsolatedConnected_MDL
