"""
__P2Isolated_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Tue Sep 17 13:32:25 2013
...
def P2Isolated_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('P2Isolated')
    # --- ASG attributes over ---
    ...
    # constraint
    self.obj50.constraint.setValue('if PreNode(\'1\')[\'cardinality\']==\'+\' and PreNode(\'2\')[\'cardinality\']==\'+\' and PreNode(\'3\')[\'cardinality\']==\'+\' and PreNode(\'4\')[\'cardinality\']==\'+\' and PreNode(\'5\')[\'cardinality\']==\'1\':\n    return True\nreturn False\n')
    self.obj50.constraint.setHeight(15)

    self.obj50.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(80.0,80.0,self.obj50)
    ...
    self.obj52=MT_pre__VirtualDevice(self)
    ...
    self.obj52.graphClass_= graph_MT_pre__VirtualDevice
    if self.genGraphics:
       new_obj = graph_MT_pre__VirtualDevice(300.0,100.0,self.obj52)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj53=MT_pre__Distributable(self)
    ...
    self.obj53.graphClass_= graph_MT_pre__Distributable
    if self.genGraphics:
       new_obj = graph_MT_pre__Distributable(300.0,232.0,self.obj53)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj51.graphClass_= graph_MT_pre__ECU
    if self.genGraphics:
       new_obj = graph_MT_pre__ECU(100.0,100.0,self.obj51)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj54=MT_pre__ExecFrame(self)
    ...
    self.obj54.graphClass_= graph_MT_pre__ExecFrame
    if self.genGraphics:
       new_obj = graph_MT_pre__ExecFrame(300.0,360.0,self.obj54)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj55=MT_pre__Signal(self)
    ...
    self.obj55.graphClass_= graph_MT_pre__Signal
    if self.genGraphics:
       new_obj = graph_MT_pre__Signal(100.0,360.0,self.obj55)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # Connections for obj52 (graphObject_: Obj2) of type MT_pre__VirtualDevice
    self.drawConnections(
 )
    # Connections for obj53 (graphObject_: Obj3) of type MT_pre__Distributable
    self.drawConnections(
 )
    # Connections for obj51 (graphObject_: Obj1) of type MT_pre__ECU
    self.drawConnections(
 )
    # Connections for obj54 (graphObject_: Obj4) of type MT_pre__ExecFrame
    self.drawConnections(
 )
    # Connections for obj55 (graphObject_: Obj5) of type MT_pre__Signal
    self.drawConnections(
 )

newfunction = P2Isolated_MDL
