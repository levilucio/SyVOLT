...
class HP2CompleteLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HP2CompleteLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HP2CompleteLHS, self).__init__(name='HP2CompleteLHS', num_nodes=14, edges=[])
        
        # Add the edges
        self.add_edges([(10, 0), (0, 11), (11, 1), (1, 12), (8, 2), (2, 10), (12, 3), (9, 3), (3, 13), (4, 5), (4, 8), (13, 7), (6, 9), (5, 6)])
...
p3
a.""")
        self["MT_constraint__"] = pickle.loads("""Vif PreNode('1')['cardinality']=='+' and PreNode('2')['cardinality']=='+' and PreNode('3')['cardinality']=='+' and PreNode('4')['cardinality']=='+' and PreNode('5')['cardinality']=='1' and PreNode('10')['cardinality']=='+' and PreNode('11')['cardinality']=='+' and PreNode('6')['associationType']=='virtualDevice' and PreNode('7')['associationType']=='distributable' and PreNode('8')['associationType']=='execFrame' and PreNode('9')['associationType']=='required' and PreNode('12')['associationType']=='port':\u000a    return True\u000areturn False\u000a
p1
.""")
        self["name"] = """"""
        self["GUID__"] = UUID('d3ff1d42-cfa9-46fc-b459-0f49f0b0e998')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('e5aba405-eb54-4f18-990c-12dbbcb5c825')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('bb74c364-e806-434a-a88a-16c5a23393d2')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('218cb55d-5f89-400d-aefa-5b0dd4ac071b')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('11b92c1c-2e51-4fad-837b-4f5ce85c62f7')
...
return True
"""
        self.vs[4]["GUID__"] = UUID('05b2da67-bf36-4bd6-91eb-6e125fdbf8ce')
...
.""")
        ...
        self.vs[5]["GUID__"] = UUID('8694d6f8-654c-4dad-a786-336d31a7c38b')
...
return True
"""
        self.vs[6]["GUID__"] = UUID('47bd63d4-6c61-45b1-9185-e8e6512f5157')
...
return True
"""
        self.vs[7]["GUID__"] = UUID('cba2a010-4a46-4109-9a64-0c5af8b50e8c')
...
.""")
        ...
        self.vs[8]["GUID__"] = UUID('86a4cf46-375b-4fe3-bb57-ad2f0ec0869d')
...
.""")
        ...
        self.vs[9]["GUID__"] = UUID('54a8a255-6203-4242-ab5c-548b466c21d3')
...
.""")
    ...
    def constraint(self, PreNode, graph):
        ...
        """
        if PreNode('1')['cardinality']=='+' and PreNode('2')['cardinality']=='+' and PreNode('3')['cardinality']=='+' and PreNode('4')['cardinality']=='+' and PreNode('5')['cardinality']=='1' and PreNode('10')['cardinality']=='+' and PreNode('11')['cardinality']=='+' and PreNode('6')['associationType']=='virtualDevice' and PreNode('7')['associationType']=='distributable' and PreNode('8')['associationType']=='execFrame' and PreNode('9')['associationType']=='required' and PreNode('12')['associationType']=='port':
            return True
        return False
