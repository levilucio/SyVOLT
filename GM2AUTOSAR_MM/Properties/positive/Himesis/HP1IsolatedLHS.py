...
class HP1IsolatedLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        ...
        super(HP1IsolatedLHS, self).__init__(name='HP1IsolatedLHS', num_nodes=5, edges=[])
...
p1
.""")
        self["name"] = """P1Isolated"""
        self["GUID__"] = UUID('a83b77a0-80b6-4569-a90c-71b54f32687e')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('fa7685ff-1a79-48ed-ad95-57dba4229533')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('b080f063-e499-49d0-b4b4-7658ae3e78de')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('7805cb60-9920-4e57-8f7c-8f490377e958')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('f808dbc5-99c2-49e5-9dfe-9fb67b8f37df')
...
return True
"""
        self.vs[4]["GUID__"] = UUID('482f5f1e-503c-4843-b3a1-347ee75dd17c')
