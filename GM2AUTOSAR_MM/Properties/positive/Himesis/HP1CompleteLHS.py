...
class HP1CompleteLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HP1CompleteLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HP1CompleteLHS, self).__init__(name='HP1CompleteLHS', num_nodes=14, edges=[])
        
        # Add the edges
        self.add_edges([(10, 0), (0, 11), (11, 1), (1, 12), (8, 2), (2, 10), (12, 3), (9, 3), (3, 13), (6, 4), (4, 9), (5, 6), (5, 8), (13, 7)])
...
p3
a.""")
        self["MT_constraint__"] = pickle.loads("""Vif PreNode('1')['cardinality']=='+' and PreNode('2')['cardinality']=='+' and PreNode('3')['cardinality']=='+' and PreNode('4')['cardinality']=='+' and PreNode('5')['cardinality']=='1' and PreNode('10')['cardinality']=='+' and PreNode('11')['cardinality']=='+' and PreNode('6')['associationType']=='virtualDevice' and PreNode('7')['associationType']=='distributable' and PreNode('8')['associationType']=='execFrame' and PreNode('9')['associationType']=='provided' and PreNode('12')['associationType']=='port':\u000a    return True\u000areturn False\u000a
p1
.""")
        self["name"] = """"""
        self["GUID__"] = UUID('15c4a5be-3270-4714-9e85-17212bca29a4')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('d199e9e7-1020-481b-8495-8e218e8bb2d7')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('efaab6b5-7bb1-445a-8a95-e68dbe0fc469')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('b521bd5e-d264-429e-88dd-85acd28837b6')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('bd680825-fffe-4113-aae6-e69659122ce2')
...
.""")
        ...
        self.vs[4]["mm__"] = """MT_pre__PPortPrototype"""
...
return True
"""
        self.vs[4]["GUID__"] = UUID('00be3b1e-71a1-40b9-9ab3-27e3ec31a82d')
...
return True
"""
        self.vs[5]["GUID__"] = UUID('19387cd3-2913-490b-84a8-1b1a3e420524')
...
.""")
        ...
        self.vs[6]["GUID__"] = UUID('ba11816d-5bf8-4fc8-b03c-8a42f3c84309')
...
return True
"""
        self.vs[7]["GUID__"] = UUID('62609faf-58f3-43fa-81ba-717f81123bf9')
...
.""")
        ...
        self.vs[8]["GUID__"] = UUID('6f0b8dc5-1839-439e-8039-c483c9763418')
...
.""")
        ...
        self.vs[9]["GUID__"] = UUID('a5c4142e-c609-4da6-a59e-2ebff05406e0')
...
.""")
        ...
        self.vs[10]["GUID__"] = UUID('e74d742e-01fa-40e6-be52-68524f18a525')
...
.""")
        ...
        self.vs[11]["GUID__"] = UUID('a9832e83-0296-4a70-856d-c574d738a930')
...
.""")
        ...
        self.vs[12]["GUID__"] = UUID('59c18922-bf98-4b88-a58b-123dff493bf5')
...
.""")
        ...
        self.vs[13]["GUID__"] = UUID('fe28eb11-a894-47d4-b49a-4b9a0dc89f40')
    ...
    def constraint(self, PreNode, graph):
        ...
        """
        if PreNode('1')['cardinality']=='+' and PreNode('2')['cardinality']=='+' and PreNode('3')['cardinality']=='+' and PreNode('4')['cardinality']=='+' and PreNode('5')['cardinality']=='1' and PreNode('10')['cardinality']=='+' and PreNode('11')['cardinality']=='+' and PreNode('6')['associationType']=='virtualDevice' and PreNode('7')['associationType']=='distributable' and PreNode('8')['associationType']=='execFrame' and PreNode('9')['associationType']=='provided' and PreNode('12')['associationType']=='port':
            return True
        return False
