...
p3
a.""")
        self["MT_constraint__"] = pickle.loads("""Vif PreNode('1')['cardinality']=='+' and PreNode('2')['cardinality']=='+' and PreNode('3')['cardinality']=='+' and PreNode('4')['cardinality']=='+' and PreNode('5')['cardinality']=='+' and PreNode('6')['associationType']=='mapping' and PreNode('7')['associationType']=='swMapping' and PreNode('8')['associationType']=='component' and PreNode('9')['associationType']=='componentPrototype':\u000a    return True\u000areturn False\u000a
p1
.""")
        self["name"] = """S1IfClauseComplete"""
        self["GUID__"] = UUID('174d86dc-0d67-4ef3-8cf7-465294901f58')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('072cd45e-4a66-47e9-9dda-b818f44f56b3')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('f0cf7927-a0e5-423f-8cd5-faaa5c098d21')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('3c7e3431-e946-49a8-8a35-daeb926d84a9')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('26dc1d02-1d85-4ae9-97ae-78fadf4fa74d')
...
return True
"""
        self.vs[4]["GUID__"] = UUID('bc28ae89-619b-45b3-b724-a01dcb92c665')
...
.""")
        ...
        self.vs[5]["GUID__"] = UUID('6c46d58e-0017-4423-80fe-61c2952cde1e')
...
.""")
        ...
        self.vs[6]["GUID__"] = UUID('aff6d783-34db-4436-a844-345c23f2551d')
...
.""")
        ...
        self.vs[7]["GUID__"] = UUID('2010dce1-0669-4125-bf9b-086a24fec45b')
...
.""")
        ...
        self.vs[8]["GUID__"] = UUID('1335de04-2559-427b-b3ae-92b60ff2083d')
