"""
__graph_MT_pre__SwCompToEcuMapping_component.py___________________________________________________________
...
class graph_MT_pre__SwCompToEcuMapping_component(graphEntity):
...
new_class = graph_MT_pre__SwCompToEcuMapping_component
