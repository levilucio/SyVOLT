"""
__graph_MT_post__PortPrototype.py___________________________________________________________
...
class graph_MT_post__PortPrototype(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([96.0, 31.0, 96.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__PortPrototype', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__PortPrototype
