"""
__MT_pre__GM2AUTOSAR_MM_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Sun Aug  9 23:43:46 2015
...
def MT_pre__GM2AUTOSAR_MM_MDL(self, rootNode, CD_ClassDiagramsV3RootNode=None):

    # --- Generating attributes code for ASG CD_ClassDiagramsV3 ---
    if( CD_ClassDiagramsV3RootNode ): 
        # name
        CD_ClassDiagramsV3RootNode.name.setValue('MT_pre__GM2AUTOSAR_MM')
    ...
    self.obj28.Graphical_Appearance.setValue( ('MT_pre__MatchModel', self.obj28))

    # name
    self.obj28.name.setValue('MT_pre__MatchModel')
    ...
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__GenericEdge_GM2AUTOSAR_MM', (('Source', 'Destination'), 1), '0', 'N'))
    lcobj2.append(cobj2)
    ...
    # Graphical_Appearance
    self.obj29.Graphical_Appearance.setValue( ('MT_pre__ApplyModel', self.obj29))

    # name
    self.obj29.name.setValue('MT_pre__ApplyModel')
    ...
    # Graphical_Appearance
    self.obj30.Graphical_Appearance.setValue( ('MT_pre__MetaModelElement_S', self.obj30))

    # name
    self.obj30.name.setValue('MT_pre__MetaModelElement_S')
    ...
    # Graphical_Appearance
    self.obj31.Graphical_Appearance.setValue( ('MT_pre__MetaModelElement_T', self.obj31))

    # name
    self.obj31.name.setValue('MT_pre__MetaModelElement_T')
    ...
    # Graphical_Appearance
    self.obj32.Graphical_Appearance.setValue( ('MT_pre__ECU', self.obj32))

    # name
    self.obj32.name.setValue('MT_pre__ECU')
    ...
    # Graphical_Appearance
    self.obj33.Graphical_Appearance.setValue( ('MT_pre__VirtualDevice', self.obj33))

    # name
    self.obj33.name.setValue('MT_pre__VirtualDevice')
    ...
    # Graphical_Appearance
    self.obj34.Graphical_Appearance.setValue( ('MT_pre__Distributable', self.obj34))

    # name
    self.obj34.name.setValue('MT_pre__Distributable')
    ...
    # Graphical_Appearance
    self.obj35.Graphical_Appearance.setValue( ('MT_pre__ExecFrame', self.obj35))

    # name
    self.obj35.name.setValue('MT_pre__ExecFrame')
    ...
    # Graphical_Appearance
    self.obj36.Graphical_Appearance.setValue( ('MT_pre__Signal', self.obj36))

    # name
    self.obj36.name.setValue('MT_pre__Signal')
    ...
    # Graphical_Appearance
    self.obj37.Graphical_Appearance.setValue( ('MT_pre__System', self.obj37))

    # name
    self.obj37.name.setValue('MT_pre__System')
    ...
    # Graphical_Appearance
    self.obj38.Graphical_Appearance.setValue( ('MT_pre__SystemMapping', self.obj38))

    # name
    self.obj38.name.setValue('MT_pre__SystemMapping')
    ...
    # Graphical_Appearance
    self.obj39.Graphical_Appearance.setValue( ('MT_pre__SoftwareComposition', self.obj39))

    # name
    self.obj39.name.setValue('MT_pre__SoftwareComposition')
    ...
    # Graphical_Appearance
    self.obj40.Graphical_Appearance.setValue( ('MT_pre__CompositionType', self.obj40))

    # name
    self.obj40.name.setValue('MT_pre__CompositionType')
    ...
    # Graphical_Appearance
    self.obj41.Graphical_Appearance.setValue( ('MT_pre__ComponentPrototype', self.obj41))

    # name
    self.obj41.name.setValue('MT_pre__ComponentPrototype')
    ...
    # Graphical_Appearance
    self.obj42.Graphical_Appearance.setValue( ('MT_pre__PPortPrototype', self.obj42))

    # name
    self.obj42.name.setValue('MT_pre__PPortPrototype')
    ...
    # Graphical_Appearance
    self.obj43.Graphical_Appearance.setValue( ('MT_pre__RPortPrototype', self.obj43))

    # name
    self.obj43.name.setValue('MT_pre__RPortPrototype')
    ...
    # Graphical_Appearance
    self.obj44.Graphical_Appearance.setValue( ('MT_pre__EcuInstance', self.obj44))

    # name
    self.obj44.name.setValue('MT_pre__EcuInstance')
    ...
    # Graphical_Appearance
    self.obj45.Graphical_Appearance.setValue( ('MT_pre__SwcToEcuMapping', self.obj45))

    # name
    self.obj45.name.setValue('MT_pre__SwcToEcuMapping')
    ...
    # Graphical_Appearance
    self.obj46.Graphical_Appearance.setValue( ('MT_pre__SwCompToEcuMapping_component', self.obj46))

    # name
    self.obj46.name.setValue('MT_pre__SwCompToEcuMapping_component')
    ...
    # Graphical_Appearance
    self.obj47.Graphical_Appearance.setValue( ('MT_pre__PortPrototype', self.obj47))

    # name
    self.obj47.name.setValue('MT_pre__PortPrototype')
    ...
    # Graphical_Appearance
    self.obj48.Graphical_Appearance.setValue( ('MT_pre__ComponentType', self.obj48))

    # name
    self.obj48.name.setValue('MT_pre__ComponentType')
    ...
    # Graphical_Appearance
    self.obj74.Graphical_Appearance.setValue( ('MT_pre__GenericNode_GM2AUTOSAR_MM', self.obj74))

    # name
    self.obj74.name.setValue('MT_pre__GenericNode_GM2AUTOSAR_MM')
    ...
    lcobj2 =[]
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__GenericEdge_GM2AUTOSAR_MM', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__GenericEdge_GM2AUTOSAR_MM', (('Source', 'Destination'), 1), '0', 'N'))
    lcobj2.append(cobj2)
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(0.0,0.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.9632812499999999, 1.0]
    ...
    # Graphical_Appearance
    self.obj50.Graphical_Appearance.setValue( ('MT_pre__match_contains', self.obj50))
    ...
    # name
    self.obj50.name.setValue('MT_pre__match_contains')
    ...
    # Graphical_Appearance
    self.obj51.Graphical_Appearance.setValue( ('MT_pre__directLink_S', self.obj51))
    ...
    # name
    self.obj51.name.setValue('MT_pre__directLink_S')
    ...
    # Graphical_Appearance
    self.obj52.Graphical_Appearance.setValue( ('MT_pre__directLink_T', self.obj52))
    ...
    # name
    self.obj52.name.setValue('MT_pre__directLink_T')
    ...
    # Graphical_Appearance
    self.obj53.Graphical_Appearance.setValue( ('MT_pre__apply_contains', self.obj53))
    ...
    # name
    self.obj53.name.setValue('MT_pre__apply_contains')
    ...
    # Graphical_Appearance
    self.obj54.Graphical_Appearance.setValue( ('MT_pre__indirectLink_S', self.obj54))
    ...
    # name
    self.obj54.name.setValue('MT_pre__indirectLink_S')
    ...
    # Graphical_Appearance
    self.obj55.Graphical_Appearance.setValue( ('MT_pre__backward_link', self.obj55))
    ...
    # name
    self.obj55.name.setValue('MT_pre__backward_link')
    ...
    # Graphical_Appearance
    self.obj56.Graphical_Appearance.setValue( ('MT_pre__trace_link', self.obj56))
    ...
    # name
    self.obj56.name.setValue('MT_pre__trace_link')
    ...
    self.obj75=CD_Association3(self)
    ...
    # Graphical_Appearance
    self.obj75.Graphical_Appearance.setValue( ('MT_pre__GenericEdge_GM2AUTOSAR_MM', self.obj75))
    self.obj75.Graphical_Appearance.linkInfo=linkEditor(self,self.obj75.Graphical_Appearance.semObject, "GenericEdge_GM2AUTOSAR_MM")
    self.obj75.Graphical_Appearance.linkInfo.FirstLink= stickylink()
    self.obj75.Graphical_Appearance.linkInfo.FirstLink.arrow=ATOM3Boolean()
    self.obj75.Graphical_Appearance.linkInfo.FirstLink.arrow.setValue((' ', 0))
    self.obj75.Graphical_Appearance.linkInfo.FirstLink.arrow.config = 0
    self.obj75.Graphical_Appearance.linkInfo.FirstLink.arrowShape1=ATOM3Integer(8)
    self.obj75.Graphical_Appearance.linkInfo.FirstLink.arrowShape2=ATOM3Integer(10)
    self.obj75.Graphical_Appearance.linkInfo.FirstLink.arrowShape3=ATOM3Integer(3)
    self.obj75.Graphical_Appearance.linkInfo.FirstLink.decoration=ATOM3Appearance()
    self.obj75.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('GenericEdge_GM2AUTOSAR_MM_1stLink', self.obj75.Graphical_Appearance.linkInfo.FirstLink))
    self.obj75.Graphical_Appearance.linkInfo.FirstSegment= widthXfillXdecoration()
    self.obj75.Graphical_Appearance.linkInfo.FirstSegment.width=ATOM3Integer(1)
    self.obj75.Graphical_Appearance.linkInfo.FirstSegment.fill=ATOM3String('purple', 20)
    self.obj75.Graphical_Appearance.linkInfo.FirstSegment.stipple=ATOM3String('', 20)
    self.obj75.Graphical_Appearance.linkInfo.FirstSegment.arrow=ATOM3Boolean()
    self.obj75.Graphical_Appearance.linkInfo.FirstSegment.arrow.setValue((' ', 0))
    self.obj75.Graphical_Appearance.linkInfo.FirstSegment.arrow.config = 0
    self.obj75.Graphical_Appearance.linkInfo.FirstSegment.arrowShape1=ATOM3Integer(8)
    self.obj75.Graphical_Appearance.linkInfo.FirstSegment.arrowShape2=ATOM3Integer(10)
    self.obj75.Graphical_Appearance.linkInfo.FirstSegment.arrowShape3=ATOM3Integer(3)
    self.obj75.Graphical_Appearance.linkInfo.FirstSegment.decoration=ATOM3Appearance()
    self.obj75.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('GenericEdge_GM2AUTOSAR_MM_1stSegment', self.obj75.Graphical_Appearance.linkInfo.FirstSegment))
    self.obj75.Graphical_Appearance.linkInfo.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
    self.obj75.Graphical_Appearance.linkInfo.Center=ATOM3Appearance()
    self.obj75.Graphical_Appearance.linkInfo.Center.setValue( ('GenericEdge_GM2AUTOSAR_MM_Center', self.obj75.Graphical_Appearance.linkInfo))
    self.obj75.Graphical_Appearance.linkInfo.SecondSegment= widthXfillXdecoration()
    self.obj75.Graphical_Appearance.linkInfo.SecondSegment.width=ATOM3Integer(1)
    self.obj75.Graphical_Appearance.linkInfo.SecondSegment.fill=ATOM3String('purple', 20)
    self.obj75.Graphical_Appearance.linkInfo.SecondSegment.stipple=ATOM3String('', 20)
    self.obj75.Graphical_Appearance.linkInfo.SecondSegment.arrow=ATOM3Boolean()
    self.obj75.Graphical_Appearance.linkInfo.SecondSegment.arrow.setValue((' ', 0))
    self.obj75.Graphical_Appearance.linkInfo.SecondSegment.arrow.config = 0
    self.obj75.Graphical_Appearance.linkInfo.SecondSegment.arrowShape1=ATOM3Integer(8)
    self.obj75.Graphical_Appearance.linkInfo.SecondSegment.arrowShape2=ATOM3Integer(10)
    self.obj75.Graphical_Appearance.linkInfo.SecondSegment.arrowShape3=ATOM3Integer(3)
    self.obj75.Graphical_Appearance.linkInfo.SecondSegment.decoration=ATOM3Appearance()
    self.obj75.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('GenericEdge_GM2AUTOSAR_MM_2ndSegment', self.obj75.Graphical_Appearance.linkInfo.SecondSegment))
    self.obj75.Graphical_Appearance.linkInfo.SecondSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
    self.obj75.Graphical_Appearance.linkInfo.SecondLink= stickylink()
    self.obj75.Graphical_Appearance.linkInfo.SecondLink.arrow=ATOM3Boolean()
    self.obj75.Graphical_Appearance.linkInfo.SecondLink.arrow.setValue((' ', 1))
    self.obj75.Graphical_Appearance.linkInfo.SecondLink.arrow.config = 0
    self.obj75.Graphical_Appearance.linkInfo.SecondLink.arrowShape1=ATOM3Integer(8)
    self.obj75.Graphical_Appearance.linkInfo.SecondLink.arrowShape2=ATOM3Integer(10)
    self.obj75.Graphical_Appearance.linkInfo.SecondLink.arrowShape3=ATOM3Integer(3)
    self.obj75.Graphical_Appearance.linkInfo.SecondLink.decoration=ATOM3Appearance()
    self.obj75.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('GenericEdge_GM2AUTOSAR_MM_2ndLink', self.obj75.Graphical_Appearance.linkInfo.SecondLink))
    self.obj75.Graphical_Appearance.linkInfo.FirstLink.decoration.semObject=self.obj75.Graphical_Appearance.semObject
    self.obj75.Graphical_Appearance.linkInfo.FirstSegment.decoration.semObject=self.obj75.Graphical_Appearance.semObject
    self.obj75.Graphical_Appearance.linkInfo.Center.semObject=self.obj75.Graphical_Appearance.semObject
    self.obj75.Graphical_Appearance.linkInfo.SecondSegment.decoration.semObject=self.obj75.Graphical_Appearance.semObject
    self.obj75.Graphical_Appearance.linkInfo.SecondLink.decoration.semObject=self.obj75.Graphical_Appearance.semObject

    # name
    self.obj75.name.setValue('MT_pre__GenericEdge_GM2AUTOSAR_MM')

    # displaySelect
    self.obj75.displaySelect.setValue( (['attributes', 'constraints', 'actions', 'cardinality'], [0, 0, 0, 0]) )
    self.obj75.displaySelect.config = 0
    ...
    lcobj2 =[]
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__GenericNode_GM2AUTOSAR_MM', (('Source', 'Destination'), 1), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__GenericNode_GM2AUTOSAR_MM', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    ...
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__ECU', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__VirtualDevice', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__Distributable', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__ExecFrame', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__Signal', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__System', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__SystemMapping', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__SoftwareComposition', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__CompositionType', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__ComponentPrototype', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__PPortPrototype', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__RPortPrototype', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__EcuInstance', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__SwcToEcuMapping', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__SwCompToEcuMapping_component', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__PortPrototype', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_pre__ComponentType', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    self.obj75.cardinality.setValue(lcobj2)

    # display
    self.obj75.display.setValue('Multiplicities:\n  - From GenericNode_GM2AUTOSAR_MM: 0 to N\n  - To GenericNode_GM2AUTOSAR_MM: 0 to N\n  - To MatchModel: 0 to N\n  - To ApplyModel: 0 to N\n  - To MetaModelElement_S: 0 to N\n  - To MetaModelElement_T: 0 to N\n  - To ECU: 0 to N\n  - To VirtualDevice: 0 to N\n  - To Distributable: 0 to N\n  - To ExecFrame: 0 to N\n  - To Signal: 0 to N\n  - To System: 0 to N\n  - To SystemMapping: 0 to N\n  - To SoftwareComposition: 0 to N\n  - To CompositionType: 0 to N\n  - To ComponentPrototype: 0 to N\n  - To PPortPrototype: 0 to N\n  - To RPortPrototype: 0 to N\n  - To EcuInstance: 0 to N\n  - To SwcToEcuMapping: 0 to N\n  - To SwCompToEcuMapping_component: 0 to N\n  - To PortPrototype: 0 to N\n  - To ComponentType: 0 to N\n')
    ...
    # Connections for obj28 (graphObject_: Obj0) named MT_pre__MatchModel
...
(self.obj28,self.obj50,[237.0, 119.0, 425.3504330872569, 120.20500000000001],"true", 2) )
    # Connections for obj29 (graphObject_: Obj1) named MT_pre__ApplyModel
    self.drawConnections(
...
(self.obj32,self.obj57,[505.0, 251.0, 545.94511815, 232.933238441],"true", 2) )
    # Connections for obj33 (graphObject_: Obj5) named MT_pre__VirtualDevice
    self.drawConnections(
(self.obj33,self.obj58,[456.0, 381.0, 581.0, 302.0],"true", 2) )
    # Connections for obj34 (graphObject_: Obj6) named MT_pre__Distributable
    self.drawConnections(
(self.obj34,self.obj59,[676.0, 381.0, 712.1875, 292.5],"true", 2) )
    # Connections for obj35 (graphObject_: Obj7) named MT_pre__ExecFrame
    self.drawConnections(
(self.obj35,self.obj60,[816.0, 381.0, 797.03125, 316.5],"true", 2) )
    # Connections for obj36 (graphObject_: Obj8) named MT_pre__Signal
    self.drawConnections(
(self.obj36,self.obj61,[941.0, 301.0, 907.33203125, 291.868852459],"true", 2) )
    # Connections for obj37 (graphObject_: Obj9) named MT_pre__System
    self.drawConnections(
(self.obj37,self.obj62,[222.0, 860.0, 494.910784314, 787.069775845],"true", 2) )
    # Connections for obj38 (graphObject_: Obj10) named MT_pre__SystemMapping
    self.drawConnections(
(self.obj38,self.obj63,[427.0, 859.0, 599.0, 787.515081967],"true", 2) )
    # Connections for obj39 (graphObject_: Obj11) named MT_pre__SoftwareComposition
    self.drawConnections(
(self.obj39,self.obj70,[453.75, 1157.0, 549.542878788, 925.565],"true", 2) )
    # Connections for obj40 (graphObject_: Obj12) named MT_pre__CompositionType
    self.drawConnections(
(self.obj40,self.obj71,[654.0, 1157.0, 652.26, 925.45],"true", 2) )
    # Connections for obj41 (graphObject_: Obj13) named MT_pre__ComponentPrototype
    self.drawConnections(
(self.obj41,self.obj69,[318.75, 979.0, 476.127935606, 859.105081967],"true", 2) )
    # Connections for obj42 (graphObject_: Obj14) named MT_pre__PPortPrototype
    self.drawConnections(
(self.obj42,self.obj72,[735.0, 1158.0, 735.0, 926.0],"true", 2) )
    # Connections for obj43 (graphObject_: Obj15) named MT_pre__RPortPrototype
    self.drawConnections(
(self.obj43,self.obj73,[936.0, 1161.0, 857.5, 926.0],"true", 2) )
    # Connections for obj44 (graphObject_: Obj16) named MT_pre__EcuInstance
    self.drawConnections(
(self.obj44,self.obj68,[570.0, 978.0, 559.0, 839.295081967213],"true", 2) )
    # Connections for obj45 (graphObject_: Obj17) named MT_pre__SwcToEcuMapping
    self.drawConnections(
(self.obj45,self.obj64,[611.0, 818.0, 668.0, 779.0],"true", 2) )
    # Connections for obj46 (graphObject_: Obj18) named MT_pre__SwCompToEcuMapping_component
    self.drawConnections(
(self.obj46,self.obj65,[985.53125, 858.0, 803.765625, 798.5],"true", 2) )
    # Connections for obj47 (graphObject_: Obj19) named MT_pre__PortPrototype
    self.drawConnections(
(self.obj47,self.obj66,[956.0, 978.0, 833.0, 853.0],"true", 2) )
    # Connections for obj48 (graphObject_: Obj20) named MT_pre__ComponentType
    self.drawConnections(
...
(self.obj75,self.obj30,[-0.48, 5.0, 600.3984375, 105.68852459016392], 0, 2),
(self.obj75,self.obj31,[-0.48, 5.0, 656.0, 593.1311475409836], 0, 2),
