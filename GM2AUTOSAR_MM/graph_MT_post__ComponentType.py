"""
__graph_MT_post__ComponentType.py___________________________________________________________
...
class graph_MT_post__ComponentType(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        font = tkFont.Font( family='Arial', size=12, weight='normal', slant='roman', underline=0)
        h = drawing.create_text(self.translate([90.0, 36.0, 90.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__ComponentType', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__ComponentType
