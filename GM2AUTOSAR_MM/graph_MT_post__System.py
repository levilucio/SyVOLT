"""
__graph_MT_post__System.py___________________________________________________________
...
class graph_MT_post__System(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([66.0, 37.0, 66.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__System', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__System
