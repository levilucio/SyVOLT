...
class HMapPN2FiveElements(Himesis):
    def __init__(self):
        ...
        self["equations"] = [((9,'shortName'),('concat',(('constant','SysMapping_'),(3,'name')))), ((11,'shortName'),('concat',(('constant','SysTemplate_'),(3,'name')))), ((13,'shortName'),('concat',(('constant','SoftwareComposition_'),(3,'name')))), ((15,'shortName'),('concat',(('constant','CompositionType_'),(3,'name')))), ((17,'shortName'),('concat',(('constant','EcuInstance_'),(3,'name')))), ]
