...
class HConnectPPortPrototype(Himesis):
    def __init__(self):
        ...
        self.add_edges([
                ...
                (6,13), # match_class Scheduler() -> association provided
                (13,7), # association provided  -> match_class Service()
        ...
        self["equations"] = [((8,'ApplyAttribute'),('constant','solveRef')), ((9,'shortName'),('concat',((6,'name'),('constant','PROV')))), ]
