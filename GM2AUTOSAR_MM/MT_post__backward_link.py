"""
__MT_post__backward_link.py_____________________________________________________
...
class MT_post__backward_link(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_post__backward_link
      ...
      self.realOrder = ['MT_post__type','MT_label__','MT_pivotOut__']
      self.directEditing = [0,1,1]
   def clone(self):
      cloneObject = MT_post__backward_link( self.parent )
