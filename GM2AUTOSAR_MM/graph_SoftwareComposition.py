"""
__graph_SoftwareComposition.py___________________________________________________________
...
class graph_SoftwareComposition(graphEntity):

    def __init__(self, x, y, semObject = None):
        self.semanticObject = semObject
        self.sizeX, self.sizeY = 155, 80
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([92.0, 32.0, 92.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'SoftwareComposition', width = '0', justify= 'left', stipple='' )
        ...
        self.gf53 = GraphicalForm(drawing, h, 'gf53', fontObject=font)
        self.graphForms.append(self.gf53)
...
new_class = graph_SoftwareComposition
