"""
__graph_MT_pre__SwcToEcuMapping.py___________________________________________________________
...
class graph_MT_pre__SwcToEcuMapping(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([93.0, 35.0, 93.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__SwcToEcuMapping', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__SwcToEcuMapping
