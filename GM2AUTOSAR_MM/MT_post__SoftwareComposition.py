"""
__MT_post__SoftwareComposition.py_____________________________________________________
...
from graph_MT_post__SoftwareComposition import *
class MT_post__SoftwareComposition(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__MetaModelElement_T']
      self.graphClass_ = graph_MT_post__SoftwareComposition
   ...
   def clone(self):
      cloneObject = MT_post__SoftwareComposition( self.parent )
