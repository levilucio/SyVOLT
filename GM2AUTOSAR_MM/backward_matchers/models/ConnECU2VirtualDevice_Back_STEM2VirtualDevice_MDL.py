"""
__ConnECU2VirtualDevice_Back_STEM2VirtualDevice_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Mon Aug 26 09:50:18 2013
...
def ConnECU2VirtualDevice_Back_STEM2VirtualDevice_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('ConnECU2VirtualDevice_Back_STEM2VirtualDevice')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MatchModel(60.0,40.0,self.obj47)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__ApplyModel(60.0,240.0,self.obj48)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__VirtualDevice(240.0,80.0,self.obj49)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj50.MT_label__.setValue('3')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__SwcToEcuMapping(240.0,260.0,self.obj50)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__paired_with(223.5,213.5,self.obj51)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__match_contains(314.5,133.5,self.obj52)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__apply_contains(321.0,323.5,self.obj53)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj57.MT_label__.setValue('9')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(412.0,243.5,self.obj57)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj47,self.obj51,[219.0, 113.0, 223.5, 213.5],"true", 2),
(self.obj47,self.obj52,[219.0, 113.0, 314.5, 133.5],"true", 2) )
    # Connections for obj48 (graphObject_: Obj1) of type MT_pre__ApplyModel
    self.drawConnections(
(self.obj48,self.obj53,[228.0, 314.0, 321.0, 323.5],"true", 2) )
