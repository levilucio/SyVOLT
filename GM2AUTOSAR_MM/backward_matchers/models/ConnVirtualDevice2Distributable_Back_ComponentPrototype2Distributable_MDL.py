"""
__ConnVirtualDevice2Distributable_Back_ComponentPrototype2Distributable_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Mon Aug 26 09:52:43 2013
...
def ConnVirtualDevice2Distributable_Back_ComponentPrototype2Distributable_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('ConnVirtualDevice2Distributable_Back_ComponentPrototype2Distributable')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MatchModel(80.0,60.0,self.obj47)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__ApplyModel(80.0,220.0,self.obj48)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Distributable(280.0,100.0,self.obj49)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj50=MT_pre__ComponentPrototype(self)
    ...
    self.obj50.graphClass_= graph_MT_pre__ComponentPrototype
    if self.genGraphics:
       new_obj = graph_MT_pre__ComponentPrototype(260.0,260.0,self.obj50)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__paired_with(243.5,213.5,self.obj51)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__match_contains(344.5,153.5,self.obj52)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__apply_contains(344.0,313.5,self.obj53)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(445.0,253.5,self.obj58)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_LHS(40.0,20.0,self.obj55)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj47,self.obj51,[239.0, 133.0, 243.5, 213.5],"true", 2),
(self.obj47,self.obj52,[239.0, 133.0, 344.5, 153.5],"true", 2) )
    # Connections for obj48 (graphObject_: Obj1) of type MT_pre__ApplyModel
    self.drawConnections(
(self.obj48,self.obj53,[248.0, 294.0, 344.0, 313.5],"true", 2) )
    # Connections for obj49 (graphObject_: Obj2) of type MT_pre__Distributable
    self.drawConnections(
 )
    # Connections for obj50 (graphObject_: Obj3) of type MT_pre__ComponentPrototype
    self.drawConnections(
(self.obj50,self.obj58,[440.0, 333.0, 445.0, 253.5],"true", 2) )
    # Connections for obj51 (graphObject_: Obj4) of type MT_pre__paired_with
    self.drawConnections(
(self.obj51,self.obj48,[243.5, 213.5, 248.0, 294.0],"true", 2) )
    # Connections for obj52 (graphObject_: Obj5) of type MT_pre__match_contains
    self.drawConnections(
(self.obj52,self.obj49,[344.5, 153.5, 450.0, 174.0],"true", 2) )
    # Connections for obj53 (graphObject_: Obj6) of type MT_pre__apply_contains
    self.drawConnections(
(self.obj53,self.obj50,[344.0, 313.5, 440.0, 333.0],"true", 2) )
    # Connections for obj58 (graphObject_: Obj9) of type MT_pre__trace_link
    self.drawConnections(
(self.obj58,self.obj49,[445.0, 253.5, 450.0, 174.0],"true", 2) )
    # Connections for obj55 (graphObject_: Obj8) of type LHS
    self.drawConnections(
 )

newfunction = ConnVirtualDevice2Distributable_Back_ComponentPrototype2Distributable_MDL
