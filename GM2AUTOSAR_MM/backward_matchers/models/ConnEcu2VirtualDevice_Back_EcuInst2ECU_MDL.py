"""
__ConnEcu2VirtualDevice_Back_EcuInst2ECU_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Mon Aug 26 09:49:22 2013
...
def ConnEcu2VirtualDevice_Back_EcuInst2ECU_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('ConnECU2VirtualDevice_Back_EcuInst2ECU')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MatchModel(60.0,80.0,self.obj47)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__ApplyModel(60.0,300.0,self.obj48)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__ECU(240.0,80.0,self.obj49)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj50=MT_pre__EcuInstance(self)
    ...
    self.obj50.graphClass_= graph_MT_pre__EcuInstance
    if self.genGraphics:
       new_obj = graph_MT_pre__EcuInstance(240.0,300.0,self.obj50)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__paired_with(223.5,263.5,self.obj51)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__match_contains(314.5,153.5,self.obj52)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__apply_contains(318.0,373.5,self.obj53)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(409.0,263.5,self.obj56)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj47,self.obj51,[219.0, 153.0, 223.5, 263.5],"true", 2),
(self.obj47,self.obj52,[219.0, 153.0, 314.5, 153.5],"true", 2) )
    # Connections for obj48 (graphObject_: Obj1) of type MT_pre__ApplyModel
    self.drawConnections(
(self.obj48,self.obj53,[228.0, 374.0, 318.0, 373.5],"true", 2) )
    # Connections for obj49 (graphObject_: Obj2) of type MT_pre__ECU
    self.drawConnections(
 )
    # Connections for obj50 (graphObject_: Obj3) of type MT_pre__EcuInstance
    self.drawConnections(
(self.obj50,self.obj56,[408.0, 373.0, 409.0, 263.5],"true", 2) )
    # Connections for obj51 (graphObject_: Obj4) of type MT_pre__paired_with
    self.drawConnections(
(self.obj51,self.obj48,[223.5, 263.5, 228.0, 374.0],"true", 2) )
    # Connections for obj52 (graphObject_: Obj5) of type MT_pre__match_contains
    self.drawConnections(
(self.obj52,self.obj49,[314.5, 153.5, 410.0, 154.0],"true", 2) )
    # Connections for obj53 (graphObject_: Obj6) of type MT_pre__apply_contains
    self.drawConnections(
(self.obj53,self.obj50,[318.0, 373.5, 408.0, 373.0],"true", 2) )
    # Connections for obj56 (graphObject_: Obj9) of type MT_pre__trace_link
    self.drawConnections(
(self.obj56,self.obj49,[409.0, 263.5, 410.0, 154.0],"true", 2) )
    # Connections for obj55 (graphObject_: Obj8) of type LHS
    self.drawConnections(
 )

newfunction = ConnEcu2VirtualDevice_Back_EcuInst2ECU_MDL
