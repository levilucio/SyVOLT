...
Author: levi
Modified: Mon Aug 26 09:48:28 2013
...
def ConnectRPortPrototype_Back_CompositionType2ECU_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__ECU(260.0,80.0,self.obj49)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__CompositionType(240.0,300.0,self.obj50)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__match_contains(324.5,153.5,self.obj52)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj53.MT_label__.setValue('7')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(419.0,263.5,self.obj56)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj47,self.obj52,[219.0, 153.0, 324.5, 153.5],"true", 2) )
...
(self.obj48,self.obj53,[228.0, 374.0, 318.0, 373.5],"true", 2) )
    ...
    self.drawConnections(
(self.obj50,self.obj56,[408.0, 373.0, 419.0, 263.5],"true", 2) )
...
(self.obj51,self.obj48,[223.5, 263.5, 228.0, 374.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj52,self.obj49,[324.5, 153.5, 430.0, 154.0],"true", 2) )
...
(self.obj53,self.obj50,[318.0, 373.5, 408.0, 373.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj56,self.obj49,[419.0, 263.5, 430.0, 154.0],"true", 2) )
