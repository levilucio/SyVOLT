"""
__ConnEcu2VirtualDevice_Back_SystemMapping2ECU_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Mon Aug 26 09:51:27 2013
...
def ConnEcu2VirtualDevice_Back_SystemMapping2ECU_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('ConnECU2VirtualDevice_Back_SystemMapping2ECU')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__ECU(260.0,120.0,self.obj49)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj50=MT_pre__SystemMapping(self)
    ...
    self.obj50.graphClass_= graph_MT_pre__SystemMapping
    if self.genGraphics:
       new_obj = graph_MT_pre__SystemMapping(260.0,280.0,self.obj50)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__paired_with(223.5,243.5,self.obj51)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__match_contains(324.5,173.5,self.obj52)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__apply_contains(329.5,343.5,self.obj53)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(430.5,273.5,self.obj58)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj47,self.obj51,[219.0, 153.0, 223.5, 243.5],"true", 2),
(self.obj47,self.obj52,[219.0, 153.0, 324.5, 173.5],"true", 2) )
    # Connections for obj48 (graphObject_: Obj1) of type MT_pre__ApplyModel
    self.drawConnections(
(self.obj48,self.obj53,[228.0, 334.0, 329.5, 343.5],"true", 2) )
    # Connections for obj49 (graphObject_: Obj2) of type MT_pre__ECU
    self.drawConnections(
 )
    # Connections for obj50 (graphObject_: Obj3) of type MT_pre__SystemMapping
    self.drawConnections(
(self.obj50,self.obj58,[431.0, 353.0, 430.5, 273.5],"true", 2) )
    # Connections for obj51 (graphObject_: Obj4) of type MT_pre__paired_with
    self.drawConnections(
(self.obj51,self.obj48,[223.5, 243.5, 228.0, 334.0],"true", 2) )
    # Connections for obj52 (graphObject_: Obj5) of type MT_pre__match_contains
    self.drawConnections(
(self.obj52,self.obj49,[324.5, 173.5, 430.0, 194.0],"true", 2) )
    # Connections for obj53 (graphObject_: Obj6) of type MT_pre__apply_contains
    self.drawConnections(
(self.obj53,self.obj50,[329.5, 343.5, 431.0, 353.0],"true", 2) )
    # Connections for obj58 (graphObject_: Obj9) of type MT_pre__trace_link
    self.drawConnections(
(self.obj58,self.obj49,[430.5, 273.5, 430.0, 194.0],"true", 2) )
    # Connections for obj55 (graphObject_: Obj8) of type LHS
    self.drawConnections(
 )

newfunction = ConnEcu2VirtualDevice_Back_SystemMapping2ECU_MDL
