...
def ConnVirtualDevice2Distributable_Back_SCTEMc2Distributable_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    self.obj50=MT_pre__SwCompToEcuMapping_component(self)
    ...
    self.obj50.graphClass_= graph_MT_pre__SwCompToEcuMapping_component
    if self.genGraphics:
       new_obj = graph_MT_pre__SwCompToEcuMapping_component(280.0,280.0,self.obj50)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__paired_with(236.0,233.5,self.obj51)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__match_contains(341.0,173.5,self.obj52)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__apply_contains(344.0,333.5,self.obj53)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(449.0,273.5,self.obj56)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_LHS(40.0,40.0,self.obj55)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj47,self.obj51,[232.0, 153.0, 236.0, 233.5],"true", 2),
(self.obj47,self.obj52,[232.0, 153.0, 341.0, 173.5],"true", 2) )
    # Connections for obj48 (graphObject_: Obj1) of type MT_pre__ApplyModel
    self.drawConnections(
(self.obj48,self.obj53,[240.0, 314.0, 344.0, 333.5],"true", 2) )
    # Connections for obj49 (graphObject_: Obj2) of type MT_pre__Distributable
    self.drawConnections(
 )
    # Connections for obj50 (graphObject_: Obj3) of type MT_pre__SwCompToEcuMapping_component
    self.drawConnections(
(self.obj50,self.obj56,[448.0, 353.0, 449.0, 273.5],"true", 2) )
    # Connections for obj51 (graphObject_: Obj4) of type MT_pre__paired_with
    self.drawConnections(
(self.obj51,self.obj48,[236.0, 233.5, 240.0, 314.0],"true", 2) )
    # Connections for obj52 (graphObject_: Obj5) of type MT_pre__match_contains
    self.drawConnections(
(self.obj52,self.obj49,[341.0, 173.5, 450.0, 194.0],"true", 2) )
    # Connections for obj53 (graphObject_: Obj6) of type MT_pre__apply_contains
    self.drawConnections(
(self.obj53,self.obj50,[344.0, 333.5, 448.0, 353.0],"true", 2) )
    # Connections for obj56 (graphObject_: Obj9) of type MT_pre__trace_link
    self.drawConnections(
(self.obj56,self.obj49,[449.0, 273.5, 450.0, 194.0],"true", 2) )
    # Connections for obj55 (graphObject_: Obj8) of type LHS
    self.drawConnections(
 )

newfunction = ConnVirtualDevice2Distributable_Back_SCTEMc2Distributable_MDL
