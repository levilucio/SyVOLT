...
class HConnVirtualDevice2Distributable_Back_CompleteLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HConnVirtualDevice2Distributable_Back_CompleteLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HConnVirtualDevice2Distributable_Back_CompleteLHS, self).__init__(name='HConnVirtualDevice2Distributable_Back_CompleteLHS', num_nodes=13, edges=[])
        
        # Add the edges
        self.add_edges([(7, 0), (11, 0), (0, 8), (8, 1), (10, 1), (12, 1), (9, 2), (2, 7), (3, 9), (4, 10), (5, 11), (6, 12)])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('ae776a90-613c-478e-a080-1f9e5aa8b768')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('fc1435b8-ea8c-4876-be87-d105123be52f')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('a1d7965e-1a40-4d1e-b839-30cb7679b54e')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('a77dea11-6a31-4435-a470-94029dcf5c34')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('90a5c9ff-481d-40d7-80f1-96b8fc67bffd')
...
return True
"""
        self.vs[4]["GUID__"] = UUID('d1394b69-9a1b-4fdd-9928-17e3ed0d10f2')
...
return True
"""
        self.vs[5]["GUID__"] = UUID('3142687f-0079-47f0-b65f-bcae4534e407')
...
.""")
        ...
        self.vs[6]["mm__"] = """MT_pre__SwCompToEcuMapping_component"""
...
return True
"""
        self.vs[6]["GUID__"] = UUID('c8f6c287-6c10-4ed0-a602-da9a1b1caa66')
...
.""")
        ...
        self.vs[7]["GUID__"] = UUID('4e4a67fc-3153-45a5-92da-45f43c5b3a17')
...
.""")
        ...
        self.vs[8]["GUID__"] = UUID('780f0a81-4554-4825-b74e-26fb91ccf24c')
...
.""")
        ...
        self.vs[9]["GUID__"] = UUID('d93bba12-a193-42e7-9782-7eb7d349b876')
        self.vs[10]["MT_subtypeMatching__"] = False
        self.vs[10]["MT_label__"] = """9"""
        self.vs[10]["MT_subtypes__"] = pickle.loads("""(lp1
.""")
        self.vs[10]["MT_dirty__"] = False
        self.vs[10]["mm__"] = """MT_pre__trace_link"""
        self.vs[10]["GUID__"] = UUID('7c05bd93-4c78-428c-ae4e-c4fcc2228866')
...
.""")
        ...
        self.vs[11]["GUID__"] = UUID('aecaa8e1-2fbd-40d7-ab73-f524c1140215')
...
.""")
        ...
        self.vs[12]["GUID__"] = UUID('1a8ed791-11cb-49f7-bf7f-84d3b0f236bc')
