"""
__move_one_input_direct_match_diff_rules_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Wed Aug 21 16:31:45 2013
...
def move_one_input_direct_match_diff_rules_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MoveOneInputDirectMatchDiffRules')
    # --- ASG attributes over ---
...
newfunction = move_one_input_direct_match_diff_rules_MDL
