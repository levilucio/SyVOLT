...
Author: levi
Modified: Mon Jul 29 15:51:56 2013
...
def move_one_output_indirect_match_diff_rules_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MoveOneOutputIndirectMatchDiffRules')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(35.0,300.0,self.obj87)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(140.0,162.0,self.obj88)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    # MT_label__
    self.obj89.MT_label__.setValue('5')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(240.0,300.0,self.obj89)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj90=MT_pre__indirectLink_S(self)
    ...
    # MT_label__
    self.obj90.MT_label__.setValue('9')
    ...
    self.obj90.graphClass_= graph_MT_pre__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(360.0,305.0,self.obj90)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj91.MT_label__.setValue('3')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(560.0,300.0,self.obj91)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj92.MT_label__.setValue('4')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(660.0,160.0,self.obj92)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj93=MT_post__MetaModelElement_S(self)
    ...
    # MT_label__
    self.obj93.MT_label__.setValue('5')
    ...
    self.obj93.graphClass_= graph_MT_post__MetaModelElement_S
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(760.0,300.0,self.obj93)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj94=MT_post__indirectLink_S(self)
    ...
    # MT_label__
    self.obj94.MT_label__.setValue('19')

    # MT_pivotOut__
    self.obj94.MT_pivotOut__.setValue('')
    self.obj94.MT_pivotOut__.setNone()

    self.obj94.graphClass_= graph_MT_post__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_post__indirectLink_S(745.0,374.0,self.obj94)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_RHS(440.0,60.0,self.obj95)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj96.constraint.setValue('#if len([i for i in graph.neighbors(PreNode(\'5\').index) if graph.vs[i][\'mm__\'] == \'match_contains\']) == 0:\n#    return True\n\n#return False\nreturn True\n')
    self.obj96.constraint.setHeight(15)

    self.obj96.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(20.0,60.0,self.obj96)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.drawConnections(
(self.obj88,self.obj90,[310.0, 236.0, 360.0, 305.0],"true", 2) )
    # Connections for obj89 (graphObject_: Obj2) of type MT_pre__MetaModelElement_S
    self.drawConnections(
 )
    # Connections for obj90 (graphObject_: Obj3) of type MT_pre__indirectLink_S
    self.drawConnections(
(self.obj90,self.obj89,[360.0, 305.0, 410.0, 374.0],"true", 2) )
    # Connections for obj91 (graphObject_: Obj4) of type MT_post__MetaModelElement_S
    self.drawConnections(
(self.obj91,self.obj94,[730.0, 374.0, 745.0, 374.0],"true", 2) )
    # Connections for obj92 (graphObject_: Obj5) of type MT_post__MetaModelElement_S
    self.drawConnections(
 )
    # Connections for obj93 (graphObject_: Obj6) of type MT_post__MetaModelElement_S
    self.drawConnections(
 )
    # Connections for obj94 (graphObject_: Obj7) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj94,self.obj93,[745.0, 374.0, 930.0, 374.0],"true", 2) )
...
newfunction = move_one_output_indirect_match_diff_rules_MDL
