"""
__graph_MT_pre__MatchModel.py___________________________________________________________
...
class graph_MT_pre__MatchModel(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([73.0, 50.0, 73.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__MatchModel', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__MatchModel
