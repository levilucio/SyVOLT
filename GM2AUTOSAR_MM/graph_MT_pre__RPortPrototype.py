"""
__graph_MT_pre__RPortPrototype.py___________________________________________________________
...
class graph_MT_pre__RPortPrototype(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([85.0, 32.0, 85.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__RPortPrototype', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__RPortPrototype
