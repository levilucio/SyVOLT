"""
__MT_post__PPortPrototype.py_____________________________________________________
...
from graph_MT_post__PPortPrototype import *
class MT_post__PPortPrototype(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__MetaModelElement_T']
      self.graphClass_ = graph_MT_post__PPortPrototype
   ...
   def clone(self):
      cloneObject = MT_post__PPortPrototype( self.parent )
