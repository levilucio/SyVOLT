"""
__graph_MT_pre__EcuInstance.py___________________________________________________________
...
class graph_MT_pre__EcuInstance(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([97.0, 30.0, 97.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__EcuInstance', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_pre__EcuInstance
