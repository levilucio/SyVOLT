"""
__graph_RPortPrototype.py___________________________________________________________
...
class graph_RPortPrototype(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([85.0, 32.0, 85.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'RPortPrototype', width = '0', justify= 'left', stipple='' )
        ...
        h = drawing.create_text(self.translate([64.0, 62.0, 64.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
...
new_class = graph_RPortPrototype
