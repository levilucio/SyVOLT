...
class graph_MT_pre__Signal(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([77.0, 35.0, 77.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__Signal', width = '0', justify= 'left', stipple='' )
