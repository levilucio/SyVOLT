...
Author: levi
Modified: Sat Aug 24 20:16:53 2013
...
def MT_post__GM2AUTOSAR_MM_MDL(self, rootNode, CD_ClassDiagramsV3RootNode=None):
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(-6.0,0.0,self.obj136)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
...
(self.obj90,self.obj114,[274.8359375, 690.0, 446.046746295, 686.241003922],"true", 2) )
    ...
    self.drawConnections(
(self.obj91,self.obj112,[793.6640625, 111.0573770491803, 1018.3561700079981, 75.74024999999999, 1018.3561700099999, 75.74025],"true", 3),
(self.obj91,self.obj115,[793.6640625, 156.1213114754098, 1273.3561700079981, 158.99844672131144, 1273.35617001, 158.998446721],"true", 3) )
    # Connections for obj92 (graphObject_: Obj77) named MT_post__MetaModelElement_T
    self.drawConnections(
(self.obj92,self.obj113,[811.0, 645.3196721311475, 1316.3611994201624, 658.7410039215686, 1316.36119942, 658.741003922],"true", 3),
(self.obj92,self.obj116,[811.0, 630.688524590164, 1334.0076837951624, 406.61395474124066, 1335.6819269, 322.343085977],"true", 3),
(self.obj92,self.obj117,[811.0, 630.688524590164, 1132.0, 606.0, 1334.0, 485.0],"true", 3) )
...
(self.obj109,self.obj128,[708.0, 978.0, 707.5, 852.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj135,self.obj136,[1.0, 41.0, -9.0, 5.0], 0, 2) )
...
(self.obj110,self.obj90,[153.0, 394.0, 150.3125, 622.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj111,self.obj91,[425.350433087, 120.205, 600.3984375, 111.0573770491803],"true", 2) )
    # Connections for obj112 (graphObject_: Obj99) named MT_post__directLink_S
    self.drawConnections(
(self.obj112,self.obj91,[1018.3561700099999, 75.74025, 1018.3561700079981, 75.74024999999999, 793.6640625, 111.0573770491803],"true", 3) )
    # Connections for obj113 (graphObject_: Obj101) named MT_post__directLink_T
    self.drawConnections(
(self.obj113,self.obj92,[1316.36119942, 658.741003922, 1316.3611994201624, 658.7410039215686, 811.0, 645.3196721311475],"true", 3) )
    # Connections for obj114 (graphObject_: Obj103) named MT_post__apply_contains
    self.drawConnections(
(self.obj114,self.obj92,[446.046746295, 686.241003922, 621.0, 682.1901639344262],"true", 2) )
    # Connections for obj115 (graphObject_: Obj105) named MT_post__indirectLink_S
    self.drawConnections(
(self.obj115,self.obj91,[1273.35617001, 158.998446721, 1273.3561700079981, 158.99844672131144, 793.6640625, 156.1213114754098],"true", 3) )
    # Connections for obj116 (graphObject_: Obj107) named MT_post__backward_link
    self.drawConnections(
(self.obj116,self.obj91,[1335.6819269, 322.343085977, 1337.3561700079981, 238.0722172131147, 793.6640625, 236.88524590163934],"true", 3) )
    # Connections for obj117 (graphObject_: Obj109) named MT_post__trace_link
    self.drawConnections(
(self.obj117,self.obj91,[1334.0, 485.0, 1154.0, 328.0, 793.6640625, 236.88524590163934],"true", 3) )
    # Connections for obj136 (graphObject_: Obj146) named MT_post__GenericEdge_GM2AUTOSAR_MM
    self.drawConnections(
(self.obj136,self.obj135,[-8.0, 5.0, 185.1875, 1.0], 0, 2),
(self.obj136,self.obj89,[-6.48, 5.0, 162.0, 51.0], 0, 2),
(self.obj136,self.obj90,[-6.48, 5.0, 150.3125, 622.0], 0, 2),
(self.obj136,self.obj91,[-6.48, 5.0, 600.3984375, 117.42622950819671], 0, 2),
(self.obj136,self.obj92,[-6.48, 5.0, 656.0, 593.1639344262295], 0, 2),
(self.obj136,self.obj93,[-6.48, 5.0, 350.0, 211.0], 0, 2),
(self.obj136,self.obj94,[-6.48, 5.0, 336.0, 381.0], 0, 2),
(self.obj136,self.obj95,[-6.48, 5.0, 556.0, 381.0], 0, 2),
(self.obj136,self.obj96,[-6.48, 5.0, 741.0, 421.0], 0, 2),
(self.obj136,self.obj97,[-6.48, 5.0, 941.0, 301.0], 0, 2),
(self.obj136,self.obj98,[-6.48, 5.0, 187.0, 820.0], 0, 2),
(self.obj136,self.obj99,[-6.48, 5.0, 272.0, 819.0], 0, 2),
(self.obj136,self.obj100,[-6.48, 5.0, 330.0, 1157.0], 0, 2),
(self.obj136,self.obj101,[-6.48, 5.0, 534.0, 1157.0], 0, 2),
(self.obj136,self.obj102,[-6.48, 5.0, 195.0, 979.0], 0, 2),
(self.obj136,self.obj103,[-6.48, 5.0, 735.0, 1158.0], 0, 2),
(self.obj136,self.obj104,[-6.48, 5.0, 936.0, 1161.0], 0, 2),
(self.obj136,self.obj105,[-6.48, 5.0, 450.0, 978.0], 0, 2),
(self.obj136,self.obj106,[-6.48, 5.0, 491.0, 818.0], 0, 2),
(self.obj136,self.obj107,[-6.48, 5.0, 985.53125, 858.0], 0, 2),
(self.obj136,self.obj108,[-6.48, 5.0, 956.0, 978.0], 0, 2),
(self.obj136,self.obj109,[-6.48, 5.0, 708.0, 978.0], 0, 2),
(self.obj136,self.obj135,[-8.0, 5.0, 185.1875, 1.0], 0, 2) )
    # Connections for obj118 (graphObject_: Obj111) of type CD_Inheritance3
    self.drawConnections(
(self.obj118,self.obj91,[545.94511815, 232.933238441, 600.3984375, 239.81147540983605],"true", 2) )
    # Connections for obj119 (graphObject_: Obj113) of type CD_Inheritance3
    self.drawConnections(
(self.obj119,self.obj91,[581.0, 302.0, 636.0, 272.0],"true", 2) )
...
(self.obj121,self.obj91,[797.03125, 316.5, 758.0625, 272.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj122,self.obj91,[907.33203125, 291.868852459, 793.6640625, 239.81147540983605],"true", 2) )
    # Connections for obj123 (graphObject_: Obj121) of type CD_Inheritance3
    self.drawConnections(
(self.obj123,self.obj92,[494.910784314, 787.069775845, 621.0, 750.6639344262295],"true", 2) )
    # Connections for obj124 (graphObject_: Obj123) of type CD_Inheritance3
    self.drawConnections(
(self.obj124,self.obj92,[599.0, 787.515081967, 621.0, 750.6639344262295],"true", 2) )
...
(self.obj128,self.obj92,[707.5, 852.0, 696.0, 777.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj129,self.obj92,[559.0, 839.295081967, 621.0, 750.6639344262295],"true", 2) )
    # Connections for obj130 (graphObject_: Obj135) of type CD_Inheritance3
    self.drawConnections(
(self.obj130,self.obj92,[476.127935606, 859.105081967, 621.0, 750.6639344262295],"true", 2) )
