"""
__forward_cardinalities_to_applymodel_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Fri Aug 23 13:55:08 2013
...
def forward_cardinalities_to_applymodel_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('ForwardCardinalitiesToApplyModel')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(260.0,140.0,self.obj71)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_T(260.0,320.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(800.0,140.0,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_T(800.0,320.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # action
    self.obj75.action.setValue('PostNode(\'2\')[\'cardinality\'] = \'+\'\n')
    self.obj75.action.setHeight(15)

    self.obj75.graphClass_= graph_RHS
    if self.genGraphics:
       new_obj = graph_RHS(620.0,100.0,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj76.constraint.setValue('if PreNode(\'1\')[\'cardinality\'] == \'+\' and PreNode(\'2\')[\'cardinality\'] != \'+\':\n    return True\n\nreturn False\n')
    self.obj76.constraint.setHeight(15)

    self.obj76.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(160.0,100.0,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
...
newfunction = forward_cardinalities_to_applymodel_MDL
