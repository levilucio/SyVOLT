"""
__SwCompToEcuMapping_component.py_____________________________________________________
...
class SwCompToEcuMapping_component(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MetaModelElement_T']
      self.graphClass_ = graph_SwCompToEcuMapping_component
   ...
   def clone(self):
      cloneObject = SwCompToEcuMapping_component( self.parent )
