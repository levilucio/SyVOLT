"""
__find_two_apply_elements_with_trace_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Fri Sep  6 16:48:01 2013
...
def find_two_apply_elements_with_trace_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('FindTwoApplyElementsWithTrace')
    # --- ASG attributes over ---
    ...
    # MT_label__
    self.obj76.MT_label__.setValue('12')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__backward_link(462.5,335.5,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(352.5,335.5,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj82.MT_label__.setValue('11')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(839.0,333.5,self.obj82)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj83=MT_post__apply_contains(self)
    ...
    self.obj83.graphClass_= graph_MT_post__apply_contains
    if self.genGraphics:
       new_obj = graph_MT_post__apply_contains(768.0,463.5,self.obj83)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_LHS(60.0,180.0,self.obj85)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj71,self.obj75,[273.0, 534.0, 274.0, 465.5],"true", 2) )
    ...
    self.drawConnections(
(self.obj73,self.obj77,[275.0, 397.0, 352.5, 335.5],"true", 2) )
    # Connections for obj74 (graphObject_: Obj3) of type MT_pre__MetaModelElement_T
    self.drawConnections(
(self.obj74,self.obj76,[495.0, 397.0, 462.5, 335.5],"true", 2) )
...
(self.obj75,self.obj73,[274.0, 465.5, 275.0, 397.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj76,self.obj72,[462.5, 335.5, 430.0, 274.0],"true", 2) )
    # Connections for obj77 (graphObject_: Obj6) of type MT_pre__trace_link
    self.drawConnections(
(self.obj77,self.obj72,[352.5, 335.5, 430.0, 274.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj79,self.obj82,[768.0, 393.0, 839.0, 333.5],"true", 2) )
    ...
    self.drawConnections(
(self.obj81,self.obj83,[768.0, 534.0, 768.0, 463.5],"true", 2) )
    # Connections for obj82 (graphObject_: Obj11) of type MT_post__trace_link
    self.drawConnections(
(self.obj82,self.obj78,[839.0, 333.5, 910.0, 274.0],"true", 2) )
    # Connections for obj83 (graphObject_: Obj12) of type MT_post__apply_contains
    self.drawConnections(
(self.obj83,self.obj79,[768.0, 463.5, 768.0, 393.0],"true", 2) )
...
newfunction = find_two_apply_elements_with_trace_MDL
