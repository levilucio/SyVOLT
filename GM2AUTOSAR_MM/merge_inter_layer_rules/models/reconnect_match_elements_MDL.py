"""
__reconnect_match_elements_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Mon Jun  3 16:42:42 2013
...
def reconnect_match_elements_MDL(self, rootNode, MT_post__GM2AUTOSAR_MMRootNode=None, MT_pre__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('ReconnectMatchElements')
    # --- ASG attributes over ---


    self.obj87=MT_post__MatchModel(self)
    ...
    self.obj87.graphClass_= graph_MT_post__MatchModel
    if self.genGraphics:
       new_obj = graph_MT_post__MatchModel(740.0,160.0,self.obj87)
    ...
    self.obj88=MT_post__MetaModelElement_S(self)
    ...
    self.obj88.graphClass_= graph_MT_post__MetaModelElement_S
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(740.0,320.0,self.obj88)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj89=MT_post__match_contains(self)
    ...
    self.obj89.graphClass_= graph_MT_post__match_contains
    if self.genGraphics:
       new_obj = graph_MT_post__match_contains(906.0,313.5,self.obj89)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj92=MT_pre__MatchModel(self)
    ...
    self.obj92.graphClass_= graph_MT_pre__MatchModel
    if self.genGraphics:
       new_obj = graph_MT_pre__MatchModel(220.0,140.0,self.obj92)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj93=MT_pre__MetaModelElement_S(self)
    ...
    # MT_label__
    self.obj93.MT_label__.setValue('2')

    # MT_pre__name
    self.obj93.MT_pre__name.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj93.MT_pre__name.setHeight(15)

    self.obj93.graphClass_= graph_MT_pre__MetaModelElement_S
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(220.0,320.0,self.obj93)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_RHS(540.0,100.0,self.obj90)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj91.constraint.setValue('if len([i for i in graph.neighbors(PreNode(\'2\').index) if graph.vs[i][\'mm__\'] == \'match_contains\']) == 0:\n    return True\n\nreturn False\n')
    self.obj91.constraint.setHeight(15)

    self.obj91.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(120.0,100.0,self.obj91)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # Connections for obj87 (graphObject_: Obj0) of type MT_post__MatchModel
    self.drawConnections(
(self.obj87,self.obj89,[902.0, 233.0, 906.0, 313.5],"true", 2) )
    # Connections for obj88 (graphObject_: Obj1) of type MT_post__MetaModelElement_S
    self.drawConnections(
 )
    # Connections for obj89 (graphObject_: Obj2) of type MT_post__match_contains
    self.drawConnections(
(self.obj89,self.obj88,[906.0, 313.5, 910.0, 394.0],"true", 2) )
    # Connections for obj92 (graphObject_: Obj5) of type MT_pre__MatchModel
    self.drawConnections(
 )
    # Connections for obj93 (graphObject_: Obj6) of type MT_pre__MetaModelElement_S
    self.drawConnections(
 )
    # Connections for obj90 (graphObject_: Obj3) of type RHS
    self.drawConnections(
 )
    # Connections for obj91 (graphObject_: Obj4) of type LHS
    self.drawConnections(
 )

newfunction = reconnect_match_elements_MDL
