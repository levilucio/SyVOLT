...
def move_one_output_repeated_indirect_match_diff_rules_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MoveOneOutputRepeatedIndirectMatchDiffRules')
    # --- ASG attributes over ---
    ...
    self.obj81=MT_pre__indirectLink_S(self)
    ...
    self.obj81.graphClass_= graph_MT_pre__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(307.5,374.0,self.obj81)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__indirectLink_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(660.0,160.0,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(760.0,300.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
...
(self.obj71,self.obj81,[205.0, 374.0, 307.5, 374.0],"true", 2) )
...
(self.obj74,self.obj73,[360.0, 305.0, 410.0, 374.0],"true", 2) )
    # Connections for obj81 (graphObject_: Obj10) of type MT_pre__indirectLink_S
    self.drawConnections(
(self.obj81,self.obj73,[307.5, 374.0, 410.0, 374.0],"true", 2) )
...
newfunction = move_one_output_repeated_indirect_match_diff_rules_MDL
