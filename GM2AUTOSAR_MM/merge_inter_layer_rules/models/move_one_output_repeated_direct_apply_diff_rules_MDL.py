"""
__move_one_output_repeated_direct_apply_diff_rules_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Tue Aug 20 20:04:12 2013
...
def move_one_output_repeated_direct_apply_diff_rules_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MoveOneOutputRepeatedDirectApplyDiffRules')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_T(34.0,302.0,self.obj71)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_T(140.0,156.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__MetaModelElement_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_T(243.0,300.0,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__MetaModelElement_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_T(359.5,301.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj82=MT_pre__directLink_T(self)
    ...
    # MT_pre__associationType
    self.obj82.MT_pre__associationType.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj82.MT_pre__associationType.setHeight(15)

    self.obj82.graphClass_= graph_MT_pre__directLink_T
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_T(306.5,374.0,self.obj82)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj75=MT_post__MetaModelElement_T(self)
    ...
    self.obj75.graphClass_= graph_MT_post__MetaModelElement_T
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_T(560.0,300.0,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_T(640.0,160.0,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_T(757.0,300.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_RHS(440.0,80.0,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_LHS(20.0,80.0,self.obj80)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj71,self.obj82,[202.0, 375.0, 306.5, 374.0],"true", 2) )
    # Connections for obj72 (graphObject_: Obj1) of type MT_pre__MetaModelElement_T
    self.drawConnections(
(self.obj72,self.obj74,[308.0, 229.0, 359.5, 301.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj74,self.obj73,[359.5, 301.0, 411.0, 373.0],"true", 2) )
    # Connections for obj82 (graphObject_: Obj10) of type MT_pre__directLink_T
    self.drawConnections(
(self.obj82,self.obj73,[306.5, 374.0, 411.0, 373.0],"true", 2) )
    # Connections for obj75 (graphObject_: Obj4) of type MT_post__MetaModelElement_T
    self.drawConnections(
 )
...
newfunction = move_one_output_repeated_direct_apply_diff_rules_MDL
