...
Author: levi
Modified: Sat Aug 24 20:15:40 2013
...
def GM2AUTOSAR_MM_MDL(self, rootNode, CD_ClassDiagramsV3RootNode=None):
    ...
    if self.genGraphics:
       ...
       new_obj.layConstraints['scale'] = [1.0171875000000001, 1.755737704918033]
    else: new_obj = None
    ...
    if self.genGraphics:
       ...
       new_obj.layConstraints['scale'] = [1.0, 1.4631147540983607]
    else: new_obj = None
