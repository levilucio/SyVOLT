"""
__graph_SwcToEcuMapping.py___________________________________________________________
...
class graph_SwcToEcuMapping(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([93.0, 35.0, 93.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'SwcToEcuMapping', width = '0', justify= 'left', stipple='' )
        ...
        h = drawing.create_text(self.translate([75.0, 69.0, 75.0, 12.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
...
new_class = graph_SwcToEcuMapping
