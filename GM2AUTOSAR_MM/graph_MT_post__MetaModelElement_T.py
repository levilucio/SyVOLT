"""
__graph_MT_post__MetaModelElement_T.py___________________________________________________________
...
class graph_MT_post__MetaModelElement_T(graphEntity):
...
new_class = graph_MT_post__MetaModelElement_T
