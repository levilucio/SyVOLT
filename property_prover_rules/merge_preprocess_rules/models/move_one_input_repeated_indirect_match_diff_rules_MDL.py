"""
__move_one_input_repeated_indirect_match_diff_rules_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Mon Aug 19 17:32:48 2013
...
def move_one_input_repeated_indirect_match_diff_rules_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MoveOneInputRepeatedIndirectMatchDiffRules')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(31.0,300.0,self.obj71)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(139.0,162.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(246.0,300.0,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj74=MT_pre__indirectLink_S(self)
    ...
    self.obj74.graphClass_= graph_MT_pre__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(362.5,305.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj121=MT_pre__indirectLink_S(self)
    ...
    # MT_label__
    self.obj121.MT_label__.setValue('10')
    ...
    self.obj121.graphClass_= graph_MT_pre__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(308.5,374.0,self.obj121)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__indirectLink_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(560.0,160.0,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(760.0,160.0,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(759.0,300.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj78=MT_post__indirectLink_S(self)
    ...
    # MT_label__
    self.obj78.MT_label__.setValue('10')

    # MT_pivotOut__
    self.obj78.MT_pivotOut__.setValue('')
    self.obj78.MT_pivotOut__.setNone()

    self.obj78.graphClass_= graph_MT_post__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_post__indirectLink_S(829.5,304.0,self.obj78)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_RHS(460.0,40.0,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj80.constraint.setValue('if PreNode(\'9\')[\'associationType\'] == PreNode(\'10\')[\'associationType\']:\n    return True\n\nreturn False\n')
    self.obj80.constraint.setHeight(15)

    self.obj80.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(20.0,40.0,self.obj80)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.drawConnections(
(self.obj73,self.obj74,[416.0, 374.0, 362.5, 305.0],"true", 2),
(self.obj73,self.obj121,[416.0, 374.0, 308.5, 374.0],"true", 2) )
    # Connections for obj74 (graphObject_: Obj3) of type MT_pre__indirectLink_S
    self.drawConnections(
(self.obj74,self.obj72,[362.5, 305.0, 309.0, 236.0],"true", 2) )
    # Connections for obj121 (graphObject_: Obj19) of type MT_pre__indirectLink_S
    self.drawConnections(
(self.obj121,self.obj71,[308.5, 374.0, 201.0, 374.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj77,self.obj78,[929.0, 374.0, 829.5, 304.0],"true", 2) )
    # Connections for obj78 (graphObject_: Obj7) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj78,self.obj75,[829.5, 304.0, 730.0, 234.0],"true", 2) )
...
newfunction = move_one_input_repeated_indirect_match_diff_rules_MDL
