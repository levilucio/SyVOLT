...
class HMoveOneInputRepeatedIndirectMatchDiffRulesRHS(HimesisPostConditionPattern):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMoveOneInputRepeatedIndirectMatchDiffRulesRHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HMoveOneInputRepeatedIndirectMatchDiffRulesRHS, self).__init__(name='HMoveOneInputRepeatedIndirectMatchDiffRulesRHS', num_nodes=4, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('46a46621-cb19-4830-8dea-7bdda8f1b9bf')
        
        # Set the node attributes
        self.vs[0]["MT_label__"] = """10"""
        self.vs[0]["mm__"] = """MT_post__indirectLink_S"""
        self.vs[0]["GUID__"] = UUID('6b5a3d9e-ba31-4a64-9d47-4419ed298fb3')
...
return attr_value
"""
        self.vs[1]["GUID__"] = UUID('6df5a27a-d430-436d-8bb1-833df55adcba')
...
return attr_value
"""
        self.vs[2]["GUID__"] = UUID('7429d448-72bd-4cb1-8aa6-fab3f5f61632')
...
return attr_value
"""
        self.vs[3]["GUID__"] = UUID('87215a9d-6f48-4acf-95f2-5cfac637a9e8')

        from HMoveOneInputRepeatedIndirectMatchDiffRulesLHS import HMoveOneInputRepeatedIndirectMatchDiffRulesLHS
        self.pre = HMoveOneInputRepeatedIndirectMatchDiffRulesLHS()
