...
class HMoveOneInputTraceLinkLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMoveOneInputTraceLinkLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HMoveOneInputTraceLinkLHS, self).__init__(name='HMoveOneInputTraceLinkLHS', num_nodes=4, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('b8af45db-7f94-4a1e-82ce-98a808b8c03d')
...
"""
        ...
        self.vs[0]["GUID__"] = UUID('34e838db-2d84-4fad-82d7-e94f62acbb3e')
...
.""")
        ...
        self.vs[1]["GUID__"] = UUID('5ae23021-a9fb-40e4-9152-4e93a4865b1b')
...
"""
        ...
        self.vs[2]["GUID__"] = UUID('31c2e2f7-4f4e-455b-a66d-9879f1dba07f')
...
"""
        ...
        self.vs[3]["GUID__"] = UUID('0e8f0029-7321-41b3-b6fc-1799942f1fc0')
