...
class HMoveOneOutputDirectApplyDiffRulesRHS(HimesisPostConditionPattern):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMoveOneOutputDirectApplyDiffRulesRHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HMoveOneOutputDirectApplyDiffRulesRHS, self).__init__(name='HMoveOneOutputDirectApplyDiffRulesRHS', num_nodes=4, edges=[])
...
.""")
        self["name"] = """"""
        self["GUID__"] = UUID('e1e8d603-c452-4679-8d7e-3ab7a5ae9800')
...
"""
        ...
        self.vs[0]["GUID__"] = UUID('1f37b795-aaa0-4856-82ed-b142008eebc8')
...
return attr_value
"""
        self.vs[1]["GUID__"] = UUID('b0ba89d3-8427-4de0-aa8c-1e603561063c')
...
return attr_value
"""
        self.vs[2]["GUID__"] = UUID('865d6aad-a4fb-4152-9259-5f13b83ea280')
...
return attr_value
"""
        self.vs[3]["GUID__"] = UUID('41e91004-0ec2-41af-90ad-1bdb5fa7e168')

        from HMoveOneOutputDirectApplyDiffRulesLHS import HMoveOneOutputDirectApplyDiffRulesLHS
        self.pre = HMoveOneOutputDirectApplyDiffRulesLHS()
    ...
    def execute(self, packet, match):
        ...
        # Create new edges
        #===============================================================================
        # MetaModelElement_T3 -> directLink_T19
        graph.add_edges([(labels['3'], labels['19'])])
        # directLink_T19 -> MetaModelElement_T5
