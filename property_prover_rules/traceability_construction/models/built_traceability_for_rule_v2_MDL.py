...
def built_traceability_for_rule_v2_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    self.obj76=MT_pre__MatchModel(self)
    ...
    self.obj77=MT_pre__ApplyModel(self)
    ...
    self.obj78=MT_pre__MetaModelElement_S(self)
    ...
    self.obj79=MT_pre__MetaModelElement_T(self)
    ...
    # constraint
    self.obj74.constraint.setValue('if set([i for i in graph.neighbors(PreNode(\'1\').index) if graph.vs[i][\'mm__\'] == \'trace_link\']).intersection(set([i for i in graph.neighbors(PreNode(\'2\').index) if graph.vs[i][\'mm__\'] == \'trace_link\'])) == set():\n    return True\n\nreturn False\n')
