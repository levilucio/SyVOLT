...
Author: levi
Modified: Wed May  6 16:14:11 2015
...
def built_traceability_for_rule_MDL(self, rootNode, MT_post__GM2AUTOSAR_MMRootNode=None, MT_pre__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    self.obj71=MT_post__MatchModel(self)
    ...
    self.obj71.graphClass_= graph_MT_post__MatchModel
    if self.genGraphics:
       new_obj = graph_MT_post__MatchModel(680.0,200.0,self.obj71)
    ...
    self.obj72=MT_post__ApplyModel(self)
    ...
    self.obj72.graphClass_= graph_MT_post__ApplyModel
    if self.genGraphics:
       new_obj = graph_MT_post__ApplyModel(680.0,340.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(856.0,232.0,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj74=MT_post__MetaModelElement_T(self)
    ...
    self.obj74.graphClass_= graph_MT_post__MetaModelElement_T
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_T(856.0,412.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj75=MT_post__match_contains(self)
    ...
    self.obj75.graphClass_= graph_MT_post__match_contains
    if self.genGraphics:
       new_obj = graph_MT_post__match_contains(934.0,289.5,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj76=MT_post__apply_contains(self)
    ...
    # MT_label__
    self.obj76.MT_label__.setValue('6')

    # MT_pivotOut__
    self.obj76.MT_pivotOut__.setValue('')
    self.obj76.MT_pivotOut__.setNone()

    self.obj76.graphClass_= graph_MT_post__apply_contains
    if self.genGraphics:
       new_obj = graph_MT_post__apply_contains(936.0,449.5,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj77.MT_label__.setValue('10')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1025.0,395.5,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj78.MT_label__.setValue('4')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__ApplyModel(160.0,300.0,self.obj78)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj79=MT_pre__MatchModel(self)
    ...
    self.obj79.graphClass_= graph_MT_pre__MatchModel
    if self.genGraphics:
       new_obj = graph_MT_pre__MatchModel(160.0,180.0,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__match_contains(414.5,273.5,self.obj80)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__apply_contains(418.0,423.5,self.obj81)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj82=MT_pre__MetaModelElement_T(self)
    ...
    # MT_subtypeMatching__
    self.obj82.MT_subtypeMatching__.setValue(('True', 1))
    ...
    # MT_pre__cardinality
    self.obj82.MT_pre__cardinality.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj82.MT_pre__cardinality.setHeight(15)

    # MT_pre__name
    self.obj82.MT_pre__name.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj82.MT_pre__name.setHeight(15)

    self.obj82.graphClass_= graph_MT_pre__MetaModelElement_T
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_T(340.0,400.0,self.obj82)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj83=MT_pre__MetaModelElement_S(self)
    ...
    # MT_subtypeMatching__
    self.obj83.MT_subtypeMatching__.setValue(('True', 1))
    ...
    # MT_pre__cardinality
    self.obj83.MT_pre__cardinality.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj83.MT_pre__cardinality.setHeight(15)

    # MT_pre__name
    self.obj83.MT_pre__name.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj83.MT_pre__name.setHeight(15)

    self.obj83.graphClass_= graph_MT_pre__MetaModelElement_S
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(340.0,220.0,self.obj83)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj85.constraint.setValue('if set([i for i in graph.neighbors(PreNode(\'1\').index) if graph.vs[i][\'mm__\'] == \'trace_link\']).intersection(set([i for i in graph.neighbors(PreNode(\'2\').index) if graph.vs[i][\'mm__\'] == \'trace_link\'])) == set():\n    return True\n\nreturn False\n')
    self.obj85.constraint.setHeight(15)

    self.obj85.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(140.0,160.0,self.obj85)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # Connections for obj71 (graphObject_: Obj0) of type MT_post__MatchModel
    self.drawConnections(
(self.obj71,self.obj75,[842.0, 273.0, 934.0, 289.5],"true", 2) )
    # Connections for obj72 (graphObject_: Obj1) of type MT_post__ApplyModel
    self.drawConnections(
(self.obj72,self.obj76,[848.0, 414.0, 936.0, 449.5],"true", 2) )
    # Connections for obj73 (graphObject_: Obj2) of type MT_post__MetaModelElement_S
    self.drawConnections(
 )
    # Connections for obj74 (graphObject_: Obj3) of type MT_post__MetaModelElement_T
    self.drawConnections(
(self.obj74,self.obj77,[1024.0, 485.0, 1025.0, 395.5],"true", 2) )
    # Connections for obj75 (graphObject_: Obj4) of type MT_post__match_contains
    self.drawConnections(
(self.obj75,self.obj73,[934.0, 289.5, 1026.0, 306.0],"true", 2) )
    # Connections for obj76 (graphObject_: Obj5) of type MT_post__apply_contains
    self.drawConnections(
(self.obj76,self.obj74,[936.0, 449.5, 1024.0, 485.0],"true", 2) )
    # Connections for obj77 (graphObject_: Obj6) of type MT_post__trace_link
    self.drawConnections(
(self.obj77,self.obj73,[1025.0, 395.5, 1026.0, 306.0],"true", 2) )
    # Connections for obj78 (graphObject_: Obj7) of type MT_pre__ApplyModel
    self.drawConnections(
(self.obj78,self.obj81,[328.0, 374.0, 418.0, 423.5],"true", 2) )
    # Connections for obj79 (graphObject_: Obj8) of type MT_pre__MatchModel
    self.drawConnections(
(self.obj79,self.obj80,[319.0, 253.0, 414.5, 273.5],"true", 2) )
    # Connections for obj80 (graphObject_: Obj9) of type MT_pre__match_contains
    self.drawConnections(
(self.obj80,self.obj83,[414.5, 273.5, 510.0, 294.0],"true", 2) )
    # Connections for obj81 (graphObject_: Obj10) of type MT_pre__apply_contains
    self.drawConnections(
(self.obj81,self.obj82,[418.0, 423.5, 508.0, 473.0],"true", 2) )
    # Connections for obj82 (graphObject_: Obj11) of type MT_pre__MetaModelElement_T
    self.drawConnections(
 )
    # Connections for obj83 (graphObject_: Obj12) of type MT_pre__MetaModelElement_S
    self.drawConnections(
 )
