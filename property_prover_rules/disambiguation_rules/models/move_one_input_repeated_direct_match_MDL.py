"""
__move_one_input_repeated_direct_match_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Wed Jan  7 16:20:19 2015
...
def move_one_input_repeated_direct_match_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MoveOneInputRepeatedDirectMatch')
    # --- ASG attributes over ---
    ...
    self.obj75=MT_pre__directLink_S(self)
    ...
    self.obj75.graphClass_= graph_MT_pre__directLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_S(310.5,374.5,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(600.0,300.0,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(676.0,152.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(797.0,300.0,self.obj78)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj79=MT_post__directLink_S(self)
    ...
    self.obj79.graphClass_= graph_MT_post__directLink_S
    if self.genGraphics:
       new_obj = graph_MT_post__directLink_S(847.0,374.0,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_RHS(480.0,100.0,self.obj80)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj81.constraint.setValue('if graph.vs[9][\'mm__\'] == graph.vs[10][\'mm__\']\n    return True\n\nreturn False\n')
    self.obj81.constraint.setHeight(15)

    self.obj81.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(20.0,100.0,self.obj81)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj73,self.obj75,[411.0, 375.0, 310.5, 374.5],"true", 2) )
    # Connections for obj74 (graphObject_: Obj3) of type MT_pre__directLink_S
    self.drawConnections(
(self.obj74,self.obj72,[350.5, 301.0, 290.0, 227.0],"true", 2) )
    # Connections for obj75 (graphObject_: Obj4) of type MT_pre__directLink_S
    self.drawConnections(
(self.obj75,self.obj71,[310.5, 374.5, 210.0, 374.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj78,self.obj79,[967.0, 374.0, 847.0, 374.0],"true", 2) )
    # Connections for obj79 (graphObject_: Obj8) of type MT_post__directLink_S
    self.drawConnections(
(self.obj79,self.obj76,[847.0, 374.0, 770.0, 374.0],"true", 2) )
...
newfunction = move_one_input_repeated_direct_match_MDL
