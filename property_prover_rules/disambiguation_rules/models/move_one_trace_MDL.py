"""
__move_one_trace_MDL.py_____________________________________________________
...
def move_one_trace_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MoveOneTrace')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_RHS(660.0,200.0,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
...
newfunction = move_one_trace_MDL
