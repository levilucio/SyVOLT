...
Author: levi
Modified: Fri Apr 24 11:59:45 2015
...
def del_uncollapsed_elem_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MatchModel(127.0,98.0,self.obj71)
    ...
    self.obj72=MT_pre__MatchModel(self)
    ...
    self.obj72.graphClass_= graph_MT_pre__MatchModel
    if self.genGraphics:
       new_obj = graph_MT_pre__MatchModel(327.0,98.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__MatchModel", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(327.0,278.0,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj74=MT_pre__MetaModelElement_S(self)
    ...
    # MT_pivotOut__
    self.obj74.MT_pivotOut__.setValue('element1')
    ...
    # MT_pivotIn__
    self.obj74.MT_pivotIn__.setValue('element1')

    # MT_label__
    self.obj74.MT_label__.setValue('1')
    ...
    self.obj74.graphClass_= graph_MT_pre__MetaModelElement_S
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(127.0,278.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj75=MT_pre__match_contains(self)
    ...
    self.obj75.graphClass_= graph_MT_pre__match_contains
    if self.genGraphics:
       new_obj = graph_MT_pre__match_contains(291.5,261.5,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj76=MT_pre__match_contains(self)
    ...
    self.obj76.graphClass_= graph_MT_pre__match_contains
    if self.genGraphics:
       new_obj = graph_MT_pre__match_contains(491.5,261.5,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__match_contains", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__match_contains(886.0,263.5,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj80.MT_label__.setValue('10')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__match_contains(986.0,263.5,self.obj80)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__match_contains", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj81=MT_post__MetaModelElement_S(self)
    ...
    # MT_pivotOut__
    self.obj81.MT_pivotOut__.setValue('element1')
    ...
    self.obj81.graphClass_= graph_MT_post__MetaModelElement_S
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(720.0,280.0,self.obj81)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MatchModel(720.0,100.0,self.obj82)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MatchModel(920.0,100.0,self.obj83)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MatchModel", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj77.graphClass_= graph_RHS
    if self.genGraphics:
       new_obj = graph_RHS(600.0,40.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj78.constraint.setValue('if len([i for i in graph.neighbors(PreNode(\'2\').index) if graph.vs[i][\'mm__\'] == \'match_contains\']) == 0:\n    return True\n\nreturn False\n')
    self.obj78.constraint.setHeight(15)

    self.obj78.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(100.0,40.0,self.obj78)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj71,self.obj75,[286.0, 171.0, 291.5, 261.5],"true", 2) )
    # Connections for obj72 (graphObject_: Obj1) of type MT_pre__MatchModel
    self.drawConnections(
(self.obj72,self.obj76,[486.0, 171.0, 491.5, 261.5],"true", 2) )
    # Connections for obj73 (graphObject_: Obj2) of type MT_pre__MetaModelElement_S
    self.drawConnections(
 )
    # Connections for obj74 (graphObject_: Obj3) of type MT_pre__MetaModelElement_S
    self.drawConnections(
 )
    # Connections for obj75 (graphObject_: Obj4) of type MT_pre__match_contains
    self.drawConnections(
(self.obj75,self.obj74,[291.5, 261.5, 297.0, 352.0],"true", 2) )
    # Connections for obj76 (graphObject_: Obj5) of type MT_pre__match_contains
    self.drawConnections(
(self.obj76,self.obj73,[491.5, 261.5, 497.0, 352.0],"true", 2) )
    # Connections for obj79 (graphObject_: Obj8) of type MT_post__match_contains
    self.drawConnections(
(self.obj79,self.obj81,[886.0, 263.5, 890.0, 354.0],"true", 2) )
    # Connections for obj80 (graphObject_: Obj9) of type MT_post__match_contains
    self.drawConnections(
(self.obj80,self.obj81,[986.0, 263.5, 890.0, 354.0],"true", 2) )
    # Connections for obj81 (graphObject_: Obj10) of type MT_post__MetaModelElement_S
    self.drawConnections(
 )
    # Connections for obj82 (graphObject_: Obj11) of type MT_post__MatchModel
    self.drawConnections(
(self.obj82,self.obj79,[882.0, 173.0, 886.0, 263.5],"true", 2) )
    # Connections for obj83 (graphObject_: Obj12) of type MT_post__MatchModel
    self.drawConnections(
(self.obj83,self.obj80,[1082.0, 173.0, 986.0, 263.5],"true", 2) )
    # Connections for obj77 (graphObject_: Obj6) of type RHS
    self.drawConnections(
 )
    # Connections for obj78 (graphObject_: Obj7) of type LHS
    self.drawConnections(
 )
