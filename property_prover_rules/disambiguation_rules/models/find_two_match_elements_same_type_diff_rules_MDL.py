...
Author: levi
Modified: Wed Jan  7 15:49:27 2015
...
def find_two_match_elements_same_type_diff_rules_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    self.obj52=MT_pre__MatchModel(self)
    ...
    self.obj52.graphClass_= graph_MT_pre__MatchModel
    if self.genGraphics:
       new_obj = graph_MT_pre__MatchModel(360.0,180.0,self.obj52)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__MatchModel", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj48=MT_pre__MetaModelElement_S(self)
    ...
    # MT_pivotOut__
    self.obj48.MT_pivotOut__.setValue('element1')

    # MT_subtypeMatching__
    self.obj48.MT_subtypeMatching__.setValue(('True', 1))
    ...
    # MT_pivotIn__
    self.obj48.MT_pivotIn__.setValue('element1')

    # MT_label__
    self.obj48.MT_label__.setValue('1')

    # MT_pre__cardinality
    self.obj48.MT_pre__cardinality.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj48.MT_pre__cardinality.setHeight(15)

    # MT_pre__name
    self.obj48.MT_pre__name.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj48.MT_pre__name.setHeight(15)

    self.obj48.graphClass_= graph_MT_pre__MetaModelElement_S
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(141.0,299.0,self.obj48)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_pivotOut__
    self.obj49.MT_pivotOut__.setValue('element2')
    ...
    # MT_pivotIn__
    self.obj49.MT_pivotIn__.setValue('element2')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(361.0,299.0,self.obj49)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj50=MT_pre__match_contains(self)
    ...
    # MT_label__
    self.obj50.MT_label__.setValue('5')
    ...
    self.obj50.graphClass_= graph_MT_pre__match_contains
    if self.genGraphics:
       new_obj = graph_MT_pre__match_contains(308.0,382.5,self.obj50)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__match_contains(526.0,304.0,self.obj55)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__match_contains", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
...
(self.obj47,self.obj50,[299.0, 253.0, 308.0, 382.5],"true", 2) )
    # Connections for obj52 (graphObject_: Obj5) of type MT_pre__MatchModel
    self.drawConnections(
(self.obj52,self.obj55,[519.0, 253.0, 526.0, 304.0],"true", 2) )
    # Connections for obj48 (graphObject_: Obj1) of type MT_pre__MetaModelElement_S
    self.drawConnections(
 )
    # Connections for obj49 (graphObject_: Obj2) of type MT_pre__MetaModelElement_S
    self.drawConnections(
 )
    # Connections for obj50 (graphObject_: Obj3) of type MT_pre__match_contains
    self.drawConnections(
(self.obj50,self.obj48,[308.0, 382.5, 311.0, 373.0],"true", 2) )
    # Connections for obj55 (graphObject_: Obj6) of type MT_pre__match_contains
    self.drawConnections(
(self.obj55,self.obj49,[526.0, 304.0, 531.0, 373.0],"true", 2) )
    # Connections for obj51 (graphObject_: Obj4) of type LHS
    self.drawConnections(
 )
