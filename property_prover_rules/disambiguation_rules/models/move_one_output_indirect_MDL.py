"""
__move_one_output_indirect_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Thu Jan  8 13:30:52 2015
...
def move_one_output_indirect_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MoveOneOutputIndirect')
    # --- ASG attributes over ---
    ...
    self.obj83=MT_pre__indirectLink_S(self)
    ...
    self.obj83.graphClass_= graph_MT_pre__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(362.0,304.0,self.obj83)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj88=MT_post__indirectLink_S(self)
    ...
    self.obj88.graphClass_= graph_MT_post__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_post__indirectLink_S(820.0,374.0,self.obj88)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.drawConnections(
(self.obj72,self.obj83,[310.0, 234.0, 362.0, 304.0],"true", 2) )
    # Connections for obj73 (graphObject_: Obj2) of type MT_pre__MetaModelElement_S
    self.drawConnections(
 )
    # Connections for obj83 (graphObject_: Obj10) of type MT_pre__indirectLink_S
    self.drawConnections(
(self.obj83,self.obj73,[362.0, 304.0, 414.0, 374.0],"true", 2) )
    # Connections for obj75 (graphObject_: Obj4) of type MT_post__MetaModelElement_S
    self.drawConnections(
(self.obj75,self.obj88,[730.0, 374.0, 820.0, 374.0],"true", 2) )
    ...
    # Connections for obj88 (graphObject_: Obj11) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj88,self.obj77,[820.0, 374.0, 910.0, 374.0],"true", 2) )
...
newfunction = move_one_output_indirect_MDL
