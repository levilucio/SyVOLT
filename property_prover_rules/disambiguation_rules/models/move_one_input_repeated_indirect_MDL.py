"""
__move_one_input_repeated_indirect_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Thu Jan  8 10:55:44 2015
...
def move_one_input_repeated_indirect_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MoveOneInputRepeatedIndirect')
    # --- ASG attributes over ---
    ...
    self.obj75=MT_pre__indirectLink_S(self)
    ...
    self.obj75.graphClass_= graph_MT_pre__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(308.5,374.0,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__indirectLink_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(560.0,160.0,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(760.0,160.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(759.0,300.0,self.obj78)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__indirectLink_S(829.5,304.0,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_RHS(460.0,40.0,self.obj80)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj81.constraint.setValue('return True\n')
    self.obj81.constraint.setHeight(15)

    self.obj81.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(20.0,40.0,self.obj81)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj73,self.obj75,[416.0, 374.0, 308.5, 374.0],"true", 2) )
...
(self.obj74,self.obj72,[362.5, 305.0, 309.0, 236.0],"true", 2) )
    # Connections for obj75 (graphObject_: Obj4) of type MT_pre__indirectLink_S
    self.drawConnections(
(self.obj75,self.obj71,[308.5, 374.0, 201.0, 374.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj78,self.obj79,[929.0, 374.0, 829.5, 304.0],"true", 2) )
    # Connections for obj79 (graphObject_: Obj8) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj79,self.obj76,[829.5, 304.0, 730.0, 234.0],"true", 2) )
...
newfunction = move_one_input_repeated_indirect_MDL
