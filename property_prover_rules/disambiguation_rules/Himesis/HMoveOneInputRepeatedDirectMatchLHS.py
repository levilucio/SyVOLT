...
class HMoveOneInputRepeatedDirectMatchLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMoveOneInputRepeatedDirectMatchLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HMoveOneInputRepeatedDirectMatchLHS, self).__init__(name='HMoveOneInputRepeatedDirectMatchLHS', num_nodes=5, edges=[])
...
p3
a.""")
        self["MT_constraint__"] = pickle.loads("""Vif graph.vs[9]['mm__'] == graph.vs[10]['mm__']\u000a    return True\u000a\u000areturn False\u000a
p1
.""")
        self["name"] = """"""
        self["GUID__"] = UUID('5ed57b3e-93da-46a1-8c8b-d9beeae20add')
...
.""")
        ...
        self.vs[0]["GUID__"] = UUID('3ef04757-c70c-44ef-ab11-0cf5daff9008')
...
.""")
        ...
        self.vs[1]["GUID__"] = UUID('cec17286-dad7-4a8b-bd70-dc207c97d13e')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('88e4e30e-47b6-4d37-86dc-29886d0c5426')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('b7ff2cd3-1a1e-43d7-b6c7-5bed96911cce')
...
return True
"""
        self.vs[4]["GUID__"] = UUID('c1a0268d-afce-4399-8f7d-ba75d08b222c')
    ...
    def constraint(self, PreNode, graph):
        ...
        """
        if graph.vs[9]['mm__'] == graph.vs[10]['mm__']
            return True
