...
p3
a.""")
        self["MT_constraint__"] = pickle.loads("""Vguid1 = graph.vs[PreNode('1').index]['GUID__']\u000aguid2 = graph.vs[PreNode('2').index]['GUID__']        \u000a        \u000aif PreNode('1')['classtype'] == PreNode('2')['classtype'] and int(guid1) < int(guid2):\u000a    return True\u000areturn False\u000a
p1
.""")
        self["name"] = """"""
        self["GUID__"] = 6250572834481439462
...
.""")
        ...
        self.vs[0]["GUID__"] = 711026824352256756
...
.""")
        ...
        self.vs[1]["GUID__"] = 88900157591942090
...
return True
"""
        self.vs[2]["GUID__"] = 7786007910363288164
...
return True
"""
        self.vs[3]["GUID__"] = 8441712032630797058
...
.""")
        ...
        self.vs[4]["GUID__"] = 9074298901031085377
...
.""")
        ...
        self.vs[5]["GUID__"] = 6429438146727603988
