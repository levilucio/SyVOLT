...
class HMoveOneOutputRepeatedDirectRHS(HimesisPostConditionPattern):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMoveOneOutputRepeatedDirectRHS.
        """
...
"""
    ...
    def execute(self, packet, match):
        ...
        # MT_pre__directLink_S9
            graph.delete_nodes(<map object at 0x7facdebf9e48>)
