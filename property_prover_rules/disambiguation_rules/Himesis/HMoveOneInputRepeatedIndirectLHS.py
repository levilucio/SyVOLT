...
class HMoveOneInputRepeatedIndirectLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMoveOneInputRepeatedIndirectLHS.
        """
...
.""")
        self["name"] = """"""
        self["GUID__"] = UUID('16086e5c-94be-41a4-adca-21f79dfac6b8')
...
.""")
        ...
        self.vs[0]["GUID__"] = UUID('a1fdb4e7-12d8-4a04-b8bb-037a6a3ebbaa')
...
.""")
        ...
        self.vs[1]["GUID__"] = UUID('e6136b1b-ca20-4f8b-98a2-b11e85e9eea0')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('e92b8632-9967-4bb8-aa80-eac3bc2bfad4')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('2ee1b748-454a-4b01-8b94-e803abe2b072')
...
return True
"""
        self.vs[4]["GUID__"] = UUID('8be7781d-c20c-418e-8f36-056577031a44')
