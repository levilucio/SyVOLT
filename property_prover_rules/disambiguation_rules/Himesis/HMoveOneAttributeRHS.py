...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('49427ced-94af-462c-929a-5b676979a5dd')
...
"""
        ...
        self.vs[0]["GUID__"] = UUID('477b32c8-6e11-41ee-88df-6ebe13d42d0f')
        self.vs[1]["MT_label__"] = """10"""
        self.vs[1]["mm__"] = """MT_post__hasAttr_S"""
        self.vs[1]["GUID__"] = UUID('896dca72-e317-4cd8-8f97-27e0db05e171')
...
return attr_value
"""
        self.vs[2]["GUID__"] = UUID('fab785f5-588d-4718-b4f9-ba6bec3bb1aa')
...
return attr_value
"""
        self.vs[3]["GUID__"] = UUID('6d329b90-69cf-4db8-aaf7-d9c9a2bbf69f')
    ...
    def execute(self, packet, match):
        ...
        # Create new edges
        #===============================================================================
        # hasAttr_S10 -> Attribute3
        graph.add_edges((labels['10'], labels['3']))
        # MetaModelElement_S1 -> hasAttr_S10
