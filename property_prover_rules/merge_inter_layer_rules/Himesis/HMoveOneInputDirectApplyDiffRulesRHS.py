...
class HMoveOneInputDirectApplyDiffRulesRHS(HimesisPostConditionPattern):
    def __init__(self):
        ...
        super(HMoveOneInputDirectApplyDiffRulesRHS, self).__init__(name='HMoveOneInputDirectApplyDiffRulesRHS', num_nodes=4, edges=[])
...
.""")
        self["name"] = """"""
        self["GUID__"] = UUID('1d1b19ee-c3ae-457b-a8c9-f8398f286f2e')
...
"""
        ...
        self.vs[0]["GUID__"] = UUID('6fc17243-b2f8-4922-9da0-6d91167ebaea')
...
return attr_value
"""
        self.vs[1]["GUID__"] = UUID('89a30dfc-610a-41ba-920c-827ad368dee9')
...
return attr_value
"""
        self.vs[2]["GUID__"] = UUID('79075d21-cb7a-4c9d-93e0-96ec5290b482')
...
return attr_value
"""
        self.vs[3]["GUID__"] = UUID('3a95f4ce-cb9a-4d89-9975-cb36515fa4d2')
    ...
    def execute(self, packet, match):
        ...
        # Create new edges
        #===============================================================================
        # MetaModelElement_T5 -> directLink_T19
        graph.add_edges([(labels['5'], labels['19'])])
        # directLink_T19 -> MetaModelElement_T3
