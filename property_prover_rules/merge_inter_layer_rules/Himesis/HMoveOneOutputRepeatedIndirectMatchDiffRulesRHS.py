...
class HMoveOneOutputRepeatedIndirectMatchDiffRulesRHS(HimesisPostConditionPattern):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMoveOneOutputRepeatedIndirectMatchDiffRulesRHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HMoveOneOutputRepeatedIndirectMatchDiffRulesRHS, self).__init__(name='HMoveOneOutputRepeatedIndirectMatchDiffRulesRHS', num_nodes=3, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('36b5a756-a531-4120-a624-a777113d076c')
...
return attr_value
"""
        self.vs[0]["GUID__"] = UUID('3f40c6d8-073e-4bc8-a697-cca35aa115a0')
...
return attr_value
"""
        self.vs[1]["GUID__"] = UUID('99d8a90d-bea7-4e90-ae78-cec69895f77a')
...
return attr_value
"""
        self.vs[2]["GUID__"] = UUID('583f9e41-5e32-42a2-a025-e86e1e5c1a81')

        from HMoveOneOutputRepeatedIndirectMatchDiffRulesLHS import HMoveOneOutputRepeatedIndirectMatchDiffRulesLHS
        self.pre = HMoveOneOutputRepeatedIndirectMatchDiffRulesLHS()
