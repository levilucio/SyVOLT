"""
__move_one_output_repeated_direct_match_diff_rules_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Wed Aug 21 10:51:58 2013
...
def move_one_output_repeated_direct_match_diff_rules_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MoveOneOutputRepeatedDirectMatchDiffRules')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_S(308.0,375.0,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(700.0,140.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(740.0,300.0,self.obj78)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__directLink_S(820.0,374.0,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_RHS(440.0,100.0,self.obj80)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj71,self.obj75,[202.0, 376.0, 308.0, 375.0],"true", 2) )
...
(self.obj74,self.obj73,[362.0, 304.0, 414.0, 374.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj75,self.obj73,[308.0, 375.0, 414.0, 374.0],"true", 2) )
    # Connections for obj76 (graphObject_: Obj5) of type MT_post__MetaModelElement_S
    self.drawConnections(
(self.obj76,self.obj79,[730.0, 374.0, 820.0, 374.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj79,self.obj78,[820.0, 374.0, 910.0, 374.0],"true", 2) )
...
newfunction = move_one_output_repeated_direct_match_diff_rules_MDL
