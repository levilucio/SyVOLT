"""
__move_one_trace_back_link_diff_rules_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Fri Sep  6 17:16:48 2013
...
def move_one_trace_back_link_diff_rules_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MoveOneTraceBackLinkDiffRules')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(240.0,420.0,self.obj71)
    ...
    # MT_label__
    self.obj72.MT_label__.setValue('8')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(320.0,240.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    # MT_label__
    self.obj73.MT_label__.setValue('9')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_T(440.0,420.0,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj74=MT_pre__backward_link(self)
    ...
    # MT_pre__type
    self.obj74.MT_pre__type.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj74.MT_pre__type.setHeight(15)

    self.obj74.graphClass_= graph_MT_pre__backward_link
    if self.genGraphics:
       new_obj = graph_MT_pre__backward_link(529.0,411.5,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj75=MT_pre__trace_link(self)
    ...
    self.obj75.graphClass_= graph_MT_pre__trace_link
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(559.0,389.5,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(760.0,420.0,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj77.MT_label__.setValue('8')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(853.0,239.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    # MT_label__
    self.obj78.MT_label__.setValue('9')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_T(973.0,419.0,self.obj78)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj79.MT_label__.setValue('21')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1033.5,521.0,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj80=MT_post__backward_link(self)
    ...
    # MT_label__
    self.obj80.MT_label__.setValue('22')
    ...
    # MT_post__type
    self.obj80.MT_post__type.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn attr_value\n')
    self.obj80.MT_post__type.setHeight(15)

    self.obj80.graphClass_= graph_MT_post__backward_link
    if self.genGraphics:
       new_obj = graph_MT_post__backward_link(1031.5,470.0,self.obj80)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj81.graphClass_= graph_RHS
    if self.genGraphics:
       new_obj = graph_RHS(660.0,200.0,self.obj81)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj82.constraint.setValue('#if len([i for i in graph.neighbors(PreNode(\'9\').index) if graph.vs[i][\'mm__\'] == \'apply_contains\']) == 0:\n#    return True\n\n#return False\nreturn True\n')
    self.obj82.constraint.setHeight(15)

    self.obj82.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(200.0,200.0,self.obj82)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.drawConnections(
(self.obj73,self.obj74,[608.0, 493.0, 529.0, 411.5],"true", 2),
(self.obj73,self.obj75,[608.0, 493.0, 559.0, 389.5],"true", 2) )
    # Connections for obj74 (graphObject_: Obj3) of type MT_pre__backward_link
    self.drawConnections(
(self.obj74,self.obj72,[529.0, 411.5, 490.0, 314.0],"true", 2) )
    # Connections for obj75 (graphObject_: Obj4) of type MT_pre__trace_link
    self.drawConnections(
(self.obj75,self.obj72,[559.0, 389.5, 490.0, 314.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj78,self.obj79,[1141.0, 492.0, 1033.5, 521.0],"true", 2),
(self.obj78,self.obj80,[1141.0, 492.0, 1031.5, 470.0],"true", 2) )
    # Connections for obj79 (graphObject_: Obj8) of type MT_post__trace_link
    self.drawConnections(
(self.obj79,self.obj76,[1033.5, 521.0, 930.0, 494.0],"true", 2) )
    # Connections for obj80 (graphObject_: Obj9) of type MT_post__backward_link
    self.drawConnections(
(self.obj80,self.obj76,[1031.5, 470.0, 930.0, 494.0],"true", 2) )
    # Connections for obj81 (graphObject_: Obj10) of type RHS
    self.drawConnections(
 )
    # Connections for obj82 (graphObject_: Obj11) of type LHS
    self.drawConnections(
 )

newfunction = move_one_trace_back_link_diff_rules_MDL
