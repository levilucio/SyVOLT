"""
__delete_traces_from_uncollapsed_element_apply_diff_rules_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Fri Sep  6 17:07:24 2013
...
def delete_traces_from_uncollapsed_element_apply_diff_rules_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('DeleteTracesFromUncollapsedApplyElement')
    # --- ASG attributes over ---
    ...
    # MT_label__
    self.obj71.MT_label__.setValue('5')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(260.0,200.0,self.obj71)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_T(327.0,324.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj73=MT_pre__trace_link(self)
    ...
    self.obj73.graphClass_= graph_MT_pre__trace_link
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(455.5,325.5,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(740.0,200.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj75.MT_label__.setValue('4')

    # MT_pivotOut__
    self.obj75.MT_pivotOut__.setValue('element2')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_T(800.0,320.0,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # action
    self.obj76.action.setValue('pass\n')
    self.obj76.action.setHeight(15)

    self.obj76.graphClass_= graph_RHS
    if self.genGraphics:
       new_obj = graph_RHS(600.0,120.0,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj77.constraint.setValue('return True\n')
    self.obj77.constraint.setHeight(15)

    self.obj77.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(160.0,120.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.drawConnections(
(self.obj72,self.obj73,[495.0, 397.0, 455.5, 325.5],"true", 2) )
    # Connections for obj73 (graphObject_: Obj2) of type MT_pre__trace_link
    self.drawConnections(
(self.obj73,self.obj71,[455.5, 325.5, 430.0, 274.0],"true", 2) )
...
newfunction = delete_traces_from_uncollapsed_element_apply_diff_rules_MDL
