"""
__move_one_input_direct_apply_diff_rules_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Wed Aug 21 16:40:54 2013
...
def move_one_input_direct_apply_diff_rules_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MoveOneInputDirectApplyDiffRules')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_T(560.0,321.0,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_T(654.0,185.0,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_T(773.0,318.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__MetaModelElement_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__directLink_T(834.5,392.5,self.obj78)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_RHS(460.0,100.0,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj74,self.obj72,[358.5, 317.5, 309.0, 259.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj77,self.obj78,[941.0, 391.0, 834.5, 392.5],"true", 2) )
    # Connections for obj78 (graphObject_: Obj7) of type MT_post__directLink_T
    self.drawConnections(
(self.obj78,self.obj75,[834.5, 392.5, 728.0, 394.0],"true", 2) )
...
newfunction = move_one_input_direct_apply_diff_rules_MDL
