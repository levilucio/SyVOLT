"""
__move_one_output_direct_apply_diff_rules_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Wed Aug 21 22:31:01 2013
...
def move_one_output_direct_apply_diff_rules_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MoveOneOutputDirectApplyDiffRules')
    # --- ASG attributes over ---
    ...
    self.obj78=MT_post__directLink_T(self)
    ...
    self.obj78.graphClass_= graph_MT_post__directLink_T
    if self.genGraphics:
       new_obj = graph_MT_post__directLink_T(805.0,374.0,self.obj78)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj80.constraint.setValue('#if len([i for i in graph.neighbors(PreNode(\'5\').index) if graph.vs[i][\'mm__\'] == \'apply_contains\']) == 0:\n#    return True\n\n#return False\nreturn True\n')
...
(self.obj74,self.obj73,[359.5, 301.0, 411.0, 373.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj75,self.obj78,[728.0, 373.0, 805.0, 374.0],"true", 2) )
    ...
    # Connections for obj78 (graphObject_: Obj7) of type MT_post__directLink_T
    self.drawConnections(
(self.obj78,self.obj77,[805.0, 374.0, 925.0, 373.0],"true", 2) )
...
newfunction = move_one_output_direct_apply_diff_rules_MDL
