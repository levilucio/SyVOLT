...
class HMoveOneInputDirectMatchDiffRulesLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMoveOneInputDirectMatchDiffRulesLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HMoveOneInputDirectMatchDiffRulesLHS, self).__init__(name='HMoveOneInputDirectMatchDiffRulesLHS', num_nodes=4, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('85165d0e-7065-40b8-8c85-a44cb21fdcb3')
...
.""")
        ...
        self.vs[0]["GUID__"] = UUID('b089efa7-f0c6-4ac5-a8d7-b26386addcc3')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('fe292b07-bc2d-4212-9187-deacf6a5ab3f')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('03cdb4d7-da3a-4efc-8364-a6b6429fef4a')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('5510d8a9-9709-43fc-b182-b8806b61a81b')
