...
class HMoveOneOutputDirectMatchDiffRulesRHS(HimesisPostConditionPattern):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMoveOneOutputDirectMatchDiffRulesRHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HMoveOneOutputDirectMatchDiffRulesRHS, self).__init__(name='HMoveOneOutputDirectMatchDiffRulesRHS', num_nodes=4, edges=[])
...
.""")
        self["name"] = """"""
        self["GUID__"] = UUID('dffebf2a-3d25-4545-8669-d6d16c01dae9')
...
"""
        ...
        self.vs[0]["GUID__"] = UUID('1a3dca64-3d97-4770-a523-79b4e7a104cb')
...
return attr_value
"""
        self.vs[1]["GUID__"] = UUID('8de320c1-5247-4f40-b86f-cdb59a4eb681')
...
return attr_value
"""
        self.vs[2]["GUID__"] = UUID('7204f02c-c5e5-42fd-91df-55bd58788e19')
...
return attr_value
"""
        self.vs[3]["GUID__"] = UUID('da2d0ed1-8c4d-4efa-915e-f9df614826af')

        from HMoveOneOutputDirectMatchDiffRulesLHS import HMoveOneOutputDirectMatchDiffRulesLHS
        self.pre = HMoveOneOutputDirectMatchDiffRulesLHS()
