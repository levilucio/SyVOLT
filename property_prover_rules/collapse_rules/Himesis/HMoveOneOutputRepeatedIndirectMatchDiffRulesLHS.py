...
class HMoveOneOutputRepeatedIndirectMatchDiffRulesLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMoveOneOutputRepeatedIndirectMatchDiffRulesLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HMoveOneOutputRepeatedIndirectMatchDiffRulesLHS, self).__init__(name='HMoveOneOutputRepeatedIndirectMatchDiffRulesLHS', num_nodes=5, edges=[])
...
.""")
        self["name"] = """"""
        self["GUID__"] = UUID('22d73def-c851-4ee4-adaa-0746e5b97dcb')
...
.""")
        ...
        self.vs[0]["GUID__"] = UUID('6752aa5b-2a64-459c-a231-482cd9180e87')
...
.""")
        ...
        self.vs[1]["GUID__"] = UUID('d04a1dd8-666d-4769-8780-13b1235ff81e')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('d9df6c76-d75f-42bb-8bbc-417e65da2623')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('6a94ef99-5abf-494e-9aab-f1b212a6b63c')
...
return True
"""
        self.vs[4]["GUID__"] = UUID('e6d116a2-7042-44ee-9375-54763b4d2191')
