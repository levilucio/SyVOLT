...
class HMM2MM_combine_0LHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMM2MM_combine_0LHS.
        """
...
p3
a.""")
        self["MT_constraint__"] = """if len([i for i in graph.neighbors(PreNode('1').index) if graph.vs[i]['mm__'] == 'directLink_S']) == 0:
    return True
return False
"""
        self["name"] = """"""
        self["GUID__"] = UUID('1b720a45-fbbe-4da8-9eb3-0e1f169b834e')
...
.""")
        ...
        self.vs[0]["GUID__"] = UUID('494b883f-7560-4fe7-975f-6c43f0baa50b')
...
.""")
        ...
        self.vs[1]["GUID__"] = UUID('dadae22d-858c-4709-9a3e-426e50eb1b2b')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('43ee26ae-ee5d-498b-973d-32f68b58f864')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('e936ca43-b4bd-429e-9ab5-3c62d0970cd9')
...
.""")
        ...
        self.vs[4]["GUID__"] = UUID('aace757f-0c3f-4e7a-a8d6-f6b962373047')
...
.""")
        ...
        self.vs[5]["GUID__"] = UUID('f98c1954-e14d-46aa-8a41-d92feb100a86')

        
        # Load the NACs
        from HMM2MM_combine_0NAC0 import HMM2MM_combine_0NAC0
        self.NACs = [HMM2MM_combine_0NAC0(LHS=self)]
