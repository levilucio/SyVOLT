...
class HF2F_combineRHS(HimesisPostConditionPattern):
    def __init__(self):
        ...
        super(HF2F_combineRHS, self).__init__(name='HF2F_combineRHS', num_nodes=3, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('8e08a28a-aeed-44c6-af09-73a338347ab6')
...
return attr_value
"""
        self.vs[0]["mm__"] = """MT_post__Female_S"""
...
return attr_value
"""
        self.vs[0]["GUID__"] = UUID('617f08d0-13a4-425d-afc3-1b31b9544365')
        self.vs[1]["MT_label__"] = """3"""
        self.vs[1]["mm__"] = """MT_post__trace_link"""
        self.vs[1]["GUID__"] = UUID('5345a1d3-54b3-43af-ae74-e059fde2e07c')
...
return attr_value
"""
        self.vs[2]["GUID__"] = UUID('4d8e7400-50f5-46eb-9bb3-cfe4431a6417')
