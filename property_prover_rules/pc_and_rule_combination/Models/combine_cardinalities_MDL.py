"""
__combine_cardinalities_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Wed Nov 12 17:21:08 2014
...
def combine_cardinalities_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('CombineCardinalities')
    # --- ASG attributes over ---
...
newfunction = combine_cardinalities_MDL
