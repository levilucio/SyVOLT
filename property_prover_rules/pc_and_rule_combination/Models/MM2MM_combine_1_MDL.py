"""
__MM2MM_combine_1_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Thu Dec  4 14:29:44 2014
...
def MM2MM_combine_1_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MT_post__PoliceStationMMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MM2MM_combine_1')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_RHS(940.0,140.0,self.obj64)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj65.constraint.setValue('return True\n')
    self.obj65.constraint.setHeight(15)

    self.obj65.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(500.0,140.0,self.obj65)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1141.0,351.0,self.obj56)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj57=MT_post__trace_link(self)
    ...
    self.obj57.graphClass_= graph_MT_post__trace_link
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1343.0,346.0,self.obj57)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj59=MT_post__directLink_T(self)
    ...
    # MT_label__
    self.obj59.MT_label__.setValue('8')
    ...
    self.obj59.MT_post__associationType.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn attr_value\n')
    self.obj59.MT_post__associationType.setHeight(15)

    self.obj59.graphClass_= graph_MT_post__directLink_T
    if self.genGraphics:
       new_obj = graph_MT_post__directLink_T(1242.0,438.5,self.obj59)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj68.MT_label__.setValue('9')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__indirectLink_S(1242.0,258.5,self.obj68)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__Male_T(1282.0,395.0,self.obj60)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__Male_T(1080.0,400.0,self.obj61)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Male_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__Male_S(1282.0,215.0,self.obj62)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj63.MT_label__.setValue('1')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__Male_S(1080.0,220.0,self.obj63)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Male_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.drawConnections(
(self.obj51,self.obj55,[821.0, 441.0, 821.0, 351.0],"true", 2) )
    # Connections for obj52 (graphObject_: Obj3) of type MT_pre__Male_T
    self.drawConnections(
(self.obj52,self.obj54,[621.0, 441.0, 621.0, 351.0],"true", 2) )
    # Connections for obj54 (graphObject_: Obj5) of type MT_pre__trace_link
    self.drawConnections(
(self.obj54,self.obj50,[621.0, 351.0, 621.0, 261.0],"true", 2) )
    # Connections for obj55 (graphObject_: Obj6) of type MT_pre__trace_link
    self.drawConnections(
(self.obj55,self.obj49,[821.0, 351.0, 821.0, 261.0],"true", 2) )
    # Connections for obj64 (graphObject_: Obj15) of type RHS
    self.drawConnections(
 )
    # Connections for obj65 (graphObject_: Obj16) of type LHS
    self.drawConnections(
 )
    # Connections for obj56 (graphObject_: Obj7) of type MT_post__trace_link
    self.drawConnections(
(self.obj56,self.obj63,[1141.0, 351.0, 1141.0, 261.0],"true", 2) )
    # Connections for obj57 (graphObject_: Obj8) of type MT_post__trace_link
    self.drawConnections(
(self.obj57,self.obj62,[1343.0, 346.0, 1343.0, 256.0],"true", 2) )
    # Connections for obj59 (graphObject_: Obj10) of type MT_post__directLink_T
    self.drawConnections(
(self.obj59,self.obj60,[1242.0, 438.5, 1343.0, 436.0],"true", 2) )
    # Connections for obj68 (graphObject_: Obj17) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj68,self.obj62,[1242.0, 258.5, 1343.0, 256.0],"true", 2) )
    # Connections for obj60 (graphObject_: Obj11) of type MT_post__Male_T
    self.drawConnections(
(self.obj60,self.obj57,[1343.0, 436.0, 1343.0, 346.0],"true", 2) )
    # Connections for obj61 (graphObject_: Obj12) of type MT_post__Male_T
    self.drawConnections(
(self.obj61,self.obj59,[1141.0, 441.0, 1242.0, 438.5],"true", 2),
(self.obj61,self.obj56,[1141.0, 441.0, 1141.0, 351.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj63,self.obj68,[1141.0, 261.0, 1242.0, 258.5],"true", 2) )

newfunction = MM2MM_combine_1_MDL
