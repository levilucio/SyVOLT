...
Author: levi
Modified: Wed Dec 10 16:28:02 2014
...
def FF2FF_combine_0_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MT_post__PoliceStationMMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('FF2FF_combine_0')
    # --- ASG attributes over ---


    self.obj49=MT_pre__Female_S(self)
    ...
    self.obj49.graphClass_= graph_MT_pre__Female_S
    if self.genGraphics:
       new_obj = graph_MT_pre__Female_S(580.0,220.0,self.obj49)
    ...
    self.obj70=MT_pre__Female_S(self)
    ...
    self.obj70.graphClass_= graph_MT_pre__Female_S
    if self.genGraphics:
       new_obj = graph_MT_pre__Female_S(140.0,220.0,self.obj70)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Female_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Female_S(320.0,220.0,self.obj71)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Female_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj51=MT_pre__Female_T(self)
    ...
    self.obj51.graphClass_= graph_MT_pre__Female_T
    if self.genGraphics:
       new_obj = graph_MT_pre__Female_T(580.0,380.0,self.obj51)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Female_T(760.0,380.0,self.obj52)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Female_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj76=MT_pre__indirectLink_S(self)
    ...
    # MT_label__
    self.obj76.MT_label__.setValue('7')
    ...
    self.obj76.graphClass_= graph_MT_pre__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(291.0,261.0,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(641.0,341.0,self.obj53)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(821.0,341.0,self.obj54)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_RHS(960.0,140.0,self.obj63)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_LHS(520.0,140.0,self.obj64)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1161.0,341.0,self.obj55)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1341.0,341.0,self.obj56)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__directLink_T(1251.0,421.0,self.obj57)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__indirectLink_S(1251.0,261.0,self.obj58)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__Female_T(1100.0,380.0,self.obj59)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj60=MT_post__Female_T(self)
    ...
    self.obj60.graphClass_= graph_MT_post__Female_T
    if self.genGraphics:
       new_obj = graph_MT_post__Female_T(1280.0,380.0,self.obj60)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Female_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj61=MT_post__Female_S(self)
    ...
    self.obj61.graphClass_= graph_MT_post__Female_S
    if self.genGraphics:
       new_obj = graph_MT_post__Female_S(1100.0,220.0,self.obj61)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__Female_S(1280.0,220.0,self.obj62)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Female_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    # Connections for obj49 (graphObject_: Obj0) of type MT_pre__Female_S
    self.drawConnections(
 )
    # Connections for obj50 (graphObject_: Obj1) of type MT_pre__Female_S
    self.drawConnections(
 )
    # Connections for obj70 (graphObject_: Obj17) of type MT_pre__Female_S
    self.drawConnections(
(self.obj70,self.obj76,[201.0, 261.0, 291.0, 261.0],"true", 2) )
    # Connections for obj71 (graphObject_: Obj18) of type MT_pre__Female_S
    self.drawConnections(
 )
    # Connections for obj51 (graphObject_: Obj2) of type MT_pre__Female_T
    self.drawConnections(
(self.obj51,self.obj53,[641.0, 421.0, 641.0, 341.0],"true", 2) )
    # Connections for obj52 (graphObject_: Obj3) of type MT_pre__Female_T
    self.drawConnections(
(self.obj52,self.obj54,[821.0, 421.0, 821.0, 341.0],"true", 2) )
    # Connections for obj76 (graphObject_: Obj19) of type MT_pre__indirectLink_S
    self.drawConnections(
(self.obj76,self.obj71,[291.0, 261.0, 381.0, 261.0],"true", 2) )
    # Connections for obj53 (graphObject_: Obj4) of type MT_pre__trace_link
    self.drawConnections(
(self.obj53,self.obj49,[641.0, 341.0, 641.0, 261.0],"true", 2) )
    # Connections for obj54 (graphObject_: Obj5) of type MT_pre__trace_link
    self.drawConnections(
(self.obj54,self.obj50,[821.0, 341.0, 821.0, 261.0],"true", 2) )
    # Connections for obj69 (graphObject_: Obj16) of type NAC
    self.drawConnections(
 )
    ...
    self.drawConnections(
(self.obj55,self.obj61,[1161.0, 341.0, 1161.0, 261.0],"true", 2) )
    # Connections for obj56 (graphObject_: Obj7) of type MT_post__trace_link
    self.drawConnections(
(self.obj56,self.obj62,[1341.0, 341.0, 1341.0, 261.0],"true", 2) )
    # Connections for obj57 (graphObject_: Obj8) of type MT_post__directLink_T
    self.drawConnections(
(self.obj57,self.obj60,[1251.0, 421.0, 1341.0, 421.0],"true", 2) )
    # Connections for obj58 (graphObject_: Obj9) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj58,self.obj62,[1251.0, 261.0, 1341.0, 261.0],"true", 2) )
    # Connections for obj59 (graphObject_: Obj10) of type MT_post__Female_T
    self.drawConnections(
(self.obj59,self.obj57,[1161.0, 421.0, 1251.0, 421.0],"true", 2),
(self.obj59,self.obj55,[1161.0, 421.0, 1161.0, 341.0],"true", 2) )
    # Connections for obj60 (graphObject_: Obj11) of type MT_post__Female_T
    self.drawConnections(
(self.obj60,self.obj56,[1341.0, 421.0, 1341.0, 341.0],"true", 2) )
    # Connections for obj61 (graphObject_: Obj12) of type MT_post__Female_S
    self.drawConnections(
(self.obj61,self.obj58,[1161.0, 261.0, 1251.0, 261.0],"true", 2) )
    # Connections for obj62 (graphObject_: Obj13) of type MT_post__Female_S
    self.drawConnections(
 )
