...
Author: levi
Modified: Thu Dec  4 14:34:03 2014
...
def SM2SM_combine_1_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MoTifRuleRootNode=None, MT_post__PoliceStationMMRootNode=None):
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Station_S(562.0,215.0,self.obj49)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Male_S(762.0,215.0,self.obj50)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Station_T(562.0,395.0,self.obj51)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Male_T(762.0,395.0,self.obj52)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(723.0,256.0,self.obj66)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(623.0,346.0,self.obj54)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(823.0,346.0,self.obj55)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__directLink_T(1243.0,436.0,self.obj61)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__indirectLink_S(1243.0,256.0,self.obj67)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj49,self.obj66,[623.0, 256.0, 723.0, 256.0],"true", 2) )
...
(self.obj59,self.obj64,[1343.0, 346.0, 1343.0, 256.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj61,self.obj63,[1243.0, 436.0, 1343.0, 436.0],"true", 2) )
    # Connections for obj67 (graphObject_: Obj18) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj67,self.obj64,[1243.0, 256.0, 1343.0, 256.0],"true", 2) )
    # Connections for obj62 (graphObject_: Obj13) of type MT_post__Station_S
    self.drawConnections(
(self.obj62,self.obj67,[1143.0, 256.0, 1243.0, 256.0],"true", 2) )
...
(self.obj63,self.obj59,[1343.0, 436.0, 1343.0, 346.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj65,self.obj61,[1143.0, 436.0, 1243.0, 436.0],"true", 2),
