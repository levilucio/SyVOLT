...
Author: levi
Modified: Sun Dec  7 13:23:13 2014
...
def SM2SM_combine_0_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MT_post__PoliceStationMMRootNode=None, MoTifRuleRootNode=None):
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Station_S(140.0,220.0,self.obj50)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Station_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Male_S(760.0,220.0,self.obj51)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj52=MT_pre__Male_S(self)
    ...
    # MT_label__
    self.obj52.MT_label__.setValue('2')
    ...
    self.obj52.graphClass_= graph_MT_pre__Male_S
    if self.genGraphics:
       new_obj = graph_MT_pre__Male_S(340.0,220.0,self.obj52)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Male_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj54=MT_pre__Male_T(self)
    ...
    self.obj54.graphClass_= graph_MT_pre__Male_T
    if self.genGraphics:
       new_obj = graph_MT_pre__Male_T(760.0,400.0,self.obj54)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj55=MT_pre__indirectLink_S(self)
    ...
    # MT_label__
    self.obj55.MT_label__.setValue('10')
    ...
    self.obj55.graphClass_= graph_MT_pre__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(301.0,261.0,self.obj55)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj66.graphClass_= graph_NAC
    if self.genGraphics:
       new_obj = graph_NAC(80.0,140.0,self.obj66)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_RHS(940.0,140.0,self.obj67)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj68.constraint.setValue('return True\n')
    self.obj68.constraint.setHeight(15)

    self.obj68.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(500.0,140.0,self.obj68)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1143.0,346.0,self.obj58)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1343.0,346.0,self.obj59)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj60=MT_post__directLink_T(self)
    ...
    # MT_label__
    self.obj60.MT_label__.setValue('8')
    ...
    self.obj60.MT_post__associationType.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn attr_value\n')
    self.obj60.MT_post__associationType.setHeight(15)

    self.obj60.graphClass_= graph_MT_post__directLink_T
    if self.genGraphics:
       new_obj = graph_MT_post__directLink_T(1243.0,436.0,self.obj60)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj61=MT_post__indirectLink_S(self)
    ...
    # MT_label__
    self.obj61.MT_label__.setValue('9')

    # MT_pivotOut__
    self.obj61.MT_pivotOut__.setValue('')
    self.obj61.MT_pivotOut__.setNone()

    self.obj61.graphClass_= graph_MT_post__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_post__indirectLink_S(1243.0,256.0,self.obj61)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj62=MT_post__Station_S(self)
    ...
    self.obj62.graphClass_= graph_MT_post__Station_S
    if self.genGraphics:
       new_obj = graph_MT_post__Station_S(1082.0,215.0,self.obj62)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj63=MT_post__Male_T(self)
    ...
    self.obj63.graphClass_= graph_MT_post__Male_T
    if self.genGraphics:
       new_obj = graph_MT_post__Male_T(1282.0,395.0,self.obj63)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj64=MT_post__Male_S(self)
    ...
    # MT_label__
    self.obj64.MT_label__.setValue('2')
    ...
    self.obj64.graphClass_= graph_MT_post__Male_S
    if self.genGraphics:
       new_obj = graph_MT_post__Male_S(1282.0,215.0,self.obj64)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.drawConnections(
(self.obj50,self.obj55,[201.0, 261.0, 301.0, 261.0],"true", 2) )
    # Connections for obj51 (graphObject_: Obj2) of type MT_pre__Male_S
    self.drawConnections(
 )
    # Connections for obj52 (graphObject_: Obj3) of type MT_pre__Male_S
    self.drawConnections(
 )
    # Connections for obj53 (graphObject_: Obj4) of type MT_pre__Station_T
    self.drawConnections(
(self.obj53,self.obj56,[621.0, 441.0, 621.0, 351.0],"true", 2) )
    # Connections for obj54 (graphObject_: Obj5) of type MT_pre__Male_T
    self.drawConnections(
(self.obj54,self.obj57,[821.0, 441.0, 821.0, 351.0],"true", 2) )
    # Connections for obj55 (graphObject_: Obj6) of type MT_pre__indirectLink_S
    self.drawConnections(
(self.obj55,self.obj52,[301.0, 261.0, 401.0, 261.0],"true", 2) )
...
(self.obj57,self.obj51,[821.0, 351.0, 821.0, 261.0],"true", 2) )
    # Connections for obj66 (graphObject_: Obj17) of type NAC
    self.drawConnections(
 )
    # Connections for obj67 (graphObject_: Obj18) of type RHS
    self.drawConnections(
 )
    # Connections for obj68 (graphObject_: Obj19) of type LHS
    self.drawConnections(
 )
    # Connections for obj58 (graphObject_: Obj9) of type MT_post__trace_link
    self.drawConnections(
(self.obj58,self.obj62,[1143.0, 346.0, 1143.0, 256.0],"true", 2) )
    # Connections for obj59 (graphObject_: Obj10) of type MT_post__trace_link
    self.drawConnections(
(self.obj59,self.obj64,[1343.0, 346.0, 1343.0, 256.0],"true", 2) )
    # Connections for obj60 (graphObject_: Obj11) of type MT_post__directLink_T
    self.drawConnections(
(self.obj60,self.obj63,[1243.0, 436.0, 1343.0, 436.0],"true", 2) )
    # Connections for obj61 (graphObject_: Obj12) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj61,self.obj64,[1243.0, 256.0, 1343.0, 256.0],"true", 2) )
    # Connections for obj62 (graphObject_: Obj13) of type MT_post__Station_S
    self.drawConnections(
(self.obj62,self.obj61,[1143.0, 256.0, 1243.0, 256.0],"true", 2) )
    # Connections for obj63 (graphObject_: Obj14) of type MT_post__Male_T
    self.drawConnections(
(self.obj63,self.obj59,[1343.0, 436.0, 1343.0, 346.0],"true", 2) )
    # Connections for obj64 (graphObject_: Obj15) of type MT_post__Male_S
    self.drawConnections(
 )
    # Connections for obj65 (graphObject_: Obj16) of type MT_post__Station_T
    self.drawConnections(
(self.obj65,self.obj60,[1143.0, 436.0, 1243.0, 436.0],"true", 2),
(self.obj65,self.obj58,[1143.0, 436.0, 1143.0, 346.0],"true", 2) )
