...
Author: levi
Modified: Wed Dec 10 16:36:43 2014
...
def MM2MM_combine_0_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MT_post__PoliceStationMMRootNode=None, MoTifRuleRootNode=None):
    ...
    self.obj49=MT_pre__Male_S(self)
    ...
    # MT_label__
    self.obj49.MT_label__.setValue('2')
    ...
    self.obj49.graphClass_= graph_MT_pre__Male_S
    if self.genGraphics:
       new_obj = graph_MT_pre__Male_S(760.0,220.0,self.obj49)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Male_S(560.0,220.0,self.obj50)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Male_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Male_S(120.0,220.0,self.obj66)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Male_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Male_S(320.0,220.0,self.obj67)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Male_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj51=MT_pre__Male_T(self)
    ...
    # MT_label__
    self.obj51.MT_label__.setValue('4')

    # MT_pre__name
    self.obj51.MT_pre__name.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj51.MT_pre__name.setHeight(15)

    self.obj51.graphClass_= graph_MT_pre__Male_T
    if self.genGraphics:
       new_obj = graph_MT_pre__Male_T(760.0,400.0,self.obj51)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj52.MT_label__.setValue('3')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Male_T(560.0,400.0,self.obj52)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Male_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj72=MT_pre__indirectLink_S(self)
    ...
    # MT_label__
    self.obj72.MT_label__.setValue('7')
    ...
    self.obj72.graphClass_= graph_MT_pre__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(281.0,261.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_RHS(940.0,160.0,self.obj63)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj64.constraint.setValue('if len([i for i in graph.neighbors(PreNode(\'1\').index) if graph.vs[i][\'mm__\'] == \'directLink_S\']) == 0:\n    return True\nreturn False\n')
    self.obj64.constraint.setHeight(15)

    self.obj64.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(500.0,160.0,self.obj64)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1141.0,351.0,self.obj55)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1343.0,346.0,self.obj56)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    # MT_label__
    self.obj57.MT_label__.setValue('8')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__indirectLink_S(1242.0,258.5,self.obj58)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj59=MT_post__Male_T(self)
    ...
    self.obj59.graphClass_= graph_MT_post__Male_T
    if self.genGraphics:
       new_obj = graph_MT_post__Male_T(1282.0,395.0,self.obj59)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj60=MT_post__Male_T(self)
    ...
    # MT_label__
    self.obj60.MT_label__.setValue('3')
    ...
    self.obj60.graphClass_= graph_MT_post__Male_T
    if self.genGraphics:
       new_obj = graph_MT_post__Male_T(1080.0,400.0,self.obj60)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Male_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj61=MT_post__Male_S(self)
    ...
    self.obj61.graphClass_= graph_MT_post__Male_S
    if self.genGraphics:
       new_obj = graph_MT_post__Male_S(1282.0,215.0,self.obj61)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj62=MT_post__Male_S(self)
    ...
    self.obj62.graphClass_= graph_MT_post__Male_S
    if self.genGraphics:
       new_obj = graph_MT_post__Male_S(1080.0,220.0,self.obj62)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Male_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    # Connections for obj49 (graphObject_: Obj0) of type MT_pre__Male_S
    self.drawConnections(
 )
    # Connections for obj50 (graphObject_: Obj1) of type MT_pre__Male_S
    self.drawConnections(
 )
    # Connections for obj66 (graphObject_: Obj17) of type MT_pre__Male_S
    self.drawConnections(
(self.obj66,self.obj72,[181.0, 261.0, 281.0, 261.0],"true", 2) )
    # Connections for obj67 (graphObject_: Obj18) of type MT_pre__Male_S
    self.drawConnections(
 )
    # Connections for obj51 (graphObject_: Obj2) of type MT_pre__Male_T
    self.drawConnections(
(self.obj51,self.obj54,[821.0, 441.0, 821.0, 351.0],"true", 2) )
    # Connections for obj52 (graphObject_: Obj3) of type MT_pre__Male_T
    self.drawConnections(
(self.obj52,self.obj53,[621.0, 441.0, 621.0, 351.0],"true", 2) )
    # Connections for obj72 (graphObject_: Obj19) of type MT_pre__indirectLink_S
    self.drawConnections(
(self.obj72,self.obj67,[281.0, 261.0, 381.0, 261.0],"true", 2) )
    # Connections for obj53 (graphObject_: Obj4) of type MT_pre__trace_link
    self.drawConnections(
(self.obj53,self.obj50,[621.0, 351.0, 621.0, 261.0],"true", 2) )
    # Connections for obj54 (graphObject_: Obj5) of type MT_pre__trace_link
    self.drawConnections(
(self.obj54,self.obj49,[821.0, 351.0, 821.0, 261.0],"true", 2) )
    # Connections for obj65 (graphObject_: Obj16) of type NAC
    self.drawConnections(
 )
    ...
    self.drawConnections(
(self.obj55,self.obj62,[1141.0, 351.0, 1141.0, 261.0],"true", 2) )
    # Connections for obj56 (graphObject_: Obj7) of type MT_post__trace_link
    self.drawConnections(
(self.obj56,self.obj61,[1343.0, 346.0, 1343.0, 256.0],"true", 2) )
    # Connections for obj57 (graphObject_: Obj8) of type MT_post__directLink_T
    self.drawConnections(
(self.obj57,self.obj59,[1242.0, 438.5, 1343.0, 436.0],"true", 2) )
    # Connections for obj58 (graphObject_: Obj9) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj58,self.obj61,[1242.0, 258.5, 1343.0, 256.0],"true", 2) )
    # Connections for obj59 (graphObject_: Obj10) of type MT_post__Male_T
    self.drawConnections(
(self.obj59,self.obj56,[1343.0, 436.0, 1343.0, 346.0],"true", 2) )
    # Connections for obj60 (graphObject_: Obj11) of type MT_post__Male_T
    self.drawConnections(
(self.obj60,self.obj57,[1141.0, 441.0, 1242.0, 438.5],"true", 2),
(self.obj60,self.obj55,[1141.0, 441.0, 1141.0, 351.0],"true", 2) )
    # Connections for obj61 (graphObject_: Obj12) of type MT_post__Male_S
    self.drawConnections(
 )
    # Connections for obj62 (graphObject_: Obj13) of type MT_post__Male_S
    self.drawConnections(
(self.obj62,self.obj58,[1141.0, 261.0, 1242.0, 258.5],"true", 2) )
