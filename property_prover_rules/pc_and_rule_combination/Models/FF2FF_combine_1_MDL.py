...
Author: levi
Modified: Thu Dec  4 14:25:35 2014
...
def FF2FF_combine_1_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MT_post__PoliceStationMMRootNode=None, MoTifRuleRootNode=None):
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(731.0,261.0,self.obj66)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(641.0,341.0,self.obj54)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(821.0,341.0,self.obj55)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1161.0,341.0,self.obj56)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1341.0,341.0,self.obj57)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__directLink_T(1251.0,421.0,self.obj59)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__indirectLink_S(1251.0,261.0,self.obj67)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__Female_T(1100.0,380.0,self.obj60)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj61=MT_post__Female_T(self)
    ...
    # MT_label__
    self.obj61.MT_label__.setValue('4')
    ...
    self.obj61.graphClass_= graph_MT_post__Female_T
    if self.genGraphics:
       new_obj = graph_MT_post__Female_T(1280.0,380.0,self.obj61)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Female_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
...
(self.obj49,self.obj66,[641.0, 261.0, 731.0, 261.0],"true", 2) )
...
(self.obj55,self.obj50,[821.0, 341.0, 821.0, 261.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj56,self.obj62,[1161.0, 341.0, 1161.0, 261.0],"true", 2) )
    # Connections for obj57 (graphObject_: Obj8) of type MT_post__trace_link
    self.drawConnections(
(self.obj57,self.obj63,[1341.0, 341.0, 1341.0, 261.0],"true", 2) )
    # Connections for obj59 (graphObject_: Obj10) of type MT_post__directLink_T
    self.drawConnections(
(self.obj59,self.obj61,[1251.0, 421.0, 1341.0, 421.0],"true", 2) )
    # Connections for obj67 (graphObject_: Obj18) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj67,self.obj63,[1251.0, 261.0, 1341.0, 261.0],"true", 2) )
    # Connections for obj60 (graphObject_: Obj11) of type MT_post__Female_T
    self.drawConnections(
(self.obj60,self.obj59,[1161.0, 421.0, 1251.0, 421.0],"true", 2),
(self.obj60,self.obj56,[1161.0, 421.0, 1161.0, 341.0],"true", 2) )
    # Connections for obj61 (graphObject_: Obj12) of type MT_post__Female_T
    self.drawConnections(
(self.obj61,self.obj57,[1341.0, 421.0, 1341.0, 341.0],"true", 2) )
    # Connections for obj62 (graphObject_: Obj13) of type MT_post__Female_S
    self.drawConnections(
(self.obj62,self.obj67,[1161.0, 261.0, 1251.0, 261.0],"true", 2) )
