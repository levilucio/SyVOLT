...
class HContract09_CompleteLHS(HimesisPreConditionPatternLHS):
	def __init__(self):
		"""
		Creates the himesis graph representing the AToM3 model HContract09_CompleteLHS
		"""
		# Flag this instance as compiled now
		self.is_compiled = True

		super(HContract09_CompleteLHS, self).__init__(name='HContract09_CompleteLHS', num_nodes=0, edges=[])
		...
		self["name"] = """"""
		self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'HContract09_CompleteLHS')
		self["equations"] = []
		...
		self.vs[3]["mm__"] = """MT_pre__WeakReference"""
		self.vs[3]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'WeakReference')
		...
		self.vs[9]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'EntityTypeassoc9WeakReference')
		...
		self.add_edges([
			...
			(9,3), # association null -> apply class null(WeakReference)
		])
