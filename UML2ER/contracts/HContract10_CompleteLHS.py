...
class HContract10_CompleteLHS(HimesisPreConditionPatternLHS):
	def __init__(self, *args, **kwargs):
		"""
		Creates the himesis graph representing the AToM3 model HContract10_CompleteLHS
		"""
		# Flag this instance as compiled now
		self.is_compiled = True

		super(HContract10_CompleteLHS, self).__init__(name='HContract10_CompleteLHS', num_nodes=0, edges=[])
		...
		self["name"] = """"""
		self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'HContract10_CompleteLHS')
		self["equations"] = []
		...
		self.vs[3]["mm__"] = """MT_pre__StrongReference"""
		self.vs[3]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'StrongReference')
		...
		self.vs[9]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'EntityTypeassoc9StrongReference')
		...
		self.add_edges([
			...
			(9,3), # association null -> apply class null(StrongReference)
		])
