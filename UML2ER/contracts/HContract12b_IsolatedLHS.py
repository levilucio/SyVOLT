...
class HContract12b_IsolatedLHS(HimesisPreConditionPatternLHS):
	def __init__(self, *args, **kwargs):
		"""
		Creates the himesis graph representing the AToM3 model HContract12b_IsolatedLHS
		"""
		# Flag this instance as compiled now
		self.is_compiled = True

		super(HContract12b_IsolatedLHS, self).__init__(name='HContract12b_IsolatedLHS', num_nodes=0, edges=[])
		...
		self["name"] = """"""
		self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'HContract12b_IsolatedLHS')
		self["equations"] = []
