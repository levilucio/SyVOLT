...
class HContract02_ConnectedLHS(HimesisPreConditionPatternLHS):
	def __init__(self, *args, **kwargs):
		"""
		Creates the himesis graph representing the AToM3 model HContract02_ConnectedLHS
		"""
		# Flag this instance as compiled now
		self.is_compiled = True

		super(HContract02_ConnectedLHS, self).__init__(name='HContract02_ConnectedLHS', num_nodes=0, edges=[])
		...
		self["name"] = """"""
		self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'HContract02_ConnectedLHS')
		self["equations"] = []
