...
class HContract12a_CompleteLHS(HimesisPreConditionPatternLHS):
	def __init__(self, *args, **kwargs):
		"""
		Creates the himesis graph representing the AToM3 model HContract12a_CompleteLHS
		"""
		# Flag this instance as compiled now
		self.is_compiled = True

		super(HContract12a_CompleteLHS, self).__init__(name='HContract12a_CompleteLHS', num_nodes=0, edges=[])
		...
		self["name"] = """"""
		self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'HContract12a_CompleteLHS')
		self["equations"] = []
		...
		self['equations'].append(((3,'type'),('constant','NoType')))
