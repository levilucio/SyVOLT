...
class HSM2SMBackComplete_run1LHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HSM2SMBackComplete_run1LHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HSM2SMBackComplete_run1LHS, self).__init__(name='HSM2SMBackComplete_run1LHS', num_nodes=8, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('9ae1e0be-26db-4a43-a2dc-c14861d3d6b0')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('1b8da127-1d1e-4799-89b7-d06884ea6f62')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('ebfd96cd-e3f9-4362-9571-95493bcbace9')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('a5d32bd5-b621-4668-a2d4-9ede4f1d680d')
...
.""")
        ...
        self.vs[3]["GUID__"] = UUID('99e03095-8b9d-4568-8a7c-184740264f9e')
...
.""")
        ...
        self.vs[4]["GUID__"] = UUID('fb9761f4-9bbf-44f7-b784-996d8dd472c7')
...
p1
.""")
        self.vs[5]["GUID__"] = UUID('01817376-266b-4e08-a4cc-8e8d6061bb2b')
...
.""")
        ...
        self.vs[6]["GUID__"] = UUID('a80deee8-ecc5-4c07-a6e6-8aaf765b9554')
...
.""")
        ...
        self.vs[7]["GUID__"] = UUID('abf4153d-6deb-4b40-9c24-5e560578ab5e')
