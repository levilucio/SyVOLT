"""
__FF2FF_run1_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Thu Dec  4 14:06:44 2014
...
def FF2FF_run1_MDL(self, rootNode, PoliceStationMMRootNode=None):
    ...
    if( PoliceStationMMRootNode ): 
        ...
        # name
        PoliceStationMMRootNode.name.setValue('FF2FF_run1')
    # --- ASG attributes over ---
    ...
    # classtype
    self.obj30.classtype.setValue('female1')

    # cardinality
    self.obj30.cardinality.setValue('+')

    # name
    self.obj30.name.setValue('7.f1')

    self.obj30.graphClass_= graph_Female_S
    if self.genGraphics:
       new_obj = graph_Female_S(380.0,220.0,self.obj30)
    ...
    # classtype
    self.obj31.classtype.setValue('female1')

    # cardinality
    self.obj31.cardinality.setValue('+')

    # name
    self.obj31.name.setValue('7.f2')

    self.obj31.graphClass_= graph_Female_S
    if self.genGraphics:
       new_obj = graph_Female_S(620.0,220.0,self.obj31)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("Female_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    # classtype
    self.obj34.classtype.setValue('female1')

    # name
    self.obj34.name.setValue('7.f1')

    self.obj34.graphClass_= graph_Female_T
    if self.genGraphics:
       new_obj = graph_Female_T(380.0,460.0,self.obj34)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # classtype
    self.obj35.classtype.setValue('female1')

    # name
    self.obj35.name.setValue('7.f2')

    self.obj35.graphClass_= graph_Female_T
    if self.genGraphics:
       new_obj = graph_Female_T(620.0,460.0,self.obj35)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("Female_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_match_contains(321.0,231.0,self.obj36)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_match_contains(441.0,231.0,self.obj37)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("match_contains", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_apply_contains(323.5,471.0,self.obj38)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_apply_contains(443.5,471.0,self.obj39)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("apply_contains", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_backward_link(441.0,381.0,self.obj40)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_backward_link(681.0,381.0,self.obj41)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("backward_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_indirectLink_S(561.0,261.0,self.obj42)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # associationType
    self.obj43.associationType.setValue('f2f')

    self.obj43.graphClass_= graph_directLink_T
    if self.genGraphics:
       new_obj = graph_directLink_T(561.0,501.0,self.obj43)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # Connections for obj30 (graphObject_: Obj0) named 7.f1
    self.drawConnections(
(self.obj30,self.obj42,[441.0, 261.0, 561.0, 261.0],"true", 2) )
    # Connections for obj31 (graphObject_: Obj1) named 7.f2
    self.drawConnections(
 )
    # Connections for obj32 (graphObject_: Obj2) of type MatchModel
    self.drawConnections(
(self.obj32,self.obj44,[201.0, 201.0, 203.5, 321.0],"true", 2),
(self.obj32,self.obj36,[201.0, 201.0, 321.0, 231.0],"true", 2),
(self.obj32,self.obj37,[201.0, 201.0, 441.0, 231.0],"true", 2) )
    # Connections for obj33 (graphObject_: Obj3) of type ApplyModel
    self.drawConnections(
(self.obj33,self.obj38,[206.0, 441.0, 323.5, 471.0],"true", 2),
(self.obj33,self.obj39,[206.0, 441.0, 443.5, 471.0],"true", 2) )
    # Connections for obj34 (graphObject_: Obj4) named 7.f1
    self.drawConnections(
(self.obj34,self.obj40,[441.0, 501.0, 441.0, 381.0],"true", 2),
(self.obj34,self.obj43,[441.0, 501.0, 561.0, 501.0],"true", 2) )
    # Connections for obj35 (graphObject_: Obj5) named 7.f2
    self.drawConnections(
(self.obj35,self.obj41,[681.0, 501.0, 681.0, 381.0],"true", 2) )
    # Connections for obj36 (graphObject_: Obj6) of type match_contains
    self.drawConnections(
(self.obj36,self.obj30,[321.0, 231.0, 441.0, 261.0],"true", 2) )
    # Connections for obj37 (graphObject_: Obj7) of type match_contains
    self.drawConnections(
(self.obj37,self.obj31,[441.0, 231.0, 681.0, 261.0],"true", 2) )
    # Connections for obj38 (graphObject_: Obj8) of type apply_contains
    self.drawConnections(
(self.obj38,self.obj34,[323.5, 471.0, 441.0, 501.0],"true", 2) )
    # Connections for obj39 (graphObject_: Obj9) of type apply_contains
    self.drawConnections(
(self.obj39,self.obj35,[443.5, 471.0, 681.0, 501.0],"true", 2) )
    # Connections for obj40 (graphObject_: Obj10) of type backward_link
    self.drawConnections(
(self.obj40,self.obj30,[441.0, 381.0, 441.0, 261.0],"true", 2) )
    # Connections for obj41 (graphObject_: Obj11) of type backward_link
    self.drawConnections(
(self.obj41,self.obj31,[681.0, 381.0, 681.0, 261.0],"true", 2) )
    # Connections for obj42 (graphObject_: Obj12) of type indirectLink_S
    self.drawConnections(
(self.obj42,self.obj31,[561.0, 261.0, 681.0, 261.0],"true", 2) )
    # Connections for obj43 (graphObject_: Obj13) of type directLink_T
    self.drawConnections(
(self.obj43,self.obj35,[561.0, 501.0, 681.0, 501.0],"true", 2) )
    # Connections for obj44 (graphObject_: Obj14) of type paired_with
    self.drawConnections(
(self.obj44,self.obj33,[203.5, 321.0, 206.0, 441.0],"true", 2) )

newfunction = FF2FF_run1_MDL
