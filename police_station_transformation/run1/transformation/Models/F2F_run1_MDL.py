"""
__F2F_run1_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Mon Nov 10 14:37:39 2014
...
def F2F_run1_MDL(self, rootNode, PoliceStationMMRootNode=None):
    ...
    if( PoliceStationMMRootNode ): 
        ...
        # name
        PoliceStationMMRootNode.name.setValue('F2F_run1')
    # --- ASG attributes over ---
    ...
    # classtype
    self.obj33.classtype.setValue('female1')

    # name
    self.obj33.name.setValue('2.f')

    self.obj33.graphClass_= graph_Female_T
    if self.genGraphics:
       new_obj = graph_Female_T(380.0,460.0,self.obj33)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_match_contains(321.0,231.0,self.obj34)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_apply_contains(323.5,471.0,self.obj35)
       new_obj.DrawObject(self.UMLmodel)
