"""
__SM2SM_run1_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Thu Dec  4 14:09:35 2014
...
def SM2SM_run1_MDL(self, rootNode, PoliceStationMMRootNode=None):
    ...
    if( PoliceStationMMRootNode ): 
        ...
        # name
        PoliceStationMMRootNode.name.setValue('SM2SM_run1')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_indirectLink_S(601.0,261.0,self.obj42)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # associationType
    self.obj43.associationType.setValue('s2m')

    self.obj43.graphClass_= graph_directLink_T
    if self.genGraphics:
       new_obj = graph_directLink_T(601.0,501.0,self.obj43)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # Connections for obj30 (graphObject_: Obj0) named 4.s
    self.drawConnections(
(self.obj30,self.obj42,[481.0, 261.0, 601.0, 261.0],"true", 2) )
    # Connections for obj31 (graphObject_: Obj1) named 4.m
    self.drawConnections(
 )
...
(self.obj33,self.obj39,[206.0, 441.0, 463.5, 471.0],"true", 2) )
    # Connections for obj34 (graphObject_: Obj4) named 4.s
    self.drawConnections(
(self.obj34,self.obj40,[481.0, 501.0, 481.0, 381.0],"true", 2),
(self.obj34,self.obj43,[481.0, 501.0, 601.0, 501.0],"true", 2) )
    # Connections for obj35 (graphObject_: Obj5) named 4.m
    self.drawConnections(
