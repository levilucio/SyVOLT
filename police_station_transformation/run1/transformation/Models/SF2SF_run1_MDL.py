"""
__SF2SF_run1_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Thu Dec  4 14:08:58 2014
...
def SF2SF_run1_MDL(self, rootNode, PoliceStationMMRootNode=None):
    ...
    if( PoliceStationMMRootNode ): 
        ...
        # name
        PoliceStationMMRootNode.name.setValue('SF2SF_run1')
    # --- ASG attributes over ---
    ...
    # name
    self.obj31.name.setValue('5.f')

    self.obj31.graphClass_= graph_Female_S
    if self.genGraphics:
       new_obj = graph_Female_S(680.0,220.0,self.obj31)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # classtype
    self.obj34.classtype.setValue('station1')

    # name
    self.obj34.name.setValue('5.s')

    self.obj34.graphClass_= graph_Station_T
    if self.genGraphics:
       new_obj = graph_Station_T(420.0,460.0,self.obj34)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # name
    self.obj35.name.setValue('5.f')

    self.obj35.graphClass_= graph_Female_T
    if self.genGraphics:
       new_obj = graph_Female_T(680.0,460.0,self.obj35)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_match_contains(341.0,231.0,self.obj36)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_match_contains(471.0,231.0,self.obj37)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("match_contains", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_apply_contains(343.5,471.0,self.obj38)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_apply_contains(473.5,471.0,self.obj39)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("apply_contains", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_backward_link(481.0,381.0,self.obj40)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_backward_link(741.0,381.0,self.obj41)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("backward_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_indirectLink_S(611.0,261.0,self.obj42)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # associationType
    self.obj43.associationType.setValue('s2f')

    self.obj43.graphClass_= graph_directLink_T
    if self.genGraphics:
       new_obj = graph_directLink_T(611.0,501.0,self.obj43)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # Connections for obj30 (graphObject_: Obj0) named 5.s
    self.drawConnections(
(self.obj30,self.obj42,[481.0, 261.0, 611.0, 261.0],"true", 2) )
    # Connections for obj31 (graphObject_: Obj1) named 5.f
    self.drawConnections(
 )
    # Connections for obj32 (graphObject_: Obj2) of type MatchModel
    self.drawConnections(
(self.obj32,self.obj44,[201.0, 201.0, 203.5, 321.0],"true", 2),
(self.obj32,self.obj36,[201.0, 201.0, 341.0, 231.0],"true", 2),
(self.obj32,self.obj37,[201.0, 201.0, 471.0, 231.0],"true", 2) )
    # Connections for obj33 (graphObject_: Obj3) of type ApplyModel
    self.drawConnections(
(self.obj33,self.obj38,[206.0, 441.0, 343.5, 471.0],"true", 2),
(self.obj33,self.obj39,[206.0, 441.0, 473.5, 471.0],"true", 2) )
    # Connections for obj34 (graphObject_: Obj4) named 5.s
    self.drawConnections(
(self.obj34,self.obj40,[481.0, 501.0, 481.0, 381.0],"true", 2),
(self.obj34,self.obj43,[481.0, 501.0, 611.0, 501.0],"true", 2) )
    # Connections for obj35 (graphObject_: Obj5) named 5.f
    self.drawConnections(
(self.obj35,self.obj41,[741.0, 501.0, 741.0, 381.0],"true", 2) )
    # Connections for obj36 (graphObject_: Obj6) of type match_contains
    self.drawConnections(
(self.obj36,self.obj30,[341.0, 231.0, 481.0, 261.0],"true", 2) )
    # Connections for obj37 (graphObject_: Obj7) of type match_contains
    self.drawConnections(
(self.obj37,self.obj31,[471.0, 231.0, 741.0, 261.0],"true", 2) )
    # Connections for obj38 (graphObject_: Obj8) of type apply_contains
    self.drawConnections(
(self.obj38,self.obj34,[343.5, 471.0, 481.0, 501.0],"true", 2) )
    # Connections for obj39 (graphObject_: Obj9) of type apply_contains
    self.drawConnections(
(self.obj39,self.obj35,[473.5, 471.0, 741.0, 501.0],"true", 2) )
    # Connections for obj40 (graphObject_: Obj10) of type backward_link
    self.drawConnections(
(self.obj40,self.obj30,[481.0, 381.0, 481.0, 261.0],"true", 2) )
    # Connections for obj41 (graphObject_: Obj11) of type backward_link
    self.drawConnections(
(self.obj41,self.obj31,[741.0, 381.0, 741.0, 261.0],"true", 2) )
    # Connections for obj42 (graphObject_: Obj12) of type indirectLink_S
    self.drawConnections(
(self.obj42,self.obj31,[611.0, 261.0, 741.0, 261.0],"true", 2) )
    # Connections for obj43 (graphObject_: Obj13) of type directLink_T
    self.drawConnections(
(self.obj43,self.obj35,[611.0, 501.0, 741.0, 501.0],"true", 2) )
    # Connections for obj44 (graphObject_: Obj14) of type paired_with
    self.drawConnections(
(self.obj44,self.obj33,[203.5, 321.0, 206.0, 441.0],"true", 2) )

newfunction = SF2SF_run1_MDL
