...
class HFF2FFBackF2F2_run2LHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HFF2FFBackF2F2_run2LHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HFF2FFBackF2F2_run2LHS, self).__init__(name='HFF2FFBackF2F2_run2LHS', num_nodes=3, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('239fe403-8fb6-434f-8174-fa93f3127840')
...
.""")
        ...
        self.vs[0]["GUID__"] = UUID('13e4f483-6f04-4121-bc5d-2f8ab78d642c')
...
.""")
        ...
        self.vs[1]["GUID__"] = UUID('6e4b1591-0d6c-4324-ba4b-478e097bd8b7')
...
"""
        ...
        self.vs[2]["GUID__"] = UUID('0d9ab207-f05d-4ef8-9793-fb362a462985')
