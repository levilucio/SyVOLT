...
class HF2FFComplete_run2LHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HF2FFComplete_run2LHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HF2FFComplete_run2LHS, self).__init__(name='HF2FFComplete_run2LHS', num_nodes=5, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('7901c2ca-8def-4438-b0e1-c47f4c7ad7ed')
...
.""")
        ...
        self.vs[0]["GUID__"] = UUID('844a0aa2-f078-456b-b52e-21bda0b40366')
...
"""
        ...
        self.vs[1]["GUID__"] = UUID('299039a9-b7d3-47b5-9e54-e26be3cfce9b')
...
.""")
        ...
        self.vs[2]["GUID__"] = UUID('9b4b7d0a-30b0-4662-95a1-ed46d34507d3')
...
"""
        ...
        self.vs[3]["GUID__"] = UUID('199d3aed-5d30-4e0e-a961-41341b82458b')
...
"""
        ...
        self.vs[4]["GUID__"] = UUID('48ac20fb-8abb-4c3d-ae60-833a6ac113fd')
