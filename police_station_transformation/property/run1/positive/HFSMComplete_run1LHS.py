...
class HFSMComplete_run1LHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HFSMComplete_run1LHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HFSMComplete_run1LHS, self).__init__(name='HFSMComplete_run1LHS', num_nodes=13, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('b361cb7e-accd-4456-9cf5-ab997120384d')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('5153dbb9-0a21-4fbd-86f8-b290c8ee49fb')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('c6608c53-25d5-4fef-8dca-efbd5717588b')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('eeec48eb-8786-4ada-980c-adaa103f7f0e')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('fe09a680-b277-4523-8851-7fc1aab6adb7')
        self.vs[4]["MT_subtypeMatching__"] = False
        self.vs[4]["MT_pre__classtype"] = """if attr_value == 'female1':
    return True
else:
    return False
"""
...
return True
"""
        self.vs[4]["GUID__"] = UUID('171f7e13-e5d8-4134-b0a1-afbd256105c3')
        self.vs[5]["MT_subtypeMatching__"] = False
        self.vs[5]["MT_pre__classtype"] = pickle.loads("""Vif attr_value == 'station1':\u000a    return True\u000aelse:\u000a    return False\u000a
p1
.""")
...
return True
"""
        self.vs[5]["GUID__"] = UUID('0277037d-c07b-4a38-b3c4-a5f5423ba0ec')
...
.""")
        ...
        self.vs[6]["GUID__"] = UUID('7d4f9ea4-69c1-4c9f-b824-12c73574e20f')
...
.""")
        ...
        self.vs[7]["GUID__"] = UUID('b73575b0-e243-4a04-b5da-e9a31f3fd844')
...
.""")
        ...
        self.vs[8]["GUID__"] = UUID('8713b901-dac1-43f3-9cd9-cac5305cb3d4')
...
.""")
        ...
        self.vs[9]["GUID__"] = UUID('a89882f2-df3a-4abc-af9d-591efd54df29')
...
.""")
        ...
        self.vs[10]["GUID__"] = UUID('e81b1417-779a-4389-bd38-79149055f736')
...
.""")
        ...
        self.vs[11]["GUID__"] = UUID('5715e094-dece-4ead-be46-41d6d4073e82')
...
.""")
        ...
        self.vs[12]["GUID__"] = UUID('230dd05f-fc54-4646-90b3-7dd7ddfc34d9')
