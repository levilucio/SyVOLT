...
class HBuildTraceabilityNoBackwardLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HBuildTraceabilityNoBackwardLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HBuildTraceabilityNoBackwardLHS, self).__init__(name='HBuildTraceabilityNoBackwardLHS', num_nodes=2, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('2bc06261-83fa-4240-af61-fe1cc7d5aa07')
...
"""
        ...
        self.vs[0]["GUID__"] = UUID('c3d4b2c2-9051-4491-aecd-6cd9616bee0f')
...
"""
        ...
        self.vs[1]["GUID__"] = UUID('781f1d92-3cd5-433a-837c-5608afdfe875')
