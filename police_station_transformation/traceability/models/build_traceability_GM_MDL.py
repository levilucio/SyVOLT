"""
__build_traceability_GM_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Thu Nov  6 16:20:57 2014
...
def build_traceability_GM_MDL(self, rootNode, MT_pre__GM2AUTOSAR_MMRootNode=None, MT_post__GM2AUTOSAR_MMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('BuildTraceabilityGM')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_S(240.0,200.0,self.obj71)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__MetaModelElement_T(240.0,380.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_S(780.0,200.0,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__MetaModelElement_T(780.0,380.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj75=MT_post__trace_link(self)
    ...
    self.obj75.graphClass_= graph_MT_post__trace_link
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(949.0,363.5,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_RHS(580.0,160.0,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_LHS(120.0,160.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.drawConnections(
(self.obj74,self.obj75,[948.0, 453.0, 949.0, 363.5],"true", 2) )
    # Connections for obj75 (graphObject_: Obj4) of type MT_post__trace_link
    self.drawConnections(
(self.obj75,self.obj73,[949.0, 363.5, 950.0, 274.0],"true", 2) )
...
newfunction = build_traceability_GM_MDL
