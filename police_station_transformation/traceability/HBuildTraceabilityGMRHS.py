...
class HBuildTraceabilityGMRHS(HimesisPostConditionPattern):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HBuildTraceabilityGMRHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HBuildTraceabilityGMRHS, self).__init__(name='HBuildTraceabilityGMRHS', num_nodes=3, edges=[])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('586ba3b8-7004-4a96-b0eb-41597d75df14')
...
return attr_value
"""
        self.vs[0]["GUID__"] = UUID('1dd27d25-7c3e-46c6-876c-186ac898a109')
        self.vs[1]["MT_label__"] = """3"""
        self.vs[1]["mm__"] = """MT_post__trace_link"""
        self.vs[1]["GUID__"] = UUID('b52cb8d9-1dc1-4503-b7db-59516a86d43f')
...
return attr_value
"""
        self.vs[2]["GUID__"] = UUID('ffaf1f73-773a-4090-a4eb-fac4ee304f53')

        from HBuildTraceabilityGMLHS import HBuildTraceabilityGMLHS
        self.pre = HBuildTraceabilityGMLHS()
