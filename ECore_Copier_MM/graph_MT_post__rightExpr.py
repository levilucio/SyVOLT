...
class graph_MT_post__rightExpr(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le=linkEditor(self,self.semObject, "rightExpr")
      ...
      self.le.FirstLink.decoration.setValue( ('rightExpr_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('rightExpr_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('rightExpr_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('rightExpr_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('rightExpr_2ndLink', self.le.SecondLink))
