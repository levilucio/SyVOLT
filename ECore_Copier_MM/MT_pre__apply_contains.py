"""
__MT_pre__apply_contains.py_____________________________________________________
...
class MT_pre__apply_contains(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_pre__apply_contains
   ...
   def clone(self):
      cloneObject = MT_pre__apply_contains( self.parent )
