"""
__graph_MT_pre__Member.py___________________________________________________________
...
class graph_MT_pre__Member(graphEntity):
...
new_class = graph_MT_pre__Member
