"""
__MT_post__ApplyModel.py_____________________________________________________
...
class MT_post__ApplyModel(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_post__ApplyModel
   ...
   def clone(self):
      cloneObject = MT_post__ApplyModel( self.parent )
