"""
__MT_post__CommunityRoot.py_____________________________________________________

Automatically generated AToM3 syntactic object (DO NOT MODIFY DIRECTLY)
Author: levi
Modified: Tue May  5 12:04:34 2015
...
from graph_MT_post__CommunityRoot import *
class MT_post__CommunityRoot(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__MetaModelElement_T']
      self.graphClass_ = graph_MT_post__CommunityRoot
      ...
      self.generatedAttributes = {'MT_post__classtype': ('ATOM3Text', ),
                                  'MT_post__name': ('ATOM3Text', ),
                                  'MT_label__': ('ATOM3String', ),
                                  'MT_pivotOut__': ('ATOM3String', )      }
      self.realOrder = ['MT_post__classtype','MT_post__name','MT_label__','MT_pivotOut__']
      self.directEditing = [0,0,1,1]
   def clone(self):
      cloneObject = MT_post__CommunityRoot( self.parent )
