"""
__graph_MT_post__Station_S.py___________________________________________________________
...
class graph_MT_post__Station_S(graphEntity):
...
new_class = graph_MT_post__Station_S
