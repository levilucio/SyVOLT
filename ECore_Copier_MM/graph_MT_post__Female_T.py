"""
__graph_MT_post__Female_T.py___________________________________________________________
...
class graph_MT_post__Female_T(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([-19.0, -18.0, -19.0, -271.0])[:2], tags = self.tag, font=font, fill = 'grey45', anchor = 'center', text = 'Female', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__Female_T
