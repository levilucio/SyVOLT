"""
__graph_MT_post__match_contains.py___________________________________________________________

Automatically generated LINK for entity MT_post__match_contains
...
class graph_MT_post__match_contains(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "match_contains")
      ...
      self.le.FirstLink.decoration.setValue( ('match_contains_1stLink', self.le.FirstLink))
      self.le.FirstSegment= widthXfillXdecoration()
      self.le.FirstSegment.width=ATOM3Integer(1)
      self.le.FirstSegment.fill=ATOM3String('grey', 20)
      ...
      self.le.SecondSegment.decoration.setValue( ('match_contains_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('match_contains_2ndLink', self.le.SecondLink))
