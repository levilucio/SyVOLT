"""
__ASG_ECoreMM.py_____________________________________________________
...
class ASG_ECoreMM(ASG, ATOM3Type):
   ...
   def open(self, parent, topWindowParent):
       from ATOM3 import *
       a = ATOM3(topWindowParent, 'ECoreMM', 0, 1, self)
