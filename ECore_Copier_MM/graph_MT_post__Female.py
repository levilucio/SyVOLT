"""
__graph_MT_post__Female.py___________________________________________________________
...
class graph_MT_post__Female(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([2.0, 3.0, 2.0, 12.0])[:2], tags = self.tag, font=font, fill = 'grey45', anchor = 'center', text = 'MT_post__Female', width = '0', justify= 'left', stipple='' )
...
new_class = graph_MT_post__Female
