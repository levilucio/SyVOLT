"""
__leftExpr.py_____________________________________________________
...
class leftExpr(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_leftExpr
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = leftExpr( self.parent )
