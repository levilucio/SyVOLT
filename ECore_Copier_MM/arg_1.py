"""
__arg_1.py_____________________________________________________
...
from graph_arg_1 import *
class arg_1(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_arg_1
