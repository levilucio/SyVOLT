"""
__MT_pre__EClass.py_____________________________________________________
...
class MT_pre__EClass(ASGNode, ATOM3Type):
   ...
   def clone(self):
      cloneObject = MT_pre__EClass( self.parent )
