"""
__graph_Female_S.py___________________________________________________________
...
class graph_Female_S(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([-19.0, -18.0, -19.0, -293.0])[:2], tags = self.tag, font=font, fill = 'grey45', anchor = 'center', text = 'Female', width = '0', justify= 'left', stipple='' )
        ...
        h = drawing.create_text(self.translate([21.0, 22.0, 21.0, -234.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = drawText, width = '0', justify= 'left', stipple='' )
