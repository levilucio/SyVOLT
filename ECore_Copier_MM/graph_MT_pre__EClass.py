"""
__graph_MT_pre__EClass.py___________________________________________________________
...
class graph_MT_pre__EClass(graphEntity):
...
new_class = graph_MT_pre__EClass
