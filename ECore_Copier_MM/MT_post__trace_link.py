"""
__MT_post__trace_link.py_____________________________________________________
...
class MT_post__trace_link(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_post__trace_link
   ...
   def clone(self):
      cloneObject = MT_post__trace_link( self.parent )
