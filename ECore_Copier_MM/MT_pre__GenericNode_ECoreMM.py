"""
__MT_pre__GenericNode_ECoreMM.py_____________________________________________________
...
from graph_MT_pre__GenericNode_ECoreMM import *
class MT_pre__GenericNode_ECoreMM(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_pre__GenericNode_ECoreMM
   ...
   def clone(self):
      cloneObject = MT_pre__GenericNode_ECoreMM( self.parent )
