"""
__graph_MT_post__Station_T.py___________________________________________________________
...
class graph_MT_post__Station_T(graphEntity):
...
new_class = graph_MT_post__Station_T
