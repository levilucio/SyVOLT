"""
__graph_MT_post__EClass.py___________________________________________________________
...
class graph_MT_post__EClass(graphEntity):
...
new_class = graph_MT_post__EClass
