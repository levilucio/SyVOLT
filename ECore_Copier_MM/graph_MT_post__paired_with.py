...
class graph_MT_post__paired_with(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le=linkEditor(self,self.semObject, "paired_with")
      ...
      self.le.FirstLink.decoration.setValue( ('paired_with_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('paired_with_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('paired_with_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('paired_with_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('paired_with_2ndLink', self.le.SecondLink))
