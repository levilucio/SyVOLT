"""
__MT_pre__ECoreMM_MM.py______________________________________________________

Automatically generated AToM3 MetaModel (DO NOT MODIFY DIRECTLY)
Author: levi
Modified: Tue May  5 12:31:58 2015
_____________________________________________________________________________
"""
from ASG_MT_pre__ECoreMM import *
...
from MT_pre__GenericNode_ECoreMM       import *
...
from MT_pre__GenericEdge_ECoreMM       import *
def createNewASGroot(self):
   return ASG_MT_pre__ECoreMM(self, None)
...
def createModelMenu(self, modelMenu):
    ...
    modelMenu.add_command(label="New MT_pre__EClass", command=lambda x=self: x.createNewMT_pre__EClass(x, 100, 100) )
    modelMenu.add_command(label="New MT_pre__EReference", command=lambda x=self: x.createNewMT_pre__EReference(x, 100, 100) )
    modelMenu.add_command(label="New MT_pre__EStructuralFeature", command=lambda x=self: x.createNewMT_pre__EStructuralFeature(x, 100, 100) )
    ...
    modelMenu.add_command(label="New MT_pre__GenericNode_ECoreMM", command=lambda x=self: x.createNewMT_pre__GenericNode_ECoreMM(x, 100, 100) )
    ...
    modelMenu.add_command(label="New MT_pre__GenericEdge_ECoreMM", command=lambda x=self: x.createNewMT_pre__GenericEdge_ECoreMM(x, 100, 100) )
def setConnectivity(self):
    self.ConnectivityMap['MT_pre__arg_1']={
          ...
          ,'MT_pre__GenericNode_ECoreMM': []
          ,'MT_pre__Expression': []
          ,'MT_pre__paired_with': []
          ,'MT_pre__GenericEdge_ECoreMM': []
    ...
    self.ConnectivityMap['MT_pre__apply_contains']={
          ...
          ,'MT_pre__arg_2': []
          ,'MT_pre__apply_contains': []
          ,'MT_pre__backward_link': [( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature), ( 'MT_pre__MetaModelElement_T', self.createNewMT_pre__MetaModelElement_T)]
          ,'MT_pre__MatchModel': []
          ,'MT_pre__match_contains': []
          ,'MT_pre__Concat': []
          ,'MT_pre__trace_link': [( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature), ( 'MT_pre__MetaModelElement_T', self.createNewMT_pre__MetaModelElement_T)]
          ,'MT_pre__ApplyModel': []
          ,'MT_pre__Constant': []
          ,'MT_pre__Attribute': []
          ,'MT_pre__indirectLink_S': [( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature)]
          ,'MT_pre__GenericNode_ECoreMM': []
          ,'MT_pre__Expression': []
          ,'MT_pre__paired_with': []
          ,'MT_pre__GenericEdge_ECoreMM': []
          ,'MT_pre__EStructuralFeature': []
          ,'MT_pre__directLink_S': [( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature)]
          ,'MT_pre__directLink_T': [( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature), ( 'MT_pre__MetaModelElement_T', self.createNewMT_pre__MetaModelElement_T)]
          ,'MT_pre__EClass': []
          ,'MT_pre__hasAttr_S': [( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature)]
          ,'MT_pre__EReference': []
          ,'MT_pre__hasAttr_T': [( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature), ( 'MT_pre__MetaModelElement_T', self.createNewMT_pre__MetaModelElement_T)]
          ,'MT_pre__leftExpr': []
          ,'MT_pre__Equation': []
          ,'MT_pre__rightExpr': []
          ,'MT_pre__MetaModelElement_T': []
    ...
    self.ConnectivityMap['MT_pre__backward_link']={
          ...
          ,'MT_pre__arg_2': []
          ,'MT_pre__apply_contains': []
          ,'MT_pre__backward_link': [( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature)]
          ,'MT_pre__MatchModel': []
          ,'MT_pre__match_contains': []
          ,'MT_pre__Concat': []
          ,'MT_pre__trace_link': [( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature)]
          ,'MT_pre__ApplyModel': []
          ,'MT_pre__Constant': []
          ,'MT_pre__Attribute': []
          ,'MT_pre__indirectLink_S': [( 'MT_pre__MetaModelElement_S', self.createNewMT_pre__MetaModelElement_S), ( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature)]
          ,'MT_pre__GenericNode_ECoreMM': []
          ,'MT_pre__Expression': []
          ,'MT_pre__paired_with': []
          ,'MT_pre__GenericEdge_ECoreMM': []
          ,'MT_pre__EStructuralFeature': []
          ,'MT_pre__directLink_S': [( 'MT_pre__MetaModelElement_S', self.createNewMT_pre__MetaModelElement_S), ( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature)]
          ,'MT_pre__directLink_T': [( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature)]
          ,'MT_pre__EClass': []
          ,'MT_pre__hasAttr_S': [( 'MT_pre__MetaModelElement_S', self.createNewMT_pre__MetaModelElement_S), ( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature)]
          ,'MT_pre__EReference': []
          ,'MT_pre__hasAttr_T': [( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature)]
          ,'MT_pre__leftExpr': []
          ,'MT_pre__Equation': []
          ,'MT_pre__rightExpr': []
          ,'MT_pre__MetaModelElement_T': []
    ...
    self.ConnectivityMap['MT_pre__MatchModel']={
          ...
          ,'MT_pre__paired_with': []
          ,'MT_pre__GenericEdge_ECoreMM': []
          ,'MT_pre__EStructuralFeature': [( 'MT_pre__match_contains', self.createNewMT_pre__match_contains)]
          ,'MT_pre__directLink_S': []
          ,'MT_pre__directLink_T': []
          ,'MT_pre__EClass': [( 'MT_pre__match_contains', self.createNewMT_pre__match_contains)]
          ,'MT_pre__hasAttr_S': []
          ,'MT_pre__EReference': [( 'MT_pre__match_contains', self.createNewMT_pre__match_contains)]
          ,'MT_pre__hasAttr_T': []
          ,'MT_pre__leftExpr': []
          ,'MT_pre__Equation': []
          ,'MT_pre__rightExpr': []
    ...
    self.ConnectivityMap['MT_pre__ApplyModel']={
          ...
          ,'MT_pre__paired_with': []
          ,'MT_pre__GenericEdge_ECoreMM': []
          ,'MT_pre__EStructuralFeature': [( 'MT_pre__apply_contains', self.createNewMT_pre__apply_contains)]
          ,'MT_pre__directLink_S': []
          ,'MT_pre__directLink_T': []
          ,'MT_pre__EClass': [( 'MT_pre__apply_contains', self.createNewMT_pre__apply_contains)]
          ,'MT_pre__hasAttr_S': []
          ,'MT_pre__EReference': [( 'MT_pre__apply_contains', self.createNewMT_pre__apply_contains)]
          ,'MT_pre__hasAttr_T': []
          ,'MT_pre__leftExpr': []
          ,'MT_pre__Equation': []
          ,'MT_pre__rightExpr': []
    ...
    self.ConnectivityMap['MT_pre__indirectLink_S']={
          ...
          ,'MT_pre__MetaModelElement_T': []
          ,'MT_pre__MetaModelElement_S': [] }
    self.ConnectivityMap['MT_pre__GenericNode_ECoreMM']={
           'MT_pre__arg_1': []
          ,'MT_pre__arg_2': []
          ,'MT_pre__apply_contains': []
          ,'MT_pre__backward_link': []
          ,'MT_pre__MatchModel': [( 'MT_pre__GenericEdge_ECoreMM', self.createNewMT_pre__GenericEdge_ECoreMM)]
          ,'MT_pre__match_contains': []
          ,'MT_pre__Concat': [( 'MT_pre__GenericEdge_ECoreMM', self.createNewMT_pre__GenericEdge_ECoreMM)]
          ,'MT_pre__trace_link': []
          ,'MT_pre__ApplyModel': [( 'MT_pre__GenericEdge_ECoreMM', self.createNewMT_pre__GenericEdge_ECoreMM)]
          ,'MT_pre__Constant': [( 'MT_pre__GenericEdge_ECoreMM', self.createNewMT_pre__GenericEdge_ECoreMM)]
          ,'MT_pre__Attribute': [( 'MT_pre__GenericEdge_ECoreMM', self.createNewMT_pre__GenericEdge_ECoreMM)]
          ,'MT_pre__indirectLink_S': []
          ,'MT_pre__GenericNode_ECoreMM': [( 'MT_pre__GenericEdge_ECoreMM', self.createNewMT_pre__GenericEdge_ECoreMM)]
          ,'MT_pre__Expression': [( 'MT_pre__GenericEdge_ECoreMM', self.createNewMT_pre__GenericEdge_ECoreMM)]
          ,'MT_pre__paired_with': []
          ,'MT_pre__GenericEdge_ECoreMM': []
          ,'MT_pre__EStructuralFeature': [( 'MT_pre__GenericEdge_ECoreMM', self.createNewMT_pre__GenericEdge_ECoreMM)]
          ,'MT_pre__directLink_S': []
          ,'MT_pre__directLink_T': []
          ,'MT_pre__EClass': [( 'MT_pre__GenericEdge_ECoreMM', self.createNewMT_pre__GenericEdge_ECoreMM)]
          ,'MT_pre__hasAttr_S': []
          ,'MT_pre__EReference': [( 'MT_pre__GenericEdge_ECoreMM', self.createNewMT_pre__GenericEdge_ECoreMM)]
          ,'MT_pre__hasAttr_T': []
          ,'MT_pre__leftExpr': []
          ,'MT_pre__Equation': [( 'MT_pre__GenericEdge_ECoreMM', self.createNewMT_pre__GenericEdge_ECoreMM)]
          ,'MT_pre__rightExpr': []
          ,'MT_pre__MetaModelElement_T': [( 'MT_pre__GenericEdge_ECoreMM', self.createNewMT_pre__GenericEdge_ECoreMM)]
          ,'MT_pre__MetaModelElement_S': [( 'MT_pre__GenericEdge_ECoreMM', self.createNewMT_pre__GenericEdge_ECoreMM)] }
    ...
    self.ConnectivityMap['MT_pre__paired_with']={
          ...
          ,'MT_pre__MetaModelElement_T': []
          ,'MT_pre__MetaModelElement_S': [] }
    self.ConnectivityMap['MT_pre__GenericEdge_ECoreMM']={
           'MT_pre__arg_1': [( 'MT_pre__Concat', self.createNewMT_pre__Concat)]
          ,'MT_pre__arg_2': [( 'MT_pre__Concat', self.createNewMT_pre__Concat)]
          ,'MT_pre__apply_contains': [( 'MT_pre__ApplyModel', self.createNewMT_pre__ApplyModel)]
          ,'MT_pre__backward_link': [( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature), ( 'MT_pre__MetaModelElement_T', self.createNewMT_pre__MetaModelElement_T)]
          ...
          ,'MT_pre__GenericEdge_ECoreMM': [( 'MT_pre__GenericNode_ECoreMM', self.createNewMT_pre__GenericNode_ECoreMM)]
          ,'MT_pre__EStructuralFeature': []
          ,'MT_pre__directLink_S': [( 'MT_pre__MetaModelElement_S', self.createNewMT_pre__MetaModelElement_S), ( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature)]
          ,'MT_pre__directLink_T': [( 'MT_pre__EClass', self.createNewMT_pre__EClass), ( 'MT_pre__EReference', self.createNewMT_pre__EReference), ( 'MT_pre__EStructuralFeature', self.createNewMT_pre__EStructuralFeature), ( 'MT_pre__MetaModelElement_T', self.createNewMT_pre__MetaModelElement_T)]
          ,'MT_pre__EClass': []
          ...
          ,'MT_pre__MetaModelElement_T': []
          ,'MT_pre__MetaModelElement_S': [] }
    self.ConnectivityMap['MT_pre__EStructuralFeature']={
           'MT_pre__arg_1': []
          ,'MT_pre__arg_2': []
          ,'MT_pre__apply_contains': []
          ,'MT_pre__backward_link': []
          ...
          ,'MT_pre__ApplyModel': []
          ,'MT_pre__Constant': []
          ,'MT_pre__Attribute': [( 'MT_pre__hasAttr_S', self.createNewMT_pre__hasAttr_S), ( 'MT_pre__hasAttr_T', self.createNewMT_pre__hasAttr_T)]
          ,'MT_pre__indirectLink_S': []
          ,'MT_pre__GenericNode_ECoreMM': []
          ,'MT_pre__Expression': []
          ,'MT_pre__paired_with': []
          ,'MT_pre__GenericEdge_ECoreMM': []
          ,'MT_pre__EStructuralFeature': [( 'MT_pre__backward_link', self.createNewMT_pre__backward_link), ( 'MT_pre__indirectLink_S', self.createNewMT_pre__indirectLink_S), ( 'MT_pre__directLink_T', self.createNewMT_pre__directLink_T), ( 'MT_pre__directLink_S', self.createNewMT_pre__directLink_S), ( 'MT_pre__trace_link', self.createNewMT_pre__trace_link)]
          ,'MT_pre__directLink_S': []
          ,'MT_pre__directLink_T': []
          ,'MT_pre__EClass': [( 'MT_pre__backward_link', self.createNewMT_pre__backward_link), ( 'MT_pre__indirectLink_S', self.createNewMT_pre__indirectLink_S), ( 'MT_pre__directLink_T', self.createNewMT_pre__directLink_T), ( 'MT_pre__directLink_S', self.createNewMT_pre__directLink_S), ( 'MT_pre__trace_link', self.createNewMT_pre__trace_link)]
          ,'MT_pre__hasAttr_S': []
          ,'MT_pre__EReference': [( 'MT_pre__backward_link', self.createNewMT_pre__backward_link), ( 'MT_pre__indirectLink_S', self.createNewMT_pre__indirectLink_S), ( 'MT_pre__directLink_T', self.createNewMT_pre__directLink_T), ( 'MT_pre__directLink_S', self.createNewMT_pre__directLink_S), ( 'MT_pre__trace_link', self.createNewMT_pre__trace_link)]
          ,'MT_pre__hasAttr_T': []
          ,'MT_pre__leftExpr': []
          ,'MT_pre__Equation': []
          ,'MT_pre__rightExpr': []
          ,'MT_pre__MetaModelElement_T': [( 'MT_pre__directLink_T', self.createNewMT_pre__directLink_T)]
          ,'MT_pre__MetaModelElement_S': [( 'MT_pre__backward_link', self.createNewMT_pre__backward_link), ( 'MT_pre__indirectLink_S', self.createNewMT_pre__indirectLink_S), ( 'MT_pre__directLink_S', self.createNewMT_pre__directLink_S), ( 'MT_pre__trace_link', self.createNewMT_pre__trace_link)] }
    ...
    self.ConnectivityMap['MT_pre__directLink_T']={
          ...
          ,'MT_pre__MetaModelElement_T': []
          ,'MT_pre__MetaModelElement_S': [] }
    self.ConnectivityMap['MT_pre__EClass']={
           'MT_pre__arg_1': []
          ,'MT_pre__arg_2': []
          ,'MT_pre__apply_contains': []
          ,'MT_pre__backward_link': []
    ...
    self.ConnectivityMap['MT_pre__rightExpr']={
          ...
          ,'MT_pre__MetaModelElement_T': []
          ,'MT_pre__MetaModelElement_S': [] }
    self.ConnectivityMap['MT_pre__EReference']={
           'MT_pre__arg_1': []
          ,'MT_pre__arg_2': []
          ,'MT_pre__apply_contains': []
          ,'MT_pre__backward_link': []
    ...
    self.ConnectivityMap['MT_pre__MetaModelElement_T']={
          ...
          ,'MT_pre__paired_with': []
          ,'MT_pre__GenericEdge_ECoreMM': []
          ,'MT_pre__EStructuralFeature': [( 'MT_pre__backward_link', self.createNewMT_pre__backward_link), ( 'MT_pre__directLink_T', self.createNewMT_pre__directLink_T), ( 'MT_pre__trace_link', self.createNewMT_pre__trace_link)]
          ,'MT_pre__directLink_S': []
          ,'MT_pre__directLink_T': []
          ,'MT_pre__EClass': [( 'MT_pre__backward_link', self.createNewMT_pre__backward_link), ( 'MT_pre__directLink_T', self.createNewMT_pre__directLink_T), ( 'MT_pre__trace_link', self.createNewMT_pre__trace_link)]
          ,'MT_pre__hasAttr_S': []
          ,'MT_pre__EReference': [( 'MT_pre__backward_link', self.createNewMT_pre__backward_link), ( 'MT_pre__directLink_T', self.createNewMT_pre__directLink_T), ( 'MT_pre__trace_link', self.createNewMT_pre__trace_link)]
          ,'MT_pre__hasAttr_T': []
          ,'MT_pre__leftExpr': []
          ,'MT_pre__Equation': []
          ,'MT_pre__rightExpr': []
    ...
    self.ConnectivityMap['MT_pre__MetaModelElement_S']={
          ...
          ,'MT_pre__paired_with': []
          ,'MT_pre__GenericEdge_ECoreMM': []
          ,'MT_pre__EStructuralFeature': [( 'MT_pre__indirectLink_S', self.createNewMT_pre__indirectLink_S), ( 'MT_pre__directLink_S', self.createNewMT_pre__directLink_S)]
          ,'MT_pre__directLink_S': []
          ,'MT_pre__directLink_T': []
          ,'MT_pre__EClass': [( 'MT_pre__indirectLink_S', self.createNewMT_pre__indirectLink_S), ( 'MT_pre__directLink_S', self.createNewMT_pre__directLink_S)]
          ,'MT_pre__hasAttr_S': []
          ,'MT_pre__EReference': [( 'MT_pre__indirectLink_S', self.createNewMT_pre__indirectLink_S), ( 'MT_pre__directLink_S', self.createNewMT_pre__directLink_S)]
          ,'MT_pre__hasAttr_T': []
          ,'MT_pre__leftExpr': []
          ,'MT_pre__Equation': []
          ,'MT_pre__rightExpr': []
    ...
    self.CardinalityTable['MT_pre__MetaModelElement_S']={
          ...
          ,'MT_pre__arg_1': []
          ,'MT_pre__arg_2': []
          ,'MT_pre__GenericEdge_ECoreMM': [('0', 'N', 'Destination')] }
    self.CardinalityTable['MT_pre__EClass']={
          'MT_pre__MetaModelElement_S': []
          ,'MT_pre__EClass': []
          ,'MT_pre__EReference': []
          ,'MT_pre__EStructuralFeature': []
          ...
          ,'MT_pre__backward_link': [('0', 'N', 'Source'), ('0', 'N', 'Destination')]
          ,'MT_pre__indirectLink_S': [('0', 'N', 'Source'), ('0', 'N', 'Destination')]
          ,'MT_pre__directLink_T': [('0', 'N', 'Source'), ('0', 'N', 'Destination')]
          ,'MT_pre__directLink_S': [('0', 'N', 'Source'), ('0', 'N', 'Destination')]
          ,'MT_pre__paired_with': []
          ,'MT_pre__trace_link': [('0', 'N', 'Source'), ('0', 'N', 'Destination')]
          ,'MT_pre__hasAttr_S': [('0', 'N', 'Source')]
          ...
          ,'MT_pre__arg_1': []
          ,'MT_pre__arg_2': []
          ,'MT_pre__GenericEdge_ECoreMM': [('0', 'N', 'Destination'), ('0', 'N', 'Destination'), ('0', 'N', 'Destination')] }
    self.CardinalityTable['MT_pre__EReference']={
          'MT_pre__MetaModelElement_S': []
          ,'MT_pre__EClass': []
          ,'MT_pre__EReference': []
          ,'MT_pre__EStructuralFeature': []
          ...
          ,'MT_pre__arg_2': []
          ,'MT_pre__GenericEdge_ECoreMM': [('0', 'N', 'Destination'), ('0', 'N', 'Destination'), ('0', 'N', 'Destination')] }
    self.CardinalityTable['MT_pre__EStructuralFeature']={
          'MT_pre__MetaModelElement_S': []
          ,'MT_pre__EClass': []
          ,'MT_pre__EReference': []
          ,'MT_pre__EStructuralFeature': []
    ...
    self.CardinalityTable['MT_pre__Attribute']={
          ...
          ,'MT_pre__GenericEdge_ECoreMM': [('0', 'N', 'Destination'), ('0', 'N', 'Destination')] }
    ...
    self.CardinalityTable['MT_pre__Concat']={
          ...
          ,'MT_pre__GenericEdge_ECoreMM': [('0', 'N', 'Destination'), ('0', 'N', 'Destination')] }
    self.CardinalityTable['MT_pre__GenericNode_ECoreMM']={
          'MT_pre__MetaModelElement_S': []
          ,'MT_pre__EClass': []
          ,'MT_pre__EReference': []
          ,'MT_pre__EStructuralFeature': []
          ...
          ,'MT_pre__arg_1': []
          ,'MT_pre__arg_2': []
          ,'MT_pre__GenericEdge_ECoreMM': [('0', 'N', 'Source'), ('0', 'N', 'Destination')] }
    self.CardinalityTable['MT_pre__match_contains']={
          'MT_pre__MetaModelElement_S': [('0', 'N', 'Source')]
          ,'MT_pre__EClass': [('0', 'N', 'Source')]
          ,'MT_pre__EReference': [('0', 'N', 'Source')]
          ,'MT_pre__EStructuralFeature': [('0', 'N', 'Source')]
    ...
    self.CardinalityTable['MT_pre__backward_link']={
          'MT_pre__MetaModelElement_S': [('0', 'N', 'Source')]
          ,'MT_pre__EClass': [('0', 'N', 'Source'), ('0', 'N', 'Destination')]
          ,'MT_pre__EReference': [('0', 'N', 'Source'), ('0', 'N', 'Destination')]
          ,'MT_pre__EStructuralFeature': [('0', 'N', 'Source'), ('0', 'N', 'Destination')]
          ,'MT_pre__MatchModel': []
          ,'MT_pre__ApplyModel': []
    ...
    self.CardinalityTable['MT_pre__trace_link']={
          'MT_pre__MetaModelElement_S': [('0', 'N', 'Source')]
          ,'MT_pre__EClass': [('0', 'N', 'Destination'), ('0', 'N', 'Source')]
          ,'MT_pre__EReference': [('0', 'N', 'Destination'), ('0', 'N', 'Source')]
          ,'MT_pre__EStructuralFeature': [('0', 'N', 'Destination'), ('0', 'N', 'Source')]
          ,'MT_pre__MatchModel': []
          ,'MT_pre__ApplyModel': []
          ,'MT_pre__MetaModelElement_T': [('0', 'N', 'Destination')]
          ,'MT_pre__Attribute': []
    ...
    self.CardinalityTable['MT_pre__hasAttr_S']={
          ...
          ,'MT_pre__EClass': [('0', 'N', 'Destination')]
          ,'MT_pre__EReference': [('0', 'N', 'Destination')]
          ,'MT_pre__EStructuralFeature': [('0', 'N', 'Destination')]
          ,'MT_pre__MatchModel': []
          ,'MT_pre__ApplyModel': []
          ,'MT_pre__MetaModelElement_T': []
    ...
    self.CardinalityTable['MT_pre__arg_2']={
          ...
          ,'MT_pre__arg_2': []
          ,'MT_pre__GenericEdge_ECoreMM': [] }
    self.CardinalityTable['MT_pre__GenericEdge_ECoreMM']={
          'MT_pre__MetaModelElement_S': [('0', 'N', 'Source')]
          ,'MT_pre__EClass': [('0', 'N', 'Source'), ('0', 'N', 'Source'), ('0', 'N', 'Source')]
          ,'MT_pre__EReference': [('0', 'N', 'Source'), ('0', 'N', 'Source'), ('0', 'N', 'Source')]
          ,'MT_pre__EStructuralFeature': [('0', 'N', 'Source'), ('0', 'N', 'Source'), ('0', 'N', 'Source')]
          ...
          ,'MT_pre__GenericNode_ECoreMM': [('0', 'N', 'Destination'), ('0', 'N', 'Source')]
          ,'MT_pre__match_contains': []
          ,'MT_pre__apply_contains': []
          ,'MT_pre__backward_link': []
          ,'MT_pre__indirectLink_S': []
    ...
    self.entitiesInMetaModel['MT_pre__ECoreMM']=["MT_pre__MetaModelElement_S", "MT_pre__EClass", "MT_pre__EReference", "MT_pre__EStructuralFeature", "MT_pre__MatchModel", "MT_pre__ApplyModel", "MT_pre__MetaModelElement_T", "MT_pre__Attribute", "MT_pre__Equation", "MT_pre__Expression", "MT_pre__Constant", "MT_pre__Concat", "MT_pre__GenericNode_ECoreMM", "MT_pre__match_contains", "MT_pre__apply_contains", "MT_pre__backward_link", "MT_pre__indirectLink_S", "MT_pre__directLink_T", "MT_pre__directLink_S", "MT_pre__paired_with", "MT_pre__trace_link", "MT_pre__hasAttr_S", "MT_pre__hasAttr_T", "MT_pre__leftExpr", "MT_pre__rightExpr", "MT_pre__arg_1", "MT_pre__arg_2", "MT_pre__GenericEdge_ECoreMM"]
...
def createNewMT_pre__EClass(self, wherex, wherey, screenCoordinates = 1):
   self.fromClass = None
   self.toClass = None
   # try the global constraints...
   res = self.ASGroot.preCondition(ASG.CREATE)
   ...
   new_semantic_obj = MT_pre__EClass(self)
   res = new_semantic_obj.preCondition ( ASGNode.CREATE )
   if res: return self.constraintViolation(res)
   new_semantic_obj.preAction ( ASGNode.CREATE ) 

   ne = len(self.ASGroot.listNodes["MT_pre__EClass"])
   if new_semantic_obj.keyword_:
      new_semantic_obj.keyword_.setValue(new_semantic_obj.keyword_.toString()+str(ne))
   if screenCoordinates:
      new_obj = graph_MT_pre__EClass(self.UMLmodel.canvasx(wherex), self.UMLmodel.canvasy(wherey), new_semantic_obj)
   else: # already in canvas coordinates
      new_obj = graph_MT_pre__EClass(wherex, wherey, new_semantic_obj)
   new_obj.DrawObject(self.UMLmodel, self.editGGLabel)
   ...
   if self.editGGLabel :
      ...
      self.statusbar.event(StatusBar.MODEL, StatusBar.CREATE)
   return new_semantic_obj
def createNewMT_pre__EReference(self, wherex, wherey, screenCoordinates = 1):
   self.fromClass = None
   self.toClass = None
   # try the global constraints...
   res = self.ASGroot.preCondition(ASG.CREATE)
   ...
   new_semantic_obj = MT_pre__EReference(self)
   res = new_semantic_obj.preCondition ( ASGNode.CREATE )
   if res: return self.constraintViolation(res)
   new_semantic_obj.preAction ( ASGNode.CREATE ) 

   ne = len(self.ASGroot.listNodes["MT_pre__EReference"])
   if new_semantic_obj.keyword_:
      new_semantic_obj.keyword_.setValue(new_semantic_obj.keyword_.toString()+str(ne))
   if screenCoordinates:
      new_obj = graph_MT_pre__EReference(self.UMLmodel.canvasx(wherex), self.UMLmodel.canvasy(wherey), new_semantic_obj)
   else: # already in canvas coordinates
      new_obj = graph_MT_pre__EReference(wherex, wherey, new_semantic_obj)
   new_obj.DrawObject(self.UMLmodel, self.editGGLabel)
   ...
   if self.editGGLabel :
      ...
      self.statusbar.event(StatusBar.MODEL, StatusBar.CREATE)
   return new_semantic_obj
def createNewMT_pre__EStructuralFeature(self, wherex, wherey, screenCoordinates = 1):
   self.fromClass = None
   self.toClass = None
   # try the global constraints...
   res = self.ASGroot.preCondition(ASG.CREATE)
   ...
   new_semantic_obj = MT_pre__EStructuralFeature(self)
   res = new_semantic_obj.preCondition ( ASGNode.CREATE )
   if res: return self.constraintViolation(res)
   new_semantic_obj.preAction ( ASGNode.CREATE ) 

   ne = len(self.ASGroot.listNodes["MT_pre__EStructuralFeature"])
   if new_semantic_obj.keyword_:
      new_semantic_obj.keyword_.setValue(new_semantic_obj.keyword_.toString()+str(ne))
   if screenCoordinates:
      new_obj = graph_MT_pre__EStructuralFeature(self.UMLmodel.canvasx(wherex), self.UMLmodel.canvasy(wherey), new_semantic_obj)
   else: # already in canvas coordinates
      new_obj = graph_MT_pre__EStructuralFeature(wherex, wherey, new_semantic_obj)
   new_obj.DrawObject(self.UMLmodel, self.editGGLabel)
...
def createNewMT_pre__Concat(self, wherex, wherey, screenCoordinates = 1):
   ...
   if self.editGGLabel :
      ...
      self.statusbar.event(StatusBar.MODEL, StatusBar.CREATE)
   return new_semantic_obj
def createNewMT_pre__GenericNode_ECoreMM(self, wherex, wherey, screenCoordinates = 1):
   self.fromClass = None
   self.toClass = None
   # try the global constraints...
   res = self.ASGroot.preCondition(ASG.CREATE)
   ...
   new_semantic_obj = MT_pre__GenericNode_ECoreMM(self)
   res = new_semantic_obj.preCondition ( ASGNode.CREATE )
   if res: return self.constraintViolation(res)
   new_semantic_obj.preAction ( ASGNode.CREATE ) 

   ne = len(self.ASGroot.listNodes["MT_pre__GenericNode_ECoreMM"])
   if new_semantic_obj.keyword_:
      new_semantic_obj.keyword_.setValue(new_semantic_obj.keyword_.toString()+str(ne))
   if screenCoordinates:
      new_obj = graph_MT_pre__GenericNode_ECoreMM(self.UMLmodel.canvasx(wherex), self.UMLmodel.canvasy(wherey), new_semantic_obj)
   else: # already in canvas coordinates
      new_obj = graph_MT_pre__GenericNode_ECoreMM(wherex, wherey, new_semantic_obj)
   new_obj.DrawObject(self.UMLmodel, self.editGGLabel)
   self.UMLmodel.addtag_withtag("MT_pre__GenericNode_ECoreMM", new_obj.tag)
   new_semantic_obj.graphObject_ = new_obj
   self.ASGroot.addNode(new_semantic_obj)
   res = self.ASGroot.postCondition(ASG.CREATE)
   if res:
...
def createNewMT_pre__arg_2(self, wherex, wherey, screenCoordinates = 1):
   ...
   if self.editGGLabel :
      ...
      self.statusbar.event(StatusBar.MODEL, StatusBar.CREATE)
   return new_semantic_obj
def createNewMT_pre__GenericEdge_ECoreMM(self, wherex, wherey, screenCoordinates = 1):
   self.fromClass = None
   self.toClass = None
   # try the global constraints...
   res = self.ASGroot.preCondition(ASG.CREATE)
   ...
   new_semantic_obj = MT_pre__GenericEdge_ECoreMM(self)
   res = new_semantic_obj.preCondition ( ASGNode.CREATE )
   if res: return self.constraintViolation(res)
   new_semantic_obj.preAction ( ASGNode.CREATE ) 

   ne = len(self.ASGroot.listNodes["MT_pre__GenericEdge_ECoreMM"])
   if new_semantic_obj.keyword_:
      new_semantic_obj.keyword_.setValue(new_semantic_obj.keyword_.toString()+str(ne))
   if screenCoordinates:
      new_obj = graph_MT_pre__GenericEdge_ECoreMM(self.UMLmodel.canvasx(wherex), self.UMLmodel.canvasy(wherey), new_semantic_obj)
   else: # already in canvas coordinates
      new_obj = graph_MT_pre__GenericEdge_ECoreMM(wherex, wherey, new_semantic_obj)
   new_obj.DrawObject(self.UMLmodel, self.editGGLabel)
   self.UMLmodel.addtag_withtag("MT_pre__GenericEdge_ECoreMM", new_obj.tag)
   new_semantic_obj.graphObject_ = new_obj
   self.ASGroot.addNode(new_semantic_obj)
   res = self.ASGroot.postCondition(ASG.CREATE)
   if res:
...
def createNew_Model(self, wherex, wherey, screenCoordinates = 1):
   self.toClass = None
   self.fromClass = None
   new_semantic_obj = ASG_MT_pre__ECoreMM(self)
   ne = len(self.ASGroot.listNodes["ASG_MT_pre__ECoreMM"])
   if new_semantic_obj.keyword_:
      new_semantic_obj.keyword_.setValue(new_semantic_obj.keyword_.toString()+str(ne))
   if screenCoordinates:
   ...
   new_obj.DrawObject(self.UMLmodel, self.editGGLabel)
   self.UMLmodel.addtag_withtag("ASG_MT_pre__ECoreMM", new_obj.tag)
   new_semantic_obj.graphObject_ = new_obj
   self.ASGroot.addNode(new_semantic_obj)
   self.mode=self.IDLEMODE
   if self.editGGLabel :
