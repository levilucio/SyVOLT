"""
__graph_MetaModelElement.py___________________________________________________________
...
class graph_MetaModelElement(graphEntity):
...
new_class = graph_MetaModelElement
