"""
__ASG_MT_pre__ECoreMM.py_____________________________________________________
...
class ASG_MT_pre__ECoreMM(ASG, ATOM3Type):
   ...
   def open(self, parent, topWindowParent):
       from ATOM3 import *
       a = ATOM3(topWindowParent, 'MT_pre__ECoreMM', 0, 1, self)
