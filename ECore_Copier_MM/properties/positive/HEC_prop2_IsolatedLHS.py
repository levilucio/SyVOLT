...
class HEC_prop2_IsolatedLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
        Creates the himesis graph representing the AToM3 model HEC_prop2_IsolatedLHS.
                """
        # Flag this instance as compiled now
                self.is_compiled = True
        
                super(HEC_prop2_IsolatedLHS, self).__init__(name='HEC_prop2_IsolatedLHS', num_nodes=0, edges=[])
