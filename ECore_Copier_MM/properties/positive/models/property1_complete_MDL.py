...
Author: levi
Modified: Wed May  6 15:41:13 2015
...
def property1_complete_MDL(self, rootNode, MT_pre__ECoreMMRootNode=None, MoTifRuleRootNode=None):
    ...
    # MT_label__
    self.obj63.MT_label__.setValue('27')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_T(470.0,362.0,self.obj63)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj64.MT_label__.setValue('28')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_T(480.0,412.0,self.obj64)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj65=MT_pre__directLink_T(self)
    ...
    # MT_label__
    self.obj65.MT_label__.setValue('29')
    ...
    self.obj65.graphClass_= graph_MT_pre__directLink_T
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_T(340.0,462.0,self.obj65)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj66=MT_pre__directLink_T(self)
    ...
    # MT_label__
    self.obj66.MT_label__.setValue('30')
    ...
    self.obj66.graphClass_= graph_MT_pre__directLink_T
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_T(330.0,412.0,self.obj66)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    # MT_label__
    self.obj67.MT_label__.setValue('23')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_S(490.0,182.0,self.obj67)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj68.MT_label__.setValue('24')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_S(490.0,232.0,self.obj68)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_S(340.0,262.0,self.obj69)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    # MT_label__
    self.obj70.MT_label__.setValue('26')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__directLink_S(340.0,212.0,self.obj70)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__directLink_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    # MT_label__
    self.obj71.MT_label__.setValue('35')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__hasAttr_S(196.5,256.0,self.obj71)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj72=MT_pre__hasAttr_S(self)
    ...
    # MT_label__
    self.obj72.MT_label__.setValue('37')
    ...
    self.obj72.graphClass_= graph_MT_pre__hasAttr_S
    if self.genGraphics:
       new_obj = graph_MT_pre__hasAttr_S(566.5,156.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__hasAttr_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    # MT_label__
    self.obj73.MT_label__.setValue('36')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__hasAttr_T(196.5,456.0,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj74=MT_pre__hasAttr_T(self)
    ...
    # MT_label__
    self.obj74.MT_label__.setValue('38')
    ...
    self.obj74.graphClass_= graph_MT_pre__hasAttr_T
    if self.genGraphics:
       new_obj = graph_MT_pre__hasAttr_T(556.5,416.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__hasAttr_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj75=MT_pre__leftExpr(self)
    ...
    # MT_label__
    self.obj75.MT_label__.setValue('41')
    ...
    self.obj75.graphClass_= graph_MT_pre__leftExpr
    if self.genGraphics:
       new_obj = graph_MT_pre__leftExpr(187.5,301.0,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj76=MT_pre__leftExpr(self)
    ...
    # MT_label__
    self.obj76.MT_label__.setValue('43')
    ...
    self.obj76.graphClass_= graph_MT_pre__leftExpr
    if self.genGraphics:
       new_obj = graph_MT_pre__leftExpr(570.5,196.0,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__leftExpr", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj77=MT_pre__rightExpr(self)
    ...
    # MT_label__
    self.obj77.MT_label__.setValue('42')
    ...
    self.obj77.graphClass_= graph_MT_pre__rightExpr
    if self.genGraphics:
       new_obj = graph_MT_pre__rightExpr(191.5,394.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj78=MT_pre__rightExpr(self)
    ...
    # MT_label__
    self.obj78.MT_label__.setValue('44')
    ...
    self.obj78.graphClass_= graph_MT_pre__rightExpr
    if self.genGraphics:
       new_obj = graph_MT_pre__rightExpr(570.5,376.0,self.obj78)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__rightExpr", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    # constraint
    self.obj79.constraint.setValue('#===============================================================================\n# This code is executed after the nodes in the LHS have been matched.\n# You can access a matched node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# The given constraint must evaluate to a boolean expression:\n#    returning True enables the rule to be applied,\n#    returning False forbids the rule from being applied.\n#===============================================================================\n\nreturn True\n')
    self.obj79.constraint.setHeight(15)

    self.obj79.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(180.0,100.0,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj38,self.obj70,[260.0, 262.0, 340.0, 212.0],"true", 2),
(self.obj38,self.obj71,[260.0, 262.0, 196.5, 256.0],"true", 2) )
    # Connections for obj39 (graphObject_: Obj1) of type MT_pre__EClass
    self.drawConnections(
(self.obj39,self.obj66,[260.0, 462.0, 330.0, 412.0],"true", 2),
(self.obj39,self.obj73,[260.0, 462.0, 196.5, 456.0],"true", 2) )
    # Connections for obj40 (graphObject_: Obj2) of type MT_pre__EClass
    self.drawConnections(
(self.obj40,self.obj64,[540.0, 362.0, 480.0, 412.0],"true", 2),
(self.obj40,self.obj74,[540.0, 362.0, 556.5, 416.0],"true", 2) )
    # Connections for obj41 (graphObject_: Obj3) of type MT_pre__EClass
    self.drawConnections(
(self.obj41,self.obj68,[540.0, 202.0, 490.0, 232.0],"true", 2),
(self.obj41,self.obj72,[540.0, 202.0, 566.5, 156.0],"true", 2) )
    # Connections for obj42 (graphObject_: Obj4) of type MT_pre__EReference
    self.drawConnections(
(self.obj42,self.obj67,[420.0, 162.0, 490.0, 182.0],"true", 2) )
    # Connections for obj43 (graphObject_: Obj5) of type MT_pre__EReference
    self.drawConnections(
(self.obj43,self.obj69,[420.0, 262.0, 340.0, 262.0],"true", 2) )
    # Connections for obj44 (graphObject_: Obj6) of type MT_pre__EReference
    self.drawConnections(
(self.obj44,self.obj63,[400.0, 362.0, 470.0, 362.0],"true", 2) )
    # Connections for obj45 (graphObject_: Obj7) of type MT_pre__EReference
    self.drawConnections(
(self.obj45,self.obj65,[420.0, 462.0, 340.0, 462.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj52,self.obj75,[268.0, 342.0, 187.5, 301.0],"true", 2),
(self.obj52,self.obj77,[268.0, 342.0, 191.5, 394.0],"true", 2) )
    # Connections for obj53 (graphObject_: Obj15) of type MT_pre__Equation
    self.drawConnections(
(self.obj53,self.obj76,[568.0, 282.0, 570.5, 196.0],"true", 2),
(self.obj53,self.obj78,[568.0, 282.0, 570.5, 376.0],"true", 2) )
    # Connections for obj63 (graphObject_: Obj25) of type MT_pre__directLink_T
    self.drawConnections(
(self.obj63,self.obj40,[470.0, 362.0, 540.0, 362.0],"true", 2) )
    # Connections for obj64 (graphObject_: Obj26) of type MT_pre__directLink_T
    self.drawConnections(
(self.obj64,self.obj45,[480.0, 412.0, 420.0, 462.0],"true", 2) )
    # Connections for obj65 (graphObject_: Obj27) of type MT_pre__directLink_T
    self.drawConnections(
(self.obj65,self.obj39,[340.0, 462.0, 260.0, 462.0],"true", 2) )
    # Connections for obj66 (graphObject_: Obj28) of type MT_pre__directLink_T
    self.drawConnections(
(self.obj66,self.obj44,[330.0, 412.0, 400.0, 362.0],"true", 2) )
    # Connections for obj67 (graphObject_: Obj29) of type MT_pre__directLink_S
    self.drawConnections(
(self.obj67,self.obj41,[490.0, 182.0, 540.0, 202.0],"true", 2) )
    # Connections for obj68 (graphObject_: Obj30) of type MT_pre__directLink_S
    self.drawConnections(
(self.obj68,self.obj43,[490.0, 232.0, 420.0, 262.0],"true", 2) )
    # Connections for obj69 (graphObject_: Obj31) of type MT_pre__directLink_S
    self.drawConnections(
(self.obj69,self.obj38,[340.0, 262.0, 260.0, 262.0],"true", 2) )
    # Connections for obj70 (graphObject_: Obj32) of type MT_pre__directLink_S
    self.drawConnections(
(self.obj70,self.obj42,[340.0, 212.0, 420.0, 162.0],"true", 2) )
    # Connections for obj71 (graphObject_: Obj33) of type MT_pre__hasAttr_S
    self.drawConnections(
(self.obj71,self.obj48,[196.5, 256.0, 253.0, 250.0],"true", 2) )
    # Connections for obj72 (graphObject_: Obj34) of type MT_pre__hasAttr_S
    self.drawConnections(
(self.obj72,self.obj50,[566.5, 156.0, 513.0, 170.0],"true", 2) )
    # Connections for obj73 (graphObject_: Obj35) of type MT_pre__hasAttr_T
    self.drawConnections(
(self.obj73,self.obj49,[196.5, 456.0, 253.0, 450.0],"true", 2) )
    # Connections for obj74 (graphObject_: Obj36) of type MT_pre__hasAttr_T
    self.drawConnections(
(self.obj74,self.obj51,[556.5, 416.0, 533.0, 430.0],"true", 2) )
    # Connections for obj75 (graphObject_: Obj37) of type MT_pre__leftExpr
    self.drawConnections(
(self.obj75,self.obj48,[187.5, 301.0, 253.0, 250.0],"true", 2) )
    # Connections for obj76 (graphObject_: Obj38) of type MT_pre__leftExpr
    self.drawConnections(
(self.obj76,self.obj50,[570.5, 196.0, 513.0, 170.0],"true", 2) )
    # Connections for obj77 (graphObject_: Obj39) of type MT_pre__rightExpr
    self.drawConnections(
(self.obj77,self.obj49,[191.5, 394.0, 253.0, 450.0],"true", 2) )
    # Connections for obj78 (graphObject_: Obj40) of type MT_pre__rightExpr
    self.drawConnections(
(self.obj78,self.obj51,[570.5, 376.0, 533.0, 430.0],"true", 2) )
    # Connections for obj79 (graphObject_: Obj41) of type LHS
    self.drawConnections(
 )
