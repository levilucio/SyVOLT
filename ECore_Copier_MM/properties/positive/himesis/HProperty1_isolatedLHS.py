...
class HProperty1_isolatedLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        ...
        super(HProperty1_isolatedLHS, self).__init__(name='HProperty1_isolatedLHS', num_nodes=9, edges=[])
        
        # Add the edges
        self.add_edges([(7, 1), (6, 2), (5, 3), (8, 4), (0, 5), (0, 6), (0, 7), (0, 8)])
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('d5a03dcb-50e0-459d-a038-4d20d8190875')
...
.""")
        ...
        self.vs[0]["GUID__"] = UUID('c487feff-e732-477a-a047-8f65ded0ebc6')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('03271b80-6e98-4597-af44-d383ab310e2c')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('c3a921c4-3cfd-449e-9652-eec69e181887')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('e4c99b92-74f7-483a-a625-5ca870786c83')
...
return True
"""
        self.vs[4]["GUID__"] = UUID('187ccc46-d91f-4048-aabd-fe5d1521b919')
...
.""")
        ...
        self.vs[5]["GUID__"] = UUID('3e47a6de-5236-4574-9e8f-f5399bbec23c')
...
.""")
        ...
        self.vs[6]["GUID__"] = UUID('3b5fdb03-7128-4803-970b-1b5ff0f0e345')
...
.""")
        ...
        self.vs[7]["GUID__"] = UUID('99fed691-d868-454e-aa68-edd154f38fbe')
        self.vs[8]["MT_subtypeMatching__"] = False
        self.vs[8]["MT_label__"] = """23"""
        self.vs[8]["MT_subtypes__"] = pickle.loads("""(lp1
.""")
        self.vs[8]["MT_dirty__"] = False
        self.vs[8]["mm__"] = """MT_pre__match_contains"""
        self.vs[8]["GUID__"] = UUID('47c3eb3b-1055-4a08-8226-5dd0e5f43bbd')
