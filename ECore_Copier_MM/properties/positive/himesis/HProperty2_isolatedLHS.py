...
class HProperty2_isolatedLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HProperty2_isolatedLHS.
        """
...
"""
        self["name"] = """"""
        self["GUID__"] = UUID('816b7e55-d7ab-438d-8af7-8b2e54d44e2f')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('1b607133-dcb5-4af6-b3ec-529a84bab982')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('d52843bb-6f33-41be-a7fb-db3dda229568')
...
.""")
        ...
        self.vs[2]["GUID__"] = UUID('b1e8fc51-3eeb-4577-9480-7b7e27a6a07c')
...
.""")
        ...
        self.vs[3]["GUID__"] = UUID('341f13c4-4be4-48e7-879e-249a0a80d93c')
...
.""")
        ...
        self.vs[4]["GUID__"] = UUID('1e106afe-ea1b-4e1e-bd17-002cf7c99cae')
