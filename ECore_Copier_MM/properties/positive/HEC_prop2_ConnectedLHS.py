...
class HEC_prop2_ConnectedLHS(HimesisPreConditionPatternLHS):
        def __init__(self):
                """
                Creates the himesis graph representing the AToM3 model HEC_prop2_ConnectedLHS.
                """
                # Flag this instance as compiled now
                self.is_compiled = True
        
                super(HEC_prop2_ConnectedLHS, self).__init__(name='HEC_prop2_ConnectedLHS', num_nodes=0, edges=[])
...
"""
        ...
        # Add the edges
                self.add_edges([
                (0,2), # match_class EClass() -> association eStructuralFeatures
                (2,1) # association eStructuralFeatures  -> match_class EStructuralFeature()
        ])
