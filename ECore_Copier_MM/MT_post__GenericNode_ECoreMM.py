"""
__MT_post__GenericNode_ECoreMM.py_____________________________________________________
...
from graph_MT_post__GenericNode_ECoreMM import *
class MT_post__GenericNode_ECoreMM(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_post__GenericNode_ECoreMM
   ...
   def clone(self):
      cloneObject = MT_post__GenericNode_ECoreMM( self.parent )
