"""
__graph_MT_post__MetaModelElement.py___________________________________________________________
...
class graph_MT_post__MetaModelElement(graphEntity):
...
new_class = graph_MT_post__MetaModelElement
