"""
__graph_MT_pre__CommunityRoot.py___________________________________________________________
...
class graph_MT_pre__CommunityRoot(graphEntity):
...
new_class = graph_MT_pre__CommunityRoot
