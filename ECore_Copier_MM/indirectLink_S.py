"""
__indirectLink_S.py_____________________________________________________
...
class indirectLink_S(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_indirectLink_S
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = indirectLink_S( self.parent )
