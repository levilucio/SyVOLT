"""
__graph_MT_post__GenericEdge_ECoreMM.py___________________________________________________________

Automatically generated LINK for entity MT_post__GenericEdge_ECoreMM
...
class graph_MT_post__GenericEdge_ECoreMM(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "GenericEdge_ECoreMM")
      ...
      self.le.FirstLink.decoration.setValue( ('GenericEdge_ECoreMM_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('GenericEdge_ECoreMM_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('GenericEdge_ECoreMM_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('GenericEdge_ECoreMM_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('GenericEdge_ECoreMM_2ndLink', self.le.SecondLink))
