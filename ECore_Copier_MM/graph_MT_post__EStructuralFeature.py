"""
__graph_MT_post__EStructuralFeature.py___________________________________________________________
...
class graph_MT_post__EStructuralFeature(graphEntity):
...
new_class = graph_MT_post__EStructuralFeature
