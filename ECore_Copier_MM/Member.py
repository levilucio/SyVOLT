"""
__Member.py_____________________________________________________
...
from graph_Member import *
class Member(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MetaModelElement_S']
      self.graphClass_ = graph_Member
   ...
   def clone(self):
      cloneObject = Member( self.parent )
