...
"""
__graph_MT_pre__GenericNode_ECoreMM.py___________________________________________________________
...
class graph_MT_pre__GenericNode_ECoreMM(graphEntity):
...
new_class = graph_MT_pre__GenericNode_ECoreMM
