"""
__MT_pre__directLink_T.py_____________________________________________________
...
class MT_pre__directLink_T(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_pre__directLink_T
      ...
      self.generatedAttributes = {'MT_pre__associationType': ('ATOM3Text', ),
                                  'MT_label__': ('ATOM3String', ),
                                  'MT_pivotOut__': ('ATOM3String', ),
                                  'MT_pivotIn__': ('ATOM3String', ),
                                  'MT_subtypeMatching__': ('ATOM3Boolean', )      }
      self.realOrder = ['MT_pre__associationType','MT_label__','MT_pivotOut__','MT_pivotIn__','MT_subtypeMatching__']
      self.directEditing = [0,1,1,1,1]
   def clone(self):
      cloneObject = MT_pre__directLink_T( self.parent )
