"""
__graph_MT_pre__HouseholdRoot.py___________________________________________________________
...
class graph_MT_pre__HouseholdRoot(graphEntity):
...
new_class = graph_MT_pre__HouseholdRoot
