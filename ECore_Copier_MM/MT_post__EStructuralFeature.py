"""
__MT_post__EStructuralFeature.py_____________________________________________________
...
from graph_MT_post__EStructuralFeature import *
class MT_post__EStructuralFeature(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = ['MT_post__MetaModelElement_S', 'MT_post__MetaModelElement_T']
      self.graphClass_ = graph_MT_post__EStructuralFeature
      ...
      self.realOrder = ['MT_post__cardinality','MT_post__classtype','MT_post__classtype','MT_post__name','MT_post__name','MT_label__','MT_pivotOut__']
      self.directEditing = [0,0,0,0,0,1,1]
   def clone(self):
      cloneObject = MT_post__EStructuralFeature( self.parent )
