"""
__graph_EStructuralFeature.py___________________________________________________________
...
class graph_EStructuralFeature(graphEntity):
...
new_class = graph_EStructuralFeature
