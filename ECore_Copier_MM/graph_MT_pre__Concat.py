...
class graph_MT_pre__Concat(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([-8.0, 1.0, -8.0, -222.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_pre__Concat', width = '0', justify= 'left', stipple='' )
