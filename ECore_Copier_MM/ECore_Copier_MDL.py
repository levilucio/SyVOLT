"""
__ECore_Copier_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Tue May  5 12:27:37 2015
...
def ECore_Copier_MDL(self, rootNode, CD_ClassDiagramsV3RootNode=None):

    # --- Generating attributes code for ASG CD_ClassDiagramsV3 ---
    if( CD_ClassDiagramsV3RootNode ): 
        # name
        CD_ClassDiagramsV3RootNode.name.setValue('ECoreMM')
    ...
    self.obj28.Graphical_Appearance.setValue( ('MetaModelElement_S', self.obj28))

    # name
    self.obj28.name.setValue('MetaModelElement_S')
    ...
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('hasAttr_S', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    ...
    if self.genGraphics:
       ...
       new_obj.layConstraints['scale'] = [1.0, 1.7901639344262295]
    else: new_obj = None
    ...
    # Graphical_Appearance
    self.obj29.Graphical_Appearance.setValue( ('EClass', self.obj29))

    # name
    self.obj29.name.setValue('EClass')
    ...
    # Graphical_Appearance
    self.obj30.Graphical_Appearance.setValue( ('EReference', self.obj30))

    # name
    self.obj30.name.setValue('EReference')
    ...
    # Graphical_Appearance
    self.obj31.Graphical_Appearance.setValue( ('EStructuralFeature', self.obj31))

    # name
    self.obj31.name.setValue('EStructuralFeature')
    ...
    # Graphical_Appearance
    self.obj32.Graphical_Appearance.setValue( ('MatchModel', self.obj32))

    # name
    self.obj32.name.setValue('MatchModel')
    ...
    # Graphical_Appearance
    self.obj33.Graphical_Appearance.setValue( ('ApplyModel', self.obj33))

    # name
    self.obj33.name.setValue('ApplyModel')
    ...
    # Graphical_Appearance
    self.obj34.Graphical_Appearance.setValue( ('MetaModelElement_T', self.obj34))

    # name
    self.obj34.name.setValue('MetaModelElement_T')
    ...
    # Abstract
    self.obj34.Abstract.setValue((None, 1))
    ...
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('hasAttr_T', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    ...
    if self.genGraphics:
       ...
       new_obj.layConstraints['scale'] = [1.0, 1.290983606557377]
    else: new_obj = None
    ...
    # Graphical_Appearance
    self.obj35.Graphical_Appearance.setValue( ('Attribute', self.obj35))

    # name
    self.obj35.name.setValue('Attribute')
    ...
    lcobj2 =[]
    cobj2=ATOM3Connection()
    cobj2.setValue(('hasAttr_S', (('Source', 'Destination'), 1), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('hasAttr_T', (('Source', 'Destination'), 1), '0', 'N'))
    lcobj2.append(cobj2)
    ...
    # Graphical_Appearance
    self.obj36.Graphical_Appearance.setValue( ('Equation', self.obj36))

    # name
    self.obj36.name.setValue('Equation')
    ...
    # Graphical_Appearance
    self.obj37.Graphical_Appearance.setValue( ('Expression', self.obj37))

    # name
    self.obj37.name.setValue('Expression')
    ...
    # Abstract
    self.obj37.Abstract.setValue((None, 1))
    ...
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('arg_1', (('Source', 'Destination'), 1), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('arg_2', (('Source', 'Destination'), 1), '0', 'N'))
    lcobj2.append(cobj2)
    ...
    # Graphical_Appearance
    self.obj38.Graphical_Appearance.setValue( ('Constant', self.obj38))

    # name
    self.obj38.name.setValue('Constant')
    ...
    # Graphical_Appearance
    self.obj39.Graphical_Appearance.setValue( ('Concat', self.obj39))

    # name
    self.obj39.name.setValue('Concat')
    ...
    lcobj2 =[]
    cobj2=ATOM3Connection()
    cobj2.setValue(('arg_1', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('arg_2', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    ...
    # Graphical_Appearance
    self.obj40.Graphical_Appearance.setValue( ('match_contains', self.obj40))
    ...
    # name
    self.obj40.name.setValue('match_contains')
    ...
    # Graphical_Appearance
    self.obj41.Graphical_Appearance.setValue( ('apply_contains', self.obj41))
    ...
    # name
    self.obj41.name.setValue('apply_contains')
    ...
    # Graphical_Appearance
    self.obj42.Graphical_Appearance.setValue( ('backward_link', self.obj42))
    ...
    # name
    self.obj42.name.setValue('backward_link')
    ...
    # Graphical_Appearance
    self.obj43.Graphical_Appearance.setValue( ('indirectLink_S', self.obj43))
    ...
    # name
    self.obj43.name.setValue('indirectLink_S')
    ...
    # Graphical_Appearance
    self.obj44.Graphical_Appearance.setValue( ('directLink_T', self.obj44))
    ...
    # name
    self.obj44.name.setValue('directLink_T')
    ...
    # Graphical_Appearance
    self.obj45.Graphical_Appearance.setValue( ('directLink_S', self.obj45))
    ...
    # name
    self.obj45.name.setValue('directLink_S')
    ...
    # Graphical_Appearance
    self.obj46.Graphical_Appearance.setValue( ('paired_with', self.obj46))
    ...
    # name
    self.obj46.name.setValue('paired_with')
    ...
    # Graphical_Appearance
    self.obj47.Graphical_Appearance.setValue( ('trace_link', self.obj47))
    ...
    # name
    self.obj47.name.setValue('trace_link')
    ...
    # Graphical_Appearance
    self.obj48.Graphical_Appearance.setValue( ('hasAttr_S', self.obj48))
    ...
    # name
    self.obj48.name.setValue('hasAttr_S')
    ...
    # Graphical_Appearance
    self.obj49.Graphical_Appearance.setValue( ('hasAttr_T', self.obj49))
    ...
    # name
    self.obj49.name.setValue('hasAttr_T')
    ...
    # Graphical_Appearance
    self.obj50.Graphical_Appearance.setValue( ('leftExpr', self.obj50))
    ...
    # name
    self.obj50.name.setValue('leftExpr')
    ...
    # Graphical_Appearance
    self.obj51.Graphical_Appearance.setValue( ('rightExpr', self.obj51))
    ...
    # name
    self.obj51.name.setValue('rightExpr')
    ...
    # Graphical_Appearance
    self.obj52.Graphical_Appearance.setValue( ('arg_1', self.obj52))
    ...
    # name
    self.obj52.name.setValue('arg_1')
    ...
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('Concat', (('Source', 'Destination'), 1), '0', 'N'))
    lcobj2.append(cobj2)
    ...
    # Graphical_Appearance
    self.obj53.Graphical_Appearance.setValue( ('arg_2', self.obj53))
    ...
    # name
    self.obj53.name.setValue('arg_2')
    ...
    # Connections for obj28 (graphObject_: Obj0) named MetaModelElement_S
...
(self.obj28,self.obj48,[711.0, 243.1081967213115, 1346.0, 240.975409836],"true", 2) )
    # Connections for obj29 (graphObject_: Obj1) named EClass
    self.drawConnections(
(self.obj29,self.obj56,[436.0, 341.0, 468.4, 303.6],"true", 2),
(self.obj29,self.obj60,[471.0, 461.0, 513.5, 501.1311475409836],"true", 0) )
    # Connections for obj30 (graphObject_: Obj2) named EReference
    self.drawConnections(
(self.obj30,self.obj54,[656.0, 341.0, 641.4, 303.6],"true", 2),
(self.obj30,self.obj61,[616.0, 481.0, 626.0, 511.1311475409836],"true", 0) )
    # Connections for obj31 (graphObject_: Obj3) named EStructuralFeature
    self.drawConnections(
(self.obj31,self.obj55,[776.0, 341.0, 754.6, 277.8],"true", 2),
(self.obj31,self.obj62,[741.0, 461.0, 708.5, 501.1311475409836],"true", 0) )
    # Connections for obj32 (graphObject_: Obj4) named MatchModel
    self.drawConnections(
(self.obj32,self.obj40,[211.0, 189.0, 361.8, 199.8],"true", 2),
(self.obj32,self.obj46,[136.0, 261.0, 136.0, 401.0],"true", 2) )
    # Connections for obj33 (graphObject_: Obj5) named ApplyModel
    self.drawConnections(
(self.obj33,self.obj41,[211.0, 581.0, 362.491532278, 586.86445],"true", 2) )
    # Connections for obj34 (graphObject_: Obj6) named MetaModelElement_T
    self.drawConnections(
...
(self.obj34,self.obj49,[711.0, 696.1803278688525, 1292.49804688, 838.905737705],"true", 2) )
    # Connections for obj35 (graphObject_: Obj7) named Attribute
    self.drawConnections(
(self.obj35,self.obj57,[1636.0, 501.0, 1656.0, 461.0],"true", 2) )
    # Connections for obj36 (graphObject_: Obj8) named Equation
    self.drawConnections(
(self.obj36,self.obj50,[1676.0, 141.0, 1618.0, 211.0],"true", 2),
(self.obj36,self.obj51,[1831.0, 121.0, 1866.15625, 208.0],"true", 2) )
    # Connections for obj37 (graphObject_: Obj9) named Expression
    self.drawConnections(
 )
    # Connections for obj38 (graphObject_: Obj10) named Constant
    self.drawConnections(
(self.obj38,self.obj58,[2041.0, 401.0, 1926.0, 405.0],"true", 2) )
    # Connections for obj39 (graphObject_: Obj11) named Concat
    self.drawConnections(
