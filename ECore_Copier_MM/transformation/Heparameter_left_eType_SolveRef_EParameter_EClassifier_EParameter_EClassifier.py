...
class Heparameter_left_eType_SolveRef_EParameter_EClassifier_EParameter_EClassifier(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule eparameter_left_eType_SolveRef_EParameter_EClassifier_EParameter_EClassifier.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(Heparameter_left_eType_SolveRef_EParameter_EClassifier_EParameter_EClassifier, self).__init__(name='Heparameter_left_eType_SolveRef_EParameter_EClassifier_EParameter_EClassifier', num_nodes=0, edges=[])
...
a.""")
        ...
        self["name"] = """eparameter_left_eType_SolveRef_EParameter_EClassifier_EParameter_EClassifier"""
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eparameter_left_eType_SolveRef_EParameter_EClassifier_EParameter_EClassifier')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eparameter_left_eType_SolveRef_EParameter_EClassifier_EParameter_EClassifiermatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eparameter_left_eType_SolveRef_EParameter_EClassifier_EParameter_EClassifierapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eparameter_left_eType_SolveRef_EParameter_EClassifier_EParameter_EClassifierpairedwith2')
