...
a.""")
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EClass() -> has_match_attribute abstract ()
    		(11,12), #  has_match_attribute abstract () -> match_attribute abstract ()
    		(3,13), # match_class EClass() -> has_match_attribute interface ()
    		(13,14), #  has_match_attribute interface () -> match_attribute interface ()
    		(5,15), # apply_class EClass() -> has_apply_attribute name ()
    		...
    		(5,20), # apply_class EClass() -> has_apply_attribute instanceClassName ()
    		...
    		(5,25), # apply_class EClass() -> has_apply_attribute abstract ()
    		(25,26), #  has_apply_attribute abstract () -> apply_attribute abstract ()
    		(27,28), #  equation of apply attribute abstract () -> left_expr
    		(28,26), #  left_expr -> apply_attribute abstract ()
    		(27,29), #  equation of apply attribute abstract () -> right_expr
    		(29,12), # right_expr --> term
    		(5,30), # apply_class EClass() -> has_apply_attribute interface ()
    		(30,31), #  has_apply_attribute interface () -> apply_attribute interface ()
    		(32,33), #  equation of apply attribute interface () -> left_expr
    		(33,31), #  left_expr -> apply_attribute interface ()
    		(32,34), #  equation of apply attribute interface () -> right_expr
    		(34,14), # right_expr --> term
    		(5,35), # apply_class EClass() -> has_apply_attribute ApplyAttribute ()
