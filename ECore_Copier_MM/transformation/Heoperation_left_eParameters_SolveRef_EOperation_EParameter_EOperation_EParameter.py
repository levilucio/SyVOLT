...
class Heoperation_left_eParameters_SolveRef_EOperation_EParameter_EOperation_EParameter(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule eoperation_left_eParameters_SolveRef_EOperation_EParameter_EOperation_EParameter.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(Heoperation_left_eParameters_SolveRef_EOperation_EParameter_EOperation_EParameter, self).__init__(name='Heoperation_left_eParameters_SolveRef_EOperation_EParameter_EOperation_EParameter', num_nodes=0, edges=[])
...
a.""")
        ...
        self["name"] = """eoperation_left_eParameters_SolveRef_EOperation_EParameter_EOperation_EParameter"""
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperation_left_eParameters_SolveRef_EOperation_EParameter_EOperation_EParameter')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperation_left_eParameters_SolveRef_EOperation_EParameter_EOperation_EParametermatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperation_left_eParameters_SolveRef_EOperation_EParameter_EOperation_EParameterapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'eoperation_left_eParameters_SolveRef_EOperation_EParameter_EOperation_EParameterpairedwith2')
