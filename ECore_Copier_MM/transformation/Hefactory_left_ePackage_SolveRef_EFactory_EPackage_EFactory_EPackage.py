...
class Hefactory_left_ePackage_SolveRef_EFactory_EPackage_EFactory_EPackage(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule efactory_left_ePackage_SolveRef_EFactory_EPackage_EFactory_EPackage.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(Hefactory_left_ePackage_SolveRef_EFactory_EPackage_EFactory_EPackage, self).__init__(name='Hefactory_left_ePackage_SolveRef_EFactory_EPackage_EFactory_EPackage', num_nodes=0, edges=[])
...
a.""")
        ...
        self["name"] = """efactory_left_ePackage_SolveRef_EFactory_EPackage_EFactory_EPackage"""
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'efactory_left_ePackage_SolveRef_EFactory_EPackage_EFactory_EPackage')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'efactory_left_ePackage_SolveRef_EFactory_EPackage_EFactory_EPackagematchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'efactory_left_ePackage_SolveRef_EFactory_EPackage_EFactory_EPackageapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'efactory_left_ePackage_SolveRef_EFactory_EPackage_EFactory_EPackagepairedwith2')
    	...
    	# match association EFactory--ePackage-->EPackage node
    	self.add_node()
    	self.vs[11]["associationType"] = """ePackage"""
        self.vs[11]["mm__"] = """directLink_S"""
        #self.vs[11]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'assoc11')
        
    	# apply association EFactory--ePackage-->EPackage node
    	self.add_node()
    	self.vs[12]["associationType"] = """ePackage"""
        ...
        self.add_edges([
    		...
    		(3,11), # match_class EFactory() -> association ePackage
    		(11,5), # association ePackage  -> match_class EPackage()
    		(7,12), # apply_class EFactory() -> association ePackage
    		(12,9), # association ePackage  -> apply_class EPackage()
