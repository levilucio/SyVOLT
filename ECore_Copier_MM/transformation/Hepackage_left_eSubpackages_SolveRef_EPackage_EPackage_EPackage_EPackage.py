...
class Hepackage_left_eSubpackages_SolveRef_EPackage_EPackage_EPackage_EPackage(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule epackage_left_eSubpackages_SolveRef_EPackage_EPackage_EPackage_EPackage.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(Hepackage_left_eSubpackages_SolveRef_EPackage_EPackage_EPackage_EPackage, self).__init__(name='Hepackage_left_eSubpackages_SolveRef_EPackage_EPackage_EPackage_EPackage', num_nodes=0, edges=[])
...
a.""")
        ...
        self["name"] = """epackage_left_eSubpackages_SolveRef_EPackage_EPackage_EPackage_EPackage"""
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'epackage_left_eSubpackages_SolveRef_EPackage_EPackage_EPackage_EPackage')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'epackage_left_eSubpackages_SolveRef_EPackage_EPackage_EPackage_EPackagematchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'epackage_left_eSubpackages_SolveRef_EPackage_EPackage_EPackage_EPackageapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'epackage_left_eSubpackages_SolveRef_EPackage_EPackage_EPackage_EPackagepairedwith2')
