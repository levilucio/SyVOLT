...
class Hereference_left_eOpposite_SolveRef_EReference_EReference_EReference_EReference(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule ereference_left_eOpposite_SolveRef_EReference_EReference_EReference_EReference.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(Hereference_left_eOpposite_SolveRef_EReference_EReference_EReference_EReference, self).__init__(name='Hereference_left_eOpposite_SolveRef_EReference_EReference_EReference_EReference', num_nodes=0, edges=[])
...
a.""")
        ...
        self["name"] = """ereference_left_eOpposite_SolveRef_EReference_EReference_EReference_EReference"""
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereference_left_eOpposite_SolveRef_EReference_EReference_EReference_EReference')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereference_left_eOpposite_SolveRef_EReference_EReference_EReference_EReferencematchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereference_left_eOpposite_SolveRef_EReference_EReference_EReference_EReferenceapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereference_left_eOpposite_SolveRef_EReference_EReference_EReference_EReferencepairedwith2')
