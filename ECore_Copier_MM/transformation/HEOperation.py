...
a.""")
        ...
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'EOperationmatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'EOperationapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'EOperationpairedwith2')
        ...
        self.add_edges([
    		...
    		(3,7), # match_class EOperation() -> has_match_attribute name ()
    		(7,8), #  has_match_attribute name () -> match_attribute name ()
    		(3,9), # match_class EOperation() -> has_match_attribute ordered ()
    		(9,10), #  has_match_attribute ordered () -> match_attribute ordered ()
    		(3,11), # match_class EOperation() -> has_match_attribute unique ()
    		(11,12), #  has_match_attribute unique () -> match_attribute unique ()
    		(3,13), # match_class EOperation() -> has_match_attribute lowerBound ()
    		(13,14), #  has_match_attribute lowerBound () -> match_attribute lowerBound ()
    		(3,15), # match_class EOperation() -> has_match_attribute upperBound ()
    		(15,16), #  has_match_attribute upperBound () -> match_attribute upperBound ()
    		(5,17), # apply_class EOperation() -> has_apply_attribute name ()
    		...
    		(5,22), # apply_class EOperation() -> has_apply_attribute ordered ()
    		...
    		(5,27), # apply_class EOperation() -> has_apply_attribute unique ()
    		...
    		(5,32), # apply_class EOperation() -> has_apply_attribute lowerBound ()
    		...
    		(5,37), # apply_class EOperation() -> has_apply_attribute upperBound ()
    		...
    		(5,42), # apply_class EOperation() -> has_apply_attribute ApplyAttribute ()
