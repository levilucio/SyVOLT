...
class Hereference_left_eType_SolveRef_EReference_EClassifier_EReference_EClassifier(Himesis):
    def __init__(self):
        """
        Creates the himesis graph representing the DSLTrans rule ereference_left_eType_SolveRef_EReference_EClassifier_EReference_EClassifier.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(Hereference_left_eType_SolveRef_EReference_EClassifier_EReference_EClassifier, self).__init__(name='Hereference_left_eType_SolveRef_EReference_EClassifier_EReference_EClassifier', num_nodes=0, edges=[])
...
a.""")
        ...
        self["name"] = """ereference_left_eType_SolveRef_EReference_EClassifier_EReference_EClassifier"""
        self["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereference_left_eType_SolveRef_EReference_EClassifier_EReference_EClassifier')
        
        # match model. We only support one match model
        self.add_node()
        self.vs[0]["mm__"] = """MatchModel"""
        #self.vs[0]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereference_left_eType_SolveRef_EReference_EClassifier_EReference_EClassifiermatchmodel0')
        
        # apply model node
        self.add_node()
        self.vs[1]["mm__"] = """ApplyModel"""
        #self.vs[1]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereference_left_eType_SolveRef_EReference_EClassifier_EReference_EClassifierapplymodel1')
        
        # paired with relation between match and apply models
        self.add_node()
        self.vs[2]["mm__"] = """paired_with"""
        #self.vs[2]["GUID__"] = uuid.uuid3(uuid.NAMESPACE_DNS,'ereference_left_eType_SolveRef_EReference_EClassifier_EReference_EClassifierpairedwith2')
