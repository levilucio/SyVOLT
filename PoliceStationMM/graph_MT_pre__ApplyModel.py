...
class graph_MT_pre__ApplyModel(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([-6.0, -1.0, -6.0, -227.0])[:2], tags = self.tag, font=font, fill = 'white', anchor = 'center', text = 'MT_pre__ApplyModel', width = '0', justify= 'left', stipple='' )
