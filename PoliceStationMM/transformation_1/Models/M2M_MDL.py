...
Author: levi
Modified: Fri Dec 12 17:05:29 2014
...
def M2M_MDL(self, rootNode, PoliceStationMMRootNode=None):
    ...
    if self.genGraphics:
       new_obj = graph_Male_T(400.0,300.0,self.obj38)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_apply_contains(333.5,361.0,self.obj43)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_hasAttr_S(597.0,180.0,self.obj45)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj46=hasAttr_T(self)
    self.obj46.isGraphObjectVisual = True

    if(hasattr(self.obj46, '_setHierarchicalLink')):
      self.obj46._setHierarchicalLink(False)

    self.obj46.graphClass_= graph_hasAttr_T
    if self.genGraphics:
       new_obj = graph_hasAttr_T(597.0,340.5,self.obj46)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj35,self.obj45,[461.0, 181.0, 597.0, 180.0],"true", 2) )
...
(self.obj36,self.obj42,[201.0, 121.0, 331.0, 151.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj37,self.obj43,[206.0, 381.0, 333.5, 361.0],"true", 2) )
    # Connections for obj38 (graphObject_: Obj3) named s_
    self.drawConnections(
(self.obj38,self.obj46,[461.0, 341.0, 597.0, 340.5],"true", 2) )
...
(self.obj42,self.obj35,[331.0, 151.0, 461.0, 181.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj43,self.obj38,[333.5, 361.0, 461.0, 341.0],"true", 2) )
...
(self.obj44,self.obj37,[203.5, 251.0, 206.0, 381.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj45,self.obj39,[597.0, 180.0, 733.0, 179.0],"true", 2) )
    # Connections for obj46 (graphObject_: Obj11) of type hasAttr_T
    self.drawConnections(
(self.obj46,self.obj40,[597.0, 340.5, 733.0, 340.0],"true", 2) )
