...
Author: levi
Modified: Mon Dec 15 11:29:19 2014
...
def MM2MM_MDL(self, rootNode, PoliceStationMMRootNode=None):
    ...
    if self.genGraphics:
       new_obj = graph_Male_S(460.0,220.0,self.obj35)
    ...
    if self.genGraphics:
       new_obj = graph_Male_S(720.0,220.0,self.obj36)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("Male_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_Male_T(460.0,400.0,self.obj39)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_Male_T(720.0,400.0,self.obj40)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("Male_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    if self.genGraphics:
       new_obj = graph_match_contains(401.0,221.0,self.obj41)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_match_contains(531.0,221.0,self.obj42)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("match_contains", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_apply_contains(403.5,471.0,self.obj43)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_apply_contains(533.5,471.0,self.obj44)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("apply_contains", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_backward_link(521.0,351.0,self.obj45)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj46=backward_link(self)
    self.obj46.isGraphObjectVisual = True

    if(hasattr(self.obj46, '_setHierarchicalLink')):
      self.obj46._setHierarchicalLink(False)

    self.obj46.graphClass_= graph_backward_link
    if self.genGraphics:
       new_obj = graph_backward_link(781.0,351.0,self.obj46)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("backward_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_indirectLink_S(651.0,261.0,self.obj47)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_directLink_T(651.0,441.0,self.obj48)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj35,self.obj47,[521.0, 261.0, 651.0, 261.0],"true", 2) )
    # Connections for obj36 (graphObject_: Obj1) named s_
    self.drawConnections(
 )
    # Connections for obj37 (graphObject_: Obj2) of type MatchModel
    self.drawConnections(
(self.obj37,self.obj41,[281.0, 181.0, 401.0, 221.0],"true", 2),
(self.obj37,self.obj42,[281.0, 181.0, 531.0, 221.0],"true", 2),
(self.obj37,self.obj49,[281.0, 181.0, 283.5, 341.0],"true", 2) )
    # Connections for obj38 (graphObject_: Obj3) of type ApplyModel
    self.drawConnections(
(self.obj38,self.obj43,[286.0, 501.0, 403.5, 471.0],"true", 2),
(self.obj38,self.obj44,[286.0, 501.0, 533.5, 471.0],"true", 2) )
    # Connections for obj39 (graphObject_: Obj4) named s_
    self.drawConnections(
(self.obj39,self.obj48,[521.0, 441.0, 651.0, 441.0],"true", 2),
(self.obj39,self.obj45,[521.0, 441.0, 521.0, 351.0],"true", 2) )
    # Connections for obj40 (graphObject_: Obj5) named s_
    self.drawConnections(
(self.obj40,self.obj46,[781.0, 441.0, 781.0, 351.0],"true", 2) )
    # Connections for obj41 (graphObject_: Obj6) of type match_contains
    self.drawConnections(
(self.obj41,self.obj35,[401.0, 221.0, 521.0, 261.0],"true", 2) )
    # Connections for obj42 (graphObject_: Obj7) of type match_contains
    self.drawConnections(
(self.obj42,self.obj36,[531.0, 221.0, 781.0, 261.0],"true", 2) )
    # Connections for obj43 (graphObject_: Obj8) of type apply_contains
    self.drawConnections(
(self.obj43,self.obj39,[403.5, 471.0, 521.0, 441.0],"true", 2) )
    # Connections for obj44 (graphObject_: Obj9) of type apply_contains
    self.drawConnections(
(self.obj44,self.obj40,[533.5, 471.0, 781.0, 441.0],"true", 2) )
    # Connections for obj45 (graphObject_: Obj10) of type backward_link
    self.drawConnections(
(self.obj45,self.obj35,[521.0, 351.0, 521.0, 261.0],"true", 2) )
    # Connections for obj46 (graphObject_: Obj11) of type backward_link
    self.drawConnections(
(self.obj46,self.obj36,[781.0, 351.0, 781.0, 261.0],"true", 2) )
    # Connections for obj47 (graphObject_: Obj12) of type indirectLink_S
    self.drawConnections(
(self.obj47,self.obj36,[651.0, 261.0, 781.0, 261.0],"true", 2) )
    # Connections for obj48 (graphObject_: Obj13) of type directLink_T
    self.drawConnections(
(self.obj48,self.obj40,[651.0, 441.0, 781.0, 441.0],"true", 2) )
