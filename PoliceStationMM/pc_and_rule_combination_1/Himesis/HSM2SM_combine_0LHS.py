...
class HSM2SM_combine_0LHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        ...
        super(HSM2SM_combine_0LHS, self).__init__(name='HSM2SM_combine_0LHS', num_nodes=6, edges=[])
...
.""")
        self["name"] = """"""
        self["GUID__"] = UUID('8adca98c-96e9-4aca-a4d0-acc00c948252')
...
return True
"""
        self.vs[0]["GUID__"] = UUID('a618de6d-d25c-431f-af9a-5e563d9cc988')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('b92c543a-ea9a-4159-9ccd-f545e85e2f1d')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('0c679869-400f-44a8-894e-994250c599b9')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('bc04142c-8667-487d-afea-6d09c0c86684')
...
.""")
        ...
        self.vs[4]["GUID__"] = UUID('bffe7442-2cea-416b-813e-35ebe2085130')
...
.""")
        ...
        self.vs[5]["GUID__"] = UUID('e90011fe-45ae-49c0-b1c0-2d72b0df721f')
