...
Author: levi
Modified: Mon Dec 15 10:38:40 2014
...
def SM2SM_combine_0_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MT_post__PoliceStationMMRootNode=None, MoTifRuleRootNode=None):
    ...
    # MT_label__
    self.obj65.MT_label__.setValue('30')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(311.0,261.0,self.obj65)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_RHS(1004.0,160.0,self.obj89)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_LHS(560.0,160.0,self.obj90)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj72=MT_post__indirectLink_S(self)
    ...
    # MT_label__
    self.obj72.MT_label__.setValue('10')

    # MT_pivotOut__
    self.obj72.MT_pivotOut__.setValue('')
    self.obj72.MT_pivotOut__.setNone()

    self.obj72.graphClass_= graph_MT_post__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_post__indirectLink_S(1211.0,241.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj74.MT_label__.setValue('21')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__hasAttr_S(1357.0,235.5,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__hasAttr_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    # MT_label__
    self.obj77.MT_label__.setValue('11')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__directLink_T(1251.0,361.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj80=MT_post__trace_link(self)
    ...
    self.obj80.graphClass_= graph_MT_post__trace_link
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1301.0,301.0,self.obj80)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj84=MT_post__Male_T(self)
    ...
    # MT_label__
    self.obj84.MT_label__.setValue('4')
    ...
    self.obj84.graphClass_= graph_MT_post__Male_T
    if self.genGraphics:
       new_obj = graph_MT_post__Male_T(1260.0,320.0,self.obj84)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj85=MT_post__Male_S(self)
    ...
    self.obj85.graphClass_= graph_MT_post__Male_S
    if self.genGraphics:
       new_obj = graph_MT_post__Male_S(1220.0,200.0,self.obj85)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.drawConnections(
(self.obj60,self.obj65,[221.0, 261.0, 311.0, 261.0],"true", 2) )
...
(self.obj63,self.obj66,[661.0, 441.0, 661.0, 351.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj64,self.obj67,[841.0, 441.0, 841.0, 351.0],"true", 2) )
    # Connections for obj65 (graphObject_: Obj6) of type MT_pre__indirectLink_S
    self.drawConnections(
(self.obj65,self.obj62,[311.0, 261.0, 401.0, 261.0],"true", 2) )
...
(self.obj66,self.obj59,[661.0, 351.0, 661.0, 261.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj67,self.obj61,[841.0, 351.0, 841.0, 261.0],"true", 2) )
    # Connections for obj88 (graphObject_: Obj29) of type NAC
    self.drawConnections(
 )
...
(self.obj71,self.obj82,[1432.0, 362.0, 1433.5, 430.5],"true", 2) )
    # Connections for obj72 (graphObject_: Obj13) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj72,self.obj85,[1211.0, 241.0, 1281.0, 241.0],"true", 2) )
...
(self.obj73,self.obj68,[1127.0, 365.5, 1113.0, 490.0],"true", 2) )
    # Connections for obj74 (graphObject_: Obj15) of type MT_post__hasAttr_S
    self.drawConnections(
(self.obj74,self.obj69,[1357.0, 235.5, 1433.0, 230.0],"true", 2) )
    ...
    # Connections for obj77 (graphObject_: Obj18) of type MT_post__directLink_T
    self.drawConnections(
(self.obj77,self.obj84,[1251.0, 361.0, 1321.0, 361.0],"true", 2) )
    # Connections for obj78 (graphObject_: Obj19) of type MT_post__Station_T
    self.drawConnections(
(self.obj78,self.obj77,[1181.0, 361.0, 1251.0, 361.0],"true", 2),
...
(self.obj79,self.obj83,[1161.0, 301.0, 1141.0, 241.0],"true", 2) )
    # Connections for obj80 (graphObject_: Obj21) of type MT_post__trace_link
    self.drawConnections(
(self.obj80,self.obj85,[1301.0, 301.0, 1281.0, 241.0],"true", 2) )
...
(self.obj82,self.obj76,[1433.5, 430.5, 1435.0, 499.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj83,self.obj72,[1141.0, 241.0, 1211.0, 241.0],"true", 2),
(self.obj83,self.obj73,[1141.0, 241.0, 1127.0, 365.5],"true", 2) )
    # Connections for obj84 (graphObject_: Obj25) of type MT_post__Male_T
    self.drawConnections(
(self.obj84,self.obj80,[1321.0, 361.0, 1301.0, 301.0],"true", 2) )
    # Connections for obj85 (graphObject_: Obj26) of type MT_post__Male_S
    self.drawConnections(
(self.obj85,self.obj74,[1281.0, 241.0, 1357.0, 235.5],"true", 2) )
