"""
__SM2SM_combine_1_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Mon Dec 15 10:40:08 2014
...
def SM2SM_combine_1_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MT_post__PoliceStationMMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('SM2SM_combine_1')
    # --- ASG attributes over ---
    ...
    # MT_label__
    self.obj63.MT_label__.setValue('8')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(751.0,261.0,self.obj63)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj64.MT_label__.setValue('6')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(661.0,351.0,self.obj64)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(841.0,351.0,self.obj65)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    # action
    self.obj86.action.setValue('#===============================================================================\n# This code is executed after the rule has been applied.\n# You can access a node labelled n matched by this rule by: PostNode(\'n\').\n# To access attribute x of node n, use: PostNode(\'n\')[\'x\'].\n#===============================================================================\n\npass\n')
    self.obj86.action.setHeight(15)

    self.obj86.graphClass_= graph_RHS
    if self.genGraphics:
       new_obj = graph_RHS(1004.0,160.0,self.obj86)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_LHS(560.0,160.0,self.obj87)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj66=MT_post__Attribute(self)
    ...
    # MT_label__
    self.obj66.MT_label__.setValue('12')
    ...
    # MT_post__name
    self.obj66.MT_post__name.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn "name"\n')
    self.obj66.MT_post__name.setHeight(15)

    self.obj66.graphClass_= graph_MT_post__Attribute
    if self.genGraphics:
       new_obj = graph_MT_post__Attribute(1060.0,460.0,self.obj66)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj67.MT_label__.setValue('16')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__Attribute(1380.0,200.0,self.obj67)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Attribute", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj68=MT_post__Equation(self)
    ...
    # MT_label__
    self.obj68.MT_label__.setValue('13')

    # MT_pivotOut__
    self.obj68.MT_pivotOut__.setValue('')
    self.obj68.MT_pivotOut__.setNone()

    self.obj68.graphClass_= graph_MT_post__Equation
    if self.genGraphics:
       new_obj = graph_MT_post__Equation(1140.0,460.0,self.obj68)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj69=MT_post__Equation(self)
    ...
    # MT_label__
    self.obj69.MT_label__.setValue('17')

    # MT_pivotOut__
    self.obj69.MT_pivotOut__.setValue('')
    self.obj69.MT_pivotOut__.setNone()

    self.obj69.graphClass_= graph_MT_post__Equation
    if self.genGraphics:
       new_obj = graph_MT_post__Equation(1360.0,320.0,self.obj69)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Equation", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj70=MT_post__indirectLink_S(self)
    ...
    self.obj70.graphClass_= graph_MT_post__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_post__indirectLink_S(1211.0,241.0,self.obj70)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj71=MT_post__hasAttr_S(self)
    ...
    # MT_label__
    self.obj71.MT_label__.setValue('15')

    # MT_pivotOut__
    self.obj71.MT_pivotOut__.setValue('')
    self.obj71.MT_pivotOut__.setNone()

    self.obj71.graphClass_= graph_MT_post__hasAttr_S
    if self.genGraphics:
       new_obj = graph_MT_post__hasAttr_S(1127.0,365.5,self.obj71)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj72.MT_label__.setValue('21')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__hasAttr_S(1357.0,235.5,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__hasAttr_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj73=MT_post__Constant(self)
    ...
    # MT_label__
    self.obj73.MT_label__.setValue('14')
    ...
    # MT_post__value
    self.obj73.MT_post__value.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn "somestation"\n')
    self.obj73.MT_post__value.setHeight(15)

    self.obj73.graphClass_= graph_MT_post__Constant
    if self.genGraphics:
       new_obj = graph_MT_post__Constant(1260.0,420.0,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj74=MT_post__Constant(self)
    ...
    # MT_label__
    self.obj74.MT_label__.setValue('18')
    ...
    # MT_post__value
    self.obj74.MT_post__value.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn "somemale"\n')
    self.obj74.MT_post__value.setHeight(15)

    self.obj74.graphClass_= graph_MT_post__Constant
    if self.genGraphics:
       new_obj = graph_MT_post__Constant(1380.0,460.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Constant", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj75=MT_post__directLink_T(self)
    ...
    # MT_label__
    self.obj75.MT_label__.setValue('11')
    ...
    self.obj75.MT_post__associationType.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn attr_value\n')
    self.obj75.MT_post__associationType.setHeight(15)

    self.obj75.graphClass_= graph_MT_post__directLink_T
    if self.genGraphics:
       new_obj = graph_MT_post__directLink_T(1251.0,361.0,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj76=MT_post__Station_T(self)
    ...
    self.obj76.graphClass_= graph_MT_post__Station_T
    if self.genGraphics:
       new_obj = graph_MT_post__Station_T(1120.0,320.0,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj77.MT_label__.setValue('6')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1161.0,301.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1301.0,301.0,self.obj78)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj79=MT_post__rightExpr(self)
    ...
    # MT_label__
    self.obj79.MT_label__.setValue('20')

    # MT_pivotOut__
    self.obj79.MT_pivotOut__.setValue('')
    self.obj79.MT_pivotOut__.setNone()

    self.obj79.graphClass_= graph_MT_post__rightExpr
    if self.genGraphics:
       new_obj = graph_MT_post__rightExpr(1263.5,480.5,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj80=MT_post__rightExpr(self)
    ...
    self.obj80.graphClass_= graph_MT_post__rightExpr
    if self.genGraphics:
       new_obj = graph_MT_post__rightExpr(1433.5,430.5,self.obj80)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__rightExpr", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj81=MT_post__Station_S(self)
    ...
    self.obj81.MT_post__cardinality.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn attr_value\n')
    self.obj81.MT_post__cardinality.setHeight(15)
    ...
    self.obj81.graphClass_= graph_MT_post__Station_S
    if self.genGraphics:
       new_obj = graph_MT_post__Station_S(1080.0,200.0,self.obj81)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj82=MT_post__Male_T(self)
    ...
    # MT_label__
    self.obj82.MT_label__.setValue('4')
    ...
    self.obj82.graphClass_= graph_MT_post__Male_T
    if self.genGraphics:
       new_obj = graph_MT_post__Male_T(1260.0,320.0,self.obj82)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj83=MT_post__Male_S(self)
    ...
    self.obj83.graphClass_= graph_MT_post__Male_S
    if self.genGraphics:
       new_obj = graph_MT_post__Male_S(1220.0,200.0,self.obj83)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj84=MT_post__leftExpr(self)
    ...
    # MT_label__
    self.obj84.MT_label__.setValue('19')

    # MT_pivotOut__
    self.obj84.MT_pivotOut__.setValue('')
    self.obj84.MT_pivotOut__.setNone()

    self.obj84.graphClass_= graph_MT_post__leftExpr
    if self.genGraphics:
       new_obj = graph_MT_post__leftExpr(1162.5,496.0,self.obj84)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj85=MT_post__leftExpr(self)
    ...
    # MT_label__
    self.obj85.MT_label__.setValue('22')

    # MT_pivotOut__
    self.obj85.MT_pivotOut__.setValue('')
    self.obj85.MT_pivotOut__.setNone()

    self.obj85.graphClass_= graph_MT_post__leftExpr
    if self.genGraphics:
       new_obj = graph_MT_post__leftExpr(1432.5,296.0,self.obj85)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__leftExpr", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
...
(self.obj59,self.obj63,[661.0, 261.0, 751.0, 261.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj61,self.obj64,[661.0, 441.0, 661.0, 351.0],"true", 2) )
    # Connections for obj62 (graphObject_: Obj3) of type MT_pre__Male_T
    self.drawConnections(
(self.obj62,self.obj65,[841.0, 441.0, 841.0, 351.0],"true", 2) )
    # Connections for obj63 (graphObject_: Obj4) of type MT_pre__indirectLink_S
    self.drawConnections(
(self.obj63,self.obj60,[751.0, 261.0, 841.0, 261.0],"true", 2) )
    # Connections for obj64 (graphObject_: Obj5) of type MT_pre__trace_link
    self.drawConnections(
(self.obj64,self.obj59,[661.0, 351.0, 661.0, 261.0],"true", 2) )
    # Connections for obj65 (graphObject_: Obj6) of type MT_pre__trace_link
    self.drawConnections(
(self.obj65,self.obj60,[841.0, 351.0, 841.0, 261.0],"true", 2) )
    # Connections for obj86 (graphObject_: Obj27) of type RHS
    self.drawConnections(
 )
    # Connections for obj87 (graphObject_: Obj28) of type LHS
    self.drawConnections(
 )
    # Connections for obj66 (graphObject_: Obj7) of type MT_post__Attribute
    self.drawConnections(
 )
    # Connections for obj67 (graphObject_: Obj8) of type MT_post__Attribute
    self.drawConnections(
 )
    # Connections for obj68 (graphObject_: Obj9) of type MT_post__Equation
    self.drawConnections(
(self.obj68,self.obj84,[1212.0, 502.0, 1162.5, 496.0],"true", 2),
(self.obj68,self.obj79,[1212.0, 502.0, 1263.5, 480.5],"true", 2) )
    # Connections for obj69 (graphObject_: Obj10) of type MT_post__Equation
    self.drawConnections(
(self.obj69,self.obj85,[1432.0, 362.0, 1432.5, 296.0],"true", 2),
(self.obj69,self.obj80,[1432.0, 362.0, 1433.5, 430.5],"true", 2) )
    # Connections for obj70 (graphObject_: Obj11) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj70,self.obj83,[1211.0, 241.0, 1281.0, 241.0],"true", 2) )
    # Connections for obj71 (graphObject_: Obj12) of type MT_post__hasAttr_S
    self.drawConnections(
(self.obj71,self.obj66,[1127.0, 365.5, 1113.0, 490.0],"true", 2) )
    # Connections for obj72 (graphObject_: Obj13) of type MT_post__hasAttr_S
    self.drawConnections(
(self.obj72,self.obj67,[1357.0, 235.5, 1433.0, 230.0],"true", 2) )
    # Connections for obj73 (graphObject_: Obj14) of type MT_post__Constant
    self.drawConnections(
 )
    # Connections for obj74 (graphObject_: Obj15) of type MT_post__Constant
    self.drawConnections(
 )
    # Connections for obj75 (graphObject_: Obj16) of type MT_post__directLink_T
    self.drawConnections(
(self.obj75,self.obj82,[1251.0, 361.0, 1321.0, 361.0],"true", 2) )
    # Connections for obj76 (graphObject_: Obj17) of type MT_post__Station_T
    self.drawConnections(
(self.obj76,self.obj75,[1181.0, 361.0, 1251.0, 361.0],"true", 2),
(self.obj76,self.obj77,[1181.0, 361.0, 1161.0, 301.0],"true", 2) )
    # Connections for obj77 (graphObject_: Obj18) of type MT_post__trace_link
    self.drawConnections(
(self.obj77,self.obj81,[1161.0, 301.0, 1141.0, 241.0],"true", 2) )
    # Connections for obj78 (graphObject_: Obj19) of type MT_post__trace_link
    self.drawConnections(
(self.obj78,self.obj83,[1301.0, 301.0, 1281.0, 241.0],"true", 2) )
    # Connections for obj79 (graphObject_: Obj20) of type MT_post__rightExpr
    self.drawConnections(
(self.obj79,self.obj73,[1263.5, 480.5, 1315.0, 459.0],"true", 2) )
    # Connections for obj80 (graphObject_: Obj21) of type MT_post__rightExpr
    self.drawConnections(
(self.obj80,self.obj74,[1433.5, 430.5, 1435.0, 499.0],"true", 2) )
    # Connections for obj81 (graphObject_: Obj22) of type MT_post__Station_S
    self.drawConnections(
(self.obj81,self.obj70,[1141.0, 241.0, 1211.0, 241.0],"true", 2),
(self.obj81,self.obj71,[1141.0, 241.0, 1127.0, 365.5],"true", 2) )
    # Connections for obj82 (graphObject_: Obj23) of type MT_post__Male_T
    self.drawConnections(
(self.obj82,self.obj78,[1321.0, 361.0, 1301.0, 301.0],"true", 2) )
    # Connections for obj83 (graphObject_: Obj24) of type MT_post__Male_S
    self.drawConnections(
(self.obj83,self.obj72,[1281.0, 241.0, 1357.0, 235.5],"true", 2) )
    # Connections for obj84 (graphObject_: Obj25) of type MT_post__leftExpr
    self.drawConnections(
(self.obj84,self.obj66,[1162.5, 496.0, 1113.0, 490.0],"true", 2) )
    # Connections for obj85 (graphObject_: Obj26) of type MT_post__leftExpr
    self.drawConnections(
(self.obj85,self.obj67,[1432.5, 296.0, 1433.0, 230.0],"true", 2) )

newfunction = SM2SM_combine_1_MDL
