...
Author: levi
Modified: Mon Dec 15 10:27:48 2014
...
def SF2SF_combine_0_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MT_post__PoliceStationMMRootNode=None, MoTifRuleRootNode=None):
    ...
    self.obj114=MT_pre__Female_S(self)
    ...
    # MT_subtypeMatching__
    self.obj114.MT_subtypeMatching__.setValue(('True', 0))
    self.obj114.MT_subtypeMatching__.config = 0

    # MT_pre__classtype
    self.obj114.MT_pre__classtype.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj114.MT_pre__classtype.setHeight(15)

    # MT_pivotIn__
    self.obj114.MT_pivotIn__.setValue('')
    self.obj114.MT_pivotIn__.setNone()

    # MT_label__
    self.obj114.MT_label__.setValue('2')

    # MT_pre__cardinality
    self.obj114.MT_pre__cardinality.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj114.MT_pre__cardinality.setHeight(15)

    # MT_pre__name
    self.obj114.MT_pre__name.setValue('\n#===============================================================================\n# This code is executed when evaluating if a node shall be matched by this rule.\n# You can access the value of the current node\'s attribute value by: attr_value.\n# You can access any attribute x of this node by: this[\'x\'].\n# If the constraint relies on attribute values from other nodes,\n# use the LHS/NAC constraint instead.\n# The given constraint must evaluate to a boolean expression.\n#===============================================================================\n\nreturn True\n')
    self.obj114.MT_pre__name.setHeight(15)

    self.obj114.graphClass_= graph_MT_pre__Female_S
    if self.genGraphics:
       new_obj = graph_MT_pre__Female_S(360.0,220.0,self.obj114)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Female_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj117=MT_pre__indirectLink_S(self)
    ...
    # MT_label__
    self.obj117.MT_label__.setValue('7')

    # MT_pivotOut__
    self.obj117.MT_pivotOut__.setValue('')
    self.obj117.MT_pivotOut__.setNone()

    # MT_subtypeMatching__
    self.obj117.MT_subtypeMatching__.setValue(('True', 0))
    self.obj117.MT_subtypeMatching__.config = 0

    # MT_pivotIn__
    self.obj117.MT_pivotIn__.setValue('')
    self.obj117.MT_pivotIn__.setNone()

    self.obj117.graphClass_= graph_MT_pre__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(321.0,261.0,self.obj117)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.drawConnections(
(self.obj60,self.obj117,[221.0, 261.0, 321.0, 261.0],"true", 2) )
    # Connections for obj92 (graphObject_: Obj33) of type MT_pre__Female_S
    self.drawConnections(
 )
    # Connections for obj114 (graphObject_: Obj36) of type MT_pre__Female_S
    self.drawConnections(
 )
...
(self.obj93,self.obj105,[861.0, 441.0, 861.0, 351.0],"true", 2) )
    # Connections for obj117 (graphObject_: Obj37) of type MT_pre__indirectLink_S
    self.drawConnections(
(self.obj117,self.obj114,[321.0, 261.0, 421.0, 261.0],"true", 2) )
