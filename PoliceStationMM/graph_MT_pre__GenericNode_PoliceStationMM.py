...
"""
__graph_MT_pre__GenericNode_PoliceStationMM.py___________________________________________________________
...
class graph_MT_pre__GenericNode_PoliceStationMM(graphEntity):
...
new_class = graph_MT_pre__GenericNode_PoliceStationMM
