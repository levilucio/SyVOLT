"""
__hasAttr_T.py_____________________________________________________
...
class hasAttr_T(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_hasAttr_T
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = hasAttr_T( self.parent )
