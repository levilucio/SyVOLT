...
class graph_MT_post__MatchModel(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([-5.0, 0.0, -5.0, 8.0])[:2], tags = self.tag, font=font, fill = 'white', anchor = 'center', text = 'MT_post__MatchModel', width = '0', justify= 'left', stipple='' )
