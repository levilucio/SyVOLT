...
class graph_MT_post__Equation(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([0.0, 1.0, 0.0, -238.0])[:2], tags = self.tag, font=font, fill = 'black', anchor = 'center', text = 'MT_post__Equation', width = '0', justify= 'left', stipple='' )
