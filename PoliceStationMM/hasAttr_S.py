"""
__hasAttr_S.py_____________________________________________________
...
class hasAttr_S(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_hasAttr_S
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = hasAttr_S( self.parent )
