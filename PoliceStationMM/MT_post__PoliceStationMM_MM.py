"""
__MT_post__PoliceStationMM_MM.py______________________________________________________
...
"""
from ASG_MT_post__PoliceStationMM import *
...
from MT_post__GenericNode_PoliceStationMM       import *
...
from MT_post__GenericEdge_PoliceStationMM       import *
def createNewASGroot(self):
   return ASG_MT_post__PoliceStationMM(self, None)
...
def createModelMenu(self, modelMenu):
    ...
    modelMenu.add_command(label="New MT_post__GenericNode_PoliceStationMM", command=lambda x=self: x.createNewMT_post__GenericNode_PoliceStationMM(x, 100, 100) )
    ...
    modelMenu.add_command(label="New MT_post__GenericEdge_PoliceStationMM", command=lambda x=self: x.createNewMT_post__GenericEdge_PoliceStationMM(x, 100, 100) )
def setConnectivity(self):
    self.ConnectivityMap['MT_post__Attribute']={
          ...
          ,'MT_post__GenericNode_PoliceStationMM': []
          ...
          ,'MT_post__Male_S': []
          ,'MT_post__Station_T': []
          ,'MT_post__GenericEdge_PoliceStationMM': []
          ,'MT_post__leftExpr': []
    ...
    self.ConnectivityMap['MT_post__MetaModelElement_T']={
          ...
          ,'MT_post__directLink_T': []
          ,'MT_post__directLink_S': []
          ,'MT_post__Female_S': [( 'MT_post__backward_link', self.createNewMT_post__backward_link), ( 'MT_post__trace_link', self.createNewMT_post__trace_link)]
          ...
          ,'MT_post__arg_1': []
          ,'MT_post__arg_2': []
          ,'MT_post__Station_S': [( 'MT_post__backward_link', self.createNewMT_post__backward_link), ( 'MT_post__trace_link', self.createNewMT_post__trace_link)]
          ,'MT_post__Male_T': [( 'MT_post__directLink_T', self.createNewMT_post__directLink_T)]
          ,'MT_post__Male_S': [( 'MT_post__backward_link', self.createNewMT_post__backward_link), ( 'MT_post__trace_link', self.createNewMT_post__trace_link)]
    ...
    self.ConnectivityMap['MT_post__indirectLink_S']={
          ...
          ,'MT_post__GenericNode_PoliceStationMM': []
          ,'MT_post__paired_with': []
          ,'MT_post__hasAttr_S': [( 'MT_post__MetaModelElement_S', self.createNewMT_post__MetaModelElement_S), ( 'MT_post__Station_S', self.createNewMT_post__Station_S), ( 'MT_post__Male_S', self.createNewMT_post__Male_S), ( 'MT_post__Female_S', self.createNewMT_post__Female_S)]
          ,'MT_post__hasAttr_T': []
          ,'MT_post__Constant': []
          ,'MT_post__directLink_T': []
          ...
          ,'MT_post__backward_link': []
          ,'MT_post__match_contains': [] }
    self.ConnectivityMap['MT_post__GenericNode_PoliceStationMM']={
           'MT_post__Attribute': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__MetaModelElement_S': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__MetaModelElement_T': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__Equation': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__MatchModel': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__indirectLink_S': []
          ,'MT_post__GenericNode_PoliceStationMM': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__paired_with': []
          ,'MT_post__hasAttr_S': []
          ,'MT_post__hasAttr_T': []
          ,'MT_post__Constant': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__directLink_T': []
          ,'MT_post__directLink_S': []
          ,'MT_post__Female_S': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__Female_T': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__apply_contains': []
          ,'MT_post__ApplyModel': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__Expression': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__Concat': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__trace_link': []
          ,'MT_post__rightExpr': []
          ,'MT_post__arg_1': []
          ,'MT_post__arg_2': []
          ,'MT_post__Station_S': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__Male_T': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__Male_S': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__Station_T': [( 'MT_post__GenericEdge_PoliceStationMM', self.createNewMT_post__GenericEdge_PoliceStationMM)]
          ,'MT_post__GenericEdge_PoliceStationMM': []
          ,'MT_post__leftExpr': []
          ,'MT_post__backward_link': []
          ,'MT_post__match_contains': [] }
    ...
    self.ConnectivityMap['MT_post__directLink_T']={
          ...
          ,'MT_post__paired_with': []
          ,'MT_post__hasAttr_S': []
          ,'MT_post__hasAttr_T': [( 'MT_post__MetaModelElement_T', self.createNewMT_post__MetaModelElement_T), ( 'MT_post__Station_T', self.createNewMT_post__Station_T), ( 'MT_post__Male_T', self.createNewMT_post__Male_T), ( 'MT_post__Female_T', self.createNewMT_post__Female_T)]
          ,'MT_post__Constant': []
          ...
          ,'MT_post__Expression': []
          ,'MT_post__Concat': []
          ,'MT_post__trace_link': [( 'MT_post__MetaModelElement_T', self.createNewMT_post__MetaModelElement_T), ( 'MT_post__Station_T', self.createNewMT_post__Station_T), ( 'MT_post__Male_T', self.createNewMT_post__Male_T), ( 'MT_post__Female_T', self.createNewMT_post__Female_T)]
          ,'MT_post__rightExpr': []
          ,'MT_post__arg_1': []
          ,'MT_post__arg_2': []
          ,'MT_post__Station_S': []
    ...
    self.ConnectivityMap['MT_post__apply_contains']={
          ...
          ,'MT_post__backward_link': [( 'MT_post__MetaModelElement_T', self.createNewMT_post__MetaModelElement_T), ( 'MT_post__Station_T', self.createNewMT_post__Station_T), ( 'MT_post__Male_T', self.createNewMT_post__Male_T), ( 'MT_post__Female_T', self.createNewMT_post__Female_T)]
          ,'MT_post__match_contains': [] }
    self.ConnectivityMap['MT_post__GenericEdge_PoliceStationMM']={
           'MT_post__Attribute': []
          ,'MT_post__MetaModelElement_S': []
          ,'MT_post__MetaModelElement_T': []
          ,'MT_post__Equation': []
          ...
          ,'MT_post__Male_S': []
          ,'MT_post__Station_T': []
          ,'MT_post__GenericEdge_PoliceStationMM': [( 'MT_post__GenericNode_PoliceStationMM', self.createNewMT_post__GenericNode_PoliceStationMM)]
    ...
    self.CardinalityTable['MT_post__MetaModelElement_S']={
          ...
          ,'MT_post__arg_1': []
          ,'MT_post__arg_2': []
          ,'MT_post__GenericEdge_PoliceStationMM': [('0', 'N', 'Destination')] }
    self.CardinalityTable['MT_post__Station_S']={
          ...
          ,'MT_post__arg_1': []
          ,'MT_post__arg_2': []
          ,'MT_post__GenericEdge_PoliceStationMM': [('0', 'N', 'Destination'), ('0', 'N', 'Destination')] }
    ...
    self.CardinalityTable['MT_post__Concat']={
          ...
          ,'MT_post__GenericEdge_PoliceStationMM': [('0', 'N', 'Destination'), ('0', 'N', 'Destination')] }
    self.CardinalityTable['MT_post__GenericNode_PoliceStationMM']={
          'MT_post__MetaModelElement_S': []
          ,'MT_post__Station_S': []
          ,'MT_post__Male_S': []
          ,'MT_post__Female_S': []
          ...
          ,'MT_post__arg_1': []
          ,'MT_post__arg_2': []
          ,'MT_post__GenericEdge_PoliceStationMM': [('0', 'N', 'Source'), ('0', 'N', 'Destination')] }
    ...
    self.CardinalityTable['MT_post__hasAttr_S']={
          ...
          ,'MT_post__Station_S': [('0', 'N', 'Destination')]
          ,'MT_post__Male_S': [('0', 'N', 'Destination')]
          ,'MT_post__Female_S': [('0', 'N', 'Destination')]
          ,'MT_post__MatchModel': []
          ,'MT_post__ApplyModel': []
          ,'MT_post__MetaModelElement_T': []
          ,'MT_post__Station_T': []
    ...
    self.CardinalityTable['MT_post__arg_2']={
          ...
          ,'MT_post__arg_2': []
          ,'MT_post__GenericEdge_PoliceStationMM': [] }
    self.CardinalityTable['MT_post__GenericEdge_PoliceStationMM']={
          'MT_post__MetaModelElement_S': [('0', 'N', 'Source')]
          ...
          ,'MT_post__GenericNode_PoliceStationMM': [('0', 'N', 'Destination'), ('0', 'N', 'Source')]
          ,'MT_post__match_contains': []
          ,'MT_post__apply_contains': []
          ,'MT_post__backward_link': []
          ,'MT_post__indirectLink_S': []
...
def createNewMT_post__Concat(self, wherex, wherey, screenCoordinates = 1):
   ...
   if self.editGGLabel :
      ...
      self.statusbar.event(StatusBar.MODEL, StatusBar.CREATE)
   return new_semantic_obj
def createNewMT_post__GenericNode_PoliceStationMM(self, wherex, wherey, screenCoordinates = 1):
   self.fromClass = None
   self.toClass = None
   # try the global constraints...
   res = self.ASGroot.preCondition(ASG.CREATE)
   ...
   new_semantic_obj = MT_post__GenericNode_PoliceStationMM(self)
   res = new_semantic_obj.preCondition ( ASGNode.CREATE )
   if res: return self.constraintViolation(res)
   new_semantic_obj.preAction ( ASGNode.CREATE ) 

   ne = len(self.ASGroot.listNodes["MT_post__GenericNode_PoliceStationMM"])
   if new_semantic_obj.keyword_:
      new_semantic_obj.keyword_.setValue(new_semantic_obj.keyword_.toString()+str(ne))
   if screenCoordinates:
      new_obj = graph_MT_post__GenericNode_PoliceStationMM(self.UMLmodel.canvasx(wherex), self.UMLmodel.canvasy(wherey), new_semantic_obj)
   else: # already in canvas coordinates
      new_obj = graph_MT_post__GenericNode_PoliceStationMM(wherex, wherey, new_semantic_obj)
   new_obj.DrawObject(self.UMLmodel, self.editGGLabel)
   self.UMLmodel.addtag_withtag("MT_post__GenericNode_PoliceStationMM", new_obj.tag)
   new_semantic_obj.graphObject_ = new_obj
   self.ASGroot.addNode(new_semantic_obj)
   res = self.ASGroot.postCondition(ASG.CREATE)
   if res:
...
def createNewMT_post__arg_2(self, wherex, wherey, screenCoordinates = 1):
   ...
   if self.editGGLabel :
      ...
      self.statusbar.event(StatusBar.MODEL, StatusBar.CREATE)
   return new_semantic_obj
def createNewMT_post__GenericEdge_PoliceStationMM(self, wherex, wherey, screenCoordinates = 1):
   self.fromClass = None
   self.toClass = None
   # try the global constraints...
   res = self.ASGroot.preCondition(ASG.CREATE)
   ...
   new_semantic_obj = MT_post__GenericEdge_PoliceStationMM(self)
   res = new_semantic_obj.preCondition ( ASGNode.CREATE )
   if res: return self.constraintViolation(res)
   new_semantic_obj.preAction ( ASGNode.CREATE ) 

   ne = len(self.ASGroot.listNodes["MT_post__GenericEdge_PoliceStationMM"])
   if new_semantic_obj.keyword_:
      new_semantic_obj.keyword_.setValue(new_semantic_obj.keyword_.toString()+str(ne))
   if screenCoordinates:
      new_obj = graph_MT_post__GenericEdge_PoliceStationMM(self.UMLmodel.canvasx(wherex), self.UMLmodel.canvasy(wherey), new_semantic_obj)
   else: # already in canvas coordinates
      new_obj = graph_MT_post__GenericEdge_PoliceStationMM(wherex, wherey, new_semantic_obj)
   new_obj.DrawObject(self.UMLmodel, self.editGGLabel)
   self.UMLmodel.addtag_withtag("MT_post__GenericEdge_PoliceStationMM", new_obj.tag)
   new_semantic_obj.graphObject_ = new_obj
   self.ASGroot.addNode(new_semantic_obj)
   res = self.ASGroot.postCondition(ASG.CREATE)
   if res:
...
def createNew_Model(self, wherex, wherey, screenCoordinates = 1):
   self.toClass = None
   self.fromClass = None
   new_semantic_obj = ASG_MT_post__PoliceStationMM(self)
   ne = len(self.ASGroot.listNodes["ASG_MT_post__PoliceStationMM"])
   if new_semantic_obj.keyword_:
      new_semantic_obj.keyword_.setValue(new_semantic_obj.keyword_.toString()+str(ne))
   if screenCoordinates:
   ...
   new_obj.DrawObject(self.UMLmodel, self.editGGLabel)
   self.UMLmodel.addtag_withtag("ASG_MT_post__PoliceStationMM", new_obj.tag)
   new_semantic_obj.graphObject_ = new_obj
   self.ASGroot.addNode(new_semantic_obj)
   self.mode=self.IDLEMODE
   if self.editGGLabel :
