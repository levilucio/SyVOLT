...
Author: levi
Modified: Fri Jan 16 17:02:50 2015
...
def F2F_match_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MT_post__PoliceStationMMRootNode=None, MoTifRuleRootNode=None):
    ...
    # MT_label__
    self.obj61.MT_label__.setValue('7')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__hasAttr_S(757.0,255.5,self.obj61)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj72.graphClass_= graph_RHS
    if self.genGraphics:
       new_obj = graph_RHS(1020.0,160.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # constraint
    self.obj73.constraint.setValue('#===============================================================================\n# This code is executed after the nodes in the LHS have been matched.\n# You can access a matched node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# The given constraint must evaluate to a boolean expression:\n#    returning True enables the rule to be applied,\n#    returning False forbids the rule from being applied.\n#===============================================================================\n\nreturn True\n')
    self.obj73.constraint.setHeight(15)

    self.obj73.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(520.0,120.0,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__Attribute(1280.0,220.0,self.obj62)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj63=MT_post__Attribute(self)
    ...
    self.obj63.graphClass_= graph_MT_post__Attribute
    if self.genGraphics:
       new_obj = graph_MT_post__Attribute(1280.0,400.0,self.obj63)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Attribute", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    self.obj64=MT_post__Equation(self)
    ...
    # MT_label__
    self.obj64.MT_label__.setValue('9')

    # MT_pivotOut__
    self.obj64.MT_pivotOut__.setValue('')
    self.obj64.MT_pivotOut__.setNone()

    self.obj64.graphClass_= graph_MT_post__Equation
    if self.genGraphics:
       new_obj = graph_MT_post__Equation(1340.0,300.0,self.obj64)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj74=MT_post__MatchModel(self)
    ...
    # MT_label__
    self.obj74.MT_label__.setValue('12')

    # MT_pivotOut__
    self.obj74.MT_pivotOut__.setValue('')
    self.obj74.MT_pivotOut__.setNone()

    self.obj74.graphClass_= graph_MT_post__MatchModel
    if self.genGraphics:
       new_obj = graph_MT_post__MatchModel(1360.0,200.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj83.MT_label__.setValue('16')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__paired_with(1446.0,351.0,self.obj83)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj65=MT_post__hasAttr_S(self)
    ...
    self.obj65.graphClass_= graph_MT_post__hasAttr_S
    if self.genGraphics:
       new_obj = graph_MT_post__hasAttr_S(1257.0,255.5,self.obj65)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj66=MT_post__hasAttr_T(self)
    ...
    self.obj66.graphClass_= graph_MT_post__hasAttr_T
    if self.genGraphics:
       new_obj = graph_MT_post__hasAttr_T(1247.0,435.5,self.obj66)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj67=MT_post__Female_S(self)
    ...
    self.obj67.MT_post__cardinality.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn attr_value\n')
    self.obj67.MT_post__cardinality.setHeight(15)
    ...
    self.obj67.graphClass_= graph_MT_post__Female_S
    if self.genGraphics:
       new_obj = graph_MT_post__Female_S(1100.0,220.0,self.obj67)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj68=MT_post__Female_T(self)
    ...
    self.obj68.graphClass_= graph_MT_post__Female_T
    if self.genGraphics:
       new_obj = graph_MT_post__Female_T(1100.0,400.0,self.obj68)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj80=MT_post__ApplyModel(self)
    ...
    # MT_label__
    self.obj80.MT_label__.setValue('13')

    # MT_pivotOut__
    self.obj80.MT_pivotOut__.setValue('')
    self.obj80.MT_pivotOut__.setNone()

    self.obj80.graphClass_= graph_MT_post__ApplyModel
    if self.genGraphics:
       new_obj = graph_MT_post__ApplyModel(1360.0,420.0,self.obj80)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj69=MT_post__trace_link(self)
    ...
    self.obj69.graphClass_= graph_MT_post__trace_link
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1161.0,351.0,self.obj69)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj70=MT_post__rightExpr(self)
    ...
    # MT_label__
    self.obj70.MT_label__.setValue('11')

    # MT_pivotOut__
    self.obj70.MT_pivotOut__.setValue('')
    self.obj70.MT_pivotOut__.setNone()

    self.obj70.graphClass_= graph_MT_post__rightExpr
    if self.genGraphics:
       new_obj = graph_MT_post__rightExpr(1372.5,386.0,self.obj70)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj82.MT_label__.setValue('15')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__apply_contains(1304.5,451.0,self.obj82)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj71=MT_post__leftExpr(self)
    ...
    # MT_label__
    self.obj71.MT_label__.setValue('10')

    # MT_pivotOut__
    self.obj71.MT_pivotOut__.setValue('')
    self.obj71.MT_pivotOut__.setNone()

    self.obj71.graphClass_= graph_MT_post__leftExpr
    if self.genGraphics:
       new_obj = graph_MT_post__leftExpr(1372.5,296.0,self.obj71)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj81=MT_post__match_contains(self)
    ...
    # MT_label__
    self.obj81.MT_label__.setValue('14')

    # MT_pivotOut__
    self.obj81.MT_pivotOut__.setValue('')
    self.obj81.MT_pivotOut__.setNone()

    self.obj81.graphClass_= graph_MT_post__match_contains
    if self.genGraphics:
       new_obj = graph_MT_post__match_contains(1302.5,251.0,self.obj81)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj59,self.obj61,[661.0, 261.0, 757.0, 255.5],"true", 2) )
    ...
    self.drawConnections(
(self.obj61,self.obj60,[757.0, 255.5, 853.0, 250.0],"true", 2) )
    # Connections for obj72 (graphObject_: Obj13) of type RHS
    self.drawConnections(
 )
    # Connections for obj73 (graphObject_: Obj14) of type LHS
    self.drawConnections(
 )
    # Connections for obj62 (graphObject_: Obj3) of type MT_post__Attribute
    self.drawConnections(
 )
    # Connections for obj63 (graphObject_: Obj4) of type MT_post__Attribute
    self.drawConnections(
 )
    # Connections for obj64 (graphObject_: Obj5) of type MT_post__Equation
    self.drawConnections(
(self.obj64,self.obj71,[1412.0, 342.0, 1372.5, 296.0],"true", 2),
(self.obj64,self.obj70,[1412.0, 342.0, 1372.5, 386.0],"true", 2) )
    # Connections for obj74 (graphObject_: Obj15) of type MT_post__MatchModel
    self.drawConnections(
(self.obj74,self.obj81,[1444.0, 241.0, 1302.5, 251.0],"true", 2),
(self.obj74,self.obj83,[1444.0, 241.0, 1446.0, 351.0],"true", 2) )
    # Connections for obj83 (graphObject_: Obj20) of type MT_post__paired_with
    self.drawConnections(
(self.obj83,self.obj80,[1446.0, 351.0, 1448.0, 461.0],"true", 2) )
    # Connections for obj65 (graphObject_: Obj6) of type MT_post__hasAttr_S
    self.drawConnections(
(self.obj65,self.obj62,[1257.0, 255.5, 1333.0, 250.0],"true", 2) )
    # Connections for obj66 (graphObject_: Obj7) of type MT_post__hasAttr_T
    self.drawConnections(
(self.obj66,self.obj63,[1247.0, 435.5, 1333.0, 430.0],"true", 2) )
    # Connections for obj67 (graphObject_: Obj8) of type MT_post__Female_S
    self.drawConnections(
(self.obj67,self.obj65,[1161.0, 261.0, 1257.0, 255.5],"true", 2) )
    # Connections for obj68 (graphObject_: Obj9) of type MT_post__Female_T
    self.drawConnections(
(self.obj68,self.obj69,[1161.0, 441.0, 1161.0, 351.0],"true", 2),
(self.obj68,self.obj66,[1161.0, 441.0, 1247.0, 435.5],"true", 2) )
    # Connections for obj80 (graphObject_: Obj17) of type MT_post__ApplyModel
    self.drawConnections(
(self.obj80,self.obj82,[1448.0, 461.0, 1304.5, 451.0],"true", 2) )
    # Connections for obj69 (graphObject_: Obj10) of type MT_post__trace_link
    self.drawConnections(
(self.obj69,self.obj67,[1161.0, 351.0, 1161.0, 261.0],"true", 2) )
    # Connections for obj70 (graphObject_: Obj11) of type MT_post__rightExpr
    self.drawConnections(
(self.obj70,self.obj63,[1372.5, 386.0, 1333.0, 430.0],"true", 2) )
    # Connections for obj82 (graphObject_: Obj19) of type MT_post__apply_contains
    self.drawConnections(
(self.obj82,self.obj68,[1304.5, 451.0, 1161.0, 441.0],"true", 2) )
    # Connections for obj71 (graphObject_: Obj12) of type MT_post__leftExpr
    self.drawConnections(
(self.obj71,self.obj62,[1372.5, 296.0, 1333.0, 250.0],"true", 2) )
    # Connections for obj81 (graphObject_: Obj18) of type MT_post__match_contains
    self.drawConnections(
(self.obj81,self.obj67,[1302.5, 251.0, 1161.0, 261.0],"true", 2) )
