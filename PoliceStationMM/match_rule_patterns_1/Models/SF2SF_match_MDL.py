...
Author: levi
Modified: Fri Jan 16 17:09:46 2015
...
def SF2SF_match_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MoTifRuleRootNode=None, MT_post__PoliceStationMMRootNode=None):
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(761.0,261.0,self.obj63)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(861.0,351.0,self.obj65)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj77=MT_post__MatchModel(self)
    ...
    # MT_label__
    self.obj77.MT_label__.setValue('12')

    # MT_pivotOut__
    self.obj77.MT_pivotOut__.setValue('')
    self.obj77.MT_pivotOut__.setNone()

    self.obj77.graphClass_= graph_MT_post__MatchModel
    if self.genGraphics:
       new_obj = graph_MT_post__MatchModel(1040.0,440.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj68=MT_post__indirectLink_S(self)
    ...
    # MT_label__
    self.obj68.MT_label__.setValue('10')

    # MT_pivotOut__
    self.obj68.MT_pivotOut__.setValue('')
    self.obj68.MT_pivotOut__.setNone()

    self.obj68.graphClass_= graph_MT_post__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_post__indirectLink_S(1211.0,241.0,self.obj68)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj83=MT_post__paired_with(self)
    ...
    self.obj83.graphClass_= graph_MT_post__paired_with
    if self.genGraphics:
       new_obj = graph_MT_post__paired_with(1236.0,481.0,self.obj83)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj69=MT_post__directLink_T(self)
    ...
    # MT_label__
    self.obj69.MT_label__.setValue('11')
    ...
    self.obj69.MT_post__associationType.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn attr_value\n')
    self.obj69.MT_post__associationType.setHeight(15)

    self.obj69.graphClass_= graph_MT_post__directLink_T
    if self.genGraphics:
       new_obj = graph_MT_post__directLink_T(1251.0,361.0,self.obj69)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj70=MT_post__Female_S(self)
    ...
    self.obj70.graphClass_= graph_MT_post__Female_S
    if self.genGraphics:
       new_obj = graph_MT_post__Female_S(1220.0,200.0,self.obj70)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__Female_T(1260.0,320.0,self.obj71)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__Station_T(1120.0,320.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj78=MT_post__ApplyModel(self)
    ...
    # MT_label__
    self.obj78.MT_label__.setValue('13')

    # MT_pivotOut__
    self.obj78.MT_pivotOut__.setValue('')
    self.obj78.MT_pivotOut__.setNone()

    self.obj78.graphClass_= graph_MT_post__ApplyModel
    if self.genGraphics:
       new_obj = graph_MT_post__ApplyModel(1260.0,440.0,self.obj78)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1161.0,301.0,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj74=MT_post__trace_link(self)
    ...
    # MT_label__
    self.obj74.MT_label__.setValue('6')

    # MT_pivotOut__
    self.obj74.MT_pivotOut__.setValue('')
    self.obj74.MT_pivotOut__.setNone()

    self.obj74.graphClass_= graph_MT_post__trace_link
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1301.0,301.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj75=MT_post__Station_S(self)
    ...
    self.obj75.graphClass_= graph_MT_post__Station_S
    if self.genGraphics:
       new_obj = graph_MT_post__Station_S(1080.0,200.0,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj81=MT_post__apply_contains(self)
    ...
    # MT_label__
    self.obj81.MT_label__.setValue('16')

    # MT_pivotOut__
    self.obj81.MT_pivotOut__.setValue('')
    self.obj81.MT_pivotOut__.setNone()

    self.obj81.graphClass_= graph_MT_post__apply_contains
    if self.genGraphics:
       new_obj = graph_MT_post__apply_contains(1264.5,421.0,self.obj81)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj82.MT_label__.setValue('17')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__apply_contains(1334.5,421.0,self.obj82)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__apply_contains", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj79=MT_post__match_contains(self)
    ...
    self.obj79.graphClass_= graph_MT_post__match_contains
    if self.genGraphics:
       new_obj = graph_MT_post__match_contains(1132.5,361.0,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj80=MT_post__match_contains(self)
    ...
    # MT_label__
    self.obj80.MT_label__.setValue('15')

    # MT_pivotOut__
    self.obj80.MT_pivotOut__.setValue('')
    self.obj80.MT_pivotOut__.setNone()

    self.obj80.graphClass_= graph_MT_post__match_contains
    if self.genGraphics:
       new_obj = graph_MT_post__match_contains(1202.5,361.0,self.obj80)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__match_contains", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj66.graphClass_= graph_RHS
    if self.genGraphics:
       new_obj = graph_RHS(960.0,140.0,self.obj66)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj67.graphClass_= graph_LHS
    if self.genGraphics:
       new_obj = graph_LHS(540.0,140.0,self.obj67)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj59,self.obj63,[661.0, 261.0, 761.0, 261.0],"true", 2) )
...
(self.obj61,self.obj64,[661.0, 441.0, 661.0, 351.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj62,self.obj65,[861.0, 441.0, 861.0, 351.0],"true", 2) )
    # Connections for obj63 (graphObject_: Obj4) of type MT_pre__indirectLink_S
    self.drawConnections(
(self.obj63,self.obj60,[761.0, 261.0, 861.0, 261.0],"true", 2) )
...
(self.obj64,self.obj59,[661.0, 351.0, 661.0, 261.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj65,self.obj60,[861.0, 351.0, 861.0, 261.0],"true", 2) )
    # Connections for obj77 (graphObject_: Obj18) of type MT_post__MatchModel
    self.drawConnections(
(self.obj77,self.obj79,[1124.0, 481.0, 1132.5, 361.0],"true", 2),
(self.obj77,self.obj80,[1124.0, 481.0, 1202.5, 361.0],"true", 2),
(self.obj77,self.obj83,[1124.0, 481.0, 1236.0, 481.0],"true", 2) )
    # Connections for obj68 (graphObject_: Obj9) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj68,self.obj70,[1211.0, 241.0, 1281.0, 241.0],"true", 2) )
    # Connections for obj83 (graphObject_: Obj24) of type MT_post__paired_with
    self.drawConnections(
(self.obj83,self.obj78,[1236.0, 481.0, 1348.0, 481.0],"true", 2) )
    # Connections for obj69 (graphObject_: Obj10) of type MT_post__directLink_T
    self.drawConnections(
(self.obj69,self.obj71,[1251.0, 361.0, 1321.0, 361.0],"true", 2) )
    # Connections for obj70 (graphObject_: Obj11) of type MT_post__Female_S
    self.drawConnections(
 )
    # Connections for obj71 (graphObject_: Obj12) of type MT_post__Female_T
    self.drawConnections(
(self.obj71,self.obj74,[1321.0, 361.0, 1301.0, 301.0],"true", 2) )
    # Connections for obj72 (graphObject_: Obj13) of type MT_post__Station_T
    self.drawConnections(
(self.obj72,self.obj73,[1181.0, 361.0, 1161.0, 301.0],"true", 2),
(self.obj72,self.obj69,[1181.0, 361.0, 1251.0, 361.0],"true", 2) )
    # Connections for obj78 (graphObject_: Obj19) of type MT_post__ApplyModel
    self.drawConnections(
(self.obj78,self.obj81,[1348.0, 481.0, 1264.5, 421.0],"true", 2),
(self.obj78,self.obj82,[1348.0, 481.0, 1334.5, 421.0],"true", 2) )
    # Connections for obj73 (graphObject_: Obj14) of type MT_post__trace_link
    self.drawConnections(
(self.obj73,self.obj75,[1161.0, 301.0, 1141.0, 241.0],"true", 2) )
    # Connections for obj74 (graphObject_: Obj15) of type MT_post__trace_link
    self.drawConnections(
(self.obj74,self.obj70,[1301.0, 301.0, 1281.0, 241.0],"true", 2) )
    # Connections for obj75 (graphObject_: Obj16) of type MT_post__Station_S
    self.drawConnections(
(self.obj75,self.obj68,[1141.0, 241.0, 1211.0, 241.0],"true", 2) )
    # Connections for obj81 (graphObject_: Obj22) of type MT_post__apply_contains
    self.drawConnections(
(self.obj81,self.obj72,[1264.5, 421.0, 1181.0, 361.0],"true", 2) )
    # Connections for obj82 (graphObject_: Obj23) of type MT_post__apply_contains
    self.drawConnections(
(self.obj82,self.obj71,[1334.5, 421.0, 1321.0, 361.0],"true", 2) )
    # Connections for obj79 (graphObject_: Obj20) of type MT_post__match_contains
    self.drawConnections(
(self.obj79,self.obj75,[1132.5, 361.0, 1141.0, 241.0],"true", 2) )
    # Connections for obj80 (graphObject_: Obj21) of type MT_post__match_contains
    self.drawConnections(
(self.obj80,self.obj70,[1202.5, 361.0, 1281.0, 241.0],"true", 2) )
    # Connections for obj66 (graphObject_: Obj7) of type RHS
    self.drawConnections(
 )
    # Connections for obj67 (graphObject_: Obj8) of type LHS
    self.drawConnections(
 )
