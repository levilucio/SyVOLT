"""
__MM2MM_match_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Thu Jan 15 22:22:59 2015
...
def MM2MM_match_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MT_post__PoliceStationMMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('MM2MM_match')
    # --- ASG attributes over ---


    self.obj72=MT_pre__Male_S(self)
    ...
    self.obj72.graphClass_= graph_MT_pre__Male_S
    if self.genGraphics:
       new_obj = graph_MT_pre__Male_S(600.0,260.0,self.obj72)
    ...
    self.obj73=MT_pre__Male_S(self)
    ...
    self.obj73.graphClass_= graph_MT_pre__Male_S
    if self.genGraphics:
       new_obj = graph_MT_pre__Male_S(780.0,260.0,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Male_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj70=MT_pre__Male_T(self)
    ...
    self.obj70.graphClass_= graph_MT_pre__Male_T
    if self.genGraphics:
       new_obj = graph_MT_pre__Male_T(600.0,440.0,self.obj70)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj71=MT_pre__Male_T(self)
    ...
    self.obj71.graphClass_= graph_MT_pre__Male_T
    if self.genGraphics:
       new_obj = graph_MT_pre__Male_T(780.0,440.0,self.obj71)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Male_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj69=MT_pre__indirectLink_S(self)
    ...
    self.obj69.graphClass_= graph_MT_pre__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_pre__indirectLink_S(751.0,301.0,self.obj69)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(661.0,391.0,self.obj67)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__trace_link(841.0,391.0,self.obj68)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_RHS(960.0,200.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_LHS(520.0,200.0,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj63=MT_post__indirectLink_S(self)
    ...
    self.obj63.graphClass_= graph_MT_post__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_post__indirectLink_S(1251.0,301.0,self.obj63)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj64=MT_post__directLink_T(self)
    ...
    # MT_label__
    self.obj64.MT_label__.setValue('8')
    ...
    self.obj64.MT_post__associationType.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn attr_value\n')
    self.obj64.MT_post__associationType.setHeight(15)

    self.obj64.graphClass_= graph_MT_post__directLink_T
    if self.genGraphics:
       new_obj = graph_MT_post__directLink_T(1251.0,481.0,self.obj64)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj65=MT_post__trace_link(self)
    ...
    self.obj65.graphClass_= graph_MT_post__trace_link
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1161.0,391.0,self.obj65)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1341.0,391.0,self.obj66)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj61=MT_post__Male_T(self)
    ...
    self.obj61.graphClass_= graph_MT_post__Male_T
    if self.genGraphics:
       new_obj = graph_MT_post__Male_T(1100.0,440.0,self.obj61)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__Male_T(1280.0,440.0,self.obj62)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Male_T", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj59=MT_post__Male_S(self)
    ...
    self.obj59.MT_post__cardinality.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn attr_value\n')
    self.obj59.MT_post__cardinality.setHeight(15)
    ...
    self.obj59.graphClass_= graph_MT_post__Male_S
    if self.genGraphics:
       new_obj = graph_MT_post__Male_S(1100.0,260.0,self.obj59)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj60=MT_post__Male_S(self)
    ...
    self.obj60.graphClass_= graph_MT_post__Male_S
    if self.genGraphics:
       new_obj = graph_MT_post__Male_S(1280.0,260.0,self.obj60)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Male_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    # Connections for obj72 (graphObject_: Obj13) of type MT_pre__Male_S
    self.drawConnections(
(self.obj72,self.obj69,[661.0, 301.0, 751.0, 301.0],"true", 2) )
    # Connections for obj73 (graphObject_: Obj14) of type MT_pre__Male_S
    self.drawConnections(
 )
    # Connections for obj70 (graphObject_: Obj11) of type MT_pre__Male_T
    self.drawConnections(
(self.obj70,self.obj67,[661.0, 481.0, 661.0, 391.0],"true", 2) )
    # Connections for obj71 (graphObject_: Obj12) of type MT_pre__Male_T
    self.drawConnections(
(self.obj71,self.obj68,[841.0, 481.0, 841.0, 391.0],"true", 2) )
    # Connections for obj69 (graphObject_: Obj10) of type MT_pre__indirectLink_S
    self.drawConnections(
(self.obj69,self.obj73,[751.0, 301.0, 841.0, 301.0],"true", 2) )
    # Connections for obj67 (graphObject_: Obj8) of type MT_pre__trace_link
    self.drawConnections(
(self.obj67,self.obj72,[661.0, 391.0, 661.0, 301.0],"true", 2) )
    # Connections for obj68 (graphObject_: Obj9) of type MT_pre__trace_link
    self.drawConnections(
(self.obj68,self.obj73,[841.0, 391.0, 841.0, 301.0],"true", 2) )
    ...
    # Connections for obj63 (graphObject_: Obj4) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj63,self.obj60,[1251.0, 301.0, 1341.0, 301.0],"true", 2) )
    # Connections for obj64 (graphObject_: Obj5) of type MT_post__directLink_T
    self.drawConnections(
(self.obj64,self.obj62,[1251.0, 481.0, 1341.0, 481.0],"true", 2) )
    # Connections for obj65 (graphObject_: Obj6) of type MT_post__trace_link
    self.drawConnections(
(self.obj65,self.obj59,[1161.0, 391.0, 1161.0, 301.0],"true", 2) )
    # Connections for obj66 (graphObject_: Obj7) of type MT_post__trace_link
    self.drawConnections(
(self.obj66,self.obj60,[1341.0, 391.0, 1341.0, 301.0],"true", 2) )
    # Connections for obj61 (graphObject_: Obj2) of type MT_post__Male_T
    self.drawConnections(
(self.obj61,self.obj65,[1161.0, 481.0, 1161.0, 391.0],"true", 2),
(self.obj61,self.obj64,[1161.0, 481.0, 1251.0, 481.0],"true", 2) )
    # Connections for obj62 (graphObject_: Obj3) of type MT_post__Male_T
    self.drawConnections(
(self.obj62,self.obj66,[1341.0, 481.0, 1341.0, 391.0],"true", 2) )
    # Connections for obj59 (graphObject_: Obj0) of type MT_post__Male_S
    self.drawConnections(
(self.obj59,self.obj63,[1161.0, 301.0, 1251.0, 301.0],"true", 2) )
    # Connections for obj60 (graphObject_: Obj1) of type MT_post__Male_S
    self.drawConnections(
 )

newfunction = MM2MM_match_MDL
