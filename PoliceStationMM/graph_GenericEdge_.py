...
"""
__graph_GenericEdge_.py___________________________________________________________

Automatically generated LINK for entity GenericEdge_
...
class graph_GenericEdge_(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('GenericEdge__1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('GenericEdge__1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('GenericEdge__Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('GenericEdge__2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('GenericEdge__2ndLink', self.le.SecondLink))
