"""
__graph_MT_post__arg_2.py___________________________________________________________

Automatically generated LINK for entity MT_post__arg_2
...
class graph_MT_post__arg_2(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('arg_2_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('arg_2_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('arg_2_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('arg_2_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('arg_2_2ndLink', self.le.SecondLink))
