...
Author: levi
Modified: Fri Jan 16 09:50:36 2015
...
def SM2SM_combine_1_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MoTifRuleRootNode=None, MT_post__PoliceStationMMRootNode=None):
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__Attribute(1060.0,480.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj78.MT_label__.setValue('21')
    ...
    # MT_label__
    self.obj81.MT_label__.setValue('50')
    ...
    if self.genGraphics:
       new_obj = graph_LHS(560.0,160.0,self.obj71)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj76,self.obj89,[1211.0, 241.0, 1281.0, 241.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj77,self.obj72,[1127.0, 365.5, 1113.0, 510.0],"true", 2) )
...
(self.obj89,self.obj78,[1281.0, 241.0, 1357.0, 235.5],"true", 2) )
    ...
    self.drawConnections(
(self.obj90,self.obj72,[1162.5, 496.0, 1113.0, 510.0],"true", 2) )
