...
Author: levi
Modified: Fri Jan 16 17:18:39 2015
...
def SM2SM_combine_1_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MT_post__PoliceStationMMRootNode=None, MoTifRuleRootNode=None):
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Attribute(649.0,490.0,self.obj63)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__Attribute(825.0,490.0,self.obj64)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__Attribute", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    # MT_label__
    self.obj68.MT_label__.setValue('11')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__hasAttr_S(681.5,390.5,self.obj68)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj69.MT_label__.setValue('21')
    ...
    if self.genGraphics:
       new_obj = graph_MT_pre__hasAttr_S(859.5,390.5,self.obj69)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_pre__hasAttr_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_RHS(1000.0,160.0,self.obj90)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__Attribute(1060.0,480.0,self.obj70)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj107=MT_post__MatchModel(self)
    ...
    # MT_label__
    self.obj107.MT_label__.setValue('51')

    # MT_pivotOut__
    self.obj107.MT_pivotOut__.setValue('')
    self.obj107.MT_pivotOut__.setNone()

    self.obj107.graphClass_= graph_MT_post__MatchModel
    if self.genGraphics:
       new_obj = graph_MT_post__MatchModel(1100.0,420.0,self.obj107)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj74.MT_label__.setValue('8')
    ...
    self.obj113=MT_post__paired_with(self)
    ...
    # MT_label__
    self.obj113.MT_label__.setValue('57')

    # MT_pivotOut__
    self.obj113.MT_pivotOut__.setValue('')
    self.obj113.MT_pivotOut__.setNone()

    self.obj113.graphClass_= graph_MT_post__paired_with
    if self.genGraphics:
       new_obj = graph_MT_post__paired_with(1286.0,461.0,self.obj113)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj76.MT_label__.setValue('21')
    ...
    # MT_label__
    self.obj79.MT_label__.setValue('50')
    ...
    self.obj80=MT_post__Station_T(self)
    ...
    # MT_label__
    self.obj80.MT_label__.setValue('3')
    ...
    self.obj80.graphClass_= graph_MT_post__Station_T
    if self.genGraphics:
       new_obj = graph_MT_post__Station_T(1120.0,320.0,self.obj80)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj108=MT_post__ApplyModel(self)
    ...
    # MT_label__
    self.obj108.MT_label__.setValue('52')

    # MT_pivotOut__
    self.obj108.MT_pivotOut__.setValue('')
    self.obj108.MT_pivotOut__.setNone()

    self.obj108.graphClass_= graph_MT_post__ApplyModel
    if self.genGraphics:
       new_obj = graph_MT_post__ApplyModel(1300.0,420.0,self.obj108)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj81=MT_post__trace_link(self)
    ...
    self.obj81.graphClass_= graph_MT_post__trace_link
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1161.0,301.0,self.obj81)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj82.MT_label__.setValue('7')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1301.0,301.0,self.obj82)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj83=MT_post__rightExpr(self)
    ...
    # MT_label__
    self.obj83.MT_label__.setValue('20')

    # MT_pivotOut__
    self.obj83.MT_pivotOut__.setValue('')
    self.obj83.MT_pivotOut__.setNone()

    self.obj83.graphClass_= graph_MT_post__rightExpr
    if self.genGraphics:
       new_obj = graph_MT_post__rightExpr(1263.5,480.5,self.obj83)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj84=MT_post__rightExpr(self)
    ...
    # MT_label__
    self.obj84.MT_label__.setValue('23')

    # MT_pivotOut__
    self.obj84.MT_pivotOut__.setValue('')
    self.obj84.MT_pivotOut__.setNone()

    self.obj84.graphClass_= graph_MT_post__rightExpr
    if self.genGraphics:
       new_obj = graph_MT_post__rightExpr(1433.5,430.5,self.obj84)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__rightExpr", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj85=MT_post__Station_S(self)
    ...
    # MT_label__
    self.obj85.MT_label__.setValue('1')
    ...
    self.obj85.graphClass_= graph_MT_post__Station_S
    if self.genGraphics:
       new_obj = graph_MT_post__Station_S(1080.0,200.0,self.obj85)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj86=MT_post__Male_T(self)
    ...
    self.obj86.graphClass_= graph_MT_post__Male_T
    if self.genGraphics:
       new_obj = graph_MT_post__Male_T(1260.0,320.0,self.obj86)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj87=MT_post__Male_S(self)
    ...
    self.obj87.graphClass_= graph_MT_post__Male_S
    if self.genGraphics:
       new_obj = graph_MT_post__Male_S(1220.0,200.0,self.obj87)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj111=MT_post__apply_contains(self)
    ...
    # MT_label__
    self.obj111.MT_label__.setValue('55')

    # MT_pivotOut__
    self.obj111.MT_pivotOut__.setValue('')
    self.obj111.MT_pivotOut__.setNone()

    self.obj111.graphClass_= graph_MT_post__apply_contains
    if self.genGraphics:
       new_obj = graph_MT_post__apply_contains(1284.5,411.0,self.obj111)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj112.MT_label__.setValue('56')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__apply_contains(1354.5,411.0,self.obj112)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__apply_contains", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj109=MT_post__match_contains(self)
    ...
    # MT_label__
    self.obj109.MT_label__.setValue('53')

    # MT_pivotOut__
    self.obj109.MT_pivotOut__.setValue('')
    self.obj109.MT_pivotOut__.setNone()

    self.obj109.graphClass_= graph_MT_post__match_contains
    if self.genGraphics:
       new_obj = graph_MT_post__match_contains(1162.5,351.0,self.obj109)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # MT_label__
    self.obj110.MT_label__.setValue('54')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__match_contains(1232.5,351.0,self.obj110)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__match_contains", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
...
(self.obj59,self.obj68,[661.0, 261.0, 681.5, 390.5],"true", 2) )
    # Connections for obj60 (graphObject_: Obj1) of type MT_pre__Male_S
    self.drawConnections(
(self.obj60,self.obj69,[841.0, 261.0, 859.5, 390.5],"true", 2) )
...
(self.obj67,self.obj60,[841.0, 351.0, 841.0, 261.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj68,self.obj63,[681.5, 390.5, 702.0, 520.0],"true", 2) )
    # Connections for obj69 (graphObject_: Obj10) of type MT_pre__hasAttr_S
    self.drawConnections(
(self.obj69,self.obj64,[859.5, 390.5, 878.0, 520.0],"true", 2) )
...
(self.obj72,self.obj83,[1212.0, 502.0, 1263.5, 480.5],"true", 2) )
    # Connections for obj73 (graphObject_: Obj14) of type MT_post__Equation
    self.drawConnections(
(self.obj73,self.obj89,[1432.0, 362.0, 1432.5, 296.0],"true", 2),
(self.obj73,self.obj84,[1432.0, 362.0, 1433.5, 430.5],"true", 2) )
    # Connections for obj107 (graphObject_: Obj36) of type MT_post__MatchModel
    self.drawConnections(
(self.obj107,self.obj109,[1184.0, 461.0, 1162.5, 351.0],"true", 2),
(self.obj107,self.obj110,[1184.0, 461.0, 1232.5, 351.0],"true", 2),
(self.obj107,self.obj113,[1184.0, 461.0, 1286.0, 461.0],"true", 2) )
    # Connections for obj74 (graphObject_: Obj15) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj74,self.obj87,[1211.0, 241.0, 1281.0, 241.0],"true", 2) )
    # Connections for obj113 (graphObject_: Obj42) of type MT_post__paired_with
    self.drawConnections(
(self.obj113,self.obj108,[1286.0, 461.0, 1388.0, 461.0],"true", 2) )
    # Connections for obj75 (graphObject_: Obj16) of type MT_post__hasAttr_S
    self.drawConnections(
(self.obj75,self.obj70,[1127.0, 365.5, 1113.0, 510.0],"true", 2) )
...
(self.obj76,self.obj71,[1357.0, 235.5, 1433.0, 230.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj79,self.obj86,[1251.0, 361.0, 1321.0, 361.0],"true", 2) )
    # Connections for obj80 (graphObject_: Obj21) of type MT_post__Station_T
    self.drawConnections(
(self.obj80,self.obj79,[1181.0, 361.0, 1251.0, 361.0],"true", 2),
(self.obj80,self.obj81,[1181.0, 361.0, 1161.0, 301.0],"true", 2) )
    # Connections for obj108 (graphObject_: Obj37) of type MT_post__ApplyModel
    self.drawConnections(
(self.obj108,self.obj111,[1388.0, 461.0, 1284.5, 411.0],"true", 2),
(self.obj108,self.obj112,[1388.0, 461.0, 1354.5, 411.0],"true", 2) )
    # Connections for obj81 (graphObject_: Obj22) of type MT_post__trace_link
    self.drawConnections(
(self.obj81,self.obj85,[1161.0, 301.0, 1141.0, 241.0],"true", 2) )
    # Connections for obj82 (graphObject_: Obj23) of type MT_post__trace_link
    self.drawConnections(
(self.obj82,self.obj87,[1301.0, 301.0, 1281.0, 241.0],"true", 2) )
    # Connections for obj83 (graphObject_: Obj24) of type MT_post__rightExpr
    self.drawConnections(
(self.obj83,self.obj77,[1263.5, 480.5, 1315.0, 459.0],"true", 2) )
    # Connections for obj84 (graphObject_: Obj25) of type MT_post__rightExpr
    self.drawConnections(
(self.obj84,self.obj78,[1433.5, 430.5, 1435.0, 499.0],"true", 2) )
    # Connections for obj85 (graphObject_: Obj26) of type MT_post__Station_S
    self.drawConnections(
(self.obj85,self.obj74,[1141.0, 241.0, 1211.0, 241.0],"true", 2),
(self.obj85,self.obj75,[1141.0, 241.0, 1127.0, 365.5],"true", 2) )
    # Connections for obj86 (graphObject_: Obj27) of type MT_post__Male_T
    self.drawConnections(
(self.obj86,self.obj82,[1321.0, 361.0, 1301.0, 301.0],"true", 2) )
    # Connections for obj87 (graphObject_: Obj28) of type MT_post__Male_S
    self.drawConnections(
(self.obj87,self.obj76,[1281.0, 241.0, 1357.0, 235.5],"true", 2) )
    # Connections for obj111 (graphObject_: Obj40) of type MT_post__apply_contains
    self.drawConnections(
(self.obj111,self.obj80,[1284.5, 411.0, 1181.0, 361.0],"true", 2) )
    # Connections for obj112 (graphObject_: Obj41) of type MT_post__apply_contains
    self.drawConnections(
(self.obj112,self.obj86,[1354.5, 411.0, 1321.0, 361.0],"true", 2) )
    # Connections for obj88 (graphObject_: Obj29) of type MT_post__leftExpr
    self.drawConnections(
(self.obj88,self.obj70,[1162.5, 496.0, 1113.0, 510.0],"true", 2) )
    # Connections for obj89 (graphObject_: Obj30) of type MT_post__leftExpr
    self.drawConnections(
(self.obj89,self.obj71,[1432.5, 296.0, 1433.0, 230.0],"true", 2) )
    # Connections for obj109 (graphObject_: Obj38) of type MT_post__match_contains
    self.drawConnections(
(self.obj109,self.obj85,[1162.5, 351.0, 1141.0, 241.0],"true", 2) )
    # Connections for obj110 (graphObject_: Obj39) of type MT_post__match_contains
    self.drawConnections(
(self.obj110,self.obj87,[1232.5, 351.0, 1281.0, 241.0],"true", 2) )
