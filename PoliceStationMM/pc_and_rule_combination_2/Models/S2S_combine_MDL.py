"""
__S2S_combine_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Sun Jan  4 14:42:26 2015
...
def S2S_combine_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MT_post__PoliceStationMMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('S2S_combine')
    # --- ASG attributes over ---
    ...
    if self.genGraphics:
       new_obj = graph_RHS(880.0,140.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_LHS(440.0,140.0,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj73=MT_post__Station_T(self)
    ...
    self.obj73.graphClass_= graph_MT_post__Station_T
    if self.genGraphics:
       new_obj = graph_MT_post__Station_T(1082.0,395.0,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1143.0,346.0,self.obj66)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj70=MT_post__Station_S(self)
    ...
    self.obj70.graphClass_= graph_MT_post__Station_S
    if self.genGraphics:
       new_obj = graph_MT_post__Station_S(1082.0,215.0,self.obj70)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # Connections for obj73 (graphObject_: Obj14) of type MT_post__Station_T
    self.drawConnections(
(self.obj73,self.obj66,[1143.0, 436.0, 1143.0, 346.0],"true", 2) )
    # Connections for obj66 (graphObject_: Obj7) of type MT_post__trace_link
    self.drawConnections(
(self.obj66,self.obj70,[1143.0, 346.0, 1143.0, 256.0],"true", 2) )
    # Connections for obj70 (graphObject_: Obj11) of type MT_post__Station_S
    self.drawConnections(
 )

newfunction = S2S_combine_MDL
