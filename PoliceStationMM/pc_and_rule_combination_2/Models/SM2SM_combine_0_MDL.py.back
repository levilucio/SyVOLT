...
Author: levi
Modified: Fri Jan 16 09:48:02 2015
...
def SM2SM_combine_0_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MoTifRuleRootNode=None, MT_post__PoliceStationMMRootNode=None):
    ...
    # MT_label__
    self.obj75.MT_label__.setValue('12')
    ...
    if self.genGraphics:
       new_obj = graph_MT_post__Attribute(1060.0,460.0,self.obj75)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj76=MT_post__Attribute(self)
    ...
    # MT_label__
    self.obj76.MT_label__.setValue('16')
    ...
    self.obj76.graphClass_= graph_MT_post__Attribute
    if self.genGraphics:
       new_obj = graph_MT_post__Attribute(1380.0,200.0,self.obj76)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Attribute", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj77=MT_post__Equation(self)
    ...
    # MT_label__
    self.obj77.MT_label__.setValue('13')

    # MT_pivotOut__
    self.obj77.MT_pivotOut__.setValue('')
    self.obj77.MT_pivotOut__.setNone()

    self.obj77.graphClass_= graph_MT_post__Equation
    if self.genGraphics:
       new_obj = graph_MT_post__Equation(1140.0,460.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj78=MT_post__Equation(self)
    ...
    # MT_label__
    self.obj78.MT_label__.setValue('17')

    # MT_pivotOut__
    self.obj78.MT_pivotOut__.setValue('')
    self.obj78.MT_pivotOut__.setNone()

    self.obj78.graphClass_= graph_MT_post__Equation
    if self.genGraphics:
       new_obj = graph_MT_post__Equation(1360.0,320.0,self.obj78)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Equation", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj79=MT_post__indirectLink_S(self)
    ...
    self.obj79.graphClass_= graph_MT_post__indirectLink_S
    if self.genGraphics:
       new_obj = graph_MT_post__indirectLink_S(1211.0,241.0,self.obj79)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj80=MT_post__hasAttr_S(self)
    ...
    # MT_label__
    self.obj80.MT_label__.setValue('31')

    # MT_pivotOut__
    self.obj80.MT_pivotOut__.setValue('')
    self.obj80.MT_pivotOut__.setNone()

    self.obj80.graphClass_= graph_MT_post__hasAttr_S
    if self.genGraphics:
       new_obj = graph_MT_post__hasAttr_S(1127.0,365.5,self.obj80)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj81=MT_post__hasAttr_S(self)
    ...
    # MT_label__
    self.obj81.MT_label__.setValue('33')

    # MT_pivotOut__
    self.obj81.MT_pivotOut__.setValue('')
    self.obj81.MT_pivotOut__.setNone()

    self.obj81.graphClass_= graph_MT_post__hasAttr_S
    if self.genGraphics:
       new_obj = graph_MT_post__hasAttr_S(1357.0,235.5,self.obj81)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__hasAttr_S", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj82=MT_post__Constant(self)
    ...
    # MT_label__
    self.obj82.MT_label__.setValue('14')
    ...
    # MT_post__value
    self.obj82.MT_post__value.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn "somestation"\n')
    self.obj82.MT_post__value.setHeight(15)

    self.obj82.graphClass_= graph_MT_post__Constant
    if self.genGraphics:
       new_obj = graph_MT_post__Constant(1260.0,420.0,self.obj82)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj83=MT_post__Constant(self)
    ...
    # MT_label__
    self.obj83.MT_label__.setValue('18')
    ...
    # MT_post__value
    self.obj83.MT_post__value.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn "somemale"\n')
    self.obj83.MT_post__value.setHeight(15)

    self.obj83.graphClass_= graph_MT_post__Constant
    if self.genGraphics:
       new_obj = graph_MT_post__Constant(1380.0,460.0,self.obj83)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__Constant", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0]
    ...
    self.obj84=MT_post__directLink_T(self)
    ...
    # MT_label__
    self.obj84.MT_label__.setValue('11')
    ...
    self.obj84.MT_post__associationType.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn attr_value\n')
    self.obj84.MT_post__associationType.setHeight(15)

    self.obj84.graphClass_= graph_MT_post__directLink_T
    if self.genGraphics:
       new_obj = graph_MT_post__directLink_T(1251.0,361.0,self.obj84)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj85=MT_post__Station_T(self)
    ...
    self.obj85.graphClass_= graph_MT_post__Station_T
    if self.genGraphics:
       new_obj = graph_MT_post__Station_T(1120.0,320.0,self.obj85)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj86=MT_post__trace_link(self)
    ...
    self.obj86.graphClass_= graph_MT_post__trace_link
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1161.0,301.0,self.obj86)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj87=MT_post__trace_link(self)
    ...
    self.obj87.graphClass_= graph_MT_post__trace_link
    if self.genGraphics:
       new_obj = graph_MT_post__trace_link(1301.0,301.0,self.obj87)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__trace_link", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj88=MT_post__rightExpr(self)
    ...
    # MT_label__
    self.obj88.MT_label__.setValue('20')

    # MT_pivotOut__
    self.obj88.MT_pivotOut__.setValue('')
    self.obj88.MT_pivotOut__.setNone()

    self.obj88.graphClass_= graph_MT_post__rightExpr
    if self.genGraphics:
       new_obj = graph_MT_post__rightExpr(1263.5,480.5,self.obj88)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj89=MT_post__rightExpr(self)
    ...
    # MT_label__
    self.obj89.MT_label__.setValue('23')

    # MT_pivotOut__
    self.obj89.MT_pivotOut__.setValue('')
    self.obj89.MT_pivotOut__.setNone()

    self.obj89.graphClass_= graph_MT_post__rightExpr
    if self.genGraphics:
       new_obj = graph_MT_post__rightExpr(1433.5,430.5,self.obj89)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__rightExpr", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj90=MT_post__Station_S(self)
    ...
    self.obj90.MT_post__cardinality.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn attr_value\n')
    self.obj90.MT_post__cardinality.setHeight(15)

    # MT_post__classtype
    self.obj90.MT_post__classtype.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn attr_value\n')
    self.obj90.MT_post__classtype.setHeight(15)

    # MT_post__name
    self.obj90.MT_post__name.setValue('\n#===============================================================================\n# You can access the value of the current node\'s attribute value by: attr_value.\n# If the current node shall be created you MUST initialize it here!\n# You can access a node labelled n by: PreNode(\'n\').\n# To access attribute x of node n, use: PreNode(\'n\')[\'x\'].\n# Note that the attribute values are those before the match is rewritten.\n# The order in which this code is executed depends on the label value\n# of the encapsulating node.\n# The given action must return the new value of the attribute.\n#===============================================================================\n\nreturn attr_value\n')
    self.obj90.MT_post__name.setHeight(15)

    self.obj90.graphClass_= graph_MT_post__Station_S
    if self.genGraphics:
       new_obj = graph_MT_post__Station_S(1080.0,200.0,self.obj90)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj91=MT_post__Male_T(self)
    ...
    # MT_label__
    self.obj91.MT_label__.setValue('4')
    ...
    self.obj91.graphClass_= graph_MT_post__Male_T
    if self.genGraphics:
       new_obj = graph_MT_post__Male_T(1260.0,320.0,self.obj91)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj92=MT_post__Male_S(self)
    ...
    self.obj92.graphClass_= graph_MT_post__Male_S
    if self.genGraphics:
       new_obj = graph_MT_post__Male_S(1220.0,200.0,self.obj92)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj93=MT_post__leftExpr(self)
    ...
    # MT_label__
    self.obj93.MT_label__.setValue('19')

    # MT_pivotOut__
    self.obj93.MT_pivotOut__.setValue('')
    self.obj93.MT_pivotOut__.setNone()

    self.obj93.graphClass_= graph_MT_post__leftExpr
    if self.genGraphics:
       new_obj = graph_MT_post__leftExpr(1162.5,496.0,self.obj93)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj94=MT_post__leftExpr(self)
    ...
    # MT_label__
    self.obj94.MT_label__.setValue('22')

    # MT_pivotOut__
    self.obj94.MT_pivotOut__.setValue('')
    self.obj94.MT_pivotOut__.setNone()

    self.obj94.graphClass_= graph_MT_post__leftExpr
    if self.genGraphics:
       new_obj = graph_MT_post__leftExpr(1432.5,296.0,self.obj94)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("MT_post__leftExpr", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    self.obj72.graphClass_= graph_NAC
    if self.genGraphics:
       new_obj = graph_NAC(120.0,160.0,self.obj72)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj73.graphClass_= graph_RHS
    if self.genGraphics:
       new_obj = graph_RHS(1004.0,160.0,self.obj73)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_LHS(560.0,160.0,self.obj74)
       new_obj.DrawObject(self.UMLmodel)
...
(self.obj71,self.obj66,[847.0, 395.5, 853.0, 523.0],"true", 2) )
    # Connections for obj75 (graphObject_: Obj16) of type MT_post__Attribute
    self.drawConnections(
 )
    # Connections for obj76 (graphObject_: Obj17) of type MT_post__Attribute
    self.drawConnections(
 )
    # Connections for obj77 (graphObject_: Obj18) of type MT_post__Equation
    self.drawConnections(
(self.obj77,self.obj93,[1212.0, 502.0, 1162.5, 496.0],"true", 2),
(self.obj77,self.obj88,[1212.0, 502.0, 1263.5, 480.5],"true", 2) )
    # Connections for obj78 (graphObject_: Obj19) of type MT_post__Equation
    self.drawConnections(
(self.obj78,self.obj94,[1432.0, 362.0, 1432.5, 296.0],"true", 2),
(self.obj78,self.obj89,[1432.0, 362.0, 1433.5, 430.5],"true", 2) )
    # Connections for obj79 (graphObject_: Obj20) of type MT_post__indirectLink_S
    self.drawConnections(
(self.obj79,self.obj92,[1211.0, 241.0, 1281.0, 241.0],"true", 2) )
    # Connections for obj80 (graphObject_: Obj21) of type MT_post__hasAttr_S
    self.drawConnections(
(self.obj80,self.obj75,[1127.0, 365.5, 1113.0, 490.0],"true", 2) )
    # Connections for obj81 (graphObject_: Obj22) of type MT_post__hasAttr_S
    self.drawConnections(
(self.obj81,self.obj76,[1357.0, 235.5, 1433.0, 230.0],"true", 2) )
    # Connections for obj82 (graphObject_: Obj23) of type MT_post__Constant
    self.drawConnections(
 )
    # Connections for obj83 (graphObject_: Obj24) of type MT_post__Constant
    self.drawConnections(
 )
    # Connections for obj84 (graphObject_: Obj25) of type MT_post__directLink_T
    self.drawConnections(
(self.obj84,self.obj91,[1251.0, 361.0, 1321.0, 361.0],"true", 2) )
    # Connections for obj85 (graphObject_: Obj26) of type MT_post__Station_T
    self.drawConnections(
(self.obj85,self.obj84,[1181.0, 361.0, 1251.0, 361.0],"true", 2),
(self.obj85,self.obj86,[1181.0, 361.0, 1161.0, 301.0],"true", 2) )
    # Connections for obj86 (graphObject_: Obj27) of type MT_post__trace_link
    self.drawConnections(
(self.obj86,self.obj90,[1161.0, 301.0, 1141.0, 241.0],"true", 2) )
    # Connections for obj87 (graphObject_: Obj28) of type MT_post__trace_link
    self.drawConnections(
(self.obj87,self.obj92,[1301.0, 301.0, 1281.0, 241.0],"true", 2) )
    # Connections for obj88 (graphObject_: Obj29) of type MT_post__rightExpr
    self.drawConnections(
(self.obj88,self.obj82,[1263.5, 480.5, 1315.0, 459.0],"true", 2) )
    # Connections for obj89 (graphObject_: Obj30) of type MT_post__rightExpr
    self.drawConnections(
(self.obj89,self.obj83,[1433.5, 430.5, 1435.0, 499.0],"true", 2) )
    # Connections for obj90 (graphObject_: Obj31) of type MT_post__Station_S
    self.drawConnections(
(self.obj90,self.obj79,[1141.0, 241.0, 1211.0, 241.0],"true", 2),
(self.obj90,self.obj80,[1141.0, 241.0, 1127.0, 365.5],"true", 2) )
    # Connections for obj91 (graphObject_: Obj32) of type MT_post__Male_T
    self.drawConnections(
(self.obj91,self.obj87,[1321.0, 361.0, 1301.0, 301.0],"true", 2) )
    # Connections for obj92 (graphObject_: Obj33) of type MT_post__Male_S
    self.drawConnections(
(self.obj92,self.obj81,[1281.0, 241.0, 1357.0, 235.5],"true", 2) )
    # Connections for obj93 (graphObject_: Obj34) of type MT_post__leftExpr
    self.drawConnections(
(self.obj93,self.obj75,[1162.5, 496.0, 1113.0, 490.0],"true", 2) )
    # Connections for obj94 (graphObject_: Obj35) of type MT_post__leftExpr
    self.drawConnections(
(self.obj94,self.obj76,[1432.5, 296.0, 1433.0, 230.0],"true", 2) )
    # Connections for obj72 (graphObject_: Obj13) of type NAC
    self.drawConnections(
 )
    # Connections for obj73 (graphObject_: Obj14) of type RHS
    self.drawConnections(
 )
    # Connections for obj74 (graphObject_: Obj15) of type LHS
    self.drawConnections(
 )
