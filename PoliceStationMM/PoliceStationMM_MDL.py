"""
__PoliceStationMM_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Fri Dec 12 15:18:26 2014
...
def PoliceStationMM_MDL(self, rootNode, CD_ClassDiagramsV3RootNode=None):

    # --- Generating attributes code for ASG CD_ClassDiagramsV3 ---
    if( CD_ClassDiagramsV3RootNode ): 
        # name
        CD_ClassDiagramsV3RootNode.name.setValue('PoliceStationMM')
    ...
    # Graphical_Appearance
    self.obj29.Graphical_Appearance.setValue( ('Station_S', self.obj29))

    # name
    self.obj29.name.setValue('Station_S')
    ...
    # Graphical_Appearance
    self.obj30.Graphical_Appearance.setValue( ('Male_S', self.obj30))

    # name
    self.obj30.name.setValue('Male_S')
    ...
    # Graphical_Appearance
    self.obj31.Graphical_Appearance.setValue( ('Female_S', self.obj31))

    # name
    self.obj31.name.setValue('Female_S')
    ...
    # Graphical_Appearance
    self.obj35.Graphical_Appearance.setValue( ('Station_T', self.obj35))

    # name
    self.obj35.name.setValue('Station_T')
    ...
    # Graphical_Appearance
    self.obj36.Graphical_Appearance.setValue( ('Male_T', self.obj36))

    # name
    self.obj36.name.setValue('Male_T')
    ...
    # Graphical_Appearance
    self.obj37.Graphical_Appearance.setValue( ('Female_T', self.obj37))

    # name
    self.obj37.name.setValue('Female_T')
...
(self.obj28,self.obj51,[711.0, 243.1081967213115, 1346.0, 240.975409836],"true", 2) )
    # Connections for obj29 (graphObject_: Obj1) named Station_S
    self.drawConnections(
(self.obj29,self.obj59,[436.0, 341.0, 468.4, 303.6],"true", 2) )
    # Connections for obj30 (graphObject_: Obj2) named Male_S
    self.drawConnections(
(self.obj30,self.obj57,[656.0, 341.0, 641.4, 303.6],"true", 2) )
    # Connections for obj31 (graphObject_: Obj3) named Female_S
    self.drawConnections(
...
(self.obj34,self.obj52,[711.0, 696.1803278688525, 1292.49804688, 838.905737705],"true", 2) )
    # Connections for obj35 (graphObject_: Obj7) named Station_T
    self.drawConnections(
(self.obj35,self.obj62,[476.0, 721.0, 502.3915322780172, 694.0332000000001],"true", 2) )
    # Connections for obj36 (graphObject_: Obj8) named Male_T
    self.drawConnections(
(self.obj36,self.obj60,[616.0, 721.0, 609.8915322780176, 704.0332],"true", 2) )
    # Connections for obj37 (graphObject_: Obj9) named Female_T
    self.drawConnections(
...
newfunction = PoliceStationMM_MDL
