"""
__MT_pre__GenericEdge_PoliceStationMM.py_____________________________________________________
...
from graph_MT_pre__GenericEdge_PoliceStationMM import *
class MT_pre__GenericEdge_PoliceStationMM(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.superTypes = []
      self.graphClass_ = graph_MT_pre__GenericEdge_PoliceStationMM
   ...
   def clone(self):
      cloneObject = MT_pre__GenericEdge_PoliceStationMM( self.parent )
