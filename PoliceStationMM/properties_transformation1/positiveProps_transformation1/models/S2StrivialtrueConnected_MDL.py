"""
__S2StrivialtrueConnected_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: gehan
Modified: Mon Jan 26 16:39:38 2015
...
def S2StrivialtrueConnected_MDL(self, rootNode, MT_pre__PoliceStationMMRootNode=None, MoTifRuleRootNode=None):
    ...
    if( MoTifRuleRootNode ): 
        ...
        # name
        MoTifRuleRootNode.name.setValue('S2StrivialtrueConnected')
    # --- ASG attributes over ---
...
newfunction = S2StrivialtrueConnected_MDL
