"""
__graph_MT_post__Male.py___________________________________________________________
...
class graph_MT_post__Male(graphEntity):
    ...
    def DrawObject(self, drawing, showGG = 0):
        ...
        h = drawing.create_text(self.translate([0.0, 3.0, 0.0, 12.0])[:2], tags = self.tag, font=font, fill = 'grey45', anchor = 'center', text = 'MT_post__Male', width = '0', justify= 'left', stipple='' )
