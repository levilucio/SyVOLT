...
"""
__graph_MT_post__GenericNode_PoliceStationMM.py___________________________________________________________
...
class graph_MT_post__GenericNode_PoliceStationMM(graphEntity):
...
new_class = graph_MT_post__GenericNode_PoliceStationMM
