"""
__ASG_PoliceStationMM.py_____________________________________________________
...
class ASG_PoliceStationMM(ASG, ATOM3Type):
   ...
   def open(self, parent, topWindowParent):
       from ATOM3 import *
       a = ATOM3(topWindowParent, 'PoliceStationMM', 0, 1, self)
