"""
__MT_post__PoliceStationMM_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: levi
Modified: Fri Dec 12 15:20:30 2014
...
def MT_post__PoliceStationMM_MDL(self, rootNode, CD_ClassDiagramsV3RootNode=None):

    # --- Generating attributes code for ASG CD_ClassDiagramsV3 ---
    if( CD_ClassDiagramsV3RootNode ): 
        # name
        CD_ClassDiagramsV3RootNode.name.setValue('MT_post__PoliceStationMM')
    ...
    self.obj81.Graphical_Appearance.setValue( ('MT_post__MetaModelElement_S', self.obj81))

    # name
    self.obj81.name.setValue('MT_post__MetaModelElement_S')
    ...
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_post__GenericEdge_PoliceStationMM', (('Source', 'Destination'), 1), '0', 'N'))
    lcobj2.append(cobj2)
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(520.0,120.0,self.obj81)
    ...
    # Graphical_Appearance
    self.obj82.Graphical_Appearance.setValue( ('MT_post__Station_S', self.obj82))

    # name
    self.obj82.name.setValue('MT_post__Station_S')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(280.0,340.0,self.obj82)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 0.8
    ...
    # Graphical_Appearance
    self.obj83.Graphical_Appearance.setValue( ('MT_post__Male_S', self.obj83))

    # name
    self.obj83.name.setValue('MT_post__Male_S')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(500.0,340.0,self.obj83)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 0.8
    ...
    # Graphical_Appearance
    self.obj84.Graphical_Appearance.setValue( ('MT_post__Female_S', self.obj84))

    # name
    self.obj84.name.setValue('MT_post__Female_S')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(740.0,340.0,self.obj84)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 0.8
    ...
    # Graphical_Appearance
    self.obj85.Graphical_Appearance.setValue( ('MT_post__MatchModel', self.obj85))

    # name
    self.obj85.name.setValue('MT_post__MatchModel')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(20.0,120.0,self.obj85)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 0.8
    ...
    # Graphical_Appearance
    self.obj86.Graphical_Appearance.setValue( ('MT_post__ApplyModel', self.obj86))

    # name
    self.obj86.name.setValue('MT_post__ApplyModel')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(20.0,540.0,self.obj86)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    ...
    # Graphical_Appearance
    self.obj87.Graphical_Appearance.setValue( ('MT_post__MetaModelElement_T', self.obj87))

    # name
    self.obj87.name.setValue('MT_post__MetaModelElement_T')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(520.0,540.0,self.obj87)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    ...
    # Graphical_Appearance
    self.obj88.Graphical_Appearance.setValue( ('MT_post__Station_T', self.obj88))

    # name
    self.obj88.name.setValue('MT_post__Station_T')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(320.0,720.0,self.obj88)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 0.8
    ...
    # Graphical_Appearance
    self.obj89.Graphical_Appearance.setValue( ('MT_post__Male_T', self.obj89))

    # name
    self.obj89.name.setValue('MT_post__Male_T')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(540.0,720.0,self.obj89)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 0.8
    ...
    # Graphical_Appearance
    self.obj90.Graphical_Appearance.setValue( ('MT_post__Female_T', self.obj90))

    # name
    self.obj90.name.setValue('MT_post__Female_T')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(760.0,720.0,self.obj90)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 0.8
    ...
    # Graphical_Appearance
    self.obj91.Graphical_Appearance.setValue( ('MT_post__Attribute', self.obj91))

    # name
    self.obj91.name.setValue('MT_post__Attribute')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(1480.0,500.0,self.obj91)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    ...
    # Graphical_Appearance
    self.obj92.Graphical_Appearance.setValue( ('MT_post__Equation', self.obj92))

    # name
    self.obj92.name.setValue('MT_post__Equation')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(1640.0,0.0,self.obj92)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj93.Graphical_Appearance.setValue( ('MT_post__Expression', self.obj93))

    # name
    self.obj93.name.setValue('MT_post__Expression')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(1640.0,280.0,self.obj93)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj94.Graphical_Appearance.setValue( ('MT_post__Constant', self.obj94))

    # name
    self.obj94.name.setValue('MT_post__Constant')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(2040.0,280.0,self.obj94)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj95.Graphical_Appearance.setValue( ('MT_post__Concat', self.obj95))

    # name
    self.obj95.name.setValue('MT_post__Concat')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(1820.0,720.0,self.obj95)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj119.Graphical_Appearance.setValue( ('MT_post__GenericNode_PoliceStationMM', self.obj119))

    # name
    self.obj119.name.setValue('MT_post__GenericNode_PoliceStationMM')
    ...
    lcobj2 =[]
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_post__GenericEdge_PoliceStationMM', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_post__GenericEdge_PoliceStationMM', (('Source', 'Destination'), 1), '0', 'N'))
    lcobj2.append(cobj2)
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(0.0,0.0,self.obj119)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.815625, 1.0]
    ...
    # Graphical_Appearance
    self.obj96.Graphical_Appearance.setValue( ('MT_post__match_contains', self.obj96))
    self.obj96.Graphical_Appearance.linkInfo=linkEditor(self,self.obj96.Graphical_Appearance.semObject, "match_contains")
    ...
    self.obj96.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('match_contains_1stLink', self.obj96.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj96.Graphical_Appearance.linkInfo.FirstSegment.fill=ATOM3String('grey', 20)
    ...
    self.obj96.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('match_contains_1stSegment', self.obj96.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj96.Graphical_Appearance.linkInfo.Center.setValue( ('match_contains_Center', self.obj96.Graphical_Appearance.linkInfo))
    ...
    self.obj96.Graphical_Appearance.linkInfo.SecondSegment.fill=ATOM3String('grey', 20)
    ...
    self.obj96.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('match_contains_2ndSegment', self.obj96.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj96.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('match_contains_2ndLink', self.obj96.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj96.name.setValue('MT_post__match_contains')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(361.8,199.8,self.obj96)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # Graphical_Appearance
    self.obj97.Graphical_Appearance.setValue( ('MT_post__apply_contains', self.obj97))
    self.obj97.Graphical_Appearance.linkInfo=linkEditor(self,self.obj97.Graphical_Appearance.semObject, "apply_contains")
    ...
    self.obj97.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('apply_contains_1stLink', self.obj97.Graphical_Appearance.linkInfo.FirstLink))
    self.obj97.Graphical_Appearance.linkInfo.FirstSegment= widthXfillXdecoration()
    self.obj97.Graphical_Appearance.linkInfo.FirstSegment.width=ATOM3Integer(1)
    self.obj97.Graphical_Appearance.linkInfo.FirstSegment.fill=ATOM3String('grey', 20)
    ...
    self.obj97.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('apply_contains_1stSegment', self.obj97.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj97.Graphical_Appearance.linkInfo.Center.setValue( ('apply_contains_Center', self.obj97.Graphical_Appearance.linkInfo))
    self.obj97.Graphical_Appearance.linkInfo.SecondSegment= widthXfillXdecoration()
    self.obj97.Graphical_Appearance.linkInfo.SecondSegment.width=ATOM3Integer(1)
    self.obj97.Graphical_Appearance.linkInfo.SecondSegment.fill=ATOM3String('grey', 20)
    ...
    self.obj97.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('apply_contains_2ndSegment', self.obj97.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj97.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('apply_contains_2ndLink', self.obj97.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj97.name.setValue('MT_post__apply_contains')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(362.491532278,586.86445,self.obj97)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 0.8
    ...
    # Graphical_Appearance
    self.obj98.Graphical_Appearance.setValue( ('MT_post__backward_link', self.obj98))
    self.obj98.Graphical_Appearance.linkInfo=linkEditor(self,self.obj98.Graphical_Appearance.semObject, "backward_link")
    ...
    self.obj98.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('backward_link_1stLink', self.obj98.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj98.Graphical_Appearance.linkInfo.FirstSegment.fill=ATOM3String('grey', 20)
    ...
    self.obj98.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('backward_link_1stSegment', self.obj98.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj98.Graphical_Appearance.linkInfo.Center.setValue( ('backward_link_Center', self.obj98.Graphical_Appearance.linkInfo))
    ...
    self.obj98.Graphical_Appearance.linkInfo.SecondSegment.fill=ATOM3String('grey', 20)
    ...
    self.obj98.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('backward_link_2ndSegment', self.obj98.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj98.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('backward_link_2ndLink', self.obj98.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj98.name.setValue('MT_post__backward_link')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1245.0,339.5,self.obj98)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj99.Graphical_Appearance.setValue( ('MT_post__indirectLink_S', self.obj99))
    self.obj99.Graphical_Appearance.linkInfo=linkEditor(self,self.obj99.Graphical_Appearance.semObject, "indirectLink_S")
    ...
    self.obj99.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('indirectLink_S_1stLink', self.obj99.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj99.Graphical_Appearance.linkInfo.FirstSegment.fill=ATOM3String('blue', 20)
    ...
    self.obj99.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('indirectLink_S_1stSegment', self.obj99.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj99.Graphical_Appearance.linkInfo.Center.setValue( ('indirectLink_S_Center', self.obj99.Graphical_Appearance.linkInfo))
    ...
    self.obj99.Graphical_Appearance.linkInfo.SecondSegment.fill=ATOM3String('blue', 20)
    ...
    self.obj99.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('indirectLink_S_2ndSegment', self.obj99.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj99.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('indirectLink_S_2ndLink', self.obj99.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj99.name.setValue('MT_post__indirectLink_S')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1274.5,81.5,self.obj99)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj100.Graphical_Appearance.setValue( ('MT_post__directLink_T', self.obj100))
    self.obj100.Graphical_Appearance.linkInfo=linkEditor(self,self.obj100.Graphical_Appearance.semObject, "directLink_T")
    ...
    self.obj100.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('directLink_T_1stLink', self.obj100.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj100.Graphical_Appearance.linkInfo.FirstSegment.fill=ATOM3String('yellow', 20)
    ...
    self.obj100.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('directLink_T_1stSegment', self.obj100.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj100.Graphical_Appearance.linkInfo.Center.setValue( ('directLink_T_Center', self.obj100.Graphical_Appearance.linkInfo))
    ...
    self.obj100.Graphical_Appearance.linkInfo.SecondSegment.fill=ATOM3String('yellow', 20)
    ...
    self.obj100.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('directLink_T_2ndSegment', self.obj100.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj100.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('directLink_T_2ndLink', self.obj100.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj100.name.setValue('MT_post__directLink_T')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1193.0,684.5,self.obj100)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj101.Graphical_Appearance.setValue( ('MT_post__directLink_S', self.obj101))
    self.obj101.Graphical_Appearance.linkInfo=linkEditor(self,self.obj101.Graphical_Appearance.semObject, "directLink_S")
    ...
    self.obj101.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('directLink_S_1stLink', self.obj101.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj101.Graphical_Appearance.linkInfo.FirstSegment.fill=ATOM3String('yellow', 20)
    ...
    self.obj101.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('directLink_S_1stSegment', self.obj101.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj101.Graphical_Appearance.linkInfo.Center.setValue( ('directLink_S_Center', self.obj101.Graphical_Appearance.linkInfo))
    ...
    self.obj101.Graphical_Appearance.linkInfo.SecondSegment.fill=ATOM3String('yellow', 20)
    ...
    self.obj101.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('directLink_S_2ndSegment', self.obj101.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj101.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('directLink_S_2ndLink', self.obj101.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj101.name.setValue('MT_post__directLink_S')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(950.5,86.5,self.obj101)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj102.Graphical_Appearance.setValue( ('MT_post__paired_with', self.obj102))
    self.obj102.Graphical_Appearance.linkInfo=linkEditor(self,self.obj102.Graphical_Appearance.semObject, "paired_with")
    ...
    self.obj102.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('paired_with_1stLink', self.obj102.Graphical_Appearance.linkInfo.FirstLink))
    self.obj102.Graphical_Appearance.linkInfo.FirstSegment= widthXfillXdecoration()
    self.obj102.Graphical_Appearance.linkInfo.FirstSegment.width=ATOM3Integer(1)
    ...
    self.obj102.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('paired_with_1stSegment', self.obj102.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj102.Graphical_Appearance.linkInfo.Center.setValue( ('paired_with_Center', self.obj102.Graphical_Appearance.linkInfo))
    self.obj102.Graphical_Appearance.linkInfo.SecondSegment= widthXfillXdecoration()
    self.obj102.Graphical_Appearance.linkInfo.SecondSegment.width=ATOM3Integer(1)
    ...
    self.obj102.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('paired_with_2ndSegment', self.obj102.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj102.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('paired_with_2ndLink', self.obj102.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj102.name.setValue('MT_post__paired_with')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(136.0,401.0,self.obj102)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj103.Graphical_Appearance.setValue( ('MT_post__trace_link', self.obj103))
    self.obj103.Graphical_Appearance.linkInfo=linkEditor(self,self.obj103.Graphical_Appearance.semObject, "trace_link")
    ...
    self.obj103.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('trace_link_1stLink', self.obj103.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj103.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('trace_link_1stSegment', self.obj103.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj103.Graphical_Appearance.linkInfo.Center.setValue( ('trace_link_Center', self.obj103.Graphical_Appearance.linkInfo))
    ...
    self.obj103.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('trace_link_2ndSegment', self.obj103.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj103.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('trace_link_2ndLink', self.obj103.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj103.name.setValue('MT_post__trace_link')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1242.0,481.0,self.obj103)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj104.Graphical_Appearance.setValue( ('MT_post__hasAttr_S', self.obj104))
    self.obj104.Graphical_Appearance.linkInfo=linkEditor(self,self.obj104.Graphical_Appearance.semObject, "hasAttr_S")
    ...
    self.obj104.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('hasAttr_S_1stLink', self.obj104.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj104.Graphical_Appearance.linkInfo.FirstSegment.fill=ATOM3String('black', 20)
    ...
    self.obj104.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('hasAttr_S_1stSegment', self.obj104.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj104.Graphical_Appearance.linkInfo.Center.setValue( ('hasAttr_S_Center', self.obj104.Graphical_Appearance.linkInfo))
    ...
    self.obj104.Graphical_Appearance.linkInfo.SecondSegment.fill=ATOM3String('black', 20)
    ...
    self.obj104.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('hasAttr_S_2ndSegment', self.obj104.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj104.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('hasAttr_S_2ndLink', self.obj104.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj104.name.setValue('MT_post__hasAttr_S')
    ...
    # display
    self.obj104.display.setValue('Multiplicities:\n  - To Attribute: 0 to N\n  - From MetaModelElement_S: 0 to N\n')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1346.0,240.975409836,self.obj104)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj105.Graphical_Appearance.setValue( ('MT_post__hasAttr_T', self.obj105))
    self.obj105.Graphical_Appearance.linkInfo=linkEditor(self,self.obj105.Graphical_Appearance.semObject, "hasAttr_T")
    ...
    self.obj105.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('hasAttr_T_1stLink', self.obj105.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj105.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('hasAttr_T_1stSegment', self.obj105.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj105.Graphical_Appearance.linkInfo.Center.setValue( ('hasAttr_T_Center', self.obj105.Graphical_Appearance.linkInfo))
    ...
    self.obj105.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('hasAttr_T_2ndSegment', self.obj105.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj105.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('hasAttr_T_2ndLink', self.obj105.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj105.name.setValue('MT_post__hasAttr_T')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1292.49804688,838.905737705,self.obj105)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj106.Graphical_Appearance.setValue( ('MT_post__leftExpr', self.obj106))
    self.obj106.Graphical_Appearance.linkInfo=linkEditor(self,self.obj106.Graphical_Appearance.semObject, "leftExpr")
    ...
    self.obj106.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('leftExpr_1stLink', self.obj106.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj106.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('leftExpr_1stSegment', self.obj106.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj106.Graphical_Appearance.linkInfo.Center.setValue( ('leftExpr_Center', self.obj106.Graphical_Appearance.linkInfo))
    ...
    self.obj106.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('leftExpr_2ndSegment', self.obj106.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj106.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('leftExpr_2ndLink', self.obj106.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj106.name.setValue('MT_post__leftExpr')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1618.0,211.0,self.obj106)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj107.Graphical_Appearance.setValue( ('MT_post__rightExpr', self.obj107))
    self.obj107.Graphical_Appearance.linkInfo=linkEditor(self,self.obj107.Graphical_Appearance.semObject, "rightExpr")
    ...
    self.obj107.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('rightExpr_1stLink', self.obj107.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj107.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('rightExpr_1stSegment', self.obj107.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj107.Graphical_Appearance.linkInfo.Center.setValue( ('rightExpr_Center', self.obj107.Graphical_Appearance.linkInfo))
    ...
    self.obj107.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('rightExpr_2ndSegment', self.obj107.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj107.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('rightExpr_2ndLink', self.obj107.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj107.name.setValue('MT_post__rightExpr')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1866.15625,208.0,self.obj107)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj108.Graphical_Appearance.setValue( ('MT_post__arg_1', self.obj108))
    self.obj108.Graphical_Appearance.linkInfo=linkEditor(self,self.obj108.Graphical_Appearance.semObject, "arg_1")
    ...
    self.obj108.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('arg_1_1stLink', self.obj108.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj108.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('arg_1_1stSegment', self.obj108.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj108.Graphical_Appearance.linkInfo.Center.setValue( ('arg_1_Center', self.obj108.Graphical_Appearance.linkInfo))
    ...
    self.obj108.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('arg_1_2ndSegment', self.obj108.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj108.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('arg_1_2ndLink', self.obj108.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj108.name.setValue('MT_post__arg_1')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1780.0,551.0,self.obj108)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj109.Graphical_Appearance.setValue( ('MT_post__arg_2', self.obj109))
    self.obj109.Graphical_Appearance.linkInfo=linkEditor(self,self.obj109.Graphical_Appearance.semObject, "arg_2")
    ...
    self.obj109.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('arg_2_1stLink', self.obj109.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj109.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('arg_2_1stSegment', self.obj109.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj109.Graphical_Appearance.linkInfo.Center.setValue( ('arg_2_Center', self.obj109.Graphical_Appearance.linkInfo))
    ...
    self.obj109.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('arg_2_2ndSegment', self.obj109.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj109.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('arg_2_2ndLink', self.obj109.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj109.name.setValue('MT_post__arg_2')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1965.53125,535.0,self.obj109)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 1.0
    ...
    # Graphical_Appearance
    self.obj120.Graphical_Appearance.setValue( ('MT_post__GenericEdge_PoliceStationMM', self.obj120))
    self.obj120.Graphical_Appearance.linkInfo=linkEditor(self,self.obj120.Graphical_Appearance.semObject, "GenericEdge_PoliceStationMM")
    ...
    self.obj120.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('GenericEdge_PoliceStationMM_1stLink', self.obj120.Graphical_Appearance.linkInfo.FirstLink))
    self.obj120.Graphical_Appearance.linkInfo.FirstSegment= widthXfillXdecoration()
    self.obj120.Graphical_Appearance.linkInfo.FirstSegment.width=ATOM3Integer(1)
    self.obj120.Graphical_Appearance.linkInfo.FirstSegment.fill=ATOM3String('purple', 20)
    ...
    self.obj120.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('GenericEdge_PoliceStationMM_1stSegment', self.obj120.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj120.Graphical_Appearance.linkInfo.Center.setValue( ('GenericEdge_PoliceStationMM_Center', self.obj120.Graphical_Appearance.linkInfo))
    self.obj120.Graphical_Appearance.linkInfo.SecondSegment= widthXfillXdecoration()
    self.obj120.Graphical_Appearance.linkInfo.SecondSegment.width=ATOM3Integer(1)
    self.obj120.Graphical_Appearance.linkInfo.SecondSegment.fill=ATOM3String('purple', 20)
    ...
    self.obj120.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('GenericEdge_PoliceStationMM_2ndSegment', self.obj120.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj120.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('GenericEdge_PoliceStationMM_2ndLink', self.obj120.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj120.name.setValue('MT_post__GenericEdge_PoliceStationMM')
    ...
    lcobj2 =[]
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_post__GenericNode_PoliceStationMM', (('Source', 'Destination'), 1), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_post__GenericNode_PoliceStationMM', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_post__MetaModelElement_S', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_post__Station_S', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_post__Male_S', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_post__Female_S', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    ...
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_post__Station_T', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_post__Male_T', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_post__Female_T', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    cobj2=ATOM3Connection()
    cobj2.setValue(('MT_post__Attribute', (('Source', 'Destination'), 0), '0', 'N'))
    lcobj2.append(cobj2)
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(0.0,0.0,self.obj120)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(641.4,303.6,self.obj110)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(754.6,277.8,self.obj111)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(468.4,303.6,self.obj112)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(609.891532278,704.0332,self.obj113)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(757.391532278,694.0332,self.obj114)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(502.391532278,694.0332,self.obj115)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(1656.0,461.0,self.obj116)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(1926.0,405.0,self.obj117)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(1831.0,571.0,self.obj118)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    # Connections for obj81 (graphObject_: Obj64) named MT_post__MetaModelElement_S
    self.drawConnections(
(self.obj81,self.obj99,[711.0, 192.98360655737704, 1274.5, 81.5, 1026.0, 203.0, 1274.5, 81.5],"true", 4),
(self.obj81,self.obj101,[711.0, 192.98360655737704, 950.5, 86.5, 950.5, 86.5],"true", 3),
(self.obj81,self.obj104,[711.0, 243.1081967213115, 1346.0, 240.975409836],"true", 2) )
    # Connections for obj82 (graphObject_: Obj65) named MT_post__Station_S
    self.drawConnections(
(self.obj82,self.obj112,[436.0, 341.0, 468.4, 303.6],"true", 2) )
    # Connections for obj83 (graphObject_: Obj66) named MT_post__Male_S
    self.drawConnections(
(self.obj83,self.obj110,[656.0, 341.0, 641.4, 303.6],"true", 2) )
    # Connections for obj84 (graphObject_: Obj67) named MT_post__Female_S
    self.drawConnections(
(self.obj84,self.obj111,[776.0, 341.0, 754.6, 277.8],"true", 2) )
    # Connections for obj85 (graphObject_: Obj68) named MT_post__MatchModel
    self.drawConnections(
(self.obj85,self.obj96,[211.0, 189.0, 361.8, 199.8],"true", 2),
(self.obj85,self.obj102,[136.0, 261.0, 136.0, 401.0],"true", 2) )
    # Connections for obj86 (graphObject_: Obj69) named MT_post__ApplyModel
    self.drawConnections(
(self.obj86,self.obj97,[211.0, 581.0, 362.491532278, 586.86445],"true", 2) )
    # Connections for obj87 (graphObject_: Obj70) named MT_post__MetaModelElement_T
    self.drawConnections(
(self.obj87,self.obj98,[711.0, 592.9016393442623, 1245.0, 424.5, 1245.0, 339.5],"true", 3),
(self.obj87,self.obj100,[711.0, 696.1803278688525, 1193.0, 684.5, 1193.0, 684.5],"true", 3),
(self.obj87,self.obj103,[711.0, 592.9016393442623, 990.0, 584.0, 1242.0, 481.0],"true", 3),
(self.obj87,self.obj105,[711.0, 696.1803278688525, 1292.49804688, 838.905737705],"true", 2) )
    # Connections for obj88 (graphObject_: Obj71) named MT_post__Station_T
    self.drawConnections(
(self.obj88,self.obj115,[476.0, 721.0, 502.3915322780172, 694.0332000000001],"true", 2) )
    # Connections for obj89 (graphObject_: Obj72) named MT_post__Male_T
    self.drawConnections(
(self.obj89,self.obj113,[616.0, 721.0, 609.8915322780176, 704.0332],"true", 2) )
    # Connections for obj90 (graphObject_: Obj73) named MT_post__Female_T
    self.drawConnections(
(self.obj90,self.obj114,[796.0, 721.0, 757.3915322780169, 694.0332000000001],"true", 2) )
    # Connections for obj91 (graphObject_: Obj74) named MT_post__Attribute
    self.drawConnections(
(self.obj91,self.obj116,[1636.0, 501.0, 1656.0, 461.0],"true", 2) )
    # Connections for obj92 (graphObject_: Obj75) named MT_post__Equation
    self.drawConnections(
(self.obj92,self.obj106,[1676.0, 141.0, 1618.0, 211.0],"true", 2),
(self.obj92,self.obj107,[1831.0, 121.0, 1866.15625, 208.0],"true", 2) )
    # Connections for obj93 (graphObject_: Obj76) named MT_post__Expression
    self.drawConnections(
 )
    # Connections for obj94 (graphObject_: Obj77) named MT_post__Constant
    self.drawConnections(
(self.obj94,self.obj117,[2041.0, 401.0, 1926.0, 405.0],"true", 2) )
    # Connections for obj95 (graphObject_: Obj78) named MT_post__Concat
    self.drawConnections(
(self.obj95,self.obj108,[1859.0, 721.0, 1780.0, 551.0],"true", 2),
(self.obj95,self.obj109,[1979.0, 721.0, 1965.53125, 535.0],"true", 2),
(self.obj95,self.obj118,[1859.0, 721.0, 1831.0, 571.0],"true", 2) )
    # Connections for obj119 (graphObject_: Obj125) named MT_post__GenericNode_PoliceStationMM
    self.drawConnections(
(self.obj119,self.obj120,[1.0, 41.0, -3.0, 5.0], 0, 2) )
    # Connections for obj96 (graphObject_: Obj79) named MT_post__match_contains
    self.drawConnections(
(self.obj96,self.obj81,[361.8, 199.8, 521.0, 192.98360655737704],"true", 2) )
    # Connections for obj97 (graphObject_: Obj81) named MT_post__apply_contains
    self.drawConnections(
(self.obj97,self.obj87,[362.491532278, 586.86445, 521.0, 592.9016393442623],"true", 2) )
    # Connections for obj98 (graphObject_: Obj83) named MT_post__backward_link
    self.drawConnections(
(self.obj98,self.obj81,[1245.0, 339.5, 1245.0, 254.5, 711.0, 243.1081967213115],"true", 3) )
    # Connections for obj99 (graphObject_: Obj85) named MT_post__indirectLink_S
    self.drawConnections(
(self.obj99,self.obj81,[1274.5, 81.5, 1274.5, 81.5, 711.0, 192.98360655737704],"true", 3) )
    # Connections for obj100 (graphObject_: Obj87) named MT_post__directLink_T
    self.drawConnections(
(self.obj100,self.obj87,[1193.0, 684.5, 1193.0, 684.5, 711.0, 696.1803278688525],"true", 3) )
    # Connections for obj101 (graphObject_: Obj89) named MT_post__directLink_S
    self.drawConnections(
(self.obj101,self.obj81,[950.5, 86.5, 950.5, 86.5, 711.0, 192.98360655737704],"true", 3) )
    # Connections for obj102 (graphObject_: Obj91) named MT_post__paired_with
    self.drawConnections(
(self.obj102,self.obj86,[136.0, 401.0, 136.0, 541.0],"true", 2) )
    # Connections for obj103 (graphObject_: Obj93) named MT_post__trace_link
    self.drawConnections(
(self.obj103,self.obj81,[1242.0, 481.0, 937.0, 308.0, 711.0, 291.44262295081967],"true", 3) )
    # Connections for obj104 (graphObject_: Obj95) named MT_post__hasAttr_S
    self.drawConnections(
(self.obj104,self.obj91,[1346.0, 240.97540983606558, 1516.0, 501.0],"true", 2) )
    # Connections for obj105 (graphObject_: Obj97) named MT_post__hasAttr_T
    self.drawConnections(
(self.obj105,self.obj91,[1292.49804688, 838.905737705, 1481.0, 621.0],"true", 2) )
    # Connections for obj106 (graphObject_: Obj99) named MT_post__leftExpr
    self.drawConnections(
(self.obj106,self.obj93,[1618.0, 211.0, 1683.0, 281.0],"true", 2) )
    # Connections for obj107 (graphObject_: Obj101) named MT_post__rightExpr
    self.drawConnections(
(self.obj107,self.obj93,[1866.15625, 208.0, 1803.0, 281.0],"true", 2) )
    # Connections for obj108 (graphObject_: Obj103) named MT_post__arg_1
    self.drawConnections(
(self.obj108,self.obj93,[1780.0, 551.0, 1763.0, 421.0],"true", 2) )
    # Connections for obj109 (graphObject_: Obj105) named MT_post__arg_2
    self.drawConnections(
(self.obj109,self.obj93,[1965.53125, 535.0, 1838.0, 401.0],"true", 2) )
    # Connections for obj120 (graphObject_: Obj126) named MT_post__GenericEdge_PoliceStationMM
    self.drawConnections(
(self.obj120,self.obj119,[-2.0, 5.0, 173.375, 1.0], 0, 2),
(self.obj120,self.obj81,[-0.6689999999999996, 5.0, 521.0, 192.98360655737704], 0, 2),
(self.obj120,self.obj82,[-0.6689999999999996, 5.0, 316.0, 341.0], 0, 2),
(self.obj120,self.obj83,[-0.6689999999999996, 5.0, 536.0, 341.0], 0, 2),
(self.obj120,self.obj84,[-0.6689999999999996, 5.0, 741.0, 381.0], 0, 2),
(self.obj120,self.obj85,[-0.6689999999999996, 5.0, 176.0, 121.0], 0, 2),
(self.obj120,self.obj86,[-0.6689999999999996, 5.0, 176.0, 541.0], 0, 2),
(self.obj120,self.obj87,[-0.6689999999999996, 5.0, 556.0, 541.2622950819672], 0, 2),
(self.obj120,self.obj88,[-0.6689999999999996, 5.0, 356.0, 721.0], 0, 2),
(self.obj120,self.obj89,[-0.6689999999999996, 5.0, 576.0, 721.0], 0, 2),
(self.obj120,self.obj90,[-0.6689999999999996, 5.0, 796.0, 721.0], 0, 2),
(self.obj120,self.obj91,[-0.6689999999999996, 5.0, 1481.0, 541.0], 0, 2),
(self.obj120,self.obj92,[-0.6689999999999996, 5.0, 1641.0, 69.0], 0, 2),
(self.obj120,self.obj93,[-0.6689999999999996, 5.0, 1641.0, 321.0], 0, 2),
(self.obj120,self.obj94,[-0.6689999999999996, 5.0, 2041.0, 321.0], 0, 2),
(self.obj120,self.obj95,[-0.6689999999999996, 5.0, 1821.0, 761.0], 0, 2),
(self.obj120,self.obj119,[-2.0, 5.0, 173.375, 1.0], 0, 2) )
    # Connections for obj110 (graphObject_: Obj107) of type CD_Inheritance3
    self.drawConnections(
(self.obj110,self.obj81,[641.4, 303.6, 636.0, 372.0],"true", 2) )
    # Connections for obj111 (graphObject_: Obj109) of type CD_Inheritance3
    self.drawConnections(
(self.obj111,self.obj81,[754.6, 277.8, 711.0, 291.44262295081967],"true", 2) )
    # Connections for obj112 (graphObject_: Obj111) of type CD_Inheritance3
    self.drawConnections(
(self.obj112,self.obj81,[468.4, 303.6, 521.0, 291.44262295081967],"true", 2) )
    # Connections for obj113 (graphObject_: Obj113) of type CD_Inheritance3
    self.drawConnections(
(self.obj113,self.obj87,[609.891532278, 704.0332, 596.0, 722.0],"true", 2) )
    # Connections for obj114 (graphObject_: Obj115) of type CD_Inheritance3
    self.drawConnections(
(self.obj114,self.obj87,[757.391532278, 694.0332, 711.0, 696.1803278688525],"true", 2) )
    # Connections for obj115 (graphObject_: Obj117) of type CD_Inheritance3
    self.drawConnections(
(self.obj115,self.obj87,[502.391532278, 694.0332, 521.0, 696.1803278688525],"true", 2) )
    # Connections for obj116 (graphObject_: Obj119) of type CD_Inheritance3
    self.drawConnections(
(self.obj116,self.obj93,[1656.0, 461.0, 1683.0, 421.0],"true", 2) )
    # Connections for obj117 (graphObject_: Obj121) of type CD_Inheritance3
    self.drawConnections(
(self.obj117,self.obj93,[1926.0, 405.0, 1838.0, 401.0],"true", 2) )
    # Connections for obj118 (graphObject_: Obj123) of type CD_Inheritance3
    self.drawConnections(
(self.obj118,self.obj93,[1831.0, 571.0, 1803.0, 421.0],"true", 2) )

newfunction = MT_post__PoliceStationMM_MDL
