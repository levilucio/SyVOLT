"""
__graph_MT_post__apply_contains.py___________________________________________________________

Automatically generated LINK for entity MT_post__apply_contains
...
class graph_MT_post__apply_contains(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "apply_contains")
      ...
      self.le.FirstLink.decoration.setValue( ('apply_contains_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('apply_contains_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('apply_contains_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('apply_contains_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('apply_contains_2ndLink', self.le.SecondLink))
