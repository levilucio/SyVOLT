"""
__graph_MT_post__hasAttr_S.py___________________________________________________________

Automatically generated LINK for entity MT_post__hasAttr_S
...
class graph_MT_post__hasAttr_S(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('hasAttr_S_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('hasAttr_S_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('hasAttr_S_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('hasAttr_S_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('hasAttr_S_2ndLink', self.le.SecondLink))
