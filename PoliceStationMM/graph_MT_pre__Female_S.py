"""
__graph_MT_pre__Female_S.py___________________________________________________________
...
class graph_MT_pre__Female_S(graphEntity):
...
new_class = graph_MT_pre__Female_S
