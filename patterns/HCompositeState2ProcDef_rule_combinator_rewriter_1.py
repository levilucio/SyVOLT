...
class HCompositeState2ProcDef_rule_combinator_rewriter_1(HimesisPostConditionPattern):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HCompositeState2ProcDef_rule_combinator_rewriter_1.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HCompositeState2ProcDef_rule_combinator_rewriter_1, self).__init__(name='HCompositeState2ProcDef_rule_combinator_rewriter_1', num_nodes=168, edges=[])
...
"""
        ...
        self.vs[152]["GUID__"] = UUID('cc73d5a4-c441-4d60-a700-68f8d7548fb0')
        self.vs[153]["MT_label__"] = """153"""
        self.vs[153]["mm__"] = """MT_post__trace_link"""
        self.vs[153]["GUID__"] = UUID('21c40694-367f-4eb3-b01d-c6533a1427f9')
        self.vs[154]["MT_label__"] = """154"""
        self.vs[154]["mm__"] = """MT_post__trace_link"""
        self.vs[154]["GUID__"] = UUID('2185bbc1-794a-4d40-b5a2-b33d310e774d')
        self.vs[155]["MT_label__"] = """155"""
        self.vs[155]["mm__"] = """MT_post__trace_link"""
        self.vs[155]["GUID__"] = UUID('8ffaffb5-404f-4043-9a7b-d7e966dda3fa')
        self.vs[156]["MT_label__"] = """156"""
        self.vs[156]["mm__"] = """MT_post__trace_link"""
        self.vs[156]["GUID__"] = UUID('5ecebbfa-0656-4c8d-85ea-cf8d580b1fa7')
        self.vs[157]["MT_label__"] = """157"""
        self.vs[157]["mm__"] = """MT_post__trace_link"""
        self.vs[157]["GUID__"] = UUID('5e381d2f-ab3d-4ba6-9313-1c696ea23fa3')
        self.vs[158]["MT_label__"] = """158"""
        self.vs[158]["mm__"] = """MT_post__trace_link"""
        self.vs[158]["GUID__"] = UUID('4ddae115-34f4-4eb7-aed8-26143e87bcc4')
        self.vs[159]["MT_label__"] = """159"""
        self.vs[159]["mm__"] = """MT_post__trace_link"""
        self.vs[159]["GUID__"] = UUID('e20714ef-3a8f-4568-9401-e7e52613805a')
        self.vs[160]["MT_label__"] = """160"""
        self.vs[160]["mm__"] = """MT_post__trace_link"""
        self.vs[160]["GUID__"] = UUID('86769431-760b-476e-be25-c0c461d15769')
        self.vs[161]["MT_label__"] = """161"""
        self.vs[161]["mm__"] = """MT_post__trace_link"""
        self.vs[161]["GUID__"] = UUID('b3a3da19-0d94-4e4f-923c-ff941a572a60')
        self.vs[162]["MT_label__"] = """162"""
        self.vs[162]["mm__"] = """MT_post__trace_link"""
        self.vs[162]["GUID__"] = UUID('8552ae37-0a09-47aa-9b47-8a11324c11ec')
        self.vs[163]["MT_label__"] = """163"""
        self.vs[163]["mm__"] = """MT_post__trace_link"""
        self.vs[163]["GUID__"] = UUID('7a4d2cfb-330b-4a17-8e4e-45ac723e5c42')
        self.vs[164]["MT_label__"] = """164"""
        self.vs[164]["mm__"] = """MT_post__trace_link"""
        self.vs[164]["GUID__"] = UUID('f619c273-c50b-4c99-b626-67f0d1c0e126')
        self.vs[165]["MT_label__"] = """165"""
        self.vs[165]["mm__"] = """MT_post__trace_link"""
        self.vs[165]["GUID__"] = UUID('8cd3f181-c691-4404-99a1-bdcd7d2128db')
        self.vs[166]["MT_label__"] = """166"""
        self.vs[166]["mm__"] = """MT_post__trace_link"""
        self.vs[166]["GUID__"] = UUID('3c9390cc-66d2-42f0-a91d-7134c08f07dc')
        self.vs[167]["MT_label__"] = """167"""
        self.vs[167]["mm__"] = """MT_post__trace_link"""
        self.vs[167]["GUID__"] = UUID('3874be21-7f2e-4de4-a472-f0163bb911b2')

        from HCompositeState2ProcDef_rule_combinator_matcher_0 import HCompositeState2ProcDef_rule_combinator_matcher_0
        self.pre = HCompositeState2ProcDef_rule_combinator_matcher_0()
    ...
    def execute(self, packet, match):
        ...
        # Constant133
        try:
            graph.vs[labels['133']]['name'] = self.set_name133(graph.vs[labels['133']]['name'], lambda i: graph.vs[match[i]], graph)
        except Exception, e:
            raise Exception('An error has occurred while computing the value of the attribute \'name\'', e)
        
        graph.vs[labels['133']][Himesis.Constants.MT_DIRTY] = True
        # Constant119
        try:
            graph.vs[labels['119']]['name'] = self.set_name119(graph.vs[labels['119']]['name'], lambda i: graph.vs[match[i]], graph)
        except Exception, e:
            raise Exception('An error has occurred while computing the value of the attribute \'name\'', e)
        
        graph.vs[labels['119']][Himesis.Constants.MT_DIRTY] = True
