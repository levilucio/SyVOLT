...
class HConnVirtualDeviceToDistributable_overlapLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        ...
        # Add the edges
        self.add_edges([[1, 3], [3, 2], [2, 4], [4, 0]])
...
return True
"""
        self.vs[1]["GUID__"] = UUID('8bf95358-1439-405a-8ac9-e16615a52562')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('f0f0bcf1-b43d-456a-b664-540d499cc206')
...
"""
        ...
        self.vs[3]["GUID__"] = UUID('3314e56b-8d14-424d-ac04-00ced8275558')
...
"""
        ...
        self.vs[4]["GUID__"] = UUID('b8be36d6-8af8-4a98-81e8-2a56f2748610')
