...
class HTransition2QInstSIBLING_overlapLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HTransition2QInstSIBLING_overlapLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HTransition2QInstSIBLING_overlapLHS, self).__init__(name='HTransition2QInstSIBLING_overlapLHS', num_nodes=9, edges=[])
        
        # Add the edges
        self.add_edges([[2, 6], [6, 3], [2, 7], [7, 0], [0, 8], [8, 1], [0, 4], [1, 5]])
...
return True
"""
        self.vs[1]["GUID__"] = UUID('f2af1e5f-3ad2-4ef0-8ddf-e99434bd4d5f')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('b70f56c5-5d66-4844-8a64-49b0897250a2')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('a0fa5bb1-25b5-4ae4-8ac0-72abe34f5ed6')
...
return True
"""
        self.vs[4]["GUID__"] = UUID('5d3df887-4076-48d9-9459-b5e5354f96f5')
...
return True
"""
        self.vs[5]["GUID__"] = UUID('bd89eb76-fb70-4074-a2d8-8cb6bd920afc')
...
"""
        ...
        self.vs[6]["GUID__"] = UUID('1aea5612-410e-458a-9cf8-0fa61c0468a2')
...
"""
        ...
        self.vs[7]["GUID__"] = UUID('4e499f8c-1ac1-4bf3-bff3-71bade69b6f4')
...
"""
        ...
        self.vs[8]["GUID__"] = UUID('e7cf6169-408c-4263-b7a1-cd985d414979')
