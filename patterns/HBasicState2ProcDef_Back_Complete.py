...
class HBasicState2ProcDef_Back_Complete(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HBasicState2ProcDef_Back_Complete.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HBasicState2ProcDef_Back_Complete, self).__init__(name='HBasicState2ProcDef_Back_Complete', num_nodes=53, edges=[])
...
return True
"""
        self["name"] = """HBasicState2ProcDef_Back_Complete"""
