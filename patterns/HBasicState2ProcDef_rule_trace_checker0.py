...
class HBasicState2ProcDef_rule_trace_checker0(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HBasicState2ProcDef_rule_trace_checker0.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HBasicState2ProcDef_rule_trace_checker0, self).__init__(name='HBasicState2ProcDef_rule_trace_checker0', num_nodes=3, edges=[])
...
return True
"""
        self["name"] = """HBasicState2ProcDef_rule_trace_checker0"""
