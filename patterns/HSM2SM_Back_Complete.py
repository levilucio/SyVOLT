...
class HSM2SM_Back_Complete(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HSM2SM_Back_Complete.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HSM2SM_Back_Complete, self).__init__(name='HSM2SM_Back_Complete', num_nodes=15, edges=[])
...
"""
        ...
        self.vs[4]["mm__"] = """MT_pre__Station_S"""
