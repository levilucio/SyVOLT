...
class HMM2MM_BackLHS0(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMM2MM_BackLHS0.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HMM2MM_BackLHS0, self).__init__(name='HMM2MM_BackLHS0', num_nodes=6, edges=[])
...
return True
"""
        self.vs[2]["MT_pre__classtype"] = """t_"""
        self.vs[2]["classtype"] = """
#===============================================================================
# This code is executed when evaluating if a node shall be matched by this rule.
# You can access the value of the current node's attribute value by: attr_value.
...
return True
"""
        self.vs[4]["MT_pre__cardinality"] = """s_"""
