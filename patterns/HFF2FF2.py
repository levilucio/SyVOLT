...
class HFF2FF2(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HFF2FF2.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HFF2FF2, self).__init__(name='HFF2FF2', num_nodes=7, edges=[])
