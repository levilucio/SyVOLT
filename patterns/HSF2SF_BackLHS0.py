...
class HSF2SF_BackLHS0(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HSF2SF_BackLHS0.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HSF2SF_BackLHS0, self).__init__(name='HSF2SF_BackLHS0', num_nodes=6, edges=[])
