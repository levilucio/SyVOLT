...
class HMM2MM1(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMM2MM1.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HMM2MM1, self).__init__(name='HMM2MM1', num_nodes=6, edges=[])
