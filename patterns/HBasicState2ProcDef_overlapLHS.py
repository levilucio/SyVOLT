...
class HBasicState2ProcDef_overlapLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HBasicState2ProcDef_overlapLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HBasicState2ProcDef_overlapLHS, self).__init__(name='HBasicState2ProcDef_overlapLHS', num_nodes=3, edges=[])
...
"""
        ...
        self.vs[1]["GUID__"] = UUID('8d3ea17a-819f-490b-a938-da50d2290119')
...
"""
        ...
        self.vs[2]["GUID__"] = UUID('70191e2b-3a0f-455c-b75b-c9d4ea6a479b')
