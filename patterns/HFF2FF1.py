...
class HFF2FF1(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HFF2FF1.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HFF2FF1, self).__init__(name='HFF2FF1', num_nodes=6, edges=[])
