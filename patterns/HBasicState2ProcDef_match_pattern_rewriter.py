...
class HBasicState2ProcDef_match_pattern_rewriter(HimesisPostConditionPattern):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HBasicState2ProcDef_match_pattern_rewriter.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HBasicState2ProcDef_match_pattern_rewriter, self).__init__(name='HBasicState2ProcDef_match_pattern_rewriter', num_nodes=56, edges=[])
...
"""
        ...
        self.vs[23]["GUID__"] = UUID('ec2efa14-b3e3-4587-98de-c2248d620ed7')
        self.vs[24]["MT_label__"] = """54"""
        self.vs[24]["mm__"] = """MT_post__trace_link"""
        self.vs[24]["GUID__"] = UUID('921c1e7b-8a0f-4954-a5a6-4799c0448d5e')
        self.vs[25]["MT_label__"] = """55"""
        self.vs[25]["mm__"] = """MT_post__trace_link"""
        self.vs[25]["GUID__"] = UUID('69ebb155-2e79-4589-9513-68c7d5f50b22')
...
"""
        ...
        from HBasicState2ProcDef_match_pattern_matcher import HBasicState2ProcDef_match_pattern_matcher
        self.pre = HBasicState2ProcDef_match_pattern_matcher()
    ...
    def execute(self, packet, match):
        ...
        try:
            graph.vs[new_node]['name'] = self.set_name47(None, lambda i: graph.vs[match[i]], graph)
        except Exception, e:
        ...
        graph.vs[new_node][Himesis.Constants.META_MODEL] = 'Constant'
        try:
            graph.vs[new_node]['name'] = self.set_name48(None, lambda i: graph.vs[match[i]], graph)
        except Exception, e:
            raise Exception('An error has occurred while computing the value of the attribute \'name\'', e)
        # Constant49
        new_node = graph.add_node()
        ...
        # ProcDef8 -> hasAttribute_T17
        graph.add_edges([(labels['8'], labels['17'])])
        # hasAttribute_T17 -> Attribute39
        graph.add_edges([(labels['17'], labels['39'])])
        ...
        # Equation29 -> rightExpr23
        graph.add_edges([(labels['29'], labels['23'])])
        # rightExpr23 -> Constant47
        graph.add_edges([(labels['23'], labels['47'])])
        # Equation30 -> rightExpr24
        graph.add_edges([(labels['30'], labels['24'])])
        # rightExpr24 -> Constant48
        graph.add_edges([(labels['24'], labels['48'])])
