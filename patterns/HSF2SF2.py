...
class HSF2SF2(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HSF2SF2.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HSF2SF2, self).__init__(name='HSF2SF2', num_nodes=7, edges=[])
