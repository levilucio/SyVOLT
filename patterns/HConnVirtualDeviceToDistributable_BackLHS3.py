...
class HConnVirtualDeviceToDistributable_BackLHS3(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HConnVirtualDeviceToDistributable_BackLHS3.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HConnVirtualDeviceToDistributable_BackLHS3, self).__init__(name='HConnVirtualDeviceToDistributable_BackLHS3', num_nodes=8, edges=[])
        
        # Add the edges
        self.add_edges([[3, 6], [6, 2], [5, 0], [7, 0], [4, 1], [1, 3], [2, 7], [4, 5]])
...
return True
"""
        self["name"] = """HConnVirtualDeviceToDistributable_BackLHS3"""
...
"""
        ...
        self.vs[5]["GUID__"] = UUID('209a01fe-bf07-4f08-b4cf-e22772a7f842')
...
"""
        ...
        self.vs[6]["GUID__"] = UUID('6a6af713-9eec-4f63-a1a8-aeea275cfd23')
        self.vs[7]["MT_subtypeMatching__"] = False
        self.vs[7]["MT_label__"] = """25"""
        self.vs[7]["MT_subtypes__"] = """[]"""
        self.vs[7]["mm__"] = """MT_pre__trace_link"""
        self.vs[7]["MT_dirty__"] = False
        self.vs[7]["GUID__"] = UUID('36cb4950-71ff-4a81-8142-3835aec06188')
