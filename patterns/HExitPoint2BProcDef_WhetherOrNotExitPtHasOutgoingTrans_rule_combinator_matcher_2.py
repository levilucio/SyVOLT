...
class HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_rule_combinator_matcher_2(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_rule_combinator_matcher_2.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_rule_combinator_matcher_2, self).__init__(name='HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_rule_combinator_matcher_2', num_nodes=17, edges=[])
...
return True
"""
        self["name"] = """HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_rule_combinator_matcher_2_rc_matcher"""
