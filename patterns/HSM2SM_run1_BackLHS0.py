...
class HSM2SM_run1_BackLHS0(HimesisPreConditionPatternLHS):
    def __init__(self):
        ...
        super(HSM2SM_run1_BackLHS0, self).__init__(name='HSM2SM_run1_BackLHS0', num_nodes=6, edges=[])
...
return True
"""
        self.vs[0]["GUID__"] = UUID('66f60d0a-10c6-48ee-904f-8892b7593a57')
...
return True
"""
        self.vs[1]["GUID__"] = UUID('25f8f13e-688d-49c2-a236-b32a94a8a0a8')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('9e2c90f0-b024-46bd-b8ce-97500b5b0f8e')
