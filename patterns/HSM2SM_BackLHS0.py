...
class HSM2SM_BackLHS0(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HSM2SM_BackLHS0.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HSM2SM_BackLHS0, self).__init__(name='HSM2SM_BackLHS0', num_nodes=6, edges=[])
...
return True
"""
        self.vs[0]["MT_pre__cardinality"] = """s_"""
