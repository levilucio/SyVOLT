...
class HSM2SM1(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HSM2SM1.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HSM2SM1, self).__init__(name='HSM2SM1', num_nodes=6, edges=[])
