...
class HFF2FF_overlapLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HFF2FF_overlapLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HFF2FF_overlapLHS, self).__init__(name='HFF2FF_overlapLHS', num_nodes=3, edges=[])
...
"""
        ...
        self.vs[1]["GUID__"] = UUID('06925961-9c12-4c77-aff3-8d837da79749')
...
"""
        ...
        self.vs[2]["GUID__"] = UUID('dc45b2e9-7e78-4c4f-987a-b4b491b553ad')
