...
class HConnectPPortPrototype_Back_Complete(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HConnectPPortPrototype_Back_Complete.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HConnectPPortPrototype_Back_Complete, self).__init__(name='HConnectPPortPrototype_Back_Complete', num_nodes=23, edges=[])
...
return True
"""
        self["name"] = """HConnectPPortPrototype_Back_Complete"""
