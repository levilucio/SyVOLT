...
class HSF2SF1(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HSF2SF1.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HSF2SF1, self).__init__(name='HSF2SF1', num_nodes=6, edges=[])
