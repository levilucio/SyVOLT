...
class HS2S_matchLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HS2S_matchLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HS2S_matchLHS, self).__init__(name='HS2S_matchLHS', num_nodes=3, edges=[])
...
"""
        ...
        self.vs[0]["GUID__"] = UUID('756bae34-952e-400c-be0b-4f68fbbaa1fe')
...
"""
        ...
        self.vs[1]["GUID__"] = UUID('a8600e37-d936-44ca-bc46-7a9d28cc631e')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('e829868f-eda2-4a6d-bd26-afe37fb27c85')
