...
class HMM2MM2(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMM2MM2.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HMM2MM2, self).__init__(name='HMM2MM2', num_nodes=7, edges=[])
