...
class HSM2SM2(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HSM2SM2.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HSM2SM2, self).__init__(name='HSM2SM2', num_nodes=7, edges=[])
