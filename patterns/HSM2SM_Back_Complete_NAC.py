...
class HSM2SM_Back_Complete_NAC(HimesisPreConditionPatternNAC):
    def __init__(self, LHS):
        """
        Creates the himesis graph representing the AToM3 model HSM2SM_Back_Complete_NAC.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HSM2SM_Back_Complete_NAC, self).__init__(name='HSM2SM_Back_Complete_NAC', num_nodes=7, edges=[], LHS=LHS)
        
        # Add the edges
        self.add_edges([[2, 5], [5, 1], [3, 6], [6, 4], [1, 0], [0, 4]])
...
return True
"""
        self["name"] = """HSM2SM_Back_Complete"""
...
"""
        ...
        self.vs[0]["GUID__"] = UUID('3998c665-525c-412f-b3ea-10756dddd288')
...
return True
"""
        self.vs[1]["MT_pre__cardinality"] = """s_"""
        self.vs[1]["GUID__"] = UUID('1eb29cc0-6f72-4fbd-b452-b1992a41f473')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('269ae635-3c89-4bf7-8d0f-8f75c71893e0')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('8861e26f-a52d-4731-ab78-b2d1de7e7020')
...
return True
"""
        self.vs[4]["GUID__"] = UUID('e7e201bc-0566-49ad-be9a-3258fc2f2b01')
...
return True
"""
        self.vs[5]["GUID__"] = UUID('d7c197b3-4bca-4aa7-ad07-f2871a497999')
...
return True
"""
        self.vs[6]["GUID__"] = UUID('49384bb0-96aa-4187-ae2b-8a79a5bb538f')

        
        # Load the bridge between this NAC and its LHS
        from HSM2SM_Back_Complete_NACBridge import HSM2SM_Back_Complete_NACBridge
        self.bridge = HSM2SM_Back_Complete_NACBridge()
