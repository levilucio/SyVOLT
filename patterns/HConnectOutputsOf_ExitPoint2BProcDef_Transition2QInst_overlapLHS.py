...
class HConnectOutputsOf_ExitPoint2BProcDef_Transition2QInst_overlapLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HConnectOutputsOf_ExitPoint2BProcDef_Transition2QInst_overlapLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HConnectOutputsOf_ExitPoint2BProcDef_Transition2QInst_overlapLHS, self).__init__(name='HConnectOutputsOf_ExitPoint2BProcDef_Transition2QInst_overlapLHS', num_nodes=3, edges=[])
...
"""
        ...
        self.vs[1]["GUID__"] = UUID('b7ca7333-4d0d-4257-a396-cbdac03aaa74')
...
"""
        ...
        self.vs[2]["GUID__"] = UUID('c3200ca9-b83f-4c9b-b0a2-5bd97a7f49ee')
