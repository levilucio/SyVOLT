...
class HConnectOP_State2CProcDef_Transition2Inst_OtherInTransitions_overlapLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HConnectOP_State2CProcDef_Transition2Inst_OtherInTransitions_overlapLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HConnectOP_State2CProcDef_Transition2Inst_OtherInTransitions_overlapLHS, self).__init__(name='HConnectOP_State2CProcDef_Transition2Inst_OtherInTransitions_overlapLHS', num_nodes=9, edges=[])
        
        # Add the edges
        self.add_edges([[2, 6], [6, 3], [3, 7], [7, 1], [3, 8], [8, 0], [0, 4], [2, 5]])
...
return True
"""
        self.vs[1]["GUID__"] = UUID('21faf13c-0810-421b-912c-dfc7a7dfd513')
...
return True
"""
        self.vs[2]["GUID__"] = UUID('ff70f313-7ab2-4a33-afd3-1c7695c1c615')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('b3c14691-4354-4f83-a900-6af37b747437')
...
return True
"""
        self.vs[4]["GUID__"] = UUID('463bd845-a0c0-4f25-96e3-01a405d770be')
...
return True
"""
        self.vs[5]["GUID__"] = UUID('a548cd2e-9328-45a1-90e7-97ff4d1ee706')
...
"""
        ...
        self.vs[6]["GUID__"] = UUID('f33d60dc-91d0-424d-a055-3ea120debf98')
...
"""
        ...
        self.vs[7]["GUID__"] = UUID('f32bd676-f039-4a8e-9dd1-d7af4cfe538e')
...
"""
        ...
        self.vs[8]["GUID__"] = UUID('438d3c27-3485-4e78-b49d-2545c63cdd88')
