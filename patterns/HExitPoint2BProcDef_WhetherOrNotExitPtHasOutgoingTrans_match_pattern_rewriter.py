...
class HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_match_pattern_rewriter(HimesisPostConditionPattern):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_match_pattern_rewriter.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_match_pattern_rewriter, self).__init__(name='HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_match_pattern_rewriter', num_nodes=72, edges=[])
...
"""
        ...
        self.vs[64]["GUID__"] = UUID('62537897-4f35-4322-becb-8ab3057455f0')
        self.vs[65]["MT_label__"] = """65"""
        self.vs[65]["mm__"] = """MT_post__trace_link"""
        self.vs[65]["GUID__"] = UUID('2e89f162-491f-48c5-9da2-247c9fff8242')
        self.vs[66]["MT_label__"] = """66"""
        self.vs[66]["mm__"] = """MT_post__trace_link"""
        self.vs[66]["GUID__"] = UUID('fe1f51c5-14c1-47a2-83d7-e80985f7cd4a')
        self.vs[67]["MT_label__"] = """67"""
        self.vs[67]["mm__"] = """MT_post__trace_link"""
        self.vs[67]["GUID__"] = UUID('e5d28cfb-41db-4951-a948-bfd400edc776')
        self.vs[68]["MT_label__"] = """68"""
        self.vs[68]["mm__"] = """MT_post__trace_link"""
        self.vs[68]["GUID__"] = UUID('0dbc5bf9-8013-4871-b24d-da460ee0c49b')
        self.vs[69]["MT_label__"] = """69"""
        self.vs[69]["mm__"] = """MT_post__trace_link"""
        self.vs[69]["GUID__"] = UUID('0ba406c7-b5f5-4d19-ab9a-488eb2b8507b')
        self.vs[70]["MT_label__"] = """70"""
        self.vs[70]["mm__"] = """MT_post__trace_link"""
        self.vs[70]["GUID__"] = UUID('76d6f912-5920-4672-a348-449b09744671')
        self.vs[71]["MT_label__"] = """71"""
        self.vs[71]["mm__"] = """MT_post__trace_link"""
        self.vs[71]["GUID__"] = UUID('8603fdc7-4bba-446d-b0e9-1a4a49689a1b')

        from HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_match_pattern_matcher import HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_match_pattern_matcher
        self.pre = HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_match_pattern_matcher()
    ...
    def execute(self, packet, match):
        ...
        try:
            graph.vs[new_node]['name'] = self.set_name51(None, lambda i: graph.vs[match[i]], graph)
        except Exception, e:
        ...
        graph.vs[new_node][Himesis.Constants.META_MODEL] = 'Constant'
        try:
            graph.vs[new_node]['name'] = self.set_name55(None, lambda i: graph.vs[match[i]], graph)
        except Exception, e:
            raise Exception('An error has occurred while computing the value of the attribute \'name\'', e)
        # Constant56
        new_node = graph.add_node()
        ...
        # LocalDef2 -> hasAttribute_T26
        graph.add_edges([(labels['2'], labels['26'])])
        # hasAttribute_T26 -> Attribute62
        graph.add_edges([(labels['26'], labels['62'])])
        ...
        # Equation39 -> rightExpr33
        graph.add_edges([(labels['39'], labels['33'])])
        # rightExpr33 -> Constant51
        graph.add_edges([(labels['33'], labels['51'])])
        ...
        # Equation43 -> leftExpr49
        graph.add_edges([(labels['43'], labels['49'])])
        # Equation44 -> leftExpr50
        graph.add_edges([(labels['44'], labels['50'])])
        # leftExpr45 -> Attribute57
        graph.add_edges([(labels['45'], labels['57'])])
        ...
        # leftExpr49 -> Attribute62
        graph.add_edges([(labels['49'], labels['62'])])
