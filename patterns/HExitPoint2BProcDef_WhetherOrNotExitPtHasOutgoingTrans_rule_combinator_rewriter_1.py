...
class HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_rule_combinator_rewriter_1(HimesisPostConditionPattern):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_rule_combinator_rewriter_1.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_rule_combinator_rewriter_1, self).__init__(name='HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_rule_combinator_rewriter_1', num_nodes=72, edges=[])
...
"""
        ...
        self.pre = HExitPoint2BProcDef_WhetherOrNotExitPtHasOutgoingTrans_rule_combinator_matcher_1()
    ...
    def execute(self, packet, match):
        ...
        new_node = graph.add_node()
        labels['10'] = new_node
        graph.vs[new_node][Himesis.Constants.META_MODEL] = 'ExitPoint'
        # Name12
        new_node = graph.add_node()
        labels['12'] = new_node
        ...
        # directLink_S0 -> ExitPoint10
        graph.add_edges([(labels['0'], labels['10'])])
