...
class HBasicStateNoOutgoing2ProcDef_Back_Complete(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HBasicStateNoOutgoing2ProcDef_Back_Complete.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HBasicStateNoOutgoing2ProcDef_Back_Complete, self).__init__(name='HBasicStateNoOutgoing2ProcDef_Back_Complete', num_nodes=29, edges=[])
...
return True
"""
        self["name"] = """HBasicStateNoOutgoing2ProcDef_Back_Complete"""
