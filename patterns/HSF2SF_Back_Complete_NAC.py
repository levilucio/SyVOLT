...
class HSF2SF_Back_Complete_NAC(HimesisPreConditionPatternNAC):
    def __init__(self, LHS):
        """
        Creates the himesis graph representing the AToM3 model HSF2SF_Back_Complete_NAC.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HSF2SF_Back_Complete_NAC, self).__init__(name='HSF2SF_Back_Complete_NAC', num_nodes=7, edges=[], LHS=LHS)
        
        # Add the edges
        self.add_edges([[3, 5], [5, 2], [0, 6], [6, 4], [2, 1], [1, 4]])
...
return True
"""
        self["name"] = """HSF2SF_Back_Complete"""
...
return True
"""
        self.vs[0]["MT_pre__classtype"] = """t_"""
        self.vs[0]["classtype"] = """
#===============================================================================
# This code is executed when evaluating if a node shall be matched by this rule.
# You can access the value of the current node's attribute value by: attr_value.
...
return True
"""
        self.vs[1]["GUID__"] = UUID('44a81247-25fa-47d9-a21b-14da925a500f')
...
return True
"""
        self.vs[2]["MT_pre__cardinality"] = """s_"""
        self.vs[2]["GUID__"] = UUID('0164d0c3-6f5a-4221-bfc2-48992a04def8')
...
return True
"""
        self.vs[3]["GUID__"] = UUID('9c9491e7-3572-42a5-bebf-7d2ce3719e3c')
...
return True
"""
        self.vs[4]["GUID__"] = UUID('655f179c-24de-49f9-b91c-4f9238eea279')
...
return True
"""
        self.vs[5]["GUID__"] = UUID('cdeb65d6-aff4-4b8f-9549-af9660ddda55')
...
return True
"""
        self.vs[6]["GUID__"] = UUID('9e9e357d-093a-4ffa-bd7a-b7ebc8660ab9')

        
        # Load the bridge between this NAC and its LHS
        from HSF2SF_Back_Complete_NACBridge import HSF2SF_Back_Complete_NACBridge
        self.bridge = HSF2SF_Back_Complete_NACBridge()
