...
class HCompositeState2ProcDef_overlapLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HCompositeState2ProcDef_overlapLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HCompositeState2ProcDef_overlapLHS, self).__init__(name='HCompositeState2ProcDef_overlapLHS', num_nodes=2, edges=[])
