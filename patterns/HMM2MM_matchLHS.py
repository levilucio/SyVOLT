...
class HMM2MM_matchLHS(HimesisPreConditionPatternLHS):
    def __init__(self):
        """
        Creates the himesis graph representing the AToM3 model HMM2MM_matchLHS.
        """
        # Flag this instance as compiled now
        self.is_compiled = True
        
        super(HMM2MM_matchLHS, self).__init__(name='HMM2MM_matchLHS', num_nodes=7, edges=[])
